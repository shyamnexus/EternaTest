...
static int mp4_h265_write_nal(mp4_h26x_writer_t *h, const unsigned char *nal, int sizeof_nal, unsigned timeStamp90kHz_next)
{
    ...
    case HEVC_NAL_PPS:
        ...
        h->need_pps = 0;
        break;
    case 35: // AUD - Access Unit Delimiter
    case 36: // EOS - End of Sequence
    case 37: // EOB - End of Bitstream
    case 38: // FD  - Filler Data
    case 39: // PREFIX_SEI
    case 40: // SUFFIX_SEI
        break; // skip non-VCL NALs that don't carry sample data
    default:
