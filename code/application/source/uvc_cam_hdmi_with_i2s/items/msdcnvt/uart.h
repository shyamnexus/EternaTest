...
inline void uart_init(UART_BAUDRATE BaudRate, UART_LENGTH Length, UART_PARITY Parity)
{
...
#else
extern void uart_init(UART_BAUDRATE BaudRate, UART_LENGTH Length, UART_PARITY Parity);
#endif
...
inline void uart2_init(UART_BAUDRATE BaudRate, UART_LENGTH Length, UART_PARITY Parity)
{
...
#if defined(__FREERTOS)
inline void uart3_init(UART_BAUDRATE BaudRate, UART_LENGTH Length, UART_PARITY Parity)
{
...
#else
extern void uart3_init(UART_BAUDRATE BaudRate, UART_LENGTH Length, UART_PARITY Parity);
#endif
//
//  Extern UART4 APIs
//
...
inline void uart4_init(UART_BAUDRATE BaudRate, UART_LENGTH Length, UART_PARITY Parity)
{
