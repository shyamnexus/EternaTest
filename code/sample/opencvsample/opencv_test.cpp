...
static void opencv_test_hog()
{
	...
	ifstream fin;
	HOGDescriptor hog(Size(OPENCVTEST_HOG_WIN_H       , OPENCVTEST_HOG_WIN_W),
					  Size(OPENCVTEST_HOG_BLK_H       , OPENCVTEST_HOG_BLK_W),
					  Size(OPENCVTEST_HOG_BLK_STRIDE_H, OPENCVTEST_HOG_BLK_STRIDE_W),
					  Size(OPENCVTEST_HOG_CELL_H      , OPENCVTEST_HOG_CELL_W),
	...
	hog.compute(src, desc,
			Size(OPENCVTEST_HOG_WIN_STRIDE_H, OPENCVTEST_HOG_WIN_STRIDE_W),
			Size(OPENCVTEST_HOG_PAD_H, OPENCVTEST_HOG_PAD_W));
