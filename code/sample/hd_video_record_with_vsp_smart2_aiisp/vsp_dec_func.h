...
extern HD_RESULT set_dec_cfg(HD_PATH_ID video_dec_path, HD_DIM *p_max_dim, UINT32 dec_type);
extern HD_RESULT set_dec_param(HD_PATH_ID video_dec_path, UINT32 dec_type);
extern HD_RESULT open_module_dec1(VIDEO_RECORD *p_stream, HD_DIM* p_proc_max_dim);
extern HD_RESULT open_module_dec2(VIDEO_RECORD *p_stream, HD_DIM* p_proc_max_dim);
extern HD_RESULT open_module_dec3(VIDEO_RECORD *p_stream, HD_DIM* p_proc_max_dim);
extern HD_RESULT open_module_dec4(VIDEO_RECORD *p_stream, HD_DIM* p_proc_max_dim);
extern BOOL check_test_pattern(UINT32 dec_type);
extern HD_RESULT get_video_frame_buf(HD_VIDEO_FRAME *p_video_frame, UINT32 dec_type);
extern void *feed_bs_thread_1(void *arg);
extern void *feed_bs_thread_2(void *arg);
extern void *feed_bs_thread_3(void *arg);
extern void *feed_bs_thread_4(void *arg);

//////////////////////////////////////////////////////////////

extern HD_RESULT set_proc_cfg(HD_PATH_ID *p_video_proc_ctrl, HD_DIM* p_max_dim, HD_OUT_ID _out_id, UINT32 isp_id, UINT32 ref_3dnr_id, UINT32 in_plxfmt);
