...
typedef uintptr_t (*NVTLIVE555_OPEN_STRM)(int channel);
typedef int(*NVTLIVE555_CLOSE_STRM)(uintptr_t handle);
typedef int(*NVTLIVE555_GET_VIDEO_INFO)(uintptr_t handle, int timeout_ms, NVTLIVE555_VIDEO_INFO *p_info);
typedef int(*NVTLIVE555_GET_AUDIO_INFO)(uintptr_t handle, int timeout_ms, NVTLIVE555_AUDIO_INFO *p_info);
typedef int(*NVTLIVE555_LOCK_STRM)(uintptr_t handle, int timeout_ms, NVTLIVE555_STRM_INFO *p_strm);
typedef int(*NVTLIVE555_UNLOCK_STRM)(uintptr_t handle);
