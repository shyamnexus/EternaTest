...
typedef IACOMM_SENSOR_INFO  USBMOVIE_SENSOR_INFO;
...
extern ER ImageApp_UsbMovie_Config(UINT32 config_id, ULONG value);
/// ImageApp_UsbMovie_Param
extern ER ImageApp_UsbMovie_SetParam(UINT32 id, UINT32 param, ULONG value);
extern ER ImageApp_UsbMovie_GetParam(UINT32 id, UINT32 param, void *value);
