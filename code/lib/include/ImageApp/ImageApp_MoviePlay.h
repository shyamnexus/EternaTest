...
typedef struct {
	...
	void (*event_cb)(UINT32 event_id, ULONG p1, ULONG p2, ULONG p3);                ///< user play callback event
...
typedef struct {
	...
	IACOMM_HDMEM_TYPE               desc_addr;        ///< video decode description addr (for H.264 and H.265)
...
typedef struct {
    ...
    IACOMM_HDMEM_TYPE        vb_pool_va;
    IACOMM_HDMEM_TYPE        vb_pool_pa;
...
/**
    ...
    @return UINT32
*/
extern ULONG ImageApp_MoviePlay_GetParam(UINT32 param);
...
/**
    ...
    @return ISF_RV
*/
extern ISF_RV ImageApp_MoviePlay_Config(UINT32 config_id, ULONG value);
...
extern ER SMediaPlay_FileRecovery(char *pFilePath, IACOMM_HDMEM_TYPE memAddr, UINT32 size);
