...
typedef INT32(*PHOTO_CAP_FSYS_FP)(uintptr_t Addr, UINT32 Size, UINT32 Fmt, INT32 SensorID);
...
/**
    ...
    @endcode
*/
extern void ImageApp_Photo_Config(UINT32 config_id, ULONG value);
...
extern void ImageApp_Photo_DispConfig(UINT32 config_id, ULONG value);
...
extern void ImageApp_Photo_WiFiConfig(UINT32 config_id, ULONG value);
...
extern void ImageApp_Photo_CapConfig(UINT32 config_id, ULONG value);
