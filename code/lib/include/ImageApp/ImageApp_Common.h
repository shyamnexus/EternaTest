...
#define IACOMM_HDMEM_TYPE               UINT32
#define IACOMM_LIVE555_HDL_TYPE         int
#else
#define IACOMM_HDMEM_TYPE               uintptr_t
#define IACOMM_LIVE555_HDL_TYPE         uintptr_t
#endif
...
typedef void (IACommonUserEventCb)(UINT32 id, IACOMM_USER_CB_EVENT event_id, ULONG value);
...
extern ER ImageApp_Common_SetParam(UINT32 id, UINT32 param, ULONG value);
extern ER ImageApp_Common_GetParam(UINT32 id, UINT32 param, void *value);
