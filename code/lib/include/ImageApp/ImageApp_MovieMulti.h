...
typedef IACOMM_SENSOR_INFO  MOVIE_SENSOR_INFO;
...
typedef struct {
	MOVIE_CFG_REC_ID  rec_id;
	UINT32            vin_id;               /// BYTE[3..2]: reserved, BYTE[1]: chip_id, BYTE[0]: vin_id
	UINT32            vcap_id_bit;
} MOVIE_AD_MAP;
...
typedef void (MovieUserEventCb)(UINT32 id, MOVIE_USER_CB_EVENT event_id, ULONG value);

typedef void (MovieAudCapCb)(IACOMM_HDMEM_TYPE pa, IACOMM_HDMEM_TYPE va, UINT32 size);
...
enum {
	...
	MOVIEMULTI_PARAM_FORCED_UNIQUE_3NDR_PATH,
	MOVIEMULTI_PARAM_FORCED_USE_YUVAUX,                                             /// only valid for ccir sensor
	MOVIEMULTI_PARAM_VCAP_OUT_SIZE,                                                 /// sie scaling down setting (56x)
	MOVIEMULTI_PARAM_VCAP_CCIR_DET_LOOP,                                            /// one loop will add extra 50ms delay
	MOVIEMULTI_PARAM_VCAP_PAT_GEN,
	...
	MOVIEMULTI_PARAM_CLONE_IME_CROP,
	...
	MOVIEMULTI_PARAM_TIMER_TRIGGER_COMPENSATION,
	MOVIEMULTI_PARAM_VUI_EN,
	MOVIEMULTI_PARAM_VDO_ENC_MAX_FRAME_SIZE,
	MOVIEMULTI_PARAM_CODEC_PROFILE_LEVEL,                                           /// var + venc + bsmux
	...
	MOVIEMULTI_PARAM_IMGCAP_SOUT_BUF_TYPE,
	MOVIEMULTI_PARAM_IMGCAP_YUVSRC,
	...
	MOVIEMULTI_PARAM_AUD_ENCBUF_MS,
	...
	MOVIEMULTI_PARAM_FILE_MAX_POP_SIZE,                                             /// fileout
	MOVIEMULTI_PARAM_EMR_BSQ_INCARD,                                                /// bsmux + fileout
	MOVIEMULTI_PARAM_FILE_RECOVERY_FUNC_EN,                                         /// bsmux, enable/disable file recovery function, default: enable
	MOVIEMULTI_PARAM_FILE_BITSTREAM_ALIGN_EN,                                       /// bsmux, enable/disable bitstream data align function, default: enable
	...
	MOVIEMULTI_PARAM_DISP_IME_CROP_AUTO_SCALING_EN,                                 /// enable this will re-calculated image size with aspect ratio, default is ENABLE
	MOVIEMULTI_PARAM_DISP_WINDOW,
	MOVIEMULTI_PARAM_DISP_FPS,
	MOVIEMULTI_PARAM_DISP_IME_CROP_FIXED_OUT_SIZE_EN,                               /// enable this setting allow crop window size != display size, default is DISABLE
	...
	MOVIEMULTI_PRARM_UVAC_FUNC,
	MOVIEMULTI_PARAM_UVAC_VEND_DEV_DESC,
	MOVIEMULTI_PARAM_UVAC_VID_RESO_ARY,
	MOVIEMULTI_PARAM_UVAC_AUD_SAMPLERATE_ARY,
	MOVIEMULTI_PARAM_UVAC_VID_FMT_TYPE,
	MOVIEMULTI_PARAM_UVAC_CDC_EN,
	MOVIEMULTI_PARAM_UVAC_CDC2_EN,
	MOVIEMULTI_PARAM_UVAC_CDC_PSTN_REQ_CB,
	...
	MOVIEMULTI_RARAM_ETHCAM_TX_CLONE_DIRECTTRIGGER_EN,
...
extern ER ImageApp_MovieMulti_Config(UINT32 config_id, ULONG value);
...
extern ER ImageApp_MovieMulti_SetParam(MOVIE_CFG_REC_ID id, UINT32 param, ULONG value);
extern ER ImageApp_MovieMulti_GetParam(MOVIE_CFG_REC_ID id, UINT32 param, void *value);
...
extern ER ImageApp_MovieMulti_EthCamTxRecId1_CBLink(HD_VIDEOENC_BS *pData, ULONG SndFunc);
extern ER ImageApp_MovieMulti_EthCamTxCloneId1_CBLink(HD_VIDEOENC_BS *pvenc_data, ULONG SndFunc);
...
extern ER ImageApp_MovieMulti_EthCamTxRecId1_SetRawEncodeBuff(IACOMM_HDMEM_TYPE WorkAddr, UINT WorkSize);
extern ER ImageApp_MovieMulti_EthCamTxRecId1_TriggerRawEncode(IACOMM_HDMEM_TYPE addr_va, UINT32 size);
extern ER ImageApp_MovieMulti_EthCamTxRecId1_SetThumbBuff(IACOMM_HDMEM_TYPE WorkAddr, UINT WorkSize);
extern ER ImageApp_MovieMulti_EthCamTxRecId1_TriggerThumb(IACOMM_HDMEM_TYPE addr_va, UINT32 size);
