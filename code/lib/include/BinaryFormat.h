...
extern UINT32 Get32BitsData(uintptr_t Addr, BOOL bIsLittleEndian);
extern UINT16 Get16BitsData(uintptr_t Addr, BOOL bIsLittleEndian);
extern void   Set32BitsData(uintptr_t Addr, UINT32 Value, BOOL bIsLittleEndian);
extern void   Set16BitsData(uintptr_t Addr, UINT16 Value, BOOL bIsLittleEndian);
