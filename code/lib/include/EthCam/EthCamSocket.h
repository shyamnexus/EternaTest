...
void EthCamSocketCli_SetDataRecvCB(ETHCAM_PATH_ID path_id, ETHSOCKIPCCLI_ID id, ULONG value);
void EthCamSocketCli_SetCmdRecvCB(ETHCAM_PATH_ID path_id, ULONG value);
void EthCamSocketCli_SetDataNotifyCB(ETHCAM_PATH_ID path_id, ETHSOCKIPCCLI_ID id, ULONG value);
void EthCamSocketCli_SetCmdNotifyCB(ETHCAM_PATH_ID path_id, ULONG value);
int EthCamSocket_Send(ETHCAM_PATH_ID path_id, ETHSOCKET_ID id, char* addr, int *size);
void EthCamSocketCli_SetCmdSendSizeCB(ETHCAM_PATH_ID path_id, ULONG value);
