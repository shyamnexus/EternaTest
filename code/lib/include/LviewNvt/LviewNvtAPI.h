...
typedef UINT32(*LVIEWNVT_GETVIDEOBUFCB)(ULONG *yAddr, ULONG *cbAddr, ULONG *crAddr, UINT32 *lineOfsY);       ///< Callback for getting video buffer.
...
typedef UINT32(*LVIEWNVT_DRAWCB)(ULONG  yAddr, ULONG cbAddr, ULONG crAddr, UINT32 lineOfsY);                 ///< Callback for draw image.
//@}
...
*/
//@{
typedef UINT32(*LVIEWD_GETJPGCB)(ULONG *jpgAddr, UINT32 *jpgSize);
...
*/
typedef struct {
	ULONG                   workMemAdr;          ///< work buffer address
