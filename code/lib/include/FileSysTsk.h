...
typedef enum _FST_PARM_ID {
	...
	FST_PARM_UPDATE_MOUNT_STATE,           ///< update the mount/umount state dirty bit. (RW)
...
/**
    File Handle.
*/
typedef ULONG  *FST_FILE;

/**
    Search File Handle.
*/
typedef ULONG  *FS_SEARCH_HDL;
...
typedef struct _FS_INIT_PARAM {
	ULONG        WorkBuf;               ///< the work buffer for filesys, should be 32 bytes align
...
*/
typedef void (*FileSys_ScanDirCB)(FIND_DATA *findDir, BOOL *bContinue, UINT16 *cLongname, ULONG Param);
/**
...
*/
typedef void (*FileSys_DelDirCB)(FIND_DATA *findDir, BOOL *bDelete, ULONG Param1, ULONG Param2);
...
/**
    ...
    @param UINT32 Param2       : reserved parameter for future use.
*/
typedef void (*FileSys_LockDirCB)(FIND_DATA *findDir, BOOL *bApply, ULONG Param1, ULONG Param2);

/**
     Specify FileSys operation by handle

*/
INT32 FileSys_Init(ULONG OpsHdl);

/**
     Get uITRON operation structure handle.

*/
ULONG FileSys_GetOPS_uITRON(void) _SECTION(".kercfg_text");

/**
     Get Linux operation structure handle.

*/
ULONG FileSys_GetOPS_Linux(void) _SECTION(".kercfg_text");

/**
     Get FileSys type by an operation structure handle

*/
FST_FS_TYPE FileSys_GetType(ULONG OpsHdl);

/**
     Install FileSys task,flag and semaphore id.

*/
extern void FileSys_InstallID(ULONG OpsHdl) _SECTION(".kercfg_text");
...
/**
    ...
    @endcode
*/
extern INT32    FileSys_ScanDir(char *pPath, FileSys_ScanDirCB DirCB, BOOL bGetlong, ULONG CBArg);
