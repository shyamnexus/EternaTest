...
} MEDIAREC_MEM_RANGE, *PMEDIAREC_MEM_RANGE; //<<obsolete>>
...
} MEDIAREC_YUV_INFO, *PMEDIAREC_YUV_INFO; //<<obsolete>>
...
} MEDIAREC_CALCSEC_SETTING; //<<obsolete>>
...
} MEDIAREC_VIDEO_BS_INFO; //<<obsolete>>
...
typedef struct {
	...
	char        name[12];
	UINT32      id;
} MEDIAREC_DUMPMEM_INFO; //<<obsolete>>
...
} SMEDIA_TS_RECORD_INFO; //<<obsolete>>
