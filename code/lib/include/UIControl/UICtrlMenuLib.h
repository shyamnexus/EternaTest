...
*/
extern void UxMenu_SetItemData(VControl *pCtrl, UINT32 index, MNUITM_DATA_SET attribute, ULONG value);
...
*/
extern void UxMenu_SetData(VControl *pCtrl, MNU_DATA_SET attribute, ULONG value);
