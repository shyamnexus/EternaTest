...
/**
    ...
    Example:
    @code
    INT32 Wnd_OnDraw(VControl *pCtrl, UINT32 paramNum, ULONG *paramArray)
    {
...
/**
    ...
    @return
        ...
        - @b NVTRET_ERROR Redraw fail
*/
extern INT32 Ux_WndDispatchMessage(NVTEVT evt, UINT32 paramNum, ULONG *paramArray);
