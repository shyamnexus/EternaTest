...
typedef enum {
	...
	U3DEV_CONFIG_ID_SUSPEND_DRAMOFF,
...
typedef enum {
	...
	U3DEV_CALLBACK_ID_STD_UNKNOWN_REQ,      ///< usb std request with unknown request type event callback. prototype as USB_GENERIC_CB.
...
*/
extern ER               usb3dev_setCallBack(U3DEV_CALLBACK_ID U3CallBackID, USB3_GENERIC_CB pCallBack);
...
extern UINT32        usb3dev_getEPBytecount(USB_EP EPn);
...
/**
    ...
    @return
        ...
        - @b TRUE: Plug State.
*/
extern BOOL                 usb3dev_state_change(void);
...
/**
    ...
    @return
        ...
        - @b USB_CHARGER_STS_CHARGER: charger detected
*/
extern USB_CHARGER_STS      usb3dev_check_charger(UINT32 debounce);
