...
typedef enum _UVAC_VIDEO_FORMAT {
	...
	UVAC_VIDEO_FORMAT_NV12,                ///< NV12 format.
	UVAC_VIDEO_FORMAT_H265,                ///< H265 format.
...
typedef struct _UVAC_VENDOR_PARAM {
	...
	uintptr_t uiDataAddr;         ///< Data address.
...
typedef  struct _UVAC_EU_DESC_ARRAY {
	UVAC_EU_DESC* eu_desc;
	UINT32 eu_num;
} UVAC_EU_DESC_ARRAY;
...
typedef enum {
	...
	UVAC_CHANNEL_3V1A,          ///< Three video and one audio channel.
	UVAC_CHANNEL_MAX,
} UVAC_CHANNEL;
...
typedef enum _UVAC_STRM_PATH {
	...
	UVAC_STRM_VID3,  ///< 3rd video bitstream
...
typedef struct _UVAC_STRM_FRM {
	uintptr_t           addr;       ///< Physical address of stream.
	UINT32              size;       ///< Size of stream.
	uintptr_t           va;         ///< Virtual address of stream
...
typedef enum _UVAC_VIDEO_FORMAT_TYPE {
	...
	UVAC_VIDEO_FORMAT_NONE_H264_MJPEG,
...
typedef enum _UVAC_CONFIG_ID {
	...
	UVAC_CONFIG_UAC_RX_VOL_CB,              ///< UAC RX channel volume callback.
	UVAC_CONFIG_UAC_RX_VOL_INFO,            ///< Set UAC RX volume info, referring to UAC_VOL_INFO.
	UVAC_CONFIG_UVC_BULK_MODE,              ///< Use bulk transfer for UVC
	UVAC_CONFIG_UVC2_BULK_MODE,             ///< Use bulk transfer for UVC2
	UVAC_CONFIG_NV12_FRM_INFO,              ///< Set NV12 frame type info, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_QUEUE_COUNT,                ///< Get queue count
	UVAC_CONFIG_UVC_HS_MJPG_FRM_INFO,       ///< Set MJPG frame info for U3 HS UVC, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC_HS_H264_FRM_INFO,       ///< Set H264 frame info for U3 HS UVC, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC2_HS_MJPG_FRM_INFO,      ///< Set MJPG frame info for U3 HS UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC2_HS_H264_FRM_INFO,      ///< Set H264 frame info for U3 HS UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_HS_YUV_FRM_INFO,            ///< Set YUV frame type info for U3 HS UVC, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_HS_NV12_FRM_INFO,           ///< Set NV12 frame type info for U3 HS UVC, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_PROBE_SET_CUR_MAX_COUNT,    ///< Set max probe set_cur count. If set_cur times is larger than this value, this probe would be considered as failed.
	UVAC_CONFIG_MSDC_IN_EP,                 ///< Set MSDC IN endpoint.
	UVAC_CONFIG_SS_EP_BANDWIDTH,            ///< Set super speed endpoint bandwidth info.
	UVAC_CONFIG_UVC2_STRING,                ///< Set string for UVC2, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UAC2_STRING,                ///< Set string for UAC2, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UVC_IAD_STRING,             ///< Set string for UVC2, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UVC2_IAD_STRING,            ///< Set string for UAC2, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UVC3_IAD_STRING,            ///< Set string for UVC3, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UAC_IAD_STRING,             ///< Set string for UVC2, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UAC2_IAD_STRING,            ///< Set string for UAC2, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UAC3_IAD_STRING,            ///< Set string for UVC3, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_UVC3_BULK_MODE,             ///< Use bulk transfer for UVC3
	UVAC_CONFIG_UVC3_MJPG_FRM_INFO,         ///< Set MJPG frame info for UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_H264_FRM_INFO,         ///< Set H264 frame info for UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_HS_MJPG_FRM_INFO,      ///< Set MJPG frame info for U3 HS UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_HS_H264_FRM_INFO,      ///< Set H264 frame info for U3 HS UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_STRING,                ///< Set string for UVC3, referring to UVAC_STRING_DESC.
	UVAC_CONFIG_VIDEO2_FORMAT_TYPE,          ///< Supported video format by UVC2 device.
	UVAC_CONFIG_VIDEO3_FORMAT_TYPE,          ///< Supported video format by UVC3 device.
	UVAC_CONFIG_UVC_NV12_BULK_PAYLOAD_SIZE,    ///< Supported UVC1 SS NV12 bulk mode payload size.
	UVAC_CONFIG_UVC_NV12_HS_BULK_PAYLOAD_SIZE, ///< Supported UVC1 HS NV12 bulk mode payload size.
	UVAC_CONFIG_HS_UVAC_CHANNEL,               ///< Set UVAC channel for high speed.
	UVAC_CONFIG_HS_DISABLE_UAC,                ///< Set TRUE to disable high speed UAC.
	UVAC_CONFIG_UVC2_YUV_FRM_INFO,          ///< Set YUV frame info for UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC2_HS_YUV_FRM_INFO,       ///< Set YUV frame info for U3 HS UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_YUV_FRM_INFO,          ///< Set YUV frame info for UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_HS_YUV_FRM_INFO,       ///< Set YUV frame info for U3 HS UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC2_NV12_FRM_INFO,         ///< Set NV12 frame info for UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC2_HS_NV12_FRM_INFO,      ///< Set NV12 frame info for U3 HS UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_NV12_FRM_INFO,         ///< Set NV12 frame info for UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_HS_NV12_FRM_INFO,      ///< Set NV12 frame info for U3 HS UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC_BULK_MULTI_PAYLOAD,     ///< Enable multiple payload for bulk transfer
	UVAC_CONFIG_UVC_BULK_PAYLOAD_SIZE,      ///< Set payload size for SS bulk transfer
	UVAC_CONFIG_UVC_HS_BULK_PAYLOAD_SIZE,   ///< Set payload size for HS bulk transfer
	UVAC_CONFIG_UVC_UVCP_EN,                ///< Set UVCP enable. default is enabled.
	UVAC_CONFIG_UVC_DISABLE_STREAM,         ///< Set disable UVC stream.

	UVAC_CONFIG_UVC_H265_FRM_INFO,          ///< Set H265 frame info for UVC, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC2_H265_FRM_INFO,         ///< Set H265 frame info for UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_H265_FRM_INFO,         ///< Set H265 frame info for UVC3, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC_HS_H265_FRM_INFO,       ///< Set H265 frame info for U3 HS UVC, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC2_HS_H265_FRM_INFO,      ///< Set H265 frame info for U3 HS UVC2, referring to UVAC_VID_RESO_ARY.
	UVAC_CONFIG_UVC3_HS_H265_FRM_INFO,      ///< Set H265 frame info for U3 HS UVC3, referring to UVAC_VID_RESO_ARY.

	UVAC_CONFIG_EU_DESC_ARRAY,              ///< Customized UVC EU descriptor, referring to UVAC_EU_DESC_ARRAY.
...
typedef struct _UVAC_INFO_ {
	uintptr_t           UvacMemAdr;                      ///< Buffer address for USB operation
...
/**
	Super speed endpoint bandwidth info.
*/
typedef struct _UVAC_SS_BANDWIDTH_INFO {
	UINT32 max_burst[UVAC_VID_EP_PACK_SIZE_MAX_CNT];
	UINT32 epc_attr[UVAC_VID_EP_PACK_SIZE_MAX_CNT];
} UVAC_SS_BANDWIDTH_INFO, *PUVAC_SS_BANDWIDTH_INFO;
...
*/
extern void UVAC_SetConfig(UVAC_CONFIG_ID ConfigID, ULONG Value);

/**
    Get UVAC configuration

    Get configuration of the specified ConfigID.

    @param[in] ConfigID         Configuration identifier
    @param[in] param            Configuration parameter for ConfigID
*/
extern ULONG UVAC_GetConfig(UVAC_CONFIG_ID ConfigID, UINT32 param);
