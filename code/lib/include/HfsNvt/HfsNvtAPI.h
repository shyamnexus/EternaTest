...
typedef INT32 HFSNVT_GET_CUSTOM_CB(CHAR *path, CHAR *argument, HFS_ULONG bufAddr, UINT32 *bufSize, CHAR *mimeType, UINT32 segmentCount);  ///< Callback function for get custom data.
...
typedef INT32 HFSNVT_CLIENT_QUERY_CB(CHAR *path, CHAR *argument, HFS_ULONG bufAddr, UINT32 *bufSize, CHAR *mimeType, UINT32 segmentCount); ///< Callback function for client query
typedef INT32 HFSNVT_UPLOAD_RESULT_CB(int result, HFS_ULONG bufAddr, UINT32 *bufSize, CHAR *mimeType);  ///< Callback function for upload command complete
typedef INT32 HFSNVT_DELETE_RESULT_CB(int result, HFS_ULONG bufAddr, UINT32 *bufSize, CHAR *mimeType);  ///< Callback function for delete command complete
typedef INT32 HFSNVT_PUT_CUSTOM_CB(CHAR *path, CHAR *argument, HFS_ULONG bufAddr, UINT32 bufSize, UINT32 segmentCount, HFS_PUT_STATUS putStatus);  ///< Callback function for put custom data.
typedef INT32 HFSNVT_HEADER_CB(HFS_ULONG headerAddr, UINT32 headerSize, CHAR *filepath, CHAR *mimeType, void *reserved);  ///< Callback function for http header parse custom.
