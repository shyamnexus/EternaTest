...
*/
typedef struct {
	UINT64      bitstram_buffer_in;			///< Audio BitStream buffer address for AGC input
	UINT64      bitstram_buffer_out;		///< Audio BitStream buffer address for AGC output
	UINT64      bitstram_buffer_length;		///< Audio Stream Length in Samples count. Allowed Unit in 1 samples.
