...
RESULT GxGfx_GetAddr(const DC *_pDC, ULONG *pPlan1, ULONG *pPlan2, ULONG *pPlan3);
RESULT GxGfx_GetLineOffset(const DC *_pDC, ULONG *pPlan1, ULONG *pPlan2, ULONG *pPlan3);
