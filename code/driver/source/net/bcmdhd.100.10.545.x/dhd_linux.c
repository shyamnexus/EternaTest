 ...
 */
char firmware_path[MOD_PARAM_PATHLEN] = "/lib/firmware/ap6255/fw_bcm43455c0_ag_apsta.bin";
char nvram_path[MOD_PARAM_PATHLEN] = "/lib/firmware/ap6255/nvram_ap6255.txt";
