...
MAIN(argc, argv)
{
    ...
    char out_file1[64],in_file1[64],in_file2[64];
    FILE  *fd;
    UINT32 file_size = 0;
...
#if defined(__FREERTOS)
	snprintf(out_file1, 64, "A:\\IVEP\\output\\add_output.bin");
#else
    snprintf(out_file1, 64, "//mnt//sd//IVEP//output//add_output.bin");
#endif
