...
HD_RESULT network_bind_cb(VIDEO_LIVEVIEW *p_stream)
{
	HD_RESULT ret = HD_OK;
...
HD_RESULT network_bind_isp_cb(VIDEO_LIVEVIEW *p_stream)
{
	HD_RESULT ret = HD_OK;
...
HD_RESULT network_set_isp_ai_cfg(VIDEO_LIVEVIEW *p_stream, UINT32 path_id, BOOL enable)
{
	HD_RESULT ret = HD_OK;
...
HD_RESULT network_set_buf_by_in_path_list(VIDEO_LIVEVIEW *p_stream, UINT32 para_id)
{
	HD_RESULT ret = HD_OK;
	NET_PROC* p_net = g_net + p_stream->net_path;
	UINT32 proc_id = p_net->proc_id;
...
HD_RESULT network_start(VIDEO_LIVEVIEW *p_stream)
{
	HD_RESULT ret = HD_OK;
...
HD_RESULT network_stop(VIDEO_LIVEVIEW *p_stream)
{
	HD_RESULT ret = HD_OK;
