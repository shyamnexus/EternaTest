...
#if (CTRL_VOL)
	/*set audio out volume control*/
	{
		VENDOR_AUDIOOUT_VOLUME audio_vol_param = {0};
		audio_vol_param.volume = 100;
		ret = vendor_audioout_set(audio_out_path, VENDOR_AUDIOOUT_ITEM_VOLUME, &audio_vol_param);
	}
#endif
