/**
	@brief Sample code of video snapshot with source out.\n

	@file video_snapshot_with_srcout.c
...
#define MAIN(argc, argv) 		EXAMFUNC_ENTRY(hd_video_snapshot_with_srcout, argc, argv)
...
static HD_RESULT take_snapshot(VIDEO_RECORD* p_stream0)
{
	...
	{
		char file_path[32] = {0};
		snprintf(file_path, 32, "/mnt/sd/dump_bs_snap%u.jpg", p_stream0->shot_count);
