#ifndef _IVE_ENG_BASE_H_
#define _IVE_ENG_BASE_H_
...
typedef enum{
    ...
    //IVE_ENG_EDGE_KER_7X7             = 1, //538 remove 7x7
...
typedef struct {
    ...
    UINT8 element_size;
    UINT16 ver_seg_num;
    UINT8 dma_soble_out_sel;
    UINT8 dma_in_fmt;

} IVE_ENG_DMA_CPY_PATH;

/* // combine to canny's thres lut
typedef struct {
    UINT8 mode; // 1~11
    UINT16 low_th;
    UINT16 high_th;
    IVE_ENG_THRES_LUT_TH th_val;
} IVE_ENG_THRES_LUT_PATH;
*/
...
typedef struct {
    ...
    UINT8 st_threshold_mode ;
    UINT32 st_threshold_val ;
} IVE_ENG_ST_PATH;
