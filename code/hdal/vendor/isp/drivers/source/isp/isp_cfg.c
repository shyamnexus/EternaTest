...
INT32 isp_cfg_str2tab_u64(INT8 *str, UINT64 *tab, INT32 count)
{
	char *string = (char *)str;
	char seps[] = ", ";
	char *token;
...
INT32 isp_cfg_str2tab_s64(INT8 *str, INT64 *tab, INT32 count)
{
	char *string = (char *)str;
	char seps[] = ", ";
	char *token;
...
EXPORT_SYMBOL(isp_cfg_str2tab_u64);
EXPORT_SYMBOL(isp_cfg_str2tab_s64);
#endif
