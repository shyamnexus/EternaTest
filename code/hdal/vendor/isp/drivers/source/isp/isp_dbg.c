...
CHAR *isp_dbg_get_ispt_item(UINT32 item)
{
	switch (item) {
		...
		case ISPT_ITEM_CA_ROI: sprintf(ioc_item_name, "ISPT_ITEM_CA_ROI"); break;
		case ISPT_ITEM_LA_ROI: sprintf(ioc_item_name, "ISPT_ITEM_LA_ROI"); break;
		case ISPT_ITEM_VA_INDEP_ROI: sprintf(ioc_item_name, "ISPT_ITEM_VA_INDEP_ROI"); break;
		...
		case ISPT_ITEM_SHDR_EV_RATIO: sprintf(ioc_item_name, "ISPT_ITEM_SHDR_EV_RATIO"); break;
		case ISPT_ITEM_CA_ENABLE: sprintf(ioc_item_name, "ISPT_ITEM_CA_ENABLE"); break;
		case ISPT_ITEM_LA_ENABLE: sprintf(ioc_item_name, "ISPT_ITEM_LA_ENABLE"); break;
		case ISPT_ITEM_IFE_VA_INDEP_ROI: sprintf(ioc_item_name, "ISPT_ITEM_IFE_VA_INDEP_ROI"); break;
		case ISPT_ITEM_IFE_VA_DATA: sprintf(ioc_item_name, "ISPT_ITEM_IFE_VA_DATA"); break;
		case ISPT_ITEM_IFE_VA_INDEP_DATA: sprintf(ioc_item_name, "ISPT_ITEM_IFE_VA_INDEP_DATA"); break;
		case ISPT_ITEM_WAIT_FRMEND: sprintf(ioc_item_name, "ISPT_ITEM_WAIT_FRMEND"); break;
		case ISPT_ITEM_WAIT_CFGSTR: sprintf(ioc_item_name, "ISPT_ITEM_WAIT_CFGSTR"); break;
		case ISPT_ITEM_WAIT_PROCEND: sprintf(ioc_item_name, "ISPT_ITEM_WAIT_PROCEND"); break;
		case ISPT_ITEM_VPRC_INDEP: sprintf(ioc_item_name, "ISPT_ITEM_VPRC_INDEP"); break;
		case ISPT_ITEM_SENSOR_MODE_MANUAL: sprintf(ioc_item_name, "ISPT_ITEM_SENSOR_MODE_MANUAL"); break;
		case ISPT_ITEM_LOW_POWER_LV: sprintf(ioc_item_name, "ISPT_ITEM_LOW_POWER_LV"); break;
...
CHAR *isp_dbg_get_iqt_item(UINT32 item)
{
	switch (item) {
		...
		case IQT_ITEM_TONE_LV: sprintf(ioc_item_name, "IQT_ITEM_TONE_LV"); break;
		...
		case IQT_ITEM_RAW_VA_PARAM: sprintf(ioc_item_name, "IQT_ITEM_RAW_VA_PARAM"); break;
		...
		case IQT_ITEM_ENH_ISO: sprintf(ioc_item_name, "IQT_ITEM_ENH_ISO"); break;
		case IQT_ITEM_POST_SHARPEN_2_PARAM: sprintf(ioc_item_name, "IQT_ITEM_POST_SHARPEN_2_PARAM"); break;
		...
		case IQT_ITEM_POST_SHARPEN_1_PARAM: sprintf(ioc_item_name, "IQT_ITEM_POST_SHARPEN_1_PARAM"); break;
		case IQT_ITEM_SHDR_DBG: sprintf(ioc_item_name, "IQT_ITEM_SHDR_DBG"); break;
		case IQT_ITEM_LCA_DBG: sprintf(ioc_item_name, "IQT_ITEM_LCA_DBG"); break;
		case IQT_ITEM_POST_SHARPEN_1_DBG: sprintf(ioc_item_name, "IQT_ITEM_POST_SHARPEN_1_DBG"); break;
		case IQT_ITEM_POST_SHARPEN_2_DBG: sprintf(ioc_item_name, "IQT_ITEM_POST_SHARPEN_2_DBG"); break;
		case IQT_ITEM_TONE_PARAM: sprintf(ioc_item_name, "IQT_ITEM_TONE_PARAM"); break;
		case IQT_ITEM_EXPAND_DPC_PARAM: sprintf(ioc_item_name, "IQT_ITEM_EXPAND_DPC_PARAM"); break;
		case IQT_ITEM_WDR_ENH_PARAM: sprintf(ioc_item_name, "IQT_ITEM_WDR_ENH_PARAM"); break;
		case IQT_ITEM_FPN_PARAM: sprintf(ioc_item_name, "IQT_ITEM_FPN_PARAM"); break;
		case IQT_ITEM_3DCC_PARAM: sprintf(ioc_item_name, "IQT_ITEM_3DCC_PARAM"); break;
		case IQT_ITEM_3DCC_EXT_PARAM: sprintf(ioc_item_name, "IQT_ITEM_3DCC_EXT_PARAM"); break;
		case IQT_ITEM_FIXTH_PARAM: sprintf(ioc_item_name, "IQT_ITEM_FIXTH_PARAM"); break;
		case IQT_ITEM_OB_MODE_MANUAL: sprintf(ioc_item_name, "IQT_ITEM_OB_MODE_MANUAL"); break;
		case IQT_ITEM_BNR_PARAM: sprintf(ioc_item_name, "IQT_ITEM_BNR_PARAM"); break;
		case IQT_ITEM_BNR_DBG: sprintf(ioc_item_name, "IQT_ITEM_BNR_DBG"); break;
		case IQT_ITEM_LOW_POWER_PARAM: sprintf(ioc_item_name, "IQT_ITEM_LOW_POWER_PARAM"); break;
		case IQT_ITEM_DG_MODE_MANUAL: sprintf(ioc_item_name, "IQT_ITEM_DG_MODE_MANUAL"); break;
		case IQT_ITEM_AIISP_PARAM: sprintf(ioc_item_name, "IQT_ITEM_AIISP_PARAM"); break;
		case IQT_ITEM_AIISP_CUSTOM_PARAM: sprintf(ioc_item_name, "IQT_ITEM_AIISP_CUSTOM_PARAM"); break;
		case IQT_ITEM_CG_MODE_MANUAL: sprintf(ioc_item_name, "IQT_ITEM_CG_MODE_MANUAL"); break;
