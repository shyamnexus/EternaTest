...
extern void ae_msg_low_power(AE_ID id);
#else
extern void ae_msg_low_power(struct seq_file *sfile, AE_ID id);
#endif


// From aet_api_int.h
extern UINT32 aet_api_get_item_size(AET_ITEM item);
extern ER aet_api_get_cmd(AET_ITEM item, ULONG addr);
extern ER aet_api_set_cmd(AET_ITEM item, ULONG addr);
extern ER aet_api_nnsc_get_cmd(AET_ITEM item, ULONG addr);
extern ER aet_api_nnsc_set_cmd(AET_ITEM item, ULONG addr);
