...
void iq_print_arr_uint32(UINT32 *arr, UINT32 len, UINT32 w_len)
{
	...
	for (i = 0; i < len; i = i + w_len) {
		if (w_len == 32) {
			...
			if ((len - i) >= 10) {
				DBG_DUMP("%7d, %7d, %7d, %7d, %7d, %7d, %7d, %7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2], arr[i + 3], arr[i + 4], arr[i + 5], arr[i + 6], arr[i + 7], arr[i + 8], arr[i + 9]);
			} else if ((len - i) >= 9) {
				DBG_DUMP("%7d, %7d, %7d, %7d, %7d, %7d, %7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2], arr[i + 3], arr[i + 4], arr[i + 5], arr[i + 6], arr[i + 7], arr[i + 8]);
			} else if ((len - i) >= 8) {
				DBG_DUMP("%7d, %7d, %7d, %7d, %7d, %7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2], arr[i + 3], arr[i + 4], arr[i + 5], arr[i + 6], arr[i + 7]);
			} else if ((len - i) >= 7) {
				DBG_DUMP("%7d, %7d, %7d, %7d, %7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2], arr[i + 3], arr[i + 4], arr[i + 5], arr[i + 6]);
			} else if ((len - i) >= 6) {
				DBG_DUMP("%7d, %7d, %7d, %7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2], arr[i + 3], arr[i + 4], arr[i + 5]);
			} else if ((len - i) >= 5) {
				DBG_DUMP("%7d, %7d, %7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2], arr[i + 3], arr[i + 4]);
			} else if ((len - i) >= 4) {
				DBG_DUMP("%7d, %7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2], arr[i + 3]);
			} else if ((len - i) >= 3) {
				DBG_DUMP("%7d, %7d, %7d, ", arr[i], arr[i + 1], arr[i + 2]);
			} else if ((len - i) >= 2) {
				DBG_DUMP("%7d, %7d, ", arr[i], arr[i + 1]);
			} else if ((len - i) >= 1) {
				DBG_DUMP("%7d, ", arr[i]);
			}
		}
