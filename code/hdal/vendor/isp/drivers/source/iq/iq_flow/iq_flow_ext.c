...
{
	PRINT_IQ(TRUE, "NT98538 not support pref_ob_manual. \r\n");
}

void iq_flow_ext_set_pre_ob_manual(IQ_ID id, UINT32 enable, UINT32 *value)
{
	PRINT_IQ(TRUE, "NT98538 not support pre_ob_manual. \r\n");
}
...
void iq_flow_ext_set_ob_mode_manual(IQ_ID id, UINT32 enable, UINT32 mode)
{
	...
	if (iq_flow_get_id_valid(id)) {
		if ((mode != IQ_OB_SIE) && (mode != IQ_OB_IFE_F) && (mode != IQ_OB_IFE)) {
...
{
	PRINT_IQ(TRUE, "NT98538 not support pre_dg_manual. \r\n");
}
...
void iq_flow_ext_set_dg_mode_manual(IQ_ID id, UINT32 enable, UINT32 mode)
{
	...
	if (iq_flow_get_id_valid(id)) {
		if ((mode != IQ_DG_SIE) && (mode != IQ_DG_IFE_F) && (mode != IQ_DG_IFE)) {
...
void iq_flow_ext_set_cg_mode_manual(IQ_ID id, UINT32 enable, UINT32 mode)
{
	...
	if (iq_flow_get_id_valid(id)) {
		if ((mode != IQ_CG_SIE) && (mode != IQ_CG_IFE_F) && (mode != IQ_CG_IFE)) {
...
{
	PRINT_IQ(TRUE, "NT98538 not support dg_ai. \r\n");
}
