...
typedef struct _IQ_FINAL_IPP {
	...
	CTL_IFE_ISP_NRS                         ife_nrs_0;
	CTL_IFE_ISP_FCURVE                      ife_fcurve;
	CTL_IFE_ISP_FUSION                      ife_fusion;
	CTL_IFE_ISP_OUTL                        ife_outl;
	...
	CTL_IFE_ISP_VA                          ife_va;
	CTL_IFE_ISP_SUBISP_IQ                   ife_subisp;
	CTL_IFE_ISP_FPN                         ife_fpn;
