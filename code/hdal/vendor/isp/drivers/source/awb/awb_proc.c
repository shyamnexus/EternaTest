...
static AWB_PROC_R_ITEM awb_proc_r_item = AWB_PROC_R_ITEM_NONE;
static AWB_ID awb_proc_id;
...
static const struct proc_ops awb_proc_info_ops = {
	.proc_open    = awb_proc_info_open,
	.proc_read    = seq_read,
...
static INT32 awb_proc_cmd_get_param(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_proc_id = simple_strtoul(argv[2], NULL, 0);

	if (awb_flow_get_id_valid(awb_proc_id) && (awb_proc_id < AWB_ID_MAX_NUM)) {
		awb_proc_r_item = AWB_PROC_R_ITEM_PARAM;
	} else {
		awb_proc_r_item = AWB_PROC_R_ITEM_NONE;
	}
...
static INT32 awb_proc_cmd_set_param(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	if (strncmp(argv[3], "th", 20) == 0) {
		...
		if (strncmp(argv[4], "cx_2300", 10) == 0) {
			awb_param[id]->target->cx[0] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "cx_2800", 10) == 0) {
			awb_param[id]->target->cx[1] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "cx_3700", 10) == 0) {
			awb_param[id]->target->cx[2] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "cx_4700", 10) == 0) {
			awb_param[id]->target->cx[0] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "cx_6500", 10) == 0) {
			awb_param[id]->target->cx[1] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "cx_11000", 10) == 0) {
			awb_param[id]->target->cx[2] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "rg_2300", 10) == 0) {
			awb_param[id]->target->rg_ratio[0] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "rg_2800", 10) == 0) {
			awb_param[id]->target->rg_ratio[1] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "rg_3700", 10) == 0) {
			awb_param[id]->target->rg_ratio[2] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "rg_4700", 10) == 0) {
			awb_param[id]->target->rg_ratio[0] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "rg_6500", 10) == 0) {
			awb_param[id]->target->rg_ratio[1] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "rg_11000", 10) == 0) {
			awb_param[id]->target->rg_ratio[2] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "bg_2300", 10) == 0) {
			awb_param[id]->target->bg_ratio[0] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "bg_2800", 10) == 0) {
			awb_param[id]->target->bg_ratio[1] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "bg_3700", 10) == 0) {
			awb_param[id]->target->bg_ratio[2] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "bg_4700", 10) == 0) {
			awb_param[id]->target->bg_ratio[0] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "bg_6500", 10) == 0) {
			awb_param[id]->target->bg_ratio[1] = simple_strtoul(argv[5], NULL, 0);
		} else if (strncmp(argv[4], "bg_11000", 10) == 0) {
			awb_param[id]->target->bg_ratio[2] = simple_strtoul(argv[5], NULL, 0);
		} else {
...
static INT32 awb_proc_cmd_get_wb(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_get_wb(id, &wb_gain);
...
static INT32 awb_proc_cmd_get_ca(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	if (awb_flow_get_id_valid(awb_proc_id) && (awb_proc_id < AWB_ID_MAX_NUM)) {
		awb_proc_r_item = AWB_PROC_R_ITEM_CA;
	} else {
		awb_proc_r_item = AWB_PROC_R_ITEM_NONE;
	}
...
static INT32 awb_proc_cmd_get_flag(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	if (awb_flow_get_id_valid(awb_proc_id) && (awb_proc_id < AWB_ID_MAX_NUM)) {
		awb_proc_r_item = AWB_PROC_R_ITEM_FLAG;
	} else {
		awb_proc_r_item = AWB_PROC_R_ITEM_NONE;
	}
...
static INT32 awb_proc_cmd_get_ui_param(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	ui_operation = awb_ui_get_info(id, AWB_UI_OPERATION);
	awb_flow_ext_get_stitch_id_mask(id, &ui_stitch_id[0]);

	awb_cmd_printf("id : %d\r\n", id);
	awb_cmd_printf("get ui scene : %d\r\n", ui_scene);
	awb_cmd_printf("get ui Rratio : %d\r\n", ui_r_ratio);
	awb_cmd_printf("get ui Bratio : %d\r\n", ui_b_ratio);
	awb_cmd_printf("get ui peration : %d\r\n", ui_operation);
	awb_cmd_printf("get ui stitch id0 : 0x%x\r\n", ui_stitch_id[0]);
	awb_cmd_printf("get ui stitch id1 : 0x%x\r\n", ui_stitch_id[1]);
...
static INT32 awb_proc_cmd_set_ui_param(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	value2 = simple_strtoul(argv[5], NULL, 0);

	awb_cmd_printf("id : %d\r\n", id);
	awb_cmd_printf("set ui type : %d, value : %d\r\n", type, value);

	if (type == 4) {
		ui_stitch_id[0] = value;
		ui_stitch_id[1] = value2;
		awb_flow_ext_set_stitch_id_mask(id, &ui_stitch_id[0]);
	} else {
...
static INT32 awb_proc_cmd_get_expand_ct(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_get_expand_ct_en(id, &expand_ct_en);
...
static INT32 awb_proc_cmd_set_expand_ct(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_set_expand_ct_en(id, en);
...
static INT32 awb_proc_cmd_get_weight_mode(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_get_weight_mode(id, &weight_en, &weight_ct_idx);
...
static INT32 awb_proc_cmd_set_weight_mode(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_set_weight_mode(id, weight_en);
	awb_flow_ext_get_weight_mode(id, &weight_en, &weight_ct_idx);
...
static INT32 awb_proc_cmd_get_gray_world_en(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_get_gray_world_en(id, &gray_en);
...
static INT32 awb_proc_cmd_set_gray_world_en(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_set_gray_world_en(id, gray_en);
...
static INT32 awb_proc_cmd_get_ca_th(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_get_ca_th(id, &ca_th);
...
static INT32 awb_proc_cmd_set_ca_th(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awb_flow_ext_set_ca_th(id, &ca_th);
...
static INT32 awb_proc_cmd_get_win(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	if (awb_flow_get_id_valid(awb_proc_id) && (awb_proc_id < AWB_ID_MAX_NUM)) {
		awb_proc_r_item = AWB_PROC_R_ITEM_WIN;
	} else {
		awb_proc_r_item = AWB_PROC_R_ITEM_NONE;
	}
...
static INT32 awb_proc_cmd_get_low_power_info(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	awb_cmd_printf("awb_proc_cmd_get_low_power_info \n");
	...
	if (awb_flow_get_id_valid(awb_proc_id) && (awb_proc_id < AWB_ID_MAX_NUM)) {
		awb_proc_r_item = AWB_PROC_R_ITEM_LOW_POWER;
	} else {
		awb_proc_r_item = AWB_PROC_R_ITEM_NONE;
	}
...
static INT32 awb_proc_cmd_set_low_power_cnt(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	AWB_ID id;
	UINT32 low_power_cnt;

	awb_cmd_printf("awb_proc_cmd_set_low_power_cnt \n");
	...
	low_power_cnt = simple_strtoul(argv[3], NULL, 0);
	awb_flow_ext_set_low_power_cnt(id, low_power_cnt);

	awb_cmd_printf("id = %d, low_power_cnt = %d\n", id, low_power_cnt);
	return 0;
}
...
static INT32 awb_proc_cmd_reload_cfg(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awbt_api_set_cmd(AWBT_ITEM_RLD_CONFIG, (ULONG)&cfg_info);
...
static INT32 awb_proc_cmd_reload_dtsi(ISP_MODULE *pdrv, INT32 argc, CHAR **argv)
{
	...
	awbt_api_set_cmd(AWBT_ITEM_RLD_DTSI, (ULONG)&dtsi_info);
...
static AWB_PROC_CMD awb_proc_r_cmd_list[] = {
	...
	{ "low_power_info",     awb_proc_cmd_get_low_power_info,  "get low_power_info, param1 is awb_id(0~2)"}
	#endif
};
...
static AWB_PROC_CMD awb_proc_w_cmd_list[] = {
	...
	{ "low_power_cnt",      awb_proc_cmd_set_low_power_cnt,  "set low power cnt, param1 is awb_id(0~2), param2 is low_power_cnt"},
	#endif
...
{
	if (g_cmd_msg.buf == NULL && awb_proc_r_item == AWB_PROC_R_ITEM_NONE) {
		return -EINVAL;
	}
	...
	if (awb_proc_r_item == AWB_PROC_R_ITEM_PARAM) {
		awb_msg_show_param(sfile, awb_proc_id);
	}

	if (awb_proc_r_item == AWB_PROC_R_ITEM_CA) {
		awb_msg_show_ca(sfile, awb_proc_id);
	}

	if (awb_proc_r_item == AWB_PROC_R_ITEM_FLAG) {
		awb_msg_show_flag(sfile, awb_proc_id);
	}

	if (awb_proc_r_item == AWB_PROC_R_ITEM_WIN) {
		awb_msg_show_win(sfile, awb_proc_id);
	}

	if (awb_proc_r_item == AWB_PROC_R_ITEM_LOW_POWER) {
		awb_msg_low_power(sfile, awb_proc_id);
	}
...
static const struct proc_ops awb_proc_command_ops = {
	.proc_open    = awb_proc_command_open,
	.proc_read    = seq_read,
	.proc_write   = awb_proc_command_write,
	.proc_lseek   = seq_lseek,
	.proc_release = single_release,
};
...
//=============================================================================
unsigned int awb_debug_level = 3;

static INT32 awb_proc_dbglevel_show(struct seq_file *sfile, void *v)
{
	seq_printf(sfile, "0: fatal; 1: err; 2: wrn; 3: msg; 4: ind; 5: func \n");
	seq_printf(sfile, "awb_debug_level = %d \n", awb_debug_level);

	return 0;
}

static INT32 awb_proc_dbglevel_open(struct inode *inode, struct file *file)
{
	return single_open(file, awb_proc_dbglevel_show, PDE_DATA(inode));
}

static ssize_t awb_proc_dbglevel_write(struct file *file, const CHAR __user *buf, size_t size, loff_t *off)
{
	INT32 len = size;
	INT32 ret = -EINVAL;
	CHAR cmd_line[MAX_CMDLINE_LENGTH];
	...
	if ((len <= 1) || (len > MAX_CMDLINE_LENGTH)) {
		...
		if (copy_from_user(cmd_line, buf, len)) {
			...
			awb_debug_level = simple_strtoul(argv[0], NULL, 0);
			awb_cmd_printf("set dbglevel %d \n", awb_debug_level);
		}
	}
...
static const struct proc_ops awb_proc_dbglevel_ops = {
	.proc_open    = awb_proc_dbglevel_open,
	.proc_read    = seq_read,
	.proc_write   = awb_proc_dbglevel_write,
	.proc_lseek   = seq_lseek,
	.proc_release = single_release
};
...
static int awb_proc_help_show(struct seq_file *sfile, void *v)
{
	...
	seq_printf(sfile, " 'echo w ui_param ID TYPE VALUE VALUE2 > /proc/hdal/vendor/awb/cmd;cat /proc/hdal/vendor/awb/cmd'     - Set AWB ui parameter\n");
	...
	seq_printf(sfile, "|--------------|----------------|----------------|----------------|----------------|----------------|----------------|\n");
	seq_printf(sfile, "| target       | cx_2300        | cx_2800        | cx_3700        | cx_4700        | cx_6500        | cx_11000       |\n");
	seq_printf(sfile, "|              | rg_2300        | rg_2800        | rg_3700        | rg_4700        | rg_6500        | rg_11000       |\n");
	seq_printf(sfile, "|              | bg_2300        | bg_2800        | bg_3700        | bg_4700        | bg_6500        | bg_11000       |\n");
	seq_printf(sfile, "|--------------|----------------|----------------|----------------|----------------|----------------|----------------|\n");
...
static const struct proc_ops awb_proc_help_ops = {
	.proc_open    = awb_proc_help_open,
	.proc_read    = seq_read,
	.proc_lseek   = seq_lseek,
	.proc_release = single_release,
};
...
INT32 awb_proc_create(void)
{
	...
	// create "info" entry
	pentry = proc_create_data("info", S_IRUGO | S_IXUGO, proc_root, &awb_proc_info_ops, NULL);
	if (pentry == NULL) {
	...
	// create "cmd" entry
	pentry = proc_create_data("cmd", S_IRUGO | S_IXUGO, proc_root, &awb_proc_command_ops, NULL);
	if (pentry == NULL) {
	...
	pentry = proc_create_data("dbglevel", S_IRUGO | S_IXUGO, root, &awb_proc_dbglevel_ops, NULL);
	if (pentry == NULL) {
	...
	// create "help" entry
	pentry = proc_create_data("help", S_IRUGO | S_IXUGO, proc_root, &awb_proc_help_ops, NULL);
	if (pentry == NULL) {
		DBG_ERR("fail to create proc command!\n");
		awb_proc_remove();
		return -EINVAL;
