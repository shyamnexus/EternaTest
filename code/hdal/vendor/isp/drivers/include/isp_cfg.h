...
#define MAX_SECTION_MAP_NUM    400    // depending on your section number
...
extern INT32 isp_cfg_str2tab_u64(INT8 *str, UINT64 *tab, INT32 count);    // convert string to UINT32 array
extern INT32 isp_cfg_str2tab_s64(INT8 *str, INT64 *tab, INT32 count);     // convert string to INT32 array
