...
#define CAL_ENG_REG_NUMS  ((0x4FC>>2)+1)
...
#define FLGPTN_CAL_LL0END       FLGPTN_BIT(24)
#define FLGPTN_CAL_LL0ERROR    	FLGPTN_BIT(25)
#define FLGPTN_CAL_LL1END       FLGPTN_BIT(28)
#define FLGPTN_CAL_LL1ERROR    	FLGPTN_BIT(29)
...
typedef enum {
	...
	CAL_ENG_INTERRUPT_LL0_END            = 0x01000000,
    CAL_ENG_INTERRUPT_LL0_ERR            = 0X02000000,
    CAL_ENG_INTERRUPT_JOB0_END           = 0X04000000,
    CAL_ENG_INTERRUPT_LL1_END            = 0x10000000,
    CAL_ENG_INTERRUPT_LL1_ERR            = 0X20000000,
    CAL_ENG_INTERRUPT_JOB1_END           = 0X40000000,
	CAL_ENG_INTERRUPT_ALL                = (CAL_ENG_INTERRUPT_FRM_END | CAL_ENG_INTERRUPT_LL0_END | CAL_ENG_INTERRUPT_LL0_ERR | CAL_ENG_INTERRUPT_JOB0_END  | CAL_ENG_INTERRUPT_LL1_END | CAL_ENG_INTERRUPT_LL1_ERR | CAL_ENG_INTERRUPT_JOB1_END),
} CAL_ENG_INTERRUPT;
...
extern VOID cal_eng_trig_ll_hw_reg(CAL_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb, UINT32 ll_idx);
...
extern VOID cal_eng_wait_framend_ll(CAL_ENG_HANDLE *p_eng, UINT32 ll_idx);
...
extern UINT32 cal_eng_get_ll_cycle(CAL_ENG_HANDLE *p_eng, UINT32 ll_idx);
...
extern UINT32 cal_eng_get_ll_sta_acc_cycle(CAL_ENG_HANDLE *p_eng, UINT32 ll_idx);
extern UINT32 cal_eng_get_clk_rate(CAL_ENG_HANDLE *p_eng);

extern INT32 cal_eng_set_ll_setting(CAL_ENG_HANDLE *p_eng, CAL_LL_SETTING *ll_param);
extern UINT32 cal_eng_get_qos_setting(CAL_ENG_HANDLE *p_eng);
...
extern UINT32 cal_eng_get_busy_count(CAL_ENG_HANDLE *p_eng, UINT32 ll_idx);
extern VOID cal_eng_clr_busy_count(CAL_ENG_HANDLE *p_eng, UINT32 ll_idx);
