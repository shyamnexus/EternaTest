/*
    ...
    NT98538 ROU internal header file.
...
#define FLGPTN_ROU_LL0_END			FLGPTN_BIT(24)
#define FLGPTN_ROU_LL1_END			FLGPTN_BIT(28)
...
extern UINT32 rou_eng_platform_get_busy_count(ROU_ENG_HANDLE *p_eng, UINT32 ll_idx);
extern VOID rou_eng_platform_clr_busy_count(ROU_ENG_HANDLE *p_eng, UINT32 ll_idx);
