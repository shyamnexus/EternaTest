...
#define MODULE_IRQ_NUM          11
#define MODULE_REG_NUM          11
#define MODULE_CLK_NUM          12
...
extern unsigned int ai_get_clk[MODULE_CLK_NUM];
extern struct clk* ai_clk[MODULE_CLK_NUM];
extern uintptr_t ai_eng_io_addr[MODULE_REG_NUM];
