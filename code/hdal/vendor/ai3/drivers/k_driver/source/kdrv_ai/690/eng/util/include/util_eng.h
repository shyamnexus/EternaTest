...
#define UTIL_ENG_REG_NUMS  ((0x3e4>>2)+1)  // for NT98690
...
#define FLGPTN_UTIL_LLEND        FLGPTN_BIT(24)
#define FLGPTN_UTIL_LLERROR     FLGPTN_BIT(25)
/*****************************************************************************/
typedef struct {
	UINT32 ofs;
	UINT32 val;
...
typedef enum {
	...
	UTIL_ENG_INTERRUPT_LL_END             = 0x01000000,
    UTIL_ENG_INTERRUPT_LL_ERR             = 0X02000000,
    UTIL_ENG_INTERRUPT_JOB_END            = 0X04000000,
	UTIL_ENG_INTERRUPT_ALL                = (UTIL_ENG_INTERRUPT_FRM_END | UTIL_ENG_INTERRUPT_LL_END | UTIL_ENG_INTERRUPT_LL_ERR | UTIL_ENG_INTERRUPT_JOB_END),
} UTIL_ENG_INTERRUPT;

typedef VOID (*UTIL_ISR_CB)(VOID *eng, UINT32 status, VOID *reserve);
...
extern VOID util_eng_trig_ll_hw_reg(UTIL_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb);
...
extern VOID util_eng_wait_framend_ll(UTIL_ENG_HANDLE *p_eng);
...
extern UINT32 util_eng_get_ll_cycle(UTIL_ENG_HANDLE *p_eng);
