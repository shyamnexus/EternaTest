...
#define DUMP_WITH_CHROME_TRACE_VIEWER 1
...
extern INT graph_debug_core_add_block(UINT32 display_mode, UINT32 color_mode, UINT32 job_id, UINT32 job_type, UINT32 record_id, GRAPH_DEBUG_CORE_HANDLER handler, UINT32 proc_id, UINT32 x1, UINT32 x2, UINT32 y1, UINT32 y2, CHAR *block_name, CHAR *eng_name, CHAR *eng2_name, UINT max_block_name_len, CHAR *color_name, CHAR *color_name2, UINT max_color_name_len);
...
extern INT graph_debug_core_add_line(GRAPH_DEBUG_CORE_HANDLER handler, CHAR *connect_name, UINT32 end_t, CHAR *end_eng, UINT32 start_t, CHAR *start_eng);
#else
extern INT graph_debug_core_add_line(GRAPH_DEBUG_CORE_HANDLER handler, UINT32 proc_id, UINT32 x1, UINT32 y1, UINT32 x2, UINT32 y2, CHAR *color_name, UINT max_color_name_len);
#endif
