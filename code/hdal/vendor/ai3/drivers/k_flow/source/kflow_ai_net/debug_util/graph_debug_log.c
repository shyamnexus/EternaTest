...
#define LOCK(x, y) vk_spin_lock_irqsave(x, y)
#define UNLOCK(x, y) vk_spin_unlock_irqrestore(x, y)
#define DECLARE_FLAGS(x) unsigned long x
#else
#define PRINTF printf
#define MALLOC(x) malloc((x))
#define FREE(x) free((x))
#define LOCK(x, y) pthread_mutex_lock(x)
#define UNLOCK(x, y) pthread_mutex_unlock(x)
#define DECLARE_FLAGS(x)
#endif
/*-----------------------------------------------------------------------------*/
