/**
	@brief Header file of definition of DLI resize layer.

	@file vendor_ai_dli_cpu_resize.hpp

	@note Nothing.

	Copyright Novatek Microelectronics Corp. 2019.  All rights reserved.
*/
#ifndef _VENDOR_AI_DLI_CPU_RESIZE_HPP_
#define _VENDOR_AI_DLI_CPU_RESIZE_HPP_
...
#endif  /* _VENDOR_AI_DLI_CPU_RESIZE_HPP_ */
