/**
	@brief Source file of DLI cpu fc_post layer.

	@file vendor_ai_dli_cpu_fc_post.cpp

	@ingroup dli_cpu_fc_post
...
//=============================================================
#define __CLASS__ 				"[ai][lib_cpu][dli_fcpost]"
#include "vendor_ai_debug.h"
//=============================================================
#include "vendor_ai_dli_cpu_fc_post.hpp"
...
static HD_RESULT dli_to_nvtnn_fc_post(NN_DLI_FC_POST_PARM *p_dli_parm, NN_FC_POST_PARM *p_nvtnn_prm)
{
	...
	p_nvtnn_prm->bias_addr             = bias_info->data_va;
	...
	p_nvtnn_prm->leaky_value           = p_dli_parm->leaky_value;
	p_nvtnn_prm->leaky_shift           = p_dli_parm->leaky_shift;
...
{
	NN_FC_POST_PARM nvtnn_prms = {0};
	dli_to_nvtnn_fc_post(p_parm, &nvtnn_prms);
	
    nvtnn_fc_post_process(&nvtnn_prms);
	return HD_OK;
}
