/**
    @brief Header file of definition of DLI dsp elementwise layer.

    @file vendor_ai_dli_dsp_elementwise.hpp

    @note Nothing.

    Copyright Novatek Microelectronics Corp. 2022.  All rights reserved.
*/
#ifndef _VENDOR_AI_DLI_DSP_ELEMENTWISE_HPP_
#define _VENDOR_AI_DLI_DSP_ELEMENTWISE_HPP_
...
#endif  /* _VENDOR_AI_DLI_DSP_ELEMENTWISE_HPP_ */
