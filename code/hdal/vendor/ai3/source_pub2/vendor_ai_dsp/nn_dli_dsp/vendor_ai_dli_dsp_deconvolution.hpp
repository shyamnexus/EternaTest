/**
    @brief Header file of definition of DLI dsp deconvolution layer.

    @file vendor_ai_dli_dsp_deconvolution.hpp

    @note Nothing.

    Copyright Novatek Microelectronics Corp. 2022.  All rights reserved.
*/
#ifndef _VENDOR_AI_DLI_DSP_DECONVOLUTION_HPP_
#define _VENDOR_AI_DLI_DSP_DECONVOLUTION_HPP_
...
#endif  /* _VENDOR_AI_DLI_DSP_DECONVOLUTION_HPP_ */
