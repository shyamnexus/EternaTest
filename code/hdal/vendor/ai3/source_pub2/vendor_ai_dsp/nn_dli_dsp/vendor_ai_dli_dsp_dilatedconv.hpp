/**
    @brief Header file of definition of DLI dsp dilated convolution layer.

    @file vendor_ai_dli_dsp_dilatedconv.hpp

    @note Nothing.

    Copyright Novatek Microelectronics Corp. 2022.  All rights reserved.
*/
#ifndef _VENDOR_AI_DLI_DSP_DILATEDCONV_HPP_
#define _VENDOR_AI_DLI_DSP_DILATEDCONV_HPP_
...
#endif  /* _VENDOR_AI_DLI_DSP_DILATEDCONV_HPP_ */
