/**
    @brief Header file of definition of DLI dsp layernorm layer.

    @file vendor_ai_dli_dsp_layernorm.hpp

    @note Nothing.

    Copyright Novatek Microelectronics Corp. 2022.  All rights reserved.
*/
#ifndef _VENDOR_AI_DLI_DSP_LAYERNORM_HPP_
#define _VENDOR_AI_DLI_DSP_LAYERNORM_HPP_
...
#endif  /* _VENDOR_AI_DLI_DSP_LAYERNORM_HPP_ */
