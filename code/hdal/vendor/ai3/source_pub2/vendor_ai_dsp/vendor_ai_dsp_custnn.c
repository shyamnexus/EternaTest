...
//=============================================================
#define __CLASS__ 				"[ai][lib_dsp][custnn]"
...
/* Interface Functions                                                         */
/*-----------------------------------------------------------------------------*/
HD_RESULT vendor_ai_dsp_cust_init(uintptr_t parm_addr, UINT32 net_id)
{
	/*
		custom parm format:
...
HD_RESULT vendor_ai_dsp_cust_uninit(uintptr_t parm_addr, UINT32 net_id)
{
	/*
		custom parm format:
		1. custom_layer_type_id(UINT32)
...
HD_RESULT vendor_ai_dsp_cust_set_tmp_buf(NN_DATA_V30 tmp_buf, uintptr_t parm_addr)
{
	/*
	custom parm format:
    1. custom_layer_type_id(UINT32)
...
HD_RESULT vendor_ai_dsp_cust(uintptr_t parm_addr, UINT32 net_id)
{
	/*
	custom parm format:
    1. custom_layer_type_id(UINT32)
