...
typedef struct _NET_SUB_IMG_KERPARM
{
    ...
    uintptr_t plane_addr;               ///< plane iamge address
...
typedef struct _NN_PRE_PARM
{
    ...
    uintptr_t in_addr;                  ///< input image address
    uintptr_t out_addr;                 ///< output image address
    uintptr_t interm_addr;				///< intermediate address
