...
typedef struct _VENDOR_AI_NET_GROUP_MEM {
	uintptr_t user_parm_addr;
	uintptr_t mctrl_entry_addr;
	UINT32 mctrl_entry_size;
	uintptr_t llgroup_addr;
	UINT32 llgroup_size;
	uintptr_t mem_entry_addr;
...
UINT32 vendor_ai_net_group_calcbuffersize(UINT32 proc_id, uintptr_t user_parm_addr);
HD_RESULT vendor_ai_net_group_setbuffer(UINT32 proc_id, uintptr_t working_buf_addr, uintptr_t user_parm_addr);
