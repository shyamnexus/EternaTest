...
extern int _hd_audioenc_in_id_str(HD_DAL dev_id, HD_IO in_id, CHAR *p_str, INT str_len);
...
extern void _hd_videoproc_vpe_cfg_max(UINT32 maxhandle, UINT32 max_2dlut_sz);
extern void _hd_videoproc_aiisp_cfg_max(UINT32 maxdevice);
