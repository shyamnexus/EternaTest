...
#define HD_VIDEOCAP_SEN_SER_MAX_DATALANE 16    ///< serial sensor max data lane
...
#define HD_VIDEOCAP_8   (1 << 8)
#define HD_VIDEOCAP_9   (1 << 9)
#define HD_VIDEOCAP_10  (1 << 10)
#define HD_VIDEOCAP_11  (1 << 11)
#define HD_VIDEOCAP_12  (1 << 12)
#define HD_VIDEOCAP_13  (1 << 13)
#define HD_VIDEOCAP_14  (1 << 14)
#define HD_VIDEOCAP_15  (1 << 15)
#define HD_VIDEOCAP_16  (1 << 16)
#define HD_VIDEOCAP_17  (1 << 17)
#define HD_VIDEOCAP_18  (1 << 18)
#define HD_VIDEOCAP_19  (1 << 19)
...
#define HD_VIDEOCAP_HDR_SENSOR5   4
#define HD_VIDEOCAP_HDR_SENSOR6   5

#define HD_VIDEOCAP_SHDR_MAP(hdr_sensor, vdocap_id) MAKE_UINT16_UINT16(hdr_sensor, vdocap_id)

#define HD_VIDEOCAP_SEN_CLANE_CSI(id, clane)    (0 << 28 | (id) << 16 | (clane))
#define HD_VIDEOCAP_SEN_CLANE_LVDS(id, clane)   (1 << 28 | (id) << 16 | (clane))
#define HD_VIDEOCAP_SEN_CLANE_SLVSEC(id, clane) (2 << 28 | (id) << 16 | (clane))
...
typedef struct _HD_VIDEOCAP_SEN_PINMUX_CFG {
	UINT32 sensor_pinmux;       ///< select pinmux set in dtsi
	UINT32 serial_if_pinmux;    ///< obsolete
	UINT32 cmd_if_pinmux;       ///< obsolete
} HD_VIDEOCAP_SEN_PINMUX_CFG;

/**
    Obsolete enum. Don't use anymore.
    Use HD_VIDEOCAP_SEN_CLANE_CSI or HD_VIDEOCAP_SEN_CLANE_LVDS instead.
*/
typedef enum _HD_VIDEOCAP_SEN_CLANE_SEL {
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI0_USE_C0 = HD_VIDEOCAP_SEN_CLANE_CSI(0, 0),  ///< MIPI CSI0 uses HSI_CK0 as clock lane.
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI0_USE_C2 = HD_VIDEOCAP_SEN_CLANE_CSI(0, 2),  ///< MIPI CSI0 uses HSI_CK2 as clock lane.
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI1_USE_C0 = HD_VIDEOCAP_SEN_CLANE_CSI(1, 0),  ///< MIPI CSI1 uses HSI_CK0 as clock lane.
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI1_USE_C1 = HD_VIDEOCAP_SEN_CLANE_CSI(1, 1),  ///< MIPI CSI1 uses HSI_CK1 as clock lane.
	HD_VIDEOCAP_SEN_CLANE_SEL_LVDS1_USE_C1 = HD_VIDEOCAP_SEN_CLANE_LVDS(1, 1),///< LVDS1 uses HSI_CK1 as clock lane in one clock lane sensor.
...
typedef struct _HD_VIDEOCAP_SEN_INIT_PIN_CFG {
	...
	UINT32 clk_lane_sel;                                           ///< only LVDS and MIPI need to set
	UINT32 sen_2_serial_pin_map[HD_VIDEOCAP_SEN_SER_MAX_DATALANE]; ///< Serial (lvds/csi/slvsec) pin 2 hw map
	UINT32 ccir_msblsb_switch;                                     ///< only for ccir sensor output HD mode (16 bits)
...
/**
     The func of HD_VIDEOCAP_SEN_CFG_EXT
*/
#define HD_VIDEOCAP_SEN_EXT_AD_MAP      0  ///< analog Decoder mapping, e.g. HD_VIDEOCAP_AD_MAP(0, 0, HD_VIDEOCAP_0|HD_VIDEOCAP_1)
#define HD_VIDEOCAP_SEN_EXT_PDAF_MAP    1  ///< PDAF sensor mapping, e.g. (HD_VIDEOCAP_0|HD_VIDEOCAP_1) for multi-frame mode or (HD_VIDEOCAP_0) for single-frame mode
#define HD_VIDEOCAP_SEN_EXT_ISP_ID      2  ///< specific ISP_ID
#define HD_VIDEOCAP_SEN_EXT_TGE_ID      3  ///< TGE HW ID
#define HD_VIDEOCAP_SEN_EXT_SW_VD_SYNC  4  ///< indicate which VCAPs use software VD sync mechanism, e.g. set 0x3 to sync VIDEOCAP0 and VIDEOCAP1
#define HD_VIDEOCAP_SEN_EXT_PAD_SEL     5  ///< pad selection, referring to CTL_SEN_PAD_SEL, only for ccir sensor
#define HD_VIDEOCAP_SEN_EXT_SMP_EDGE    6  ///< smp edge, referring to CTL_SEN_SMP_EDGE, only for ccir sensor
#define HD_VIDEOCAP_SEN_EXT_COMBO_MAP   7  ///< combination mapping
