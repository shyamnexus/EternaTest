...
#define HD_DAL_VIDEOPROC_RESERVED_BASE  0x3300 ///< for reserved HD_DAL_VIDEOPROC
...
typedef enum _HD_CTRL_ID {
	...
	/* DEVICE 4 */
	HD_AUDIOOUT_4_CTRL = HD_AUDIOOUT_CTRL(4),
	/* DEVICE 5 */
	HD_AUDIOOUT_5_CTRL = HD_AUDIOOUT_CTRL(5),
...
typedef enum _HD_IN_ID {
	...
	/* DEVICE 2 */
	HD_VIDEOOUT_2_IN_0 = HD_VIDEOOUT_IN(2, 0),
	HD_VIDEOOUT_2_IN_1 = HD_VIDEOOUT_IN(2, 1),
	HD_VIDEOOUT_2_IN_2 = HD_VIDEOOUT_IN(2, 2),
	HD_VIDEOOUT_2_IN_3 = HD_VIDEOOUT_IN(2, 3),
	HD_VIDEOOUT_2_IN_4 = HD_VIDEOOUT_IN(2, 4),
	HD_VIDEOOUT_2_IN_5 = HD_VIDEOOUT_IN(2, 5),
	HD_VIDEOOUT_2_IN_6 = HD_VIDEOOUT_IN(2, 6),
	HD_VIDEOOUT_2_IN_7 = HD_VIDEOOUT_IN(2, 7),
	HD_VIDEOOUT_2_IN_8 = HD_VIDEOOUT_IN(2, 8),
	HD_VIDEOOUT_2_IN_9 = HD_VIDEOOUT_IN(2, 9),
	HD_VIDEOOUT_2_IN_10 = HD_VIDEOOUT_IN(2, 10),
	HD_VIDEOOUT_2_IN_11 = HD_VIDEOOUT_IN(2, 11),
	HD_VIDEOOUT_2_IN_12 = HD_VIDEOOUT_IN(2, 12),
	HD_VIDEOOUT_2_IN_13 = HD_VIDEOOUT_IN(2, 13),
	HD_VIDEOOUT_2_IN_14 = HD_VIDEOOUT_IN(2, 14),
	HD_VIDEOOUT_2_IN_15 = HD_VIDEOOUT_IN(2, 15),
...
typedef enum _HD_OUT_ID {
	...
	/* DEVICE 2 */
	HD_VIDEOOUT_2_OUT_0 = HD_VIDEOOUT_OUT(2, 0),
	...
	/* DEVICE 4 */
	HD_AUDIOOUT_4_OUT_0 = HD_AUDIOOUT_OUT(4, 0),
	/* DEVICE 5 */
	HD_AUDIOOUT_5_OUT_0 = HD_AUDIOOUT_OUT(5, 0),
...
typedef enum _HD_VIDEO_PXLFMT {
	...
	HD_VIDEO_PXLFMT_ARGB4444_RLE =      0x31104444, ///< novatek-rgb-compress
	HD_VIDEO_PXLFMT_ARGB8565_RLE =      0x31208565, ///< novatek-rgb-compress
	HD_VIDEO_PXLFMT_ARGB8888_RLE =      0x31208888, ///< novatek-rgb-compress
	HD_VIDEO_PXLFMT_I8_RLE       =      0x31300008, ///< novatek-rgb-compress
	/* 4 = video raw format */
	...
	HD_VIDEO_PXLFMT_YUV420 =            0x520c0420, ///< 2 plane, pixel=Y(w,h), UV(w/2,h/2), NV12 semi-planer format with U1V1 
	HD_VIDEO_PXLFMT_YUV420_LEGACY =     0x51100420, ///< 1 plane, YYUYYV(w,h), packed format with Y4U1V1
	...
	HD_VIDEO_PXLFMT_YUV420_MB4 =        0x520ce420, ///< 2 plane, pixel=Y(w,h), UV(w/2,h/2), 32x8 macro block format
	HD_VIDEO_PXLFMT_YUV420_MB5 =        0x520cf420, ///< 2 plane, pixel=Y(w,h), UV(w/2,h/2), wx1 macro block format
	/* 5 = video yuv format extension */
	HD_VIDEO_PXLFMT_YUV_PLANAR_420 =     HD_VIDEO_PXLFMT_YUV420_PLANAR,
	HD_VIDEO_PXLFMT_YVU_PLANAR_420 =     0x530c1420, ///< 3 plane, pixel=Y(w,h), V(w/2,h/2), and U(w/2,h/2)
	HD_VIDEO_PXLFMT_YUV_PLANAR_422 =     HD_VIDEO_PXLFMT_YUV422_PLANAR,
	HD_VIDEO_PXLFMT_YVU_PLANAR_422 =     0x53101422, ///< 3 plane, pixel=Y(w,h), V(w/2,h), and U(w/2,h)
	HD_VIDEO_PXLFMT_YUV_PLANAR_444 =     HD_VIDEO_PXLFMT_YUV444_PLANAR,
	HD_VIDEO_PXLFMT_YVU_PLANAR_444 =     0x53181444, ///< 3 plane, pixel=Y(w,h), V(w,h), and U(w,h)
	HD_VIDEO_PXLFMT_YUV_SEMIPLANAR_420 = HD_VIDEO_PXLFMT_YUV420,
	HD_VIDEO_PXLFMT_YVU_SEMIPLANAR_420 = 0x520c1420, ///< 2 plane, pixel=Y(w,h), VU(w/2,h/2), NV21 semi-planer format with U1V1
	HD_VIDEO_PXLFMT_YUV_SEMIPLANAR_422 = HD_VIDEO_PXLFMT_YUV422,
	HD_VIDEO_PXLFMT_YVU_SEMIPLANAR_422 = 0x52101422, ///< 2 plane, pixel=Y(w,h), VU(w/2,h), semi-planer format with U1V1
	HD_VIDEO_PXLFMT_YUV_SEMIPLANAR_444 = HD_VIDEO_PXLFMT_YUV444,
	HD_VIDEO_PXLFMT_YVU_SEMIPLANAR_444 = 0x52181444, ///< 2 plane, pixel=Y(w,h), VU(w,h), semi-planer format with U1V1
	HD_VIDEO_PXLFMT_UYVY_PACKED_422 =    HD_VIDEO_PXLFMT_YUV422_UYVY,
	HD_VIDEO_PXLFMT_VYUY_PACKED_422 =    HD_VIDEO_PXLFMT_YUV422_VYUY,
	HD_VIDEO_PXLFMT_YUYV_PACKED_422 =    HD_VIDEO_PXLFMT_YUV422_YUYV,
	HD_VIDEO_PXLFMT_YVYU_PACKED_422 =    HD_VIDEO_PXLFMT_YUV422_YVYU,
	HD_VIDEO_PXLFMT_UVYY_PACKED_422 =    0x51104422, ///< 1 plane, pixel=UVYY(w,h), packed format with Y2U1V1
	HD_VIDEO_PXLFMT_VUYY_PACKED_422 =    0x51105422, ///< 1 plane, pixel=VUYY(w,h), packed format with Y2U1V1
	HD_VIDEO_PXLFMT_YYUV_PACKED_422 =    0x51106422, ///< 1 plane, pixel=YYUV(w,h), packed format with Y2U1V1
	HD_VIDEO_PXLFMT_YYVU_PACKED_422 =    0x51107422, ///< 1 plane, pixel=YYVU(w,h), packed format with Y2U1V1
	HD_VIDEO_PXLFMT_YUV_PACKED_444 =     HD_VIDEO_PXLFMT_YUV444_ONE,
	HD_VIDEO_PXLFMT_YVU_PACKED_444 =     0x51181444, ///< 1 plane, pixel=YVU(w,h), packed format with Y1U1V1
	HD_VIDEO_PXLFMT_UY1VY0_PACKED_422 =  0x52200422, ///< 2 plane, pixel=VY0(w,h), UY1(w,h), packed format with Y2U1V1
	HD_VIDEO_PXLFMT_VY1UY0_PACKED_422 =  0x52201422, ///< 2 plane, pixel=UY0(w,h), VY1(w,h), packed format with Y2U1V1
	HD_VIDEO_PXLFMT_UV_420 =             0x51000420, ///< 1 plane, pixel=UV(w,h)
	...
	HD_VIDEO_PXLFMT_YUV420_NVX2 =       0x610c2420, ///< novatek-yuv-compress-2 of YUV420 (YCC)
	HD_VIDEO_PXLFMT_YUV420_NVX3 =       0x610c3420, ///< novatek-yuv-compress-3 of YUV420 (SCE)
...
typedef struct _HD_VIDEO_FRAME {
	...
	ULONG  poc_info;                    ///< poc_info for user trigger
	ULONG  reserved[7];                 ///< reserved info
...
typedef enum _HD_VIDEO_CODEC {
	...
	HD_CODEC_TYPE_YDCC8,                ///< ydcc8 codec type
	HD_CODEC_TYPE_YDCC12,               ///< ydcc12 codec type
	HD_CODEC_TYPE_MAX,
...
typedef struct _HD_VIDEOENC_BS3 {
	...
	UINTPTR blk;                         ///< [r]memory block
	UINTPTR blk2;                       ///< [r]memory block 2
...
typedef enum _HD_AUDIO_SR {
	...
	HD_AUDIO_SR_96000 = 96000,          ///< sample rate 96000 Hz
	HD_AUDIO_SR_192000 = 192000,        ///< sample rate 192000 Hz
	HD_AUDIO_SR_MAX_CNT = 11,           ///< maximum count
...
typedef enum _HD_AUDIO_BIT_WIDTH {
	...
	HD_AUDIO_BIT_WIDTH_32 = 32,         ///< 32bit width
	HD_AUDIO_BIT_WIDTH_MAX_CNT = 3,     ///< maximum count
...
#define HD_STAMP_EX_MAX                 (HD_STAMP_EX_BASE+32-1)
...
#define HD_MASK_MAX                     (HD_MASK_BASE+16-1)
