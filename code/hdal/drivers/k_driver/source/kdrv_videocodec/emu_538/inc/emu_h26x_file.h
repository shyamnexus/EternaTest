...
BOOL  h26xFileRead(H26XFile *pH26XFile, UINT32 Size, uintptr_t BufAddr);
BOOL  h26xFilePreRead(H26XFile *pH26XFile, UINT32 Size, uintptr_t BufAddr);
BOOL  h26xFileWrite(H26XFile *pH26XFile, UINT32 Size, uintptr_t BufAddr);
void h26xFileClose(H26XFile *pH26XFile);
void h26xFileDebug(void);
BOOL h26xFileReadFlush(H26XFile *pH26XFile, UINT32 Size, uintptr_t BufAddr);
void h26xFileDummyRead(void);

void h26xFileOpen2(FST_FILE *fp, H26XFile *pH26XFile);
void h26xFileRead2(FST_FILE *fp, H26XFile *pH26XFile, UINT32 Size, uintptr_t BufAddr);
void h26xFileSeek2(FST_FILE *fp, H26XFile *pH26XFile, UINT32 size);
void h26xFileClose2(FST_FILE *fp);
BOOL h26xFileChkExist(H26XFile *pH26XFile);
