...
/**
    JPEG OSG Parameter
*/
#define MAX_JPEG_OSG_LAYER		2
#define MAX_JPEG_OSG_NUM		16
...
// ctg reg //
extern ER jpeg_set_ctg_reg(UINT32 ctg_src_en, UINT32 ctg_out_en);
// pad reg //
...
extern ER jpeg_set_fpga_osg_win_reg(UINT32 osg_graph_reg[OSG_LAYER][OSG_REGION][9], UINT32 osg_chroma);
...
// mask reg //
extern ER jpeg_set_mask_reg(UINT32 mask_reg[417]);
extern ER jpeg_set_mask_disable(void);
// ycc api //
...
// osg kdriver api //
extern ER jpeg_set_osg_win_cfg(UINT8 ucId, UINT8 ucLayerIdx, UINT8 ucWinIdx, JPEG_OSG_WIN_CFG *pOsgWin);
