...
#define SUPPORT_JPEG_ENGINE			0

#define OSG_REGION					16
#define OSG_LAYER					2
...
#if SUPPORT_JE_OSG
	UINT32		uiOSGGraphBuf[OSG_LAYER][OSG_REGION];
#endif
