...
extern uintptr_t jpeg_engine_io_addr;
#if (SUPPORT_JPEG_ENGINE)
    #define JPEG_SETREG(ofs, value)     OUTW(jpeg_engine_io_addr+(ofs), (value))
    #define JPEG_GETREG(ofs)            INW(jpeg_engine_io_addr+(ofs))
#else
