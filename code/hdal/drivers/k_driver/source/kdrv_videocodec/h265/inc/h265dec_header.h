...
#define MAX_HEVC_WIDTH                 (8192)
#define MAX_HEVC_HEIGHT                (8192)
...
extern UINT32 h265Dec_getNumRpsCurrTempList(H265DecSliceObj *slice);
extern void h265Dec_parseRPLM(UINT32 type, H265DecSliceObj *slice, bstream *pBs);
extern int calculateLenOfSyntaxElement(int numVal);
extern int readByteAlignment(bstream *const bs);
extern INT32 H265DecSlice(H265DEC_INFO *pH265DecInfo, H265DecHdrObj *pH265DecHdrObj, uintptr_t uiBsAddr, UINT32 uiBsLen,
                            int nuh_layer_id);
extern INT32 H265DecSeqHeader(H265DEC_INIT *pH265DecInit, H265DecHdrObj *pH265DecHdrObj, H26XDEC_VUI *pVui);
extern void h265Dec_parsePTL(int profilePresentFlag, int maxNumSubLayersMinus1, PTL *pptl, bstream *pBs);
extern UINT32 H265DecNal(bstream *pBstream, H265DecSliceObj *slice);
extern int h265Dec_parseSTRPS(int idxRps, int num_short_term_ref_pic_sets, STRPS *rps, bstream *pBs, H265DecSpsObj *sps);
