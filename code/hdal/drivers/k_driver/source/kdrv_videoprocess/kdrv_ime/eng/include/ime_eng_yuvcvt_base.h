...
//-------------------------------------------------------------------
// YUV converter
extern VOID ime_eng_set_yuv_converter_enable_buf_reg(IME_ENG_HANDLE *p_eng, UINT32 set_en);
extern VOID ime_eng_set_yuv_converter_sel_buf_reg(IME_ENG_HANDLE *p_eng, UINT32 set_sel);

#if (IME_GET_API_EN == 1)
extern UINT32 ime_eng_get_yuv_converter_enable_buf_reg(IME_ENG_HANDLE *p_eng, VOID);
extern UINT32 ime_eng_get_yuv_converter_sel_buf_reg(IME_ENG_HANDLE *p_eng, VOID);
#endif
