...
#define IME_FULL_LINE_BUF_SIZE  4096//2688
#define IME_ISD_OUTPUT_BUF_SIZE 2048//1344
...
typedef enum _IME_SRC_CTRL_SEL {
	SRC_CTRL_IPP_DIRECT = 0,         ///< IPP direct
	SRC_CTRL_IPP_D2D    = 1,         ///< IPP Dram to Dram
...
//extern volatile NT98690_IME_ENG_REG_STRUCT *imeg;
