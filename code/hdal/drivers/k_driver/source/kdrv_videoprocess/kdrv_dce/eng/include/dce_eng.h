...
#define DCE_ENG_WDR_FBC_TH_NUM    6
#define DCE_ENG_WDR_TONE_CURVE_L_NUM 65
#define DCE_ENG_WDR_TONE_CURVE_R_NUM 17
#define DCE_ENG_WDR_OUTPUT_BLEND_L_NUM 65
#define DCE_ENG_WDR_OUTPUT_BLEND_R_NUM 17


#define DCE_ENG_WDR_HIST_BIN_NUM 128


#define IMG_STP_MAX_NUM 24
...
typedef enum {
	...
	DCE_ENG_INTERRUPT_2_PIXEL_TOO_FAR	= 0x00000020,
	...
	DCE_ENG_INTERRUPT_ALL 				= (DCE_ENG_INTERRUPT_FRMST |
										DCE_ENG_INTERRUPT_FRMEND |
										DCE_ENG_INTERRUPT_STEND |
										DCE_ENG_INTERRUPT_STP_ERR |
										DCE_ENG_INTERRUPT_LB_OVF |
										DCE_ENG_INTERRUPT_2_PIXEL_TOO_FAR |
										DCE_ENG_INTERRUPT_STP_OB |
										DCE_ENG_INTERRUPT_Y_BACK |
										DCE_ENG_INTERRUPT_LL_END |
										DCE_ENG_INTERRUPT_LL_ERROR |
										DCE_ENG_INTERRUPT_LL_ERROR2 |
										DCE_ENG_INTERRUPT_LL_JOBEND |
										DCE_ENG_INTERRUPT_FRAMEERR),
} DCE_ENG_INTERRUPT;
...
typedef struct {
	...
	UINT32 dce_frame_error;
	UINT32 dce_2_pixel_too_far;
...
typedef struct {
	...
	DCE_ENG_WDR_SUBIMG_DIV  wdr_subimg_div; //wdr subimage division ratio
} DCE_ENG_WDR_SUBIMG;
...
typedef struct {
	ULONG lut2d_addr;                  // 2D lut DRAM address
	BOOL ymin_auto_en;
...
typedef struct {
	...
	UINT16 imeolap_msb_user_val;   	// user-defined overlap value msb
	UINT16 imeolap_user_val;     	// user-defined overlap value
	UINT16 *p_hstp; 			// 16 entries, DCE_ENG_STP_MAX_NUM
...
typedef enum {
	...
	DCE_ENG_STRP_GDC_BEST = 2,     			// stripe configuration for GDC best performance without low latency
...
typedef struct {
	...
	UINT16 *p_dce_out_hstp;	// H stripe results of DCE output image, DCE_ENG_STP_MAX_NUM
	UINT16 *p_ime_in_hstp;	// H stripe results of IME input image, DCE_ENG_STP_MAX_NUM
	UINT16 *p_ime_out_hstp;	// H stripe results of IME output image, DCE_ENG_STP_MAX_NUM
} DCE_ENG_STP_RESULT;
...
extern VOID dce_eng_set_reg_buf(ULONG reg_base_addr, ULONG reg_flag_addr);
...
extern ER dce_eng_get_output_stp_setting(DCE_ENG_CAL_STP_INFO *p_cal_info, DCE_ENG_STP_RESULT *p_ns_result);
...
extern void dce_eng_trig_ll_hw_reg(DCE_ENG_HANDLE *p_eng, ULONG ll_addr);
...
extern void dce_eng_set_axi_disable_hw_reg(DCE_ENG_HANDLE *p_eng, BOOL enable);
...
extern void dce_eng_set_wdr_sub_in_buf_reg(ULONG subin_addr, UINT32 subin_lofs);
extern void dce_eng_set_wdr_sub_out_buf_reg(ULONG subout_addr, UINT32 subout_lofs);
extern void dce_eng_set_wdr_subimg_param_reg(DCE_ENG_WDR_SUBIMG *p_wdr_subimg);
...
extern void dce_eng_set_wdr_tone_curve_buf_r_reg(UINT16 *p_tone_r_buf);
extern void dce_eng_set_wdr_tone_curve_buf_l_reg(UINT16 *p_tone_l_buf);

extern void dce_eng_set_wdr_output_blend_enable_buf_reg(BOOL outbld_enable);
extern void dce_eng_set_wdr_output_blend_buf_r_reg(UINT16 *p_outbld_r_buf);
extern void dce_eng_set_wdr_output_blend_buf_l_reg(UINT16 *p_outbld_l_buf);
...
extern void dce_eng_set_2dlut_buf_reg(DCE_ENG_2DLUT_PARAM *p_2dlut_param);//removed from 98530, do nothing inside
...
extern INT32 dce_eng_chk_limitation(ULONG reg_base_addr, ULONG reg_flag_addr);
