...
/*
    ...
    dce_global_load_en:    [0x0, 0x1],          bits : 5
...
REGDEF_BIT(dce_global_load_en,        1)
REGDEF_BIT(,        22)
...
/*
    ...
    d2d_rand               :    [0x0, 0x1],         bits : 21
    d2d_rand_rst           :    [0x0, 0x1],         bits : 22
    fstr_rst_disable       :    [0x0, 0x1],         bits : 23
    d2d_fmt                :    [0x0, 0x3],         bits : 25_24
    d2d_uv_out_disable     :    [0x0, 0x1],         bits : 26
    d2d_uv_filt            :    [0x0, 0x1],         bits : 27
    d2d_io_stop            :    [0x0, 0x1],         bits : 28
...
REGDEF_BIT(d2d_rand,        1)
REGDEF_BIT(d2d_rand_rst,        1)
REGDEF_BIT(fstr_rst_disable,        1)
REGDEF_BIT(d2d_fmt,        2)
REGDEF_BIT(d2d_uv_out_disable,        1)
REGDEF_BIT(d2d_uv_filt,        1)
REGDEF_BIT(d2d_io_stop,        1)
...
REGDEF_BIT(inte_2_pxl_too_far,        1)
...
REGDEF_BIT(int_2_pxl_too_far,        1)
...
/*
    ...
    hstp_inst_auto  :    [0x0, 0x1],            bits : 16
...
*/
#define LL_FRAME_REGISTER_0_OFS 0x0078
...
*/
#define LL_FRAME_REGISTER_1_OFS 0x007c
...
*/
#define LL_FRAME_REGISTER_2_OFS 0x0080
...
*/
#define LL_FRAME_REGISTER_3_OFS 0x0084
...
*/
#define RESERVED_REGISTER_0_OFS 0x0088
REGDEF_BEGIN(RESERVED_REGISTER_0)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_0)
...
/*
    crop_hstart:    [0x0, 0xfff],          bits : 12_1
*/
#define OUTPUT_CROP_REGISTER_1_OFS 0x0090
REGDEF_BEGIN(OUTPUT_CROP_REGISTER_1)
REGDEF_BIT(,        1)
REGDEF_BIT(crop_hstart,        12)
REGDEF_END(OUTPUT_CROP_REGISTER_1)


/*
    dce_axi_disable:    [0x0, 0x1],         bits : 0
    dce_r_ostd_num :    [0x0, 0xff],            bits : 15_8
    dce_w_ostd_num :    [0x0, 0xff],            bits : 23_16
    dce_axi_ch_idle:    [0x0, 0x1],         bits : 24
*/
#define AXI_REGISTER_0_OFS 0x0094
REGDEF_BEGIN(AXI_REGISTER_0)
REGDEF_BIT(dce_axi_disable,        1)
REGDEF_BIT(,        7)
REGDEF_BIT(dce_r_ostd_num,        8)
REGDEF_BIT(dce_w_ostd_num,        8)
REGDEF_BIT(dce_axi_ch_idle,        1)
REGDEF_END(AXI_REGISTER_0)


/*
    dce_axi_ch_enable_mask   :    [0x0, 0xff],          bits : 7_0
    dce_axi_lock_disable_mask:    [0x0, 0xff],          bits : 23_16
*/
#define AXI_REGISTER_1_OFS 0x0098
REGDEF_BEGIN(AXI_REGISTER_1)
REGDEF_BIT(dce_axi_ch_enable_mask,        8)
REGDEF_BIT(,        8)
REGDEF_BIT(dce_axi_lock_disable_mask,        8)
REGDEF_END(AXI_REGISTER_1)


/*
    dce_axi_ch_sta:    [0x0, 0xffffffff],           bits : 31_0
*/
#define AXI_REGISTER_2_OFS 0x009c
REGDEF_BEGIN(AXI_REGISTER_2)
REGDEF_BIT(dce_axi_ch_sta,        32)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_1_OFS 0x00dc
REGDEF_BEGIN(RESERVED_REGISTER_1)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_1)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_2_OFS 0x0100
REGDEF_BEGIN(RESERVED_REGISTER_2)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_2)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_3_OFS 0x0104
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_4_OFS 0x0108
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_5_OFS 0x010c
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_6_OFS 0x0110
REGDEF_BEGIN(RESERVED_REGISTER_6)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_6)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_7_OFS 0x0114
REGDEF_BEGIN(RESERVED_REGISTER_7)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_7)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_8_OFS 0x0118
REGDEF_BEGIN(RESERVED_REGISTER_8)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_8)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_9_OFS 0x011c
REGDEF_BEGIN(RESERVED_REGISTER_9)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_9)


/*
    wdr_subimg_width  :    [0x0, 0x3f],         bits : 5_0
    wdr_subimg_height :    [0x0, 0x3f],         bits : 13_8
    wdr_dithering_en  :    [0x0, 0x1],          bits : 16
    wdr_rand_reset    :    [0x0, 0x1],          bits : 17
    wdr_rand_sel      :    [0x0, 0x3],          bits : 19_18
*/
#define WDR_SUBIMAGE_REGISTER_0_OFS 0x0120
REGDEF_BEGIN(WDR_SUBIMAGE_REGISTER_0)
REGDEF_BIT(wdr_subimg_width,        6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_subimg_height,        6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_dithering_en,        1)
...
/*
    wdr_subimg_ratio_hori:    [0x0, 0xffff],            bits : 15_0
    wdr_subimg_ratio_vert:    [0x0, 0xffff],            bits : 31_16
*/
#define WDR_SUBIMAGE_REGISTER_5_OFS 0x0134
REGDEF_BEGIN(WDR_SUBIMAGE_REGISTER_5)
REGDEF_BIT(wdr_subimg_ratio_hori,        16)
REGDEF_BIT(wdr_subimg_ratio_vert,        16)
REGDEF_END(WDR_SUBIMAGE_REGISTER_5)


/*
    wdr_subimg_ratio_hori_div:    [0x0, 0x3fffff],          bits : 21_0
*/
#define WDR_SUBIMAGE_REGISTER_6_OFS 0x0138
REGDEF_BEGIN(WDR_SUBIMAGE_REGISTER_6)
REGDEF_BIT(wdr_subimg_ratio_hori_div,        22)
REGDEF_END(WDR_SUBIMAGE_REGISTER_6)


/*
    wdr_subimg_ratio_vert_div:    [0x0, 0x3fffff],          bits : 21_0
*/
#define WDR_SUBIMAGE_REGISTER_7_OFS 0x013c
REGDEF_BEGIN(WDR_SUBIMAGE_REGISTER_7)
REGDEF_BIT(wdr_subimg_ratio_vert_div,        22)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_10_OFS 0x0140
...
/*
    wdr_tcurve_val_lut_l0:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_l1:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER0_OFS 0x0168
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER0)
REGDEF_BIT(wdr_tcurve_val_lut_l0,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l1,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER0)


/*
    wdr_tcurve_val_lut_l2:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_l3:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER1_OFS 0x016c
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER1)
REGDEF_BIT(wdr_tcurve_val_lut_l2,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l3,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER1)


/*
    wdr_tcurve_val_lut_l4:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_l5:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER2_OFS 0x0170
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER2)
REGDEF_BIT(wdr_tcurve_val_lut_l4,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l5,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER2)


/*
    wdr_tcurve_val_lut_l6:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_l7:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER3_OFS 0x0174
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER3)
REGDEF_BIT(wdr_tcurve_val_lut_l6,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l7,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER3)


/*
    wdr_tcurve_val_lut_l8:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_l9:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER4_OFS 0x0178
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER4)
REGDEF_BIT(wdr_tcurve_val_lut_l8,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l9,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER4)


/*
    wdr_tcurve_val_lut_l10:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l11:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER5_OFS 0x017c
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER5)
REGDEF_BIT(wdr_tcurve_val_lut_l10,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l11,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER5)


/*
    wdr_tcurve_val_lut_l12:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l13:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER6_OFS 0x0180
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER6)
REGDEF_BIT(wdr_tcurve_val_lut_l12,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l13,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER6)


/*
    wdr_tcurve_val_lut_l14:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l15:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER7_OFS 0x0184
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER7)
REGDEF_BIT(wdr_tcurve_val_lut_l14,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l15,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER7)


/*
    wdr_tcurve_val_lut_l16:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l17:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER8_OFS 0x0188
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER8)
REGDEF_BIT(wdr_tcurve_val_lut_l16,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l17,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER8)


/*
    wdr_tcurve_val_lut_l18:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l19:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER9_OFS 0x018c
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER9)
REGDEF_BIT(wdr_tcurve_val_lut_l18,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l19,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER9)


/*
    wdr_tcurve_val_lut_l20:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l21:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER10_OFS 0x0190
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER10)
REGDEF_BIT(wdr_tcurve_val_lut_l20,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l21,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER10)


/*
    wdr_tcurve_val_lut_l22:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l23:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER11_OFS 0x0194
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER11)
REGDEF_BIT(wdr_tcurve_val_lut_l22,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l23,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER11)


/*
    wdr_tcurve_val_lut_l24:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l25:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER12_OFS 0x0198
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER12)
REGDEF_BIT(wdr_tcurve_val_lut_l24,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l25,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER12)


/*
    wdr_tcurve_val_lut_l26:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l27:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER13_OFS 0x019c
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER13)
REGDEF_BIT(wdr_tcurve_val_lut_l26,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l27,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER13)


/*
    wdr_tcurve_val_lut_l28:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l29:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER14_OFS 0x01a0
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER14)
REGDEF_BIT(wdr_tcurve_val_lut_l28,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l29,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER14)


/*
    wdr_tcurve_val_lut_l30:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l31:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER15_OFS 0x01a4
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER15)
REGDEF_BIT(wdr_tcurve_val_lut_l30,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l31,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER15)


/*
    wdr_tcurve_val_lut_l32:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l33:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER16_OFS 0x01a8
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER16)
REGDEF_BIT(wdr_tcurve_val_lut_l32,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l33,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER16)


/*
    wdr_tcurve_val_lut_l34:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l35:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER17_OFS 0x01ac
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER17)
REGDEF_BIT(wdr_tcurve_val_lut_l34,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l35,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER17)


/*
    wdr_tcurve_val_lut_l36:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l37:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER18_OFS 0x01b0
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER18)
REGDEF_BIT(wdr_tcurve_val_lut_l36,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l37,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER18)


/*
    wdr_tcurve_val_lut_l38:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l39:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER19_OFS 0x01b4
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER19)
REGDEF_BIT(wdr_tcurve_val_lut_l38,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l39,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER19)


/*
    wdr_tcurve_val_lut_l40:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l41:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER20_OFS 0x01b8
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER20)
REGDEF_BIT(wdr_tcurve_val_lut_l40,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l41,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER20)


/*
    wdr_tcurve_val_lut_l42:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l43:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER21_OFS 0x01bc
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER21)
REGDEF_BIT(wdr_tcurve_val_lut_l42,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l43,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER21)


/*
    wdr_tcurve_val_lut_l44:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l45:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER22_OFS 0x01c0
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER22)
REGDEF_BIT(wdr_tcurve_val_lut_l44,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l45,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER22)


/*
    wdr_tcurve_val_lut_l46:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l47:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER23_OFS 0x01c4
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER23)
REGDEF_BIT(wdr_tcurve_val_lut_l46,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l47,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER23)


/*
    wdr_tcurve_val_lut_l48:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l49:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER24_OFS 0x01c8
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER24)
REGDEF_BIT(wdr_tcurve_val_lut_l48,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l49,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER24)


/*
    wdr_tcurve_val_lut_l50:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l51:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER25_OFS 0x01cc
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER25)
REGDEF_BIT(wdr_tcurve_val_lut_l50,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l51,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER25)


/*
    wdr_tcurve_val_lut_l52:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l53:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER26_OFS 0x01d0
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER26)
REGDEF_BIT(wdr_tcurve_val_lut_l52,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l53,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER26)


/*
    wdr_tcurve_val_lut_l54:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l55:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER27_OFS 0x01d4
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER27)
REGDEF_BIT(wdr_tcurve_val_lut_l54,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l55,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER27)


/*
    wdr_tcurve_val_lut_l56:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l57:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER28_OFS 0x01d8
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER28)
REGDEF_BIT(wdr_tcurve_val_lut_l56,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l57,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER28)


/*
    wdr_tcurve_val_lut_l58:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l59:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER29_OFS 0x01dc
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER29)
REGDEF_BIT(wdr_tcurve_val_lut_l58,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l59,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER29)


/*
    wdr_tcurve_val_lut_l60:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l61:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER30_OFS 0x01e0
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER30)
REGDEF_BIT(wdr_tcurve_val_lut_l60,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l61,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER30)


/*
    wdr_tcurve_val_lut_l62:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_l63:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER31_OFS 0x01e4
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER31)
REGDEF_BIT(wdr_tcurve_val_lut_l62,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_l63,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER31)


/*
    wdr_tcurve_val_lut_l64:    [0x0, 0xfff],            bits : 11_0
*/
#define WDR_TONE_CURVE_REGISTER32_OFS 0x01e8
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER32)
REGDEF_BIT(wdr_tcurve_val_lut_l64,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER32)


/*
    wdr_tcurve_val_lut_r0:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_r1:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER33_OFS 0x01ec
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER33)
REGDEF_BIT(wdr_tcurve_val_lut_r0,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r1,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER33)


/*
    wdr_tcurve_val_lut_r2:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_r3:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER34_OFS 0x01f0
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER34)
REGDEF_BIT(wdr_tcurve_val_lut_r2,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r3,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER34)


/*
    wdr_tcurve_val_lut_r4:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_r5:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER35_OFS 0x01f4
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER35)
REGDEF_BIT(wdr_tcurve_val_lut_r4,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r5,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER35)


/*
    wdr_tcurve_val_lut_r6:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_r7:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER36_OFS 0x01f8
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER36)
REGDEF_BIT(wdr_tcurve_val_lut_r6,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r7,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER36)


/*
    wdr_tcurve_val_lut_r8:    [0x0, 0xfff],         bits : 11_0
    wdr_tcurve_val_lut_r9:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER37_OFS 0x01fc
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER37)
REGDEF_BIT(wdr_tcurve_val_lut_r8,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r9,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER37)


/*
    wdr_tcurve_val_lut_r10:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_r11:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER38_OFS 0x0200
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER38)
REGDEF_BIT(wdr_tcurve_val_lut_r10,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r11,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER38)


/*
    wdr_tcurve_val_lut_r12:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_r13:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER39_OFS 0x0204
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER39)
REGDEF_BIT(wdr_tcurve_val_lut_r12,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r13,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER39)


/*
    wdr_tcurve_val_lut_r14:    [0x0, 0xfff],            bits : 11_0
    wdr_tcurve_val_lut_r15:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_TONE_CURVE_REGISTER40_OFS 0x0208
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER40)
REGDEF_BIT(wdr_tcurve_val_lut_r14,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_tcurve_val_lut_r15,        12)
REGDEF_END(WDR_TONE_CURVE_REGISTER40)


/*
    wdr_tcurve_val_lut_r16:    [0x0, 0xfff],            bits : 11_0
*/
#define WDR_TONE_CURVE_REGISTER41_OFS 0x020c
REGDEF_BEGIN(WDR_TONE_CURVE_REGISTER41)
REGDEF_BIT(wdr_tcurve_val_lut_r16,        12)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_11_OFS 0x0210
...
/*
    wdr_outbld_val_lut_l0:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_l1:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER0_OFS 0x0214
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER0)
REGDEF_BIT(wdr_outbld_val_lut_l0,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l1,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER0)


/*
    wdr_outbld_val_lut_l2:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_l3:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER1_OFS 0x0218
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER1)
REGDEF_BIT(wdr_outbld_val_lut_l2,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l3,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER1)


/*
    wdr_outbld_val_lut_l4:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_l5:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER2_OFS 0x021c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER2)
REGDEF_BIT(wdr_outbld_val_lut_l4,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l5,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER2)


/*
    wdr_outbld_val_lut_l6:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_l7:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER3_OFS 0x0220
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER3)
REGDEF_BIT(wdr_outbld_val_lut_l6,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l7,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER3)


/*
    wdr_outbld_val_lut_l8:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_l9:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER4_OFS 0x0224
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER4)
REGDEF_BIT(wdr_outbld_val_lut_l8,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l9,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER4)


/*
    wdr_outbld_val_lut_l10:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l11:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER5_OFS 0x0228
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER5)
REGDEF_BIT(wdr_outbld_val_lut_l10,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l11,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER5)


/*
    wdr_outbld_val_lut_l12:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l13:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER6_OFS 0x022c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER6)
REGDEF_BIT(wdr_outbld_val_lut_l12,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l13,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER6)


/*
    wdr_outbld_val_lut_l14:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l15:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER7_OFS 0x0230
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER7)
REGDEF_BIT(wdr_outbld_val_lut_l14,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l15,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER7)


/*
    wdr_outbld_val_lut_l16:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l17:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER8_OFS 0x0234
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER8)
REGDEF_BIT(wdr_outbld_val_lut_l16,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l17,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER8)


/*
    wdr_outbld_val_lut_l18:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l19:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER9_OFS 0x0238
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER9)
REGDEF_BIT(wdr_outbld_val_lut_l18,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l19,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER9)


/*
    wdr_outbld_val_lut_l20:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l21:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER10_OFS 0x023c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER10)
REGDEF_BIT(wdr_outbld_val_lut_l20,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l21,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER10)


/*
    wdr_outbld_val_lut_l22:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l23:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER11_OFS 0x0240
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER11)
REGDEF_BIT(wdr_outbld_val_lut_l22,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l23,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER11)


/*
    wdr_outbld_val_lut_l24:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l25:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER12_OFS 0x0244
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER12)
REGDEF_BIT(wdr_outbld_val_lut_l24,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l25,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER12)


/*
    wdr_outbld_val_lut_l26:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l27:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER13_OFS 0x0248
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER13)
REGDEF_BIT(wdr_outbld_val_lut_l26,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l27,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER13)


/*
    wdr_outbld_val_lut_l28:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l29:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER14_OFS 0x024c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER14)
REGDEF_BIT(wdr_outbld_val_lut_l28,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l29,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER14)


/*
    wdr_outbld_val_lut_l30:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l31:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER15_OFS 0x0250
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER15)
REGDEF_BIT(wdr_outbld_val_lut_l30,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l31,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER15)


/*
    wdr_outbld_val_lut_l32:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l33:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER16_OFS 0x0254
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER16)
REGDEF_BIT(wdr_outbld_val_lut_l32,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l33,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER16)


/*
    wdr_outbld_val_lut_l34:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l35:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER17_OFS 0x0258
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER17)
REGDEF_BIT(wdr_outbld_val_lut_l34,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l35,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER17)


/*
    wdr_outbld_val_lut_l36:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l37:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER18_OFS 0x025c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER18)
REGDEF_BIT(wdr_outbld_val_lut_l36,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l37,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER18)


/*
    wdr_outbld_val_lut_l38:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l39:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER19_OFS 0x0260
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER19)
REGDEF_BIT(wdr_outbld_val_lut_l38,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l39,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER19)


/*
    wdr_outbld_val_lut_l40:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l41:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER20_OFS 0x0264
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER20)
REGDEF_BIT(wdr_outbld_val_lut_l40,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l41,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER20)


/*
    wdr_outbld_val_lut_l42:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l43:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER21_OFS 0x0268
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER21)
REGDEF_BIT(wdr_outbld_val_lut_l42,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l43,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER21)


/*
    wdr_outbld_val_lut_l44:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l45:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER22_OFS 0x026c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER22)
REGDEF_BIT(wdr_outbld_val_lut_l44,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l45,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER22)


/*
    wdr_outbld_val_lut_l46:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l47:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER23_OFS 0x0270
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER23)
REGDEF_BIT(wdr_outbld_val_lut_l46,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l47,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER23)


/*
    wdr_outbld_val_lut_l48:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l49:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER24_OFS 0x0274
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER24)
REGDEF_BIT(wdr_outbld_val_lut_l48,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l49,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER24)


/*
    wdr_outbld_val_lut_l50:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l51:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER25_OFS 0x0278
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER25)
REGDEF_BIT(wdr_outbld_val_lut_l50,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l51,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER25)


/*
    wdr_outbld_val_lut_l52:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l53:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER26_OFS 0x027c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER26)
REGDEF_BIT(wdr_outbld_val_lut_l52,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l53,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER26)


/*
    wdr_outbld_val_lut_l54:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l55:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER27_OFS 0x0280
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER27)
REGDEF_BIT(wdr_outbld_val_lut_l54,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l55,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER27)


/*
    wdr_outbld_val_lut_l56:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l57:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER28_OFS 0x0284
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER28)
REGDEF_BIT(wdr_outbld_val_lut_l56,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l57,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER28)


/*
    wdr_outbld_val_lut_l58:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l59:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER29_OFS 0x0288
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER29)
REGDEF_BIT(wdr_outbld_val_lut_l58,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l59,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER29)


/*
    wdr_outbld_val_lut_l60:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l61:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER30_OFS 0x028c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER30)
REGDEF_BIT(wdr_outbld_val_lut_l60,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l61,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER30)


/*
    wdr_outbld_val_lut_l62:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_l63:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER31_OFS 0x0290
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER31)
REGDEF_BIT(wdr_outbld_val_lut_l62,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_l63,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER31)


/*
    wdr_outbld_val_lut_l64:    [0x0, 0xfff],            bits : 11_0
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER32_OFS 0x0294
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER32)
REGDEF_BIT(wdr_outbld_val_lut_l64,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER32)


/*
    wdr_outbld_val_lut_r0:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_r1:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER33_OFS 0x0298
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER33)
REGDEF_BIT(wdr_outbld_val_lut_r0,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r1,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER33)


/*
    wdr_outbld_val_lut_r2:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_r3:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER34_OFS 0x029c
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER34)
REGDEF_BIT(wdr_outbld_val_lut_r2,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r3,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER34)


/*
    wdr_outbld_val_lut_r4:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_r5:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER35_OFS 0x02a0
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER35)
REGDEF_BIT(wdr_outbld_val_lut_r4,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r5,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER35)


/*
    wdr_outbld_val_lut_r6:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_r7:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER36_OFS 0x02a4
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER36)
REGDEF_BIT(wdr_outbld_val_lut_r6,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r7,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER36)


/*
    wdr_outbld_val_lut_r8:    [0x0, 0xfff],         bits : 11_0
    wdr_outbld_val_lut_r9:    [0x0, 0xfff],         bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER37_OFS 0x02a8
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER37)
REGDEF_BIT(wdr_outbld_val_lut_r8,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r9,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER37)


/*
    wdr_outbld_val_lut_r10:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_r11:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER38_OFS 0x02ac
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER38)
REGDEF_BIT(wdr_outbld_val_lut_r10,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r11,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER38)


/*
    wdr_outbld_val_lut_r12:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_r13:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER39_OFS 0x02b0
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER39)
REGDEF_BIT(wdr_outbld_val_lut_r12,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r13,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER39)


/*
    wdr_outbld_val_lut_r14:    [0x0, 0xfff],            bits : 11_0
    wdr_outbld_val_lut_r15:    [0x0, 0xfff],            bits : 27_16
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER40_OFS 0x02b4
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER40)
REGDEF_BIT(wdr_outbld_val_lut_r14,        12)
REGDEF_BIT(,        4)
REGDEF_BIT(wdr_outbld_val_lut_r15,        12)
REGDEF_END(WDR_OUTPUT_BLENDING_CURVE_REGISTER40)


/*
    wdr_outbld_val_lut_r16:    [0x0, 0xfff],            bits : 11_0
*/
#define WDR_OUTPUT_BLENDING_CURVE_REGISTER41_OFS 0x02b8
REGDEF_BEGIN(WDR_OUTPUT_BLENDING_CURVE_REGISTER41)
REGDEF_BIT(wdr_outbld_val_lut_r16,        12)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_12_OFS 0x02bc
...
/*
    wdr_mode         :    [0x0, 0x1],           bits : 0
    wdr_anti_halo_opt:    [0x0, 0x1],           bits : 1
    wdr_halo_ratio   :    [0x0, 0xff],          bits : 15_8
    wdr_halo_slope   :    [0x0, 0xff],          bits : 23_16
*/
#define WDR_TONE_MAPPING_REGISTER0_OFS 0x02c8
REGDEF_BEGIN(WDR_TONE_MAPPING_REGISTER0)
REGDEF_BIT(wdr_mode,        1)
REGDEF_BIT(wdr_anti_halo_opt,        1)
REGDEF_BIT(,        6)
REGDEF_BIT(wdr_halo_ratio,        8)
REGDEF_BIT(wdr_halo_slope,        8)
REGDEF_END(WDR_TONE_MAPPING_REGISTER0)


/*
    wdr_b2p_var:    [0x0, 0xfff],           bits : 11_0
*/
#define WDR_TONE_MAPPING_REGISTER1_OFS 0x02cc
REGDEF_BEGIN(WDR_TONE_MAPPING_REGISTER1)
REGDEF_BIT(wdr_b2p_var,        12)
REGDEF_END(WDR_TONE_MAPPING_REGISTER1)
...
/*
    wdr_fbc_en :    [0x0, 0x1],         bits : 0
    wdr_fbc_rto:    [0x0, 0xff],            bits : 15_8
    wdr_fbc_th0:    [0x0, 0x1fff],          bits : 28_16
*/
#define WDR_FBC_REGISTER_0_OFS 0x03d4
REGDEF_BEGIN(WDR_FBC_REGISTER_0)
REGDEF_BIT(wdr_fbc_en,        1)
REGDEF_BIT(,        7)
REGDEF_BIT(wdr_fbc_rto,        8)
REGDEF_BIT(wdr_fbc_th0,        13)
REGDEF_END(WDR_FBC_REGISTER_0)


/*
    wdr_fbc_th1:    [0x0, 0x1fff],          bits : 12_0
    wdr_fbc_th2:    [0x0, 0x1fff],          bits : 28_16
*/
#define WDR_FBC_REGISTER_1_OFS 0x03d8
REGDEF_BEGIN(WDR_FBC_REGISTER_1)
REGDEF_BIT(wdr_fbc_th1,        13)
REGDEF_BIT(,        3)
REGDEF_BIT(wdr_fbc_th2,        13)
REGDEF_END(WDR_FBC_REGISTER_1)


/*
    wdr_fbc_th3:    [0x0, 0x1fff],          bits : 12_0
    wdr_fbc_th4:    [0x0, 0x1fff],          bits : 28_16
*/
#define WDR_FBC_REGISTER_2_OFS 0x03dc
REGDEF_BEGIN(WDR_FBC_REGISTER_2)
REGDEF_BIT(wdr_fbc_th3,        13)
REGDEF_BIT(,        3)
REGDEF_BIT(wdr_fbc_th4,        13)
REGDEF_END(WDR_FBC_REGISTER_2)


/*
    wdr_fbc_th5:    [0x0, 0x1fff],          bits : 12_0
*/
#define WDR_FBC_REGISTER_3_OFS 0x03e0
REGDEF_BEGIN(WDR_FBC_REGISTER_3)
REGDEF_BIT(wdr_fbc_th5,        13)
REGDEF_END(WDR_FBC_REGISTER_3)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define WDR_YV_BLD_REGISTER_0_OFS 0x03e4
REGDEF_BEGIN(WDR_YV_BLD_REGISTER_0)
REGDEF_BIT(wdr_input_yv_bld_lut0,      6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_input_yv_bld_lut1,      6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_input_yv_bld_lut2,      6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_input_yv_bld_lut3,      6)
REGDEF_BIT(,        2)
REGDEF_END(WDR_YV_BLD_REGISTER_0)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define WDR_YV_BLD_REGISTER_1_OFS 0x03e8
REGDEF_BEGIN(WDR_YV_BLD_REGISTER_1)
REGDEF_BIT(wdr_input_yv_bld_lut4,      6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_input_yv_bld_lut5,      6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_input_yv_bld_lut6,      6)
REGDEF_BIT(,        2)
REGDEF_BIT(wdr_input_yv_bld_lut7,      6)
REGDEF_BIT(,        2)
REGDEF_END(WDR_YV_BLD_REGISTER_1)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define WDR_YV_BLD_REGISTER_2_OFS 0x03ec
REGDEF_BEGIN(WDR_YV_BLD_REGISTER_2)
REGDEF_BIT(wdr_input_yv_bld_lut8,      6)
REGDEF_BIT(,       26)
REGDEF_END(WDR_YV_BLD_REGISTER_2)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_16_OFS 0x03f0
REGDEF_BEGIN(RESERVED_REGISTER_16)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_16)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_17_OFS 0x03f4
REGDEF_BEGIN(RESERVED_REGISTER_17)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_17)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_18_OFS 0x03f8
REGDEF_BEGIN(RESERVED_REGISTER_18)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_18)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_19_OFS 0x03fc
REGDEF_BEGIN(RESERVED_REGISTER_19)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_19)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_20_OFS 0x0400
REGDEF_BEGIN(RESERVED_REGISTER_20)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_20)
...
/*
    ...
    gdc_normfact_10b:    [0x0, 0x3ff],          bits : 25_16
*/
...
/*
    gdc_boundr:    [0x0, 0x3ff],            bits : 7_0
    gdc_boundg:    [0x0, 0x3ff],            bits : 15_8
    gdc_boundb:    [0x0, 0x3ff],            bits : 23_16
*/
#define GDC_FOV_BOUNDARY_REGISTER_OFS 0x0414
REGDEF_BEGIN(GDC_FOV_BOUNDARY_REGISTER)
REGDEF_BIT(gdc_boundr,        8)
REGDEF_BIT(gdc_boundg,        8)
REGDEF_BIT(gdc_boundb,        8)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_21_OFS 0x0420
REGDEF_BEGIN(RESERVED_REGISTER_21)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_21)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_22_OFS 0x0424
REGDEF_BEGIN(RESERVED_REGISTER_22)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_22)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_23_OFS 0x0428
REGDEF_BEGIN(RESERVED_REGISTER_23)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_23)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_24_OFS 0x042c
REGDEF_BEGIN(RESERVED_REGISTER_24)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_24)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_25_OFS 0x0430
REGDEF_BEGIN(RESERVED_REGISTER_25)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_25)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_26_OFS 0x0434
REGDEF_BEGIN(RESERVED_REGISTER_26)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_26)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_27_OFS 0x0438
REGDEF_BEGIN(RESERVED_REGISTER_27)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_27)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_28_OFS 0x043c
REGDEF_BEGIN(RESERVED_REGISTER_28)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_28)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_29_OFS 0x04c4
REGDEF_BEGIN(RESERVED_REGISTER_29)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_29)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_30_OFS 0x04c8
REGDEF_BEGIN(RESERVED_REGISTER_30)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_30)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_31_OFS 0x04cc
REGDEF_BEGIN(RESERVED_REGISTER_31)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_31)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_32_OFS 0x0554
REGDEF_BEGIN(RESERVED_REGISTER_32)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_32)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_33_OFS 0x0558
REGDEF_BEGIN(RESERVED_REGISTER_33)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_33)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_34_OFS 0x055c
REGDEF_BEGIN(RESERVED_REGISTER_34)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_34)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_35_OFS 0x05e4
REGDEF_BEGIN(RESERVED_REGISTER_35)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_35)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_36_OFS 0x05e8
REGDEF_BEGIN(RESERVED_REGISTER_36)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_36)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_37_OFS 0x05ec
REGDEF_BEGIN(RESERVED_REGISTER_37)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_37)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_38_OFS 0x05f0
REGDEF_BEGIN(RESERVED_REGISTER_38)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_38)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_39_OFS 0x05f4
REGDEF_BEGIN(RESERVED_REGISTER_39)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_39)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_40_OFS 0x05f8
REGDEF_BEGIN(RESERVED_REGISTER_40)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_40)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_41_OFS 0x05fc
REGDEF_BEGIN(RESERVED_REGISTER_41)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_41)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_42_OFS 0x0600
REGDEF_BEGIN(RESERVED_REGISTER_42)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_42)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define RESERVED_REGISTER_43_OFS 0x0604
REGDEF_BEGIN(RESERVED_REGISTER_43)
REGDEF_BIT(reserved,        32)
REGDEF_END(RESERVED_REGISTER_43)
...
typedef struct {
	...
	union {
		struct {
			...
			unsigned dce_global_load_en        : 1;       // bits : 5
			unsigned                           : 22;
	...
	union {
		struct {
			...
			unsigned d2d_rand                       : 1;      // bits : 21
			unsigned d2d_rand_rst                   : 1;      // bits : 22
			unsigned fstr_rst_disable               : 1;      // bits : 23
			unsigned d2d_fmt                        : 2;      // bits : 25_24
			unsigned d2d_uv_out_disable             : 1;      // bits : 26
			unsigned d2d_uv_filt                    : 1;      // bits : 27
			unsigned d2d_io_stop                    : 1;      // bits : 28
	...
	union {
		struct {
			...
			unsigned inte_2_pxl_too_far    : 1;       // bits : 5
	...
	union {
		struct {
			...
			unsigned int_2_pxl_too_far    : 1;        // bits : 5
	...
	union {
		struct {
			unsigned                    : 1;
			unsigned crop_hstart        : 12;     // bits : 12_1
		} bit;
		UINT32 word;
	} reg_36; // 0x0090
	...
	union {
		struct {
			unsigned dce_axi_disable        : 1;      // bits : 0
			unsigned                        : 7;
			unsigned dce_r_ostd_num         : 8;      // bits : 15_8
			unsigned dce_w_ostd_num         : 8;      // bits : 23_16
			unsigned dce_axi_ch_idle        : 1;      // bits : 24
		} bit;
		UINT32 word;
	} reg_37; // 0x0094
	...
	union {
		struct {
			unsigned dce_axi_ch_enable_mask           : 8;        // bits : 7_0
			unsigned                                  : 8;
			unsigned dce_axi_lock_disable_mask        : 8;        // bits : 23_16
		} bit;
		UINT32 word;
	} reg_38; // 0x0098
	...
	union {
		struct {
			unsigned dce_axi_ch_sta        : 32;      // bits : 31_0
		} bit;
		UINT32 word;
	} reg_39; // 0x009c
	...
	union {
		struct {
			unsigned wdr_subimg_width          : 6;       // bits : 5_0
			unsigned                           : 2;
			unsigned wdr_subimg_height         : 6;       // bits : 13_8
			unsigned                           : 2;
			unsigned wdr_dithering_en          : 1;       // bits : 16
			unsigned wdr_rand_reset            : 1;       // bits : 17
			unsigned wdr_rand_sel              : 2;       // bits : 19_18
		} bit;
		UINT32 word;
	} reg_72; // 0x0120
	...
	union {
		struct {
			unsigned wdr_subimg_ratio_hori        : 16;       // bits : 15_0
			unsigned wdr_subimg_ratio_vert        : 16;       // bits : 31_16
		} bit;
		UINT32 word;
	} reg_77; // 0x0134
	...
	union {
		struct {
			unsigned wdr_subimg_ratio_hori_div        : 22;       // bits : 21_0
		} bit;
		UINT32 word;
	} reg_78; // 0x0138
	...
	union {
		struct {
			unsigned wdr_subimg_ratio_vert_div        : 22;       // bits : 21_0
		} bit;
		UINT32 word;
	} reg_79; // 0x013c
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l0        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_l1        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_90; // 0x0168
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l2        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_l3        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_91; // 0x016c
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l4        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_l5        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_92; // 0x0170
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l6        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_l7        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_93; // 0x0174
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l8        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_l9        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_94; // 0x0178
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l10        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l11        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_95; // 0x017c
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l12        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l13        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_96; // 0x0180
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l14        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l15        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_97; // 0x0184
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l16        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l17        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_98; // 0x0188
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l18        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l19        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_99; // 0x018c
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l20        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l21        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_100; // 0x0190
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l22        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l23        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_101; // 0x0194
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l24        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l25        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_102; // 0x0198
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l26        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l27        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_103; // 0x019c
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l28        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l29        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_104; // 0x01a0
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l30        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l31        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_105; // 0x01a4
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l32        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l33        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_106; // 0x01a8
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l34        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l35        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_107; // 0x01ac
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l36        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l37        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_108; // 0x01b0
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l38        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l39        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_109; // 0x01b4
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l40        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l41        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_110; // 0x01b8
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l42        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l43        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_111; // 0x01bc
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l44        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l45        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_112; // 0x01c0
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l46        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l47        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_113; // 0x01c4
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l48        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l49        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_114; // 0x01c8
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l50        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l51        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_115; // 0x01cc
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l52        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l53        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_116; // 0x01d0
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l54        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l55        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_117; // 0x01d4
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l56        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l57        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_118; // 0x01d8
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l58        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l59        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_119; // 0x01dc
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l60        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l61        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_120; // 0x01e0
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l62        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_l63        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_121; // 0x01e4
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_l64        : 12;      // bits : 11_0
		} bit;
		UINT32 word;
	} reg_122; // 0x01e8
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r0        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_r1        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_123; // 0x01ec
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r2        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_r3        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_124; // 0x01f0
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r4        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_r5        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_125; // 0x01f4
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r6        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_r7        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_126; // 0x01f8
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r8        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_tcurve_val_lut_r9        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_127; // 0x01fc
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r10        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_r11        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_128; // 0x0200
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r12        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_r13        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_129; // 0x0204
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r14        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_tcurve_val_lut_r15        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_130; // 0x0208
	...
	union {
		struct {
			unsigned wdr_tcurve_val_lut_r16        : 12;      // bits : 11_0
		} bit;
		UINT32 word;
	} reg_131; // 0x020c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l0        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_l1        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_133; // 0x0214
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l2        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_l3        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_134; // 0x0218
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l4        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_l5        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_135; // 0x021c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l6        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_l7        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_136; // 0x0220
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l8        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_l9        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_137; // 0x0224
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l10        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l11        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_138; // 0x0228
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l12        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l13        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_139; // 0x022c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l14        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l15        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_140; // 0x0230
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l16        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l17        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_141; // 0x0234
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l18        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l19        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_142; // 0x0238
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l20        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l21        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_143; // 0x023c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l22        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l23        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_144; // 0x0240
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l24        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l25        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_145; // 0x0244
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l26        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l27        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_146; // 0x0248
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l28        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l29        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_147; // 0x024c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l30        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l31        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_148; // 0x0250
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l32        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l33        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_149; // 0x0254
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l34        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l35        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_150; // 0x0258
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l36        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l37        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_151; // 0x025c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l38        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l39        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_152; // 0x0260
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l40        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l41        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_153; // 0x0264
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l42        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l43        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_154; // 0x0268
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l44        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l45        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_155; // 0x026c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l46        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l47        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_156; // 0x0270
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l48        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l49        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_157; // 0x0274
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l50        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l51        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_158; // 0x0278
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l52        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l53        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_159; // 0x027c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l54        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l55        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_160; // 0x0280
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l56        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l57        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_161; // 0x0284
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l58        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l59        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_162; // 0x0288
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l60        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l61        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_163; // 0x028c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l62        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_l63        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_164; // 0x0290
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_l64        : 12;      // bits : 11_0
		} bit;
		UINT32 word;
	} reg_165; // 0x0294
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r0        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_r1        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_166; // 0x0298
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r2        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_r3        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_167; // 0x029c
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r4        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_r5        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_168; // 0x02a0
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r6        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_r7        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_169; // 0x02a4
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r8        : 12;       // bits : 11_0
			unsigned                              : 4;
			unsigned wdr_outbld_val_lut_r9        : 12;       // bits : 27_16
		} bit;
		UINT32 word;
	} reg_170; // 0x02a8
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r10        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_r11        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_171; // 0x02ac
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r12        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_r13        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_172; // 0x02b0
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r14        : 12;      // bits : 11_0
			unsigned                               : 4;
			unsigned wdr_outbld_val_lut_r15        : 12;      // bits : 27_16
		} bit;
		UINT32 word;
	} reg_173; // 0x02b4
	...
	union {
		struct {
			unsigned wdr_outbld_val_lut_r16        : 12;      // bits : 11_0
		} bit;
		UINT32 word;
	} reg_174; // 0x02b8
	...
	union {
		struct {
			unsigned wdr_mode                 : 1;        // bits : 0
			unsigned wdr_anti_halo_opt        : 1;        // bits : 1
			unsigned                          : 6;
			unsigned wdr_halo_ratio           : 8;        // bits : 15_8
			unsigned wdr_halo_slope           : 8;        // bits : 23_16
		} bit;
		UINT32 word;
	} reg_178; // 0x02c8
	...
	union {
		struct {
			unsigned wdr_b2p_var        : 12;     // bits : 11_0
		} bit;
		UINT32 word;
	} reg_179; // 0x02cc
	...
	union {
		struct {
			unsigned wdr_fbc_en         : 1;      // bits : 0
			unsigned                    : 7;
			unsigned wdr_fbc_rto        : 8;      // bits : 15_8
			unsigned wdr_fbc_th0        : 13;     // bits : 28_16
		} bit;
		UINT32 word;
	} reg_245; // 0x03d4
	...
	union {
		struct {
			unsigned wdr_fbc_th1        : 13;     // bits : 12_0
			unsigned                    : 3;
			unsigned wdr_fbc_th2        : 13;     // bits : 28_16
		} bit;
		UINT32 word;
	} reg_246; // 0x03d8
	...
	union {
		struct {
			unsigned wdr_fbc_th3        : 13;     // bits : 12_0
			unsigned                    : 3;
			unsigned wdr_fbc_th4        : 13;     // bits : 28_16
		} bit;
		UINT32 word;
	} reg_247; // 0x03dc
	...
	union {
		struct {
			unsigned wdr_fbc_th5        : 13;     // bits : 12_0
		} bit;
		UINT32 word;
	} reg_248; // 0x03e0
	...
	union {
		struct {
			unsigned wdr_input_yv_bld_lut0        : 6;      // bits : 5_0
			unsigned                              : 2;
			unsigned wdr_input_yv_bld_lut1        : 6;      // bits : 13_8
			unsigned                              : 2;
			unsigned wdr_input_yv_bld_lut2        : 6;      // bits : 21_16
			unsigned                              : 2;
			unsigned wdr_input_yv_bld_lut3        : 6;      // bits : 29_24
		} bit;
		UINT32 word;
	} reg_249; // 0x03e4
	...
	union {
		struct {
			unsigned wdr_input_yv_bld_lut4        : 6;      // bits : 5_0
			unsigned                              : 2;
			unsigned wdr_input_yv_bld_lut5        : 6;      // bits : 13_8
			unsigned                              : 2;
			unsigned wdr_input_yv_bld_lut6        : 6;      // bits : 21_16
			unsigned                              : 2;
			unsigned wdr_input_yv_bld_lut7        : 6;      // bits : 29_24
		} bit;
		UINT32 word;
	} reg_250; // 0x03e8
	...
	union {
		struct {
			unsigned wdr_input_yv_bld_lut8        : 6;      // bits : 5_0
		} bit;
		UINT32 word;
	} reg_251; // 0x03ec
	...
	union {
		struct {
			unsigned gdc_boundr        : 8;       // bits : 7_0
			unsigned gdc_boundg        : 8;       // bits : 15_8
			unsigned gdc_boundb        : 8;       // bits : 23_16
		} bit;
		UINT32 word;
	} reg_261; // 0x0414
	...
	union {
		struct {
			unsigned dce_checksum_llc        : 32;        // bits : 31_0
		} bit;
		UINT32 word;
	} reg_394; // 0x0628

} NT98530_DCE_ENG_REG_STRUCT;
