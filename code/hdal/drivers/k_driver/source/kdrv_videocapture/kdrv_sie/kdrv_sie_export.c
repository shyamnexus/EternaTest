...
EXPORT_SYMBOL(kdrv_sie_module_init);
EXPORT_SYMBOL(kdrv_sie_module_uninit);
...
EXPORT_SYMBOL(kdrv_sie_dbg_skip_chk_limit);
EXPORT_SYMBOL(kdrv_sie_dump_intrpt_sts);
EXPORT_SYMBOL(kdrv_sie_set_err_log_rate);
