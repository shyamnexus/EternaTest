...
static struct proc_ops proc_cmd_fops = {
        .proc_open    = nvt_senphy_proc_cmd_open,
        .proc_read    = seq_read,
        .proc_lseek   = seq_lseek,
        .proc_release = single_release,
        .proc_write   = nvt_senphy_proc_cmd_write
};
#else
...
static int nvt_senphy_proc_help_show(struct seq_file *sfile, void *v)
{
	...
	seq_printf(sfile, "=====================================================================\n");
	seq_printf(sfile, "SENPHY REG (0x%08lX)::\n", (uintptr_t)psenphy_drv_info_data->module_info.io_addr[0]);
...
static struct proc_ops proc_help_fops = {
        .proc_open    = nvt_senphy_proc_help_open,
        .proc_read    = seq_read,
        .proc_lseek   = seq_lseek,
        .proc_release = single_release,
};
