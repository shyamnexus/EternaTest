...
typedef enum {
	...
	CSI_CONFIG_ID_LPKT_MANUAL4,     ///< Configure the CSI Pixel packet receiving as Manual mode4 enable. TRUE: Manual Mode4 enable. FALSE: Manual Mode4 disable.
	...
	CSI_CONFIG_ID_MANUAL4_FORMAT,   ///< If the CSI_CONFIG_ID_LPKT_MANUAL4 is set to manual mode, this is used to select the manaul depack format. Use CSI_MANDEPACK_* as input parameter.
	CSI_CONFIG_ID_MANUAL4_DATA_ID,  ///< If the CSI_CONFIG_ID_LPKT_MANUAL4 is set to manual mode, this is used to specify the receiving data id. Valid value from 0x00 to 0xFF.

	CSI_CONFIG_ID_CHID_MODE,        ///< Configure HDR channel id is from virtual channel id or SONY DOL id or Data Type. (CSI_CHID_MIPIDI or CSI_CHID_SONYLI or CSI_CHID_DATATYPE)
	...
	///< When CSI2/3/4, transmitted line numbers to SIE3
	...
	///< When CSI2/3/4, transmitted line numbers to SIE4
	CSI_CONFIG_ID_VALID_HEIGHT3,    ///< Configure pixel image receiving valid height for SIEx path.
	///<This value would be the line numbers transmitted to SIEx engine and including the sensor vertical blanking lines.
	///< When CSI, transmitted line numbers to SIE3
	///< When CSI2/3/4/5, transmitted line numbers to SIE5
	CSI_CONFIG_ID_VALID_HEIGHT4,    ///< Configure pixel image receiving valid height for SIEx path.
	///<This value would be the line numbers transmitted to SIEx engine and including the sensor vertical blanking lines.
	///< When CSI, transmitted line numbers to SIE4
	///< When CSI2/3/4/5, transmitted line numbers to SIE6
	...
	CSI_CONFIG_ID_CH0_GATING,       ///< Set csi ch0 pixel clock auto gating enable.
	CSI_CONFIG_ID_CH1_GATING,       ///< Set csi ch1 pixel clock auto gating enable.
	CSI_CONFIG_ID_CH2_GATING,       ///< Set csi ch2 pixel clock auto gating enable.
	CSI_CONFIG_ID_CH3_GATING,       ///< Set csi ch3 pixel clock auto gating enable.

	CSI_CONFIG_ID_FIELD_BIT,        ///< Set / Get FIELD bit is on WC bit[n] (n = 0x0 ~ 0xF)
	CSI_CONFIG_ID_FIELD_EN,         ///< Enable / Disable field signal to VIEx. Valid for CSI3 only.
	...
	*/
	...
	CSI_CONFIG_ID_HSCLK,            ///< Set HS-clock operation frequency for the sensor, and the PHY can optimize parameters based on the input.
	                                ///< Please use CSI_HSCLK_RATE as input.

	/*
		Phase Skew Calibration Control, Valid for CSI#1 only.
	*/
	CSI_CONFIG_ID_TRIG_PSC,           ///< Set 1 to trigger start Phase Skew Calibration.
	CSI_CONFIG_ID_PSC_EN,             ///< Set Enable/Disable Phase Skew Calibration.
	CSI_CONFIG_ID_LOAD_DLYD0,         ///< Set 1 to load Data Lane 0 new delay settings.
	CSI_CONFIG_ID_LOAD_DLYD1,         ///< Set 1 to load Data Lane 1 new delay settings.
	CSI_CONFIG_ID_LOAD_DLYD2,         ///< Set 1 to load Data Lane 2 new delay settings.
	CSI_CONFIG_ID_LOAD_DLYD3,         ///< Set 1 to load Data Lane 3 new delay settings.
	CSI_CONFIG_ID_CLR_RESULT0,        ///< Set 1 to Clear Data Lane 0 PSC scan result.
	CSI_CONFIG_ID_CLR_RESULT1,        ///< Set 1 to Clear Data Lane 1 PSC scan result.
	CSI_CONFIG_ID_CLR_RESULT2,        ///< Set 1 to Clear Data Lane 2 PSC scan result.
	CSI_CONFIG_ID_CLR_RESULT3,        ///< Set 1 to Clear Data Lane 3 PSC scan result.
	CSI_CONFIG_ID_ASC_SCP_BITS,       ///< Set/Get Skew Calibration Packet Detect bit-1 number. Valid value from 0 ~ 2.
	CSI_CONFIG_ID_LOAD_METHOD,        ///< Set/Get new delay setting activate timings.
	CSI_CONFIG_ID_NEW_DAT0_DLY_VAL,   ///< Set/Get Data Lane 0 new delay value.
	CSI_CONFIG_ID_NEW_DAT1_DLY_VAL,   ///< Set/Get Data Lane 1 new delay value.
	CSI_CONFIG_ID_NEW_DAT2_DLY_VAL,   ///< Set/Get Data Lane 2 new delay value.
	CSI_CONFIG_ID_NEW_DAT3_DLY_VAL,   ///< Set/Get Data Lane 3 new delay value.
	CSI_CONFIG_ID_DAT0_DLY_VAL,       ///< Get current Data Lane 0 delay value.
	CSI_CONFIG_ID_DAT1_DLY_VAL,       ///< Get current Data Lane 1 delay value.
	CSI_CONFIG_ID_DAT2_DLY_VAL,       ///< Get current Data Lane 2 delay value.
	CSI_CONFIG_ID_DAT3_DLY_VAL,       ///< Get current Data Lane 3 delay value.
	CSI_CONFIG_ID_ALLOW_SOT_1BIT_ERR, ///< Set 1 to Allow SOT 1-bit error(DANGEROUS)

	CSI_CONFIG_ID_D0IPSC_START,       ///< Configure Data Lane 0 Initial PSC Start Scan delay units. Valid value from 0 ~ 47.
	CSI_CONFIG_ID_D0IPSC_STEP,        ///< Configure Data Lane 0 Initial PSC Scan increment step value. Valid value from 1 ~ 15.
	CSI_CONFIG_ID_D0IPSC_COUNT,       ///< Configure Data Lane 0 Initial PSC Scan Count. Valid value from 0 ~ 47.
	CSI_CONFIG_ID_D0IPSC_BYPASS,      ///< Configure Data Lane 0 Initial PSC apply new delay units. Valid value from 0 ~ 15.
	CSI_CONFIG_ID_D0IPSC_PERIOD,      ///< Configure Data Lane 0 Initial Phase skew checking period. Valid value from 0 ~ 4095.
	CSI_CONFIG_ID_D0PPSC_START,       ///< Configure Data Lane 0 Periodic PSC Start Scan delay units. Valid value from 0 ~ 47.
	CSI_CONFIG_ID_D0PPSC_STEP,        ///< Configure Data Lane 0 Periodic PSC Scan increment step value. Valid value from 1 ~ 15.
	CSI_CONFIG_ID_D0PPSC_COUNT,       ///< Configure Data Lane 0 Periodic PSC Scan Count. Valid value from 0 ~ 47.
	CSI_CONFIG_ID_D0PPSC_BYPASS,      ///< Configure Data Lane 0 Periodic PSC apply new delay units. Valid value from 0 ~ 15.
	CSI_CONFIG_ID_D0PPSC_PERIOD,      ///< Configure Data Lane 0 Periodic Phase skew checking period. Valid value from 0 ~ 4095.

	CSI_CONFIG_ID_D1IPSC_START,       ///< Configure Data Lane 1 Initial PSC Start Scan delay units.
	CSI_CONFIG_ID_D1IPSC_STEP,        ///< Configure Data Lane 1 Initial PSC Scan increment step value.
	CSI_CONFIG_ID_D1IPSC_COUNT,       ///< Configure Data Lane 1 Initial PSC Scan Count.
	CSI_CONFIG_ID_D1IPSC_BYPASS,      ///< Configure Data Lane 1 Initial PSC apply new delay units.
	CSI_CONFIG_ID_D1IPSC_PERIOD,      ///< Configure Data Lane 1 Initial Phase skew checking period. Valid value from 0 ~ 4095.
	CSI_CONFIG_ID_D1PPSC_START,       ///< Configure Data Lane 1 Periodic PSC Start Scan delay units.
	CSI_CONFIG_ID_D1PPSC_STEP,        ///< Configure Data Lane 1 Periodic PSC Scan increment step value.
	CSI_CONFIG_ID_D1PPSC_COUNT,       ///< Configure Data Lane 1 Periodic PSC Scan Count.
	CSI_CONFIG_ID_D1PPSC_BYPASS,      ///< Configure Data Lane 1 Periodic PSC apply new delay units.
	CSI_CONFIG_ID_D1PPSC_PERIOD,      ///< Configure Data Lane 1 Periodic Phase skew checking period. Valid value from 0 ~ 4095.

	CSI_CONFIG_ID_D2IPSC_START,       ///< Configure Data Lane 2 Initial PSC Start Scan delay units.
	CSI_CONFIG_ID_D2IPSC_STEP,        ///< Configure Data Lane 2 Initial PSC Scan increment step value.
	CSI_CONFIG_ID_D2IPSC_COUNT,       ///< Configure Data Lane 2 Initial PSC Scan Count.
	CSI_CONFIG_ID_D2IPSC_BYPASS,      ///< Configure Data Lane 2 Initial PSC apply new delay units.
	CSI_CONFIG_ID_D2IPSC_PERIOD,      ///< Configure Data Lane 2 Initial Phase skew checking period. Valid value from 0 ~ 4095.
	CSI_CONFIG_ID_D2PPSC_START,       ///< Configure Data Lane 2 Periodic PSC Start Scan delay units.
	CSI_CONFIG_ID_D2PPSC_STEP,        ///< Configure Data Lane 2 Periodic PSC Scan increment step value.
	CSI_CONFIG_ID_D2PPSC_COUNT,       ///< Configure Data Lane 2 Periodic PSC Scan Count.
	CSI_CONFIG_ID_D2PPSC_BYPASS,      ///< Configure Data Lane 2 Periodic PSC apply new delay units.
	CSI_CONFIG_ID_D2PPSC_PERIOD,      ///< Configure Data Lane 2 Periodic Phase skew checking period. Valid value from 0 ~ 4095.

	CSI_CONFIG_ID_D3IPSC_START,       ///< Configure Data Lane 3 Initial PSC Start Scan delay units.
	CSI_CONFIG_ID_D3IPSC_STEP,        ///< Configure Data Lane 3 Initial PSC Scan increment step value.
	CSI_CONFIG_ID_D3IPSC_COUNT,       ///< Configure Data Lane 3 Initial PSC Scan Count.
	CSI_CONFIG_ID_D3IPSC_BYPASS,      ///< Configure Data Lane 3 Initial PSC apply new delay units.
	CSI_CONFIG_ID_D3IPSC_PERIOD,      ///< Configure Data Lane 3 Initial Phase skew checking period. Valid value from 0 ~ 4095.
	CSI_CONFIG_ID_D3PPSC_START,       ///< Configure Data Lane 3 Periodic PSC Start Scan delay units.
	CSI_CONFIG_ID_D3PPSC_STEP,        ///< Configure Data Lane 3 Periodic PSC Scan increment step value.
	CSI_CONFIG_ID_D3PPSC_COUNT,       ///< Configure Data Lane 3 Periodic PSC Scan Count.
	CSI_CONFIG_ID_D3PPSC_BYPASS,      ///< Configure Data Lane 3 Periodic PSC apply new delay units.
	CSI_CONFIG_ID_D3PPSC_PERIOD,      ///< Configure Data Lane 3 Periodic Phase skew checking period. Valid value from 0 ~ 4095.

	CSI_CONFIG_ID_ISC_D0_RESULT_55,   ///< Get Data Lane 0 Initial Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_ISC_D0_RESULT_AA,   ///< Get Data Lane 0 Initial Skew Calibration Scanning result with compare to data byte 0xAA.
	CSI_CONFIG_ID_PSC_D0_RESULT_55,   ///< Get Data Lane 0 Periodic Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_PSC_D0_RESULT_AA,   ///< Get Data Lane 0 Periodic Skew Calibration Scanning result with compare to data byte 0xAA.
	CSI_CONFIG_ID_ISC_D1_RESULT_55,   ///< Get Data Lane 1 Initial Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_ISC_D1_RESULT_AA,   ///< Get Data Lane 1 Initial Skew Calibration Scanning result with compare to data byte 0xAA.
	CSI_CONFIG_ID_PSC_D1_RESULT_55,   ///< Get Data Lane 1 Periodic Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_PSC_D1_RESULT_AA,   ///< Get Data Lane 1 Periodic Skew Calibration Scanning result with compare to data byte 0xAA.
	CSI_CONFIG_ID_ISC_D2_RESULT_55,   ///< Get Data Lane 2 Initial Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_ISC_D2_RESULT_AA,   ///< Get Data Lane 2 Initial Skew Calibration Scanning result with compare to data byte 0xAA.
	CSI_CONFIG_ID_PSC_D2_RESULT_55,   ///< Get Data Lane 2 Periodic Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_PSC_D2_RESULT_AA,   ///< Get Data Lane 2 Periodic Skew Calibration Scanning result with compare to data byte 0xAA.
	CSI_CONFIG_ID_ISC_D3_RESULT_55,   ///< Get Data Lane 3 Initial Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_ISC_D3_RESULT_AA,   ///< Get Data Lane 3 Initial Skew Calibration Scanning result with compare to data byte 0xAA.
	CSI_CONFIG_ID_PSC_D3_RESULT_55,   ///< Get Data Lane 3 Periodic Skew Calibration Scanning result with compare to data byte 0x55.
	CSI_CONFIG_ID_PSC_D3_RESULT_AA,   ///< Get Data Lane 3 Periodic Skew Calibration Scanning result with compare to data byte 0xAA.

	CSI_CONFIG_ID_DATATYPE_ID,        ///< Configure DataType virtual id  value. Valid value is 0x0 ~ 0x3F.(It is valid when CSI_CHID_DATATYPE)
	CSI_CONFIG_ID_DATATYPE_ID2,       ///< Configure DataType virtual id2 value. Valid value is 0x0 ~ 0x3F.(It is valid when CSI_CHID_DATATYPE)
	CSI_CONFIG_ID_DATATYPE_ID3,       ///< Configure DataType virtual id3 value. Valid value is 0x0 ~ 0x3F.(It is valid when CSI_CHID_DATATYPE)
	CSI_CONFIG_ID_DATATYPE_ID4,       ///< Configure DataType virtual id4 value. Valid value is 0x0 ~ 0x3F.(It is valid when CSI_CHID_DATATYPE)

	CSI_CONFIG_ID_IMAGE_OUTPUT_VIE,   ///< Image output to VIE engine, Valid for CSI3 only. 0: SIE; 1: VIE

	CSI_CONFIG_ID_DBG_LEVEL,          ///< Configure csi debug level
...
typedef enum {
	...
	CSI_CHID_DATATYPE,             ///< channel id is from DataType bits
...
/**
	...
	This definition is used in csix_set_config(CSI_CONFIG_ID_IMAGE_OUTPUT_VIE) / csi4_set_config(CSI_CONFIG_ID_IMAGE_OUTPUT_VIE)
    to specify the pxclk source
*/
typedef enum {
	CSI_PXCLK_FROM_SIE = 0,  ///< select pixel clock source from SIE
	CSI_PXCLK_FROM_VIE,      ///< select pixel clock source from VIE

	ENUM_DUMMY4WORD(CSI_PXCLK_SRC)
} CSI_PXCLK_SRC;

/**
	CSI HS-CLK source

	This definition is used in csi_platform_hsclk_enable() to specify the HS-CLK source

*/
typedef enum {
	CSI_CK0D4 = 0,   ///< CSI  HS-CLK CK0, D0/D1
	CSI_CK1D4,       ///< CSI  HS-CLK CK1, D2/D3
	CSI_CK2D4,       ///< CSI  HS-CLK CK2, D4/D5
	CSI_CK3D4,       ///< CSI  HS-CLK CK3, D6/D7
	CSI2_CK1D4,      ///< CSI2 HS-CLK CK1, D2/D3
	CSI3_CK2D4,      ///< CSI3 HS-CLK CK2, D4/D5
	CSI3_CK3D4,      ///< CSI3 HS-CLK CK3, D6/D7
	CSI4_CK3D4,      ///< CSI4 HS-CLK CK3, D6/D7

	CSI_HSCLK_MAX,

	ENUM_DUMMY4WORD(CSI_HSCLK_SRC)
} CSI_HSCLK_SRC;

/**
	CSI module clock source

	This definition is used in csi_platform_clk_set_freq() to specify the module clock source

*/
typedef enum {
	CSI_CLK_60M = 0, ///< CSI clock source:  60MHz
	CSI_CLK_120M,    ///< CSI clock source: 120MHz
	CSI_CLK_240M,    ///< CSI clock source: 240MHz

	ENUM_DUMMY4WORD(CSI_MCLK_SRC)
} CSI_MCLK_SRC;

/**
	CSI HS-clock frequency

*/
typedef enum {
	CSI_HSCLK_RATE_500M = 0, ///< data rate <=  500Mbps
	CSI_HSCLK_RATE_1000M,    ///< data rate  =  501Mbps ~ 1000Mpbs
	CSI_HSCLK_RATE_1500M,    ///< data rate  = 1001Mbps ~ 1500Mpbs

	ENUM_DUMMY4WORD(CSI_HSCLK_RATE)
} CSI_HSCLK_RATE;
...
extern void				csi_set_base_addr(ULONG addr);
extern void				siecsi_set_base_addr(ULONG addr);
...
extern void				csi2_set_base_addr(ULONG addr);
...
extern void				csi3_set_base_addr(ULONG addr);
extern void				csi3_set_fastboot(void);
#endif
...
extern void				csi4_set_base_addr(ULONG addr);
extern void				csi4_set_fastboot(void);
#endif
...
extern void				csi5_set_base_addr(ULONG addr);
extern void				csi5_set_fastboot(void);
#endif
