...
typedef enum {
	...
	LVDS2_DATLANE_ID_MAX = LVDS_DATLANE_ID_2,
	LVDS3_DATLANE_ID_MAX = LVDS_DATLANE_ID_4,
...
typedef enum {
	...
	LVDS_CONFIG_ID_FORCE_HWRST,     ///< Set 1 to enable force disable and use HW to reset the controller

	LVDS_CONFIG_ID_VD_CNT,			//   Get the sensor VD count.

	LVDS_CONFIG_ID_SYNC_WORD1,      ///< Set/Get LVDS Sync word 1.
	LVDS_CONFIG_ID_SYNC_WORD2,      ///< Set/Get LVDS Sync word 2.
	LVDS_CONFIG_ID_SYNC_WORD3,      ///< Set/Get LVDS Sync word 3.
	LVDS_CONFIG_ID_SYNC_WORD4,      ///< Set/Get LVDS Sync word 4.
	LVDS_CONFIG_ID_SYNC_WORD5,      ///< Set/Get LVDS Sync word 5.
	LVDS_CONFIG_ID_SYNC_WORD6,      ///< Set/Get LVDS Sync word 6.
	LVDS_CONFIG_ID_SYNC_WORD7,      ///< Set/Get LVDS Sync word 7.
	LVDS_CONFIG_ID_SYNC_LEN,        ///< Set/Get LVDS Sync word length. Valid value is 3 ~ 7.

	LVDS_CONFIG_ID_CH0_GATING,      ///< Set/Get LVDSx ch0 pixel clock auto gating enable.
	LVDS_CONFIG_ID_CH1_GATING,      ///< Set/Get LVDSx ch1 pixel clock auto gating enable.
	LVDS_CONFIG_ID_CH2_GATING,      ///< Set/Get LVDSx ch2 pixel clock auto gating enable.
	LVDS_CONFIG_ID_CH3_GATING,      ///< Set/Get LVDSx ch3 pixel clock auto gating enable. LVDS#1-2 only.

	LVDS_CONFIG_ID_SENSOR_REAL_HSCLK,  ///< Sensor real operation LVDS clock frequency.(unit:Kbps, Decimal)
