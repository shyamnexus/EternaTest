...
REGDEF_BIT(, 26)
REGDEF_BIT(PIXCLK_GAT_EN_CH0, 1)
REGDEF_BIT(PIXCLK_GAT_EN_CH1, 1)
REGDEF_BIT(PIXCLK_GAT_EN_CH2, 1)
REGDEF_BIT(PIXCLK_GAT_EN_CH3, 1)
...
// 0x1A8 Line End Control Word Register 2
REGDEF_OFFSET(LVDS_LE2_REG, 0x1A8)
REGDEF_BEGIN(LVDS_LE2_REG)
REGDEF_BIT(CTRL_W_LE4, 16)
REGDEF_BIT(CTRL_W_LE5, 16)
REGDEF_END(LVDS_LE2_REG)


// 0x1AC Line End Control Word Register 3
REGDEF_OFFSET(LVDS_LE3_REG, 0x1AC)
REGDEF_BEGIN(LVDS_LE3_REG)
REGDEF_BIT(CTRL_W_LE6, 16)
REGDEF_BIT(CTRL_W_LE7, 16)
REGDEF_END(LVDS_LE3_REG)
...
REGDEF_OFFSET(LVDS_D4FE_REG, 0x1E0)
REGDEF_OFFSET(LVDS_D5FE_REG, 0x1E8)
REGDEF_OFFSET(LVDS_D6FE_REG, 0x1F0)
REGDEF_OFFSET(LVDS_D7FE_REG, 0x1F8)
...
REGDEF_OFFSET(LVDS_D4FE2_REG, 0x1E4)
REGDEF_OFFSET(LVDS_D5FE2_REG, 0x1EC)
REGDEF_OFFSET(LVDS_D6FE2_REG, 0x1E4)
REGDEF_OFFSET(LVDS_D7FE2_REG, 0x1EC)
