...
typedef enum {
	...
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_SIE3,  ///< Configure image height each frame sent to SIE3. This value includes OB and invalid data lines.
	...
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_SIE6,  ///< Configure image height each frame sent to SIE6. This value includes OB and invalid data lines.

	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE,       ///< Configure image height each frame sent to VIE all ch.  This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE_CH0,   ///< Configure image height each frame sent to VIE ch0.  This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE_CH1,   ///< Configure image height each frame sent to VIE ch1.  This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE_CH2,   ///< Configure image height each frame sent to VIE ch2.  This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE_CH3,   ///< Configure image height each frame sent to VIE ch3.  This value includes OB and invalid data lines.

	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE2,      ///< Configure image height each frame sent to VIE2 all ch. This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE2_CH0,  ///< Configure image height each frame sent to VIE2 ch0. This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE2_CH1,  ///< Configure image height each frame sent to VIE2 ch1. This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE2_CH2,  ///< Configure image height each frame sent to VIE2 ch2. This value includes OB and invalid data lines.
	DAL_SSENIFCSI_CFGID_VALID_HEIGHT_VIE2_CH3,  ///< Configure image height each frame sent to VIE2 ch3. This value includes OB and invalid data lines.
	...
	DAL_SSENIFCSI_CFGID_IMAGE_OUTPUT_VIE,   ///< Configure Image output mux, Valid for CSI3 only.
	///< For [CSI3], 0: Image output to SIE3/4/5; 1: Image output to VIE

	DAL_SSENIFCSI_CFGID_IMGID_TO_SIE,       ///< [HDR] Select IMAGE frame ID sent to SIE1. Valid for CSI/CSI2 only.
	DAL_SSENIFCSI_CFGID_IMGID_TO_SIE2,      ///< [HDR] Select IMAGE frame ID sent to SIE2. Valid for CSI/CSI2 only.
	DAL_SSENIFCSI_CFGID_IMGID_TO_SIE3,      ///< [HDR] Select IMAGE frame ID sent to SIE3. Valid for CSI/CSI2/CSI3/CSI4.
	DAL_SSENIFCSI_CFGID_IMGID_TO_SIE4,      ///< [HDR] Select IMAGE frame ID sent to SIE4. Valid for CSI/CSI2/CSI3/CSI4.
	DAL_SSENIFCSI_CFGID_IMGID_TO_SIE5,      ///< [HDR] Select IMAGE frame ID sent to SIE5. Valid for CSI3/CSI4 only.
	DAL_SSENIFCSI_CFGID_IMGID_TO_SIE6,      ///< reserved.

	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE_VC0,   ///< [HDR] Select IMAGE frame ID sent to VIE ch0. Valid for CSI3 only.
	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE_VC1,   ///< [HDR] Select IMAGE frame ID sent to VIE ch1. Valid for CSI3 only.
	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE_VC2,   ///< [HDR] Select IMAGE frame ID sent to VIE ch2. Valid for CSI3 only.
	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE_VC3,   ///< [HDR] Select IMAGE frame ID sent to VIE ch3. Valid for CSI3 only.

	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE2_VC0,   ///< reserved.
	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE2_VC1,   ///< reserved.
	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE2_VC2,   ///< reserved.
	DAL_SSENIFCSI_CFGID_IMGID_TO_VIE2_VC3,   ///< reserved.
	...
	DAL_SSENIFCSI_CFGID_CH0_GATING,         ///<[OPTIONAL] Set CSIx ch0 pixel clock auto gating.
	DAL_SSENIFCSI_CFGID_CH1_GATING,         ///<[OPTIONAL] Set CSIx ch1 pixel clock auto gating.
	DAL_SSENIFCSI_CFGID_CH2_GATING,         ///<[OPTIONAL] Set CSIx ch2 pixel clock auto gating.
	DAL_SSENIFCSI_CFGID_CH3_GATING,         ///<[OPTIONAL] Set CSIx ch3 pixel clock auto gating.
...
typedef enum {
	...
	DAL_SSENIFLVDS_CFGID_VD_GEN_METHOD,     ///< Set new configuration to Vsync generation method.
	DAL_SSENIFLVDS_CFGID_VD_GEN_WITH_HD,    ///< Set Vsync generation together with Hsync function enable/disable.

	DAL_SSENIFLVDS_CFGID_IMGID_TO_SIE,      ///< [HDR] Select IMAGE frame ID sent to SIE1. Valid for LVDS only.
	DAL_SSENIFLVDS_CFGID_IMGID_TO_SIE2,     ///< [HDR] Select IMAGE frame ID sent to SIE2. Valid for LVDS only.
	DAL_SSENIFLVDS_CFGID_IMGID_TO_SIE3,     ///< [HDR] Select IMAGE frame ID sent to SIE3. Valid for LVDS/LVDS2/LVDS3/LVDS4 only.
	DAL_SSENIFLVDS_CFGID_IMGID_TO_SIE4,     ///< [HDR] Select IMAGE frame ID sent to SIE4. Valid for LVDS/LVDS2/LVDS3/LVDS4 only.
	DAL_SSENIFLVDS_CFGID_IMGID_TO_SIE5,     ///< [HDR] Select IMAGE frame ID sent to SIE5. Valid for LVDS2/LVDS3/LVDS4/LVDS5 only.
	DAL_SSENIFLVDS_CFGID_IMGID_TO_SIE6,     ///< [HDR] Select IMAGE frame ID sent to SIE6. Valid for LVDS2/LVDS3/LVDS4/LVDS5 only.
	...
	DAL_SSENIFLVDS_CFGID_SYNC_WORD1,        ///< [OPTIONAL] Set LVDS Sync word 1.
	DAL_SSENIFLVDS_CFGID_SYNC_WORD2,        ///< [OPTIONAL] Set LVDS Sync word 2.
	DAL_SSENIFLVDS_CFGID_SYNC_WORD3,        ///< [OPTIONAL] Set LVDS Sync word 3.
	DAL_SSENIFLVDS_CFGID_SYNC_WORD4,        ///< [OPTIONAL] Set LVDS Sync word 4.
	DAL_SSENIFLVDS_CFGID_SYNC_WORD5,        ///< [OPTIONAL] Set LVDS Sync word 5.
	DAL_SSENIFLVDS_CFGID_SYNC_WORD6,        ///< [OPTIONAL] Set LVDS Sync word 6.
	DAL_SSENIFLVDS_CFGID_SYNC_WORD7,        ///< [OPTIONAL] Set LVDS Sync word 7.
	DAL_SSENIFLVDS_CFGID_SYNC_LEN,          ///< [OPTIONAL] Set LVDS Sync word length.

	DAL_SSENIFLVDS_CFGID_FORCE_HWRST,       ///<[OPTIONAL] Set 1 to enable force disable and toggle lvds HW reset

	DAL_SSENIFLVDS_CFGID_SENSOR_REAL_HSCLK,  ///< Sensor real operation LVDS clock frequency.(unit:Kbps, Decimal)
...
typedef enum {
	...
	DAL_SSENIFLVDS_LANECFGID_CTRLWORD_LE,       ///< [OPTIONAL] Set the sensor data lane LE SYNCCODE. If user is not sure how to set this, just use the .set_lvds_laneconfig(DAL_SSENIFLVDS_LANECFGID_SYNCCODE_DEFAULT).
	DAL_SSENIFLVDS_LANECFGID_CTRLWORD_FE,       ///< [OPTIONAL] Set the sensor data lane FE SYNCCODE. If user is not sure how to set this, just use the .set_lvds_laneconfig(DAL_SSENIFLVDS_LANECFGID_SYNCCODE_DEFAULT).
	DAL_SSENIFLVDS_LANECFGID_CTRLWORD_FE2,      ///< [OPTIONAL] Set the sensor data lane FE2 SYNCCODE. If user is not sure how to set this, just use the .set_lvds_laneconfig(DAL_SSENIFLVDS_LANECFGID_SYNCCODE_DEFAULT).
	DAL_SSENIFLVDS_LANECFGID_CTRLWORD_FE3,      ///< [OPTIONAL] Set the sensor data lane FE3 SYNCCODE. If user is not sure how to set this, just use the .set_lvds_laneconfig(DAL_SSENIFLVDS_LANECFGID_SYNCCODE_DEFAULT).
	DAL_SSENIFLVDS_LANECFGID_CTRLWORD_FE4,      ///< [OPTIONAL] Set the sensor data lane FE4 SYNCCODE. If user is not sure how to set this, just use the .set_lvds_laneconfig(DAL_SSENIFLVDS_LANECFGID_SYNCCODE_DEFAULT).
...
/**
    ...
    This definition is used in lvds_set_config(DAL_SSENIFLVDS_CFGID_VD_GEN_METHOD)
...
*/
typedef enum {
	DAL_SSENIFLVDS_VSYNC_GEN_MATCH_VD,          ///< LVDS/HiSPi Vsync Pulse Generate is compare the VD Sync code matched.
									            ///< This option is suited for the PANASONIC/Aptina LVDS sensor.
	DAL_SSENIFLVDS_VSYNC_GEN_VD2HD,             ///< LVDS/HiSPi Vsync Pulse Generate is detecting SYNC_VD to SYNC_HD transition.
									            ///< This option is suited for the SONY/SHARP/Samsung LVDS sensor.
	DAL_SSENIFLVDS_VSYNC_GEN_HD2VD,             ///< LVDS/HiSPi Vsync Pulse Generate is detecting SYNC_HD to SYNC_VD transition.
									            ///< This option is reserved for future usage.
	DAL_SSENIFLVDS_VSYNC_GEN_MATCH_VD_BY_FSET,  ///< LVDS/HiSPi Vsync Pulse Generate is depending on the FSET bit changed in SYNC Code.
	...
	ENUM_DUMMY4WORD(DAL_SSENIFLVDS_VSYNC_GEN)
} DAL_SSENIFLVDS_VSYNC_GEN;
...
typedef enum {
	...
	DAL_SSENIF_INTERRUPT_SIE3_VD    	= 0x00000400,
	DAL_SSENIF_INTERRUPT_SIE4_VD    	= 0x00000800,
	DAL_SSENIF_INTERRUPT_SIE5_VD    	= 0x00001000,
	DAL_SSENIF_INTERRUPT_SIE6_VD    	= 0x00002000,
	DAL_SSENIF_INTERRUPT_SIE1_FRAMEEND	= 0x00010000,
	DAL_SSENIF_INTERRUPT_SIE2_FRAMEEND 	= 0x00020000,
	DAL_SSENIF_INTERRUPT_SIE3_FRAMEEND 	= 0x00040000,
	DAL_SSENIF_INTERRUPT_SIE4_FRAMEEND 	= 0x00080000,
	DAL_SSENIF_INTERRUPT_SIE5_FRAMEEND 	= 0x00100000,
	DAL_SSENIF_INTERRUPT_SIE6_FRAMEEND 	= 0x00200000,

	DAL_SSENIF_INTERRUPT_VIE1_CH0_VD       = DAL_SSENIF_INTERRUPT_SIE3_VD,
	DAL_SSENIF_INTERRUPT_VIE1_CH1_VD       = DAL_SSENIF_INTERRUPT_SIE4_VD,
	DAL_SSENIF_INTERRUPT_VIE1_CH2_VD       = DAL_SSENIF_INTERRUPT_SIE5_VD,
	DAL_SSENIF_INTERRUPT_VIE1_CH3_VD       = DAL_SSENIF_INTERRUPT_SIE6_VD,
	DAL_SSENIF_INTERRUPT_VIE1_CH0_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE3_FRAMEEND,
	DAL_SSENIF_INTERRUPT_VIE1_CH1_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE4_FRAMEEND,
	DAL_SSENIF_INTERRUPT_VIE1_CH2_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE5_FRAMEEND,
	DAL_SSENIF_INTERRUPT_VIE1_CH3_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE6_FRAMEEND,

	DAL_SSENIF_INTERRUPT_VIE2_CH0_VD       = DAL_SSENIF_INTERRUPT_SIE3_VD,
	DAL_SSENIF_INTERRUPT_VIE2_CH1_VD       = DAL_SSENIF_INTERRUPT_SIE4_VD,
	DAL_SSENIF_INTERRUPT_VIE2_CH2_VD       = DAL_SSENIF_INTERRUPT_SIE5_VD,
	DAL_SSENIF_INTERRUPT_VIE2_CH3_VD       = DAL_SSENIF_INTERRUPT_SIE6_VD,
	DAL_SSENIF_INTERRUPT_VIE2_CH0_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE3_FRAMEEND,
	DAL_SSENIF_INTERRUPT_VIE2_CH1_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE4_FRAMEEND,
	DAL_SSENIF_INTERRUPT_VIE2_CH2_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE5_FRAMEEND,
	DAL_SSENIF_INTERRUPT_VIE2_CH3_FRAMEEND = DAL_SSENIF_INTERRUPT_SIE6_FRAMEEND,
...
typedef enum {
	...
	DAL_SSENIF_SENSORTYPE_MANUAL,       ///< Sensor control word is defined by the user, Valid for LVDS.

	DAL_SSENIF_SENSORTYPE_VC,           ///< Sensor data diversion by virtual channel id
	DAL_SSENIF_SENSORTYPE_DATATYPE,     ///< Sensor data diversion by data type
...
typedef enum {
	...
	DAL_SSENIF_STOPMETHOD_SIE3_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_SIE4_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_SIE5_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_SIE6_FRAMEEND,

	DAL_SSENIF_STOPMETHOD_VIE1_CH0_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_VIE1_CH1_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_VIE1_CH2_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_VIE1_CH3_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_VIE2_CH0_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_VIE2_CH1_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_VIE2_CH2_FRAMEEND,
	DAL_SSENIF_STOPMETHOD_VIE2_CH3_FRAMEEND,
...
typedef enum {
#if 1
	DAL_SSENIF_CFGID_CLANE_CSI_USE_C0,      ///< MIPI CSI/LVDS uses HSI1_CK0 as clock lane.
	DAL_SSENIF_CFGID_CLANE_CSI2_USE_C0,     ///< MIPI CSI2/LVDS2 uses HSI2_CK0 as clock lane.
	DAL_SSENIF_CFGID_CLANE_CSI2_USE_C1,     ///< MIPI CSI2/LVDS2 uses HSI2_CK1 as clock lane.
	DAL_SSENIF_CFGID_CLANE_CSI2_USE_C2,     ///< MIPI CSI2/LVDS2 uses HSI2_CK2 as clock lane.
	DAL_SSENIF_CFGID_CLANE_CSI2_USE_C3,     ///< MIPI CSI2/LVDS2 uses HSI2_CK3 as clock lane.

	DAL_SSENIF_CFGID_CLANE_CSI3_USE_C1,     ///< MIPI CSI3/LVDS3 uses HSI2_CK1 as clock lane.

	DAL_SSENIF_CFGID_CLANE_CSI4_USE_C2,     ///< MIPI CSI4/LVDS4 uses HSI2_CK2 as clock lane.
	DAL_SSENIF_CFGID_CLANE_CSI4_USE_C3,     ///< MIPI CSI4/LVDS4 uses HSI2_CK3 as clock lane.
	DAL_SSENIF_CFGID_CLANE_CSI5_USE_C3,     ///< MIPI CSI5/LVDS5 uses HSI2_CK3 as clock lane.
#else
