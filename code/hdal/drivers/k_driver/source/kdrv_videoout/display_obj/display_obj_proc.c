...
#define VERF_PROC_EN 0
#else
#define VERF_PROC_EN 1
#endif
...
static PROC_CMD cmd_write_list[] = {
	// keyword          function name
	{ "reg",            nvt_dispobj_api_write_reg          },
	{ "pattern",        nvt_dispobj_api_write_pattern       },
#if VERF_PROC_EN
	{ "lcdopen",        nvt_dispobj_api_lcd_open },
	{ "tvopen",         nvt_dispobj_api_tv_open },
	{ "background",     nvt_dispobj_api_fill_background },
	{ "fillvideo1",		nvt_dispobj_api_fill_video		},
	{ "fillvideo2",		nvt_dispobj_api_fill_video2		},
	{ "fillosd",		nvt_dispobj_api_fill_osd		},
	{ "video1sc",		nvt_dispobj_api_v1_scaling		},
	{ "video2sc",		nvt_dispobj_api_v2_scaling		},
	{ "osdsc",		    nvt_dispobj_api_osd_scaling		}
#endif
};

#define NUM_OF_WRITE_CMD (sizeof(cmd_write_list) / sizeof(PROC_CMD))

static int nvt_dispobj_proc_cmd_show(struct seq_file *sfile, void *v)
{
	nvt_dbg(IND, "\n");
	return 0;
}

static int nvt_dispobj_proc_cmd_open(struct inode *inode, struct file *file)
{
	nvt_dbg(IND, "\n");
	return single_open(file, nvt_dispobj_proc_cmd_show, &pdrv_info_data->module_info);
}

static ssize_t nvt_dispobj_proc_cmd_write(struct file *file, const char __user *buf,
...
static struct proc_ops proc_cmd_fops = {
	.proc_open    = nvt_dispobj_proc_cmd_open,
	.proc_read    = seq_read,
	.proc_lseek   = seq_lseek,
	.proc_release = single_release,
	.proc_write   = nvt_dispobj_proc_cmd_write
};
#else
static struct file_operations proc_cmd_fops = {
	.owner   = THIS_MODULE,
	.open    = nvt_dispobj_proc_cmd_open,
	.read    = seq_read,
	.llseek  = seq_lseek,
	.release = single_release,
	.write   = nvt_dispobj_proc_cmd_write
};
#endif
...
//=============================================================================
static int nvt_dispobj_proc_help_show(struct seq_file *sfile, void *v)
{
	seq_printf(sfile, "=====================================================================\n");
...
static int nvt_dispobj_proc_help_open(struct inode *inode, struct file *file)
{
	return single_open(file, nvt_dispobj_proc_help_show, NULL);
}

#if (LINUX_VERSION_CODE > KERNEL_VERSION(5, 10, 0))
static struct proc_ops proc_help_fops = {
	.proc_open    = nvt_dispobj_proc_help_open,
	.proc_release = single_release,
	.proc_read    = seq_read,
	.proc_lseek   = seq_lseek,
};
...
static struct file_operations proc_help_fops = {
	.owner  = THIS_MODULE,
	.open   = nvt_dispobj_proc_help_open,
	.release = single_release,
	.read   = seq_read,
	.llseek = seq_lseek,
};
...
int nvt_dispobj_proc_init(PDISPOBJ_DRV_INFO pdrv_info)
{
	int ret = 0;
	struct proc_dir_entry *pmodule_root = NULL;
	struct proc_dir_entry *pentry = NULL;

	pmodule_root = proc_mkdir("dispobj", NULL);
...
int nvt_dispobj_proc_remove(PDISPOBJ_DRV_INFO pdrv_info)
{
