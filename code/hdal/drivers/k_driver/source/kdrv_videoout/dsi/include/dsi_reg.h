...
REGDEF_BIT(VVALID_START, 12)
REGDEF_BIT(, 4)
REGDEF_BIT(VVALID_END, 13)
REGDEF_BIT(, 3)
...
// 0x400 MIPI DSI Time Gen 0 Register
#define DSI_TIME_GEN0_REG_OFS               0xF00
REGDEF_BEGIN(DSI_TIME_GEN0_REG)
REGDEF_BIT(DSI_TG_EN, 1)
REGDEF_BIT(DSI_TG_MODE, 1)
REGDEF_BIT(, 2)
REGDEF_BIT(DSI_TG_PKT_SEL, 3)
REGDEF_BIT(, 25)
REGDEF_END(DSI_TIME_GEN0_REG)

// 0x404 MIPI DSI Time Gen 1 Register
#define DSI_TIME_GEN1_REG_OFS               0xF04
REGDEF_BEGIN(DSI_TIME_GEN1_REG)
REGDEF_BIT(DSI_TG_X_AXIS, 16)
REGDEF_BIT(DSI_TG_Y_AXIS, 16)
REGDEF_END(DSI_TIME_GEN1_REG)

// 0x408 MIPI DSI Time Gen 2 Register
#define DSI_TIME_GEN2_REG_OFS               0xF08
REGDEF_BEGIN(DSI_TIME_GEN2_REG)
REGDEF_BIT(DSI_TG_FRAME_WIDTH, 16)
REGDEF_BIT(DSI_TG_FRAME_HEIGHT, 16)
REGDEF_END(DSI_TIME_GEN2_REG)

// 0x40C MIPI DSI Time Gen 3 Register
#define DSI_TIME_GEN3_REG_OFS               0xF0C
REGDEF_BEGIN(DSI_TIME_GEN3_REG)
REGDEF_BIT(DSI_TG_FRAME_TOTAL_WIDTH, 16)
REGDEF_BIT(DSI_TG_FRAME_TOTAL_HEIGHT, 16)
REGDEF_END(DSI_TIME_GEN3_REG)

/* DSIPHY common register */
...
/* DSIPHY controller register */
// 0x100, 0x200 D-PHY Clock Register
#define DSIPHY_CTRL_CLOCK_REG_OFS           0x000
REGDEF_BEGIN(DSIPHY_CTRL_CLOCK_REG)
REGDEF_BIT(DSIPHY_DIV8_EN, 1)
REGDEF_BIT(DSIPHY_CKIN_SEL, 1)
REGDEF_BIT(DSIPHY_HS_CLK_INVERSE, 1)
REGDEF_BIT(, 1)
REGDEF_BIT(DSIPHY_CLK_PHASE_OFS, 4)
REGDEF_BIT(, 24)
REGDEF_END(DSIPHY_CTRL_CLOCK_REG)

// 0x104, 0x204 D-PHY Clock Register
#define DSIPHY_CTRL_CONTROLLER_REG_OFS      0x004
...
#define DSIPHY_CTRL_PLL1_REG_OFS            0x008
REGDEF_BEGIN(DSIPHY_CTRL_PLL1_REG)
REGDEF_BIT(, 1)
REGDEF_BIT(DSIPHY_EN_LDO, 1)
REGDEF_BIT(DSIPHY_PLL_PDB, 1)
REGDEF_BIT(, 1)
REGDEF_BIT(DSIPHY_PLL_DIV_CNT, 5)
REGDEF_BIT(, 3)
REGDEF_BIT(DSIPHY_PLL_CP, 2)
REGDEF_BIT(, 2)
REGDEF_BIT(DSIPHY_PLL_RSV, 4)
REGDEF_BIT(DSIPHY_PLL_CLKMULT_CTL, 3)
REGDEF_BIT(, 1)
REGDEF_BIT(DSIPHY_PLL_DIV_PRE, 3)
REGDEF_BIT(DSIPHY_PLL_FLOCK_EN, 1)
REGDEF_BIT(DSIPHY_PLL_VCO_BAND_SEL, 1)
REGDEF_BIT(DSIPHY_PLL_VCO_CAP_EN, 1)
REGDEF_BIT(DSIPHY_PLL_VLDOSEL, 2)
REGDEF_END(DSIPHY_CTRL_PLL1_REG)

// 0x10C, 0x20C D-PHY PLL Register 2
#define DSIPHY_CTRL_PLL2_REG_OFS            0x00C
