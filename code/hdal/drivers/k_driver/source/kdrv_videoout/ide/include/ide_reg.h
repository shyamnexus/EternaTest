...
REGDEF_BIT(dramend_irqsts, 1)	// yuv output dram end
...
#define IDE_V1_YCC_ERROR_IRQEN   		((UINT32)0x00000001 << 12)
#define IDE_V2_YCC_ERROR_IRQEN   		((UINT32)0x00000001 << 13)
...
#define IDE_V1_YCC_ERROR_IRQSTS   		((UINT32)0x00000001 << 28)
#define IDE_V2_YCC_ERROR_IRQSTS   		((UINT32)0x00000001 << 29)
#define IDE_MON_N1_LINE_IRQSTS   		((UINT32)0x00000001 << 30)
#define IDE_MON_N2_LINE_IRQSTS   		((UINT32)0x00000001 << 31)
