#ifndef __DSIPHY_MAIN_H__
#define __DSIPHY_MAIN_H__
...
#define MODULE_NAME          "nvt_dsiphy"

typedef struct dsiphy_drv_info {
	DSIPHY_MODULE_INFO module_info;
...
} DSIPHY_DRV_INFO, *PDSIPHY_DRV_INFO;
