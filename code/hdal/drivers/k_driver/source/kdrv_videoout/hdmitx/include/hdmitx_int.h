...
typedef enum {
	...
	HDMICFG_OPTION_RGB_RANGE, // 0x0: default 0x1: limited 0x2: full range
...
#define HDMIINFO_AVI_RGB_BY_DEFAULT    			    0x00
#define HDMIINFO_AVI_RGB_LIMITED    			    0x04
#define HDMIINFO_AVI_RGB_FULL_RANGE    			    0x08
...
extern DISPDEV_IOCTRL   p_hdmi_io_control;
extern HDMI_MODE        g_dispdev_hdmi_mode;
extern HDMI_VIDEOID     g_dispdev_hdmi_vid;
extern HDMI_AUDIOFMT    g_dispdev_aud_fmt;
extern HDMI_SRCFMT		g_dispdev_src_fmt;
...
extern hdmi_state_t hdmi_state;
extern int hdmi_hpd_status;
