...
// // Global variable
// //============================================================================
// static PHWCOPY_DRV_INFO pdrv_info_data[HWCP_MAX_CHIP];
...
// 	{ "reg",            nvt_hwcopy_api_read_reg           },
//     { "auto",            nvt_hwcopy_api_auto_test           },
// };
...
// 	// keyword          function name
// 	{ "auto",           nvt_hwcopy_api_auto_test          },
// 	{ "reg",            nvt_hwcopy_api_write_reg          },
// 	{ "pattern",    nvt_hwcopy_api_write_pattern       }
// };

// #define NUM_OF_WRITE_CMD (sizeof(cmd_write_list) / sizeof(PROC_CMD))

// static int nvt_hwcopy_proc_cmd_show(struct seq_file *sfile, void *v)
// {
// 	nvt_dbg(IND, "\n");
// 	return 0;
// }

// static int nvt_hwcopy_proc_cmd_open(struct inode *inode, struct file *file)
// {
//     int id = 0;
// 	nvt_dbg(IND, "\n");
// 	return single_open(file, nvt_hwcopy_proc_cmd_show, &pdrv_info_data[id]->module_info);
// }

// static ssize_t nvt_hwcopy_proc_cmd_write(struct file *file, const char __user *buf,
...
//     // //pdrv_info_data[id]->pproc_cmd_entry
...
// 	// 			ret = cmd_read_list[loop].execute(&pdrv_info_data[1]->module_info, ucargc - 2, &argv[2]);
// 	// 			break;
// 	// 		}
// 	// 	}
...
// 	// 			ret = cmd_write_list[loop].execute(&pdrv_info_data[id]->module_info, ucargc - 2, &argv[2]);
// 	// 			break;
// 	// 		}
// 	// 	}
...
// 	.owner   = THIS_MODULE,
// 	.open    = nvt_hwcopy_proc_cmd_open,
// 	.read    = seq_read,
// 	.llseek  = seq_lseek,
// 	.release = single_release,
// 	.write   = nvt_hwcopy_proc_cmd_write
// };

// //=============================================================================
// // proc "help" file operation functions
// //=============================================================================
// static int nvt_hwcopy_proc_help_show(struct seq_file *sfile, void *v)
// {
// 	seq_printf(sfile, "=====================================================================\n");
...
// static int nvt_hwcopy_proc_help_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, nvt_hwcopy_proc_help_show, NULL);
// }

// static struct file_operations proc_help_fops = {
// 	.owner  = THIS_MODULE,
// 	.open   = nvt_hwcopy_proc_help_open,
// 	.release = single_release,
// 	.read   = seq_read,
// 	.llseek = seq_lseek,
// };

// int nvt_hwcopy_proc_init(PHWCOPY_DRV_INFO pdrv_info)
// {
// 	int ret = 0;
...
// 	// if(pdrv_info->chip_idx > 0){
// 	// 	snprintf(path, sizeof(path), "kdrv_hwcopy_ep%d", pdrv_info->chip_idx-1);
// 	// }
// 	// else{
// 	// 	snprintf(path, sizeof(path), "kdrv_hwcopy");
// 	// }
...
// 	// pdrv_info_data[pdrv_info->chip_idx] = pdrv_info;
...
// int nvt_hwcopy_proc_remove(PHWCOPY_DRV_INFO pdrv_info)
// {
