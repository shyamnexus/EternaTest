...
#ifndef __NVT_EMU_HWCOPY__
#define __NVT_EMU_HWCOPY__
...
#define AUTOTEST_BUFSIZE_HWCOPY    0x00100000
...
#define MEM1_WIDTH      16368
#define MEM1_HEIGHT     16
#define MEM1_LOFF       16368

#define MEM2_WIDTH      16
#define MEM2_HEIGHT     16368
#define MEM2_LOFF       16

#define HWCOPY_AUTO_FS_MODE   (0)

#define auto_msg(msg)               printk msg
#endif

extern AUTOTEST_RESULT emu_hwcopy_auto(uintptr_t addr, UINT32 size, HWCOPY_ID id);
