...
REGDEF_BIT(dma_mode, 1)         /* dma mode => 0: read mode 03H / 1: write mode 02H */
REGDEF_BIT(, 26)
...
REGDEF_BIT(cmd02_conflict, 1)   /* command 02H conflict; when slave is read mode 03H, but master issues 02H */
REGDEF_BIT(cmd03_conflict, 1)   /* command 03H conflict; when slave is write mode 02H, but master issues 03H */
