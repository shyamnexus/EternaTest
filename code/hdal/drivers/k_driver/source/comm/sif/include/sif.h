...
extern void     sif_init(ULONG BaseAddr);
...
extern void     sif_sendDMA(SIF_CH Ch, ULONG uiAddr, UINT32 uiDMALength);
extern void     sif_waitDMATransferEnd(SIF_CH Ch);

extern void     sif_send_burst_DMA(SIF_CH Ch, ULONG uiAddr, UINT8 uiBurstNumber, UINT32 uiDMALength1, UINT32 uiDMALength2, UINT32 uiDMALength3);

extern BOOL 	sif_dmapack_start(UINT32 *current_index);
extern BOOL 	sif_dmapack_data(SIF_CH Ch, ULONG desc_buf_addr, UINT32 *current_index, UINT32 max_buf_size, UINT32 data_bit_len, UINT32* data);
extern BOOL 	sif_dmapack_delay_us(SIF_CH Ch, ULONG desc_buf_addr, UINT32 *current_index, UINT32 max_buf_size, UINT32 delay_us);
