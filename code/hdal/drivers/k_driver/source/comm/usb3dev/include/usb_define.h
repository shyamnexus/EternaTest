...
typedef enum {
	...
	USB_EP9 = USB_EP8 + 1,                      ///< USB End Point number 9
...
*/
//@{
typedef void (*USB_GENERIC_CB)(uintptr_t);
//@}
...
#define USB_SET_SEL      				0x30	///< SET SEL
#define USB_SET_ISOC_DELAY   			0x31	///< SET Isochronous Delay
//@}
...
#define EP9                             0x08    ///< Endpoint 9
#define EP10                            0x00    ///< Endpoint 10
#define EP11                            0x01    ///< Endpoint 11
#define EP12                            0x02    ///< Endpoint 12
#define EP13                            0x03    ///< Endpoint 13
#define EP14                            0x04    ///< Endpoint 14
#define EP15                            0x05    ///< Endpoint 15
...
typedef enum {
	...
	USB3_EVENT_EP9OUT,                           ///< (0x10002)USB3 (OUT)EP0  RX
	USB3_EVENT_EP9IN,                            ///< (0x10003)USB3  (IN)EP0  TX
	USB3_EVENT_EP10OUT,                           ///< (0x10004)USB3 (OUT)EP0  RX
	USB3_EVENT_EP10IN,                            ///< (0x10005)USB3  (IN)EP0  TX
	USB3_EVENT_EP11OUT,                           ///< (0x10006)USB3 (OUT)EP0  RX
	USB3_EVENT_EP11IN,                            ///< (0x10007)USB3  (IN)EP0  TX
	USB3_EVENT_EP12OUT,                           ///< (0x10008)USB3 (OUT)EP0  RX
	USB3_EVENT_EP12IN,                            ///< (0x10009)USB3  (IN)EP0  TX
	USB3_EVENT_EP13OUT,                           ///< (0x1000A)USB3 (OUT)EP0  RX
	USB3_EVENT_EP13IN,                            ///< (0x1000B)USB3  (IN)EP0  TX
	USB3_EVENT_EP14OUT,                           ///< (0x1000C)USB3 (OUT)EP0  RX
	USB3_EVENT_EP14IN,                            ///< (0x1000D)USB3  (IN)EP0  TX
	USB3_EVENT_EP15OUT,                           ///< (0x1000E)USB3 (OUT)EP0  RX
	USB3_EVENT_EP15IN,                            ///< (0x1000F)USB3  (IN)EP0  TX
