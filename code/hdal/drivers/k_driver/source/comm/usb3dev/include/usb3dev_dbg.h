#ifndef __USB3DEV_DBG_H_
#define __USB3DEV_DBG_H_
...
extern unsigned int usb3dev_debug_level;
#define nvt_dbg(level, fmt, args...)                \
do {                                               \
if (unlikely(NVT_DBG_##level <= usb3dev_debug_level))    \
...
//#define USB3DEV_API_DBG
#ifdef USB3DEV_API_DBG
#define usb3dev_api  printk
#else
#define usb3dev_api(fmt, ...)
#endif
