...
#if !defined __FREERTOS
extern void __iomem *_REGIOBASE;
extern void __iomem *IOADDR_TIMER_REG_BASE;
#else
...
extern ULONG timer_platform_spin_lock(void);
extern void timer_platform_spin_unlock(ULONG flags);
...
extern UINT32 timer_platform_dma_is_cacheable(uintptr_t addr);
extern UINT32 timer_platform_dma_flush_dev2mem_width_neq_loff(uintptr_t addr, UINT32 size);
extern UINT32 timer_platform_dma_flush_dev2mem(uintptr_t addr, UINT32 size);
extern UINT32 timer_platform_dma_flush_mem2dev(uintptr_t addr, UINT32 size);
extern BOOL timer_platform_is_valid_va(uintptr_t addr);
extern UINT32 timer_platform_va2pa(uintptr_t addr);
