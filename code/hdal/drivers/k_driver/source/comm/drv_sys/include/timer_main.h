...
typedef struct xxx_drv_info {
	...
	struct proc_dir_entry *pproc_nvt_jiffies_module_root;
	struct proc_dir_entry *pproc_nvt_jiffies_help_entry;
	struct proc_dir_entry *pproc_nvt_jiffies_cmd_entry;

	struct proc_dir_entry *pproc_hwclock_module_root;
	struct proc_dir_entry *pproc_hwclock_help_entry;
	struct proc_dir_entry *pproc_hwclock_cmd_entry;
