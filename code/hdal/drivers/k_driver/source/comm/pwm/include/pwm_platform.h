...
extern ULONG IOADDR_PWM_REG_BASE;
#endif
...
extern void (*PWM_SETREG)(UINT32 ofs, UINT32 value);
extern NVT_API_CHK_DECLARE(pwm);
...
extern ULONG pwm_platform_spin_lock(void);
extern void pwm_platform_spin_unlock(ULONG flags);
