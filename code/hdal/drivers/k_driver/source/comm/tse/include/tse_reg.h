...
REGDEF_BIT(IN_ADDR, 32)                         // input address
...
REGDEF_BIT(OUT0_ADDR, 32)                       // output address
...
REGDEF_BIT(OUT1_ADDR, 32)                       // output address
...
REGDEF_BIT(OUT2_ADDR, 32)                       // output address
...
// 0x8C, TSE adapt field manual mode
REGDEF_OFFSET(TSE_ADAPT_MANUAL_REG, 0x8c)
REGDEF_BEGIN(TSE_ADAPT_MANUAL_REG)
REGDEF_BIT(ADAPT_MANUAL_MODE, 1)
REGDEF_BIT(, 7)
REGDEF_BIT(ADAPT_FIELD_LENGTH, 8)
REGDEF_BIT(RESIDUAL_COUNT, 8)
REGDEF_BIT(, 8)
REGDEF_END(TSE_ADAPT_MANUAL_REG)
...
// 0xA0, TSE AXI_WRAP_EN Register
REGDEF_OFFSET(TSE_AXI_WRAP_EN_REG, 0xA0)
REGDEF_BEGIN(TSE_AXI_WRAP_EN_REG)
REGDEF_BIT(WRITE_CHANNEL, 1)
REGDEF_BIT(READ_CHANNEL, 1)
REGDEF_BIT(, 30)
REGDEF_END(TSE_AXI_WRAP_EN_REG)

// 0xA4, TSE AXI_LOCK_DIS Register
REGDEF_OFFSET(TSE_AXI_LOCK_DIS_REG, 0xA4)
REGDEF_BEGIN(TSE_AXI_LOCK_DIS_REG)
REGDEF_BIT(LOCK_WRITE_CHANNEL, 1)
REGDEF_BIT(LOCK_READ_CHANNEL, 1)
REGDEF_BIT(, 30)
REGDEF_END(TSE_AXI_LOCK_DIS_REG)
