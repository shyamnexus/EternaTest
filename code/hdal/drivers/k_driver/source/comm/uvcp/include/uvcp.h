...
extern void 	uvcp_config_dma(uintptr_t input_address, UINT32 input_size, uintptr_t output_address, UINT32 *output_size);

#ifdef CONFIG_PM
/**
   Support nvt_uvcp suspend/resume API
 */
extern void uvcp_suspend(void);
extern void uvcp_resume(void);
#endif
