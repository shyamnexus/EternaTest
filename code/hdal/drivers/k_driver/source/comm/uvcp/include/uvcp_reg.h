...
// UVCP AXI Channel Control Register
REGDEF_OFFSET(UVCP_AXI_MON_REG, 0x20)
REGDEF_BEGIN(UVCP_AXI_MON_REG)
REGDEF_BIT(UVCP_OUT_CH_OSTD_NUM,  8)
REGDEF_BIT(UVCP_IN_CH_OSTD_NUM,  8)
REGDEF_BIT(UVCP_CH_DIS,  1)
REGDEF_BIT(,  15)
REGDEF_END(UVCP_AXI_MON_REG)
