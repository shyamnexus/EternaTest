...
// 0x404 AXI Monitor Register
#define USB_AXI_MONI_REG_OFS 0x404
REGDEF_BEGIN(USB_AXI_MONI_REG)
REGDEF_BIT(MONI_WOSTD_NUM, 8)
REGDEF_BIT(MONI_ROSTD_NUM, 8)
REGDEF_BIT(MONI_CH_DIS, 1)
REGDEF_BIT(MONI_CHANNEL_IDLE, 1)
REGDEF_BIT(, 2)
...
#define USB_DEVVMDA_CMPLT_EMP_FXINT_REG_OFS 0x3A8
REGDEF_BEGIN(USB_DEVVMDA_CMPLT_EMP_FXINT_REG)
REGDEF_BIT(VDMA_CMPLT_EMP_FXINT,  16)       // VDMA Complete And FIFO empty interrupt
REGDEF_BIT(,  16)
REGDEF_END(USB_DEVVMDA_CMPLT_EMP_FXINT_REG)

#define USB_DEVVMDA_CMPLT_EMP_FXINTMASK_REG_OFS 0x3AC
REGDEF_BEGIN(USB_DEVVMDA_CMPLT_EMP_FXINTMASK_REG)
REGDEF_BIT(VDMA_CMPLT_EMP_FXINTMASK,  16)       // Mask of VDMA Complete And FIFO empty interrupt
REGDEF_BIT(,  16)
REGDEF_END(USB_DEVVMDA_CMPLT_EMP_FXINTMASK_REG)
...
// PHY ADDR 0x0B
#define USB_PHYCTRL0B_REG_OFS          0x2C
...
// PHY ADDR 0x0C
#define USB_PHYCTRL0C_REG_OFS          0x30
...
// PHY ADDR 0x3C
#define USB_PHYCTRL3C_REG_OFS      0xF0
