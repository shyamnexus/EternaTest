...
extern uintptr_t _USB2DEV_REG_BASE_ADDR[MODULE_REG_NUM];
extern uintptr_t _USB2DEV_PHY_REG_BASE_ADDR[MODULE_REG_NUM];
extern uintptr_t _USB3_PHY_REG_BASE_ADDR[MODULE_REG_NUM];
extern uintptr_t _USB3_UTMI_PHY_REG_BASE_ADDR[MODULE_REG_NUM];
extern uintptr_t _USB3_CTRL_REG_BASE_ADDR[MODULE_REG_NUM];

#define USB_REGS_ADDR(ofs)               (_USB2DEV_REG_BASE_ADDR[0] + (ofs))
#define USB_SETREG(ofs, value)          OUTW(USB_REGS_ADDR(ofs), (value))
#define USB_GETREG(ofs)                 INW(USB_REGS_ADDR(ofs))

#define USB_PHY_REGS_ADDR(ofs)           (_USB2DEV_PHY_REG_BASE_ADDR[0] + (ofs))
#define USBPHY_SETREG(ofs, value)       OUTW(USB_PHY_REGS_ADDR(ofs), (value))
#define USBPHY_GETREG(ofs)              INW(USB_PHY_REGS_ADDR(ofs))

#define U3_PHY_REGS_ADDR(ofs)           (_USB3_PHY_REG_BASE_ADDR[0] + (ofs))
#define U3PHY_SETREG(ofs, value)       OUTW(U3_PHY_REGS_ADDR(ofs), (value))
#define U3PHY_GETREG(ofs)              INW(U3_PHY_REGS_ADDR(ofs))

#define U3UTMI_PHY_REGS_ADDR(ofs)           (_USB3_UTMI_PHY_REG_BASE_ADDR[0] + (ofs))
#define U3UTMIPHY_SETREG(ofs, value)       OUTW(U3UTMI_PHY_REGS_ADDR(ofs), (value))
#define U3UTMIPHY_GETREG(ofs)              INW(U3UTMI_PHY_REGS_ADDR(ofs))

#define U3CTRL_REGS_ADDR(ofs)           (_USB3_CTRL_REG_BASE_ADDR[0] + (ofs))
#define U3CTL_SETREG(ofs, value)       OUTW(U3CTRL_REGS_ADDR(ofs), (value))
#define U3CTL_GETREG(ofs)              INW(U3CTRL_REGS_ADDR(ofs))
...
#define FLGPTN_USB_EP_FREE      FLGPTN_BIT(28)     //  USB endpoint not busy, dma cmplt and fifo empty.
...
extern void usb_fifoempty_interrupt(void);
...
extern ER               usb_writePhyReg(uintptr_t uiOffset, UINT32 uiValue);
extern ER               usb_readPhyReg(uintptr_t uiOffset, UINT32 *puiValue);
extern ER               usb_writePhy2Reg(uintptr_t uiOffset, UINT32 uiValue);
extern ER               usb_readPhy2Reg(uintptr_t uiOffset, UINT32 *puiValue);
