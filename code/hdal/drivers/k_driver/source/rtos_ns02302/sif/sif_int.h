...
#define FLGPTN_SIFDMA0          FLGPTN_BIT(6)
#define FLGPTN_SIFDMA1          FLGPTN_BIT(7)
#define FLGPTN_SIFEMPTY0        FLGPTN_BIT(8)
#define FLGPTN_SIFEMPTY1        FLGPTN_BIT(9)
#define FLGPTN_SIFEMPTY2        FLGPTN_BIT(10)
#define FLGPTN_SIFEMPTY3        FLGPTN_BIT(11)
#define FLGPTN_SIFEMPTY4        FLGPTN_BIT(12)
#define FLGPTN_SIFEMPTY5        FLGPTN_BIT(13)
#endif
...
#define SIF_DPSEL_CH4               4
#define SIF_DPSEL_CH5               5
