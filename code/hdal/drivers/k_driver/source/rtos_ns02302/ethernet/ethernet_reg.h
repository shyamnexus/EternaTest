...
#define ETH_MAC_RXQ_CTL_REG_OFS 0xA0
REGDEF_BEGIN(ETH_MAC_RXQ_CTL_REG)   /* RxQ Control Register */
REGDEF_BIT(RXQ0EN, 2)                  /* RXQ0 Enable AVB or DCB*/
REGDEF_BIT(RXQ1EN, 2)                   /* RXQ1 Enable AVB or DCB */
REGDEF_BIT(RXQ2EN, 2)                   /* RXQ2 Enable AVB or DCB */
REGDEF_BIT(RXQ3EN, 2)                   /* RXQ3 Enable AVB or DCB */
REGDEF_BIT(, 24)
REGDEF_END(ETH_MAC_RXQ_CTL_REG)     /* Rx Flow Control Register end */
...
REGDEF_BIT(ATSNS, 5)                    /* (NOT Configured) ATSNS: Number of Auxiliary Timestamp Snapshots */
REGDEF_BIT(, 2)
...
#define ETH_TIMESTAMP_PPS_TRG_TIME_SEC_REG_OFS    0xB80
REGDEF_BEGIN(ETH_TIMESTAMP_PPS_TRG_TIME_SEC_REG)  /* MAC Timestamp Egress Corr Nanoseconds Register */
REGDEF_BIT(TSTRH0, 32)                        /* TSEC: Timestamp Egress Correction */
REGDEF_END(ETH_TIMESTAMP_PPS_TRG_TIME_SEC_REG)    /* MAC Timestamp Egress Corr Nanoseconds Register end */

#define ETH_TIMESTAMP_PPS_TRG_TIME_NANOSEC_REG_OFS    0xB84
REGDEF_BEGIN(ETH_TIMESTAMP_PPS_TRG_TIME_NANOSEC_REG)  /* MAC Timestamp Egress Corr Nanoseconds Register */
REGDEF_BIT(TTSL0, 31)                        /* TSEC: Timestamp Egress Correction */
REGDEF_BIT(TRGTBUSY0, 1)                        /* TSEC: Timestamp Egress Correction */
REGDEF_END(ETH_TIMESTAMP_PPS_TRG_TIME_NANOSEC_REG)    /* MAC Timestamp Egress Corr Nanoseconds Register end */
...
#define ETH_MTL_TxQ0_OP_MODE_REG_OFS        0xD00 + QOFS
...
#define ETH_MTL_TxQ0_UNDERFLOW_REG_OFS      0xD04 + QOFS
...
#define ETH_MTL_TxQ0_DBG_REG_OFS            0xD08 + QOFS
...
#define ETH_MTL_Q0_INT_CTRL_REG_OFS         0xD2C + QOFS
...
#define ETH_MTL_RxQ0_OP_MODE_REG_OFS        0xD30 + QOFS
...
#define ETH_MTL_TxQ1_OP_MODE_REG_OFS        0xD40 + QOFS
REGDEF_BEGIN(ETH_MTL_TxQ1_OP_MODE_REG)      /* MTL TxQ1 Operation Mode Register */
REGDEF_BIT(FTQ, 1)                      /* Flush Transmit Queue */
REGDEF_BIT(TSF, 1)                      /* Transmit Store and Forward */
REGDEF_BIT(TXQEN, 2)                    /* Transmit Queue Enable */
REGDEF_BIT(TTC, 3)                      /* Transmit Threshold Control */
...
REGDEF_BIT(TQS, 4)                      /* Transmit Queue Size */
REGDEF_BIT(, 12)
REGDEF_END(ETH_MTL_TxQ1_OP_MODE_REG)        /* MTL TxQ1 Operation Mode Register end */

#define ETH_MTL_TxQ1_UNDERFLOW_REG_OFS      0xD44 + QOFS
REGDEF_BEGIN(ETH_MTL_TxQ1_UNDERFLOW_REG)    /* MTL TxQ1 Underflow Register */
REGDEF_BIT(UFFRMCNT, 11)                /* Underflow Packet Counter */
REGDEF_BIT(UFCNTOVF, 1)                 /* Overflow Bit for Underflow Packet Counter */
REGDEF_BIT(, 20)
REGDEF_END(ETH_MTL_TxQ1_UNDERFLOW_REG)      /* MTL TxQ1 Underflow Register end */

#define ETH_MTL_TxQ1_DBG_REG_OFS            0xD48 + QOFS
REGDEF_BEGIN(ETH_MTL_TxQ1_DBG_REG)          /* MTL TxQ1 Debug Register */
REGDEF_BIT(TXQPAUSED, 1)                /* Transmit Queue in Pause */
REGDEF_BIT(TRCSTS, 2)                   /* MTL Tx Queue Read Controller Status */
REGDEF_BIT(TWCSTS, 1)                   /* MTL Tx Queue Write Controller Status */
REGDEF_BIT(TXQSTS, 1)                   /* MTL Tx Queue Not Empty Status */
...
REGDEF_BIT(STXSTSF, 3)                  /* Number of Status Words in Tx Status FIFO of Queue */
REGDEF_BIT(, 9)
REGDEF_END(ETH_MTL_TxQ1_DBG_REG)            /* MTL TxQ1 Debug Register end */

#define ETH_MTL_Q1_INT_CTRL_REG_OFS         0xD6C + QOFS
REGDEF_BEGIN(ETH_MTL_Q1_INT_CTRL_REG)       /* MTL Q1 Interrupt Control Status Register */
REGDEF_BIT(TXUNFIS, 1)                  /* Transmit Queue Underflow Interrupt Status */
REGDEF_BIT(ABPSIS, 1)                   /* (NOT Configured) Average Bits Per Slot Interrupt Status */
REGDEF_BIT(, 6)
REGDEF_BIT(TXUIE, 1)                    /* Transmit Queue Underflow Interrupt Enable */
...
REGDEF_BIT(RXOIE, 1)                    /* Receive Queue Overflow Interrupt Enable */
REGDEF_BIT(, 7)
REGDEF_END(ETH_MTL_Q1_INT_CTRL_REG)         /* MTL Q1 Interrupt Control Status end */

#define ETH_MTL_RxQ1_OP_MODE_REG_OFS        0xD70 + QOFS
REGDEF_BEGIN(ETH_MTL_RxQ1_OP_MODE_REG)      /* MTL RxQ1 Operation Mode Register */
REGDEF_BIT(RTC, 2)                      /* Receive Queue Threshold Control */
REGDEF_BIT(, 1)
REGDEF_BIT(FUP, 1)                      /* Forward Undersized Good Packets */
REGDEF_BIT(FEP, 1)                      /* Forward Error Packets */
...
REGDEF_BIT(RQS, 4)                      /* Receive Queue Size */
REGDEF_BIT(, 8)
REGDEF_END(ETH_MTL_RxQ1_OP_MODE_REG)        /* MTL RxQ1 Operation Mode end */
...
#define ETH_DMA_CH0_CTRL_REG_OFS    0x1100 + DMAOFS
...
#define ETH_DMA_CH0_TX_CTRL_REG_OFS 0x1104 + DMAOFS
...
#define ETH_DMA_CH0_RX_CTRL_REG_OFS 0x1108 + DMAOFS
...
#define ETH_DMA_CH0_TxDesc_LIST_HADDR_REG_OFS    0x1110 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH0_TxDesc_LIST_HADDR_REG)  /* DMA CH0 TxDesc List HAddress Register */
REGDEF_BIT(TDESHA, 8)
REGDEF_BIT(, 24)
REGDEF_END(ETH_DMA_CH0_TxDesc_LIST_HADDR_REG)    /* DMA CH0 TxDesc List HAddress Register end */

#define ETH_DMA_CH0_TxDesc_LIST_ADDR_REG_OFS    0x1114 + DMAOFS
...
#define ETH_DMA_CH0_RxDesc_LIST_HADDR_REG_OFS    0x1118 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH0_RxDesc_LIST_HADDR_REG)  /* DMA CH0 RxDesc List HAddress Register */
REGDEF_BIT(RDESHA, 8)
REGDEF_BIT(, 24)
REGDEF_END(ETH_DMA_CH0_RxDesc_LIST_HADDR_REG)    /* DMA CH0 RxDesc List HAddress Register end */

#define ETH_DMA_CH0_RxDesc_LIST_ADDR_REG_OFS    0x111C + DMAOFS
...
#define ETH_DMA_CH0_TxDesc_TAIL_PNTR_REG_OFS    0x1120 + DMAOFS
...
#define ETH_DMA_CH0_RxDesc_TAIL_PNTR_REG_OFS    0x1128 + DMAOFS
...
#define ETH_DMA_CH0_TxDesc_RING_LEN_REG_OFS     0x112C + DMAOFS
...
#define ETH_DMA_CH0_RxDesc_RING_LEN_REG_OFS     0x1130 + DMAOFS
...
#define ETH_DMA_CH0_INTEN_REG_OFS   0x1134 + DMAOFS
...
#define ETH_DMA_CH0_RX_INT_WATCHDOG_TIMER_REG_OFS   0x1138 + DMAOFS
...
#define ETH_DMA_CH0_CURR_APP_TXDESC_REG_OFS         0x1144 + DMAOFS
...
#define ETH_DMA_CH0_CURR_APP_RXDESC_REG_OFS         0x114C + DMAOFS
...
#define ETH_DMA_CH0_CURR_APP_TXBUF_REG_OFS          0x1154 + DMAOFS
...
#define ETH_DMA_CH0_CURR_APP_RXBUF_REG_OFS          0x115C + DMAOFS
...
#define ETH_DMA_CH0_STS_REG_OFS     0x1160 + DMAOFS
...
#define ETH_DMA_CH1_CTRL_REG_OFS    0x1180 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_CTRL_REG)      /* DMA Debug Status1 Register */
REGDEF_BIT(MSS, 14)                 /* Maximum Segment Size (unit: byte) */
REGDEF_BIT(, 2)
REGDEF_BIT(PBLx8, 1)                /* 8xPBL mode */
REGDEF_BIT(, 1)
...
REGDEF_BIT(SPH, 1)                  /* Split Headers */
REGDEF_BIT(, 7)
REGDEF_END(ETH_DMA_CH1_CTRL_REG)        /* DMA Debug Status0 Register end */

#define ETH_DMA_CH1_TX_CTRL_REG_OFS 0x1184 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_TX_CTRL_REG)   /* DMA CH1 Tx Control Register */
REGDEF_BIT(ST, 1)                   /* Start/stop Transmission command */
REGDEF_BIT(TCW, 3)                  /* (NOT Configured) Transmit Channel Weight */
REGDEF_BIT(OSF, 1)                  /* Operate on Second Packet */
REGDEF_BIT(, 7)
...
REGDEF_BIT(TxPBL, 6)                /* Transmit Programmable Burst Length */
REGDEF_BIT(, 2)
REGDEF_BIT(TQOS, 4)                 /* Transmit QOS */
REGDEF_BIT(, 4)
REGDEF_END(ETH_DMA_CH1_TX_CTRL_REG)     /* DMA CH1 Tx Control Register end */

#define ETH_DMA_CH1_RX_CTRL_REG_OFS 0x1188 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_RX_CTRL_REG)   /* DMA CH1 Rx Control Register */
REGDEF_BIT(SR, 1)                   /* Stop/run Receive */
REGDEF_BIT(, 3)
REGDEF_BIT(RBSZ, 11)                 /* Receive Buffer Size (unit: 4word) */
REGDEF_BIT(, 1)
...
REGDEF_BIT(RQOS, 4)                 /* (NOT Configured) Rx QOS */
REGDEF_BIT(, 3)
REGDEF_BIT(RPF, 1)                  /* DMA Rx Channel1 Packet Flush */
REGDEF_END(ETH_DMA_CH1_RX_CTRL_REG)     /* DMA CH1 Rx Control Register end */

#define ETH_DMA_CH1_TxDesc_LIST_HADDR_REG_OFS    0x1190 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_TxDesc_LIST_HADDR_REG)  /* DMA CH1 TxDesc List HAddress Register */
REGDEF_BIT(TDESHA, 8)
REGDEF_BIT(, 24)
REGDEF_END(ETH_DMA_CH1_TxDesc_LIST_HADDR_REG)    /* DMA CH1 TxDesc List HAddress Register end */

#define ETH_DMA_CH1_TxDesc_LIST_ADDR_REG_OFS    0x1194 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_TxDesc_LIST_ADDR_REG)  /* DMA CH1 TxDesc List Address Register */
REGDEF_BIT(, 4)
REGDEF_BIT(TDESLA, 28)
REGDEF_END(ETH_DMA_CH1_TxDesc_LIST_ADDR_REG)    /* DMA CH1 TxDesc List Address Register end */

#define ETH_DMA_CH1_RxDesc_LIST_HADDR_REG_OFS    0x1198 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_RxDesc_LIST_HADDR_REG)  /* DMA CH1 RxDesc List HAddress Register */
REGDEF_BIT(RDESHA, 8)
REGDEF_BIT(, 24)
REGDEF_END(ETH_DMA_CH1_RxDesc_LIST_HADDR_REG)    /* DMA CH1 RxDesc List HAddress Register end */

#define ETH_DMA_CH1_RxDesc_LIST_ADDR_REG_OFS    0x11AC + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_RxDesc_LIST_ADDR_REG)  /* DMA CH1 RxDesc List Address Register */
REGDEF_BIT(, 4)
REGDEF_BIT(RDESLA, 28)
REGDEF_END(ETH_DMA_CH1_RxDesc_LIST_ADDR_REG)    /* DMA CH1 RxDesc List Address Register end */

#define ETH_DMA_CH1_TxDesc_TAIL_PNTR_REG_OFS    0x11A0 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_TxDesc_TAIL_PNTR_REG)  /* DMA CH1 TxDesc List Address Register */
REGDEF_BIT(, 4)
REGDEF_BIT(TDTP, 28)
REGDEF_END(ETH_DMA_CH1_TxDesc_TAIL_PNTR_REG)    /* DMA CH1 TxDesc List Address Register end */

#define ETH_DMA_CH1_RxDesc_TAIL_PNTR_REG_OFS    0x11A8 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_RxDesc_TAIL_PNTR_REG)  /* DMA CH1 RxDesc List Address Register */
REGDEF_BIT(, 4)
REGDEF_BIT(RDTP, 28)
REGDEF_END(ETH_DMA_CH1_RxDesc_TAIL_PNTR_REG)    /* DMA CH1 RxDesc List Address Register end */

#define ETH_DMA_CH1_TxDesc_RING_LEN_REG_OFS     0x11AC + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_TxDesc_RING_LEN_REG)   /* DMA CH1 TxDesc Ring Length Register */
REGDEF_BIT(TDRL, 10)
REGDEF_BIT(, 22)
REGDEF_END(ETH_DMA_CH1_TxDesc_RING_LEN_REG)     /* DMA CH1 TxDesc Ring Length Register end */

#define ETH_DMA_CH1_RxDesc_RING_LEN_REG_OFS     0x11B0 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_RxDesc_RING_LEN_REG)   /* DMA CH1 RxDesc Ring Length Register */
REGDEF_BIT(RDRL, 10)
REGDEF_BIT(, 22)
REGDEF_END(ETH_DMA_CH1_RxDesc_RING_LEN_REG)     /* DMA CH1 RxDesc Ring Length Register end */

#define ETH_DMA_CH1_INTEN_REG_OFS   0x11B4 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_INTEN_REG)     /* DMA CH1 Interrupt Enable Register */
REGDEF_BIT(TIE, 1)                  /* Transmit Interrupt Enable */
REGDEF_BIT(TXSE, 1)                 /* Transmit Stopped Enable */
REGDEF_BIT(TBUE, 1)                 /* Transmit buffer Unavailable Enable */
REGDEF_BIT(, 3)
...
REGDEF_BIT(NIE, 1)                  /* Normal Interrupt summary Enable */
REGDEF_BIT(, 16)
REGDEF_END(ETH_DMA_CH1_INTEN_REG)       /* DMA CH1Interrupt Enable Register end */

#define ETH_DMA_CH1_RX_INT_WATCHDOG_TIMER_REG_OFS   0x11B8 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_RX_INT_WATCHDOG_TIMER_REG) /* DMA CH1 Rx Interrupt Watchdog Timer Register */
REGDEF_BIT(RWT, 8)                              /* RI watchdog timer count */
REGDEF_BIT(, 8)
REGDEF_BIT(RWTU, 2)                             /* Receive Interrupt Watchdog Timer Count Units */
REGDEF_BIT(, 14)
REGDEF_END(ETH_DMA_CH1_RX_INT_WATCHDOG_TIMER_REG)   /* DMA CH1 Rx Interrupt Watchdog Timer Register end */

#define ETH_DMA_CH1_CURR_APP_TXDESC_REG_OFS         0x11C4 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_CURR_APP_TXDESC_REG)       /* DMA CH1 Current App TxDesc Register */
REGDEF_BIT(CURTDESAPTR, 32)
REGDEF_END(ETH_DMA_CH1_CURR_APP_TXDESC_REG)         /* DMA CH1 Current App TxDesc Register end */

#define ETH_DMA_CH1_CURR_APP_RXDESC_REG_OFS         0x11CC + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_CURR_APP_RXDESC_REG)       /* DMA CH1 Current App RxDesc Register */
REGDEF_BIT(CURRDESAPTR, 32)
REGDEF_END(ETH_DMA_CH1_CURR_APP_RXDESC_REG)         /* DMA CH1 Current App RxDesc Register end */

#define ETH_DMA_CH1_CURR_APP_TXBUF_REG_OFS          0x11D4 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_CURR_APP_TXBUF_REG)        /* DMA CH1 Current App TxBuffer Register */
REGDEF_BIT(CURTBUFAPTR, 32)
REGDEF_END(ETH_DMA_CH1_CURR_APP_TXBUF_REG)          /* DMA CH1 Current App TxBuffer Register end */

#define ETH_DMA_CH1_CURR_APP_RXBUF_REG_OFS          0x11DC + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_CURR_APP_RXBUF_REG)        /* DMA CH1 Current App RxBuffer Register */
REGDEF_BIT(CURRBUFAPTR, 32)
REGDEF_END(ETH_DMA_CH1_CURR_APP_RXBUF_REG)          /* DMA CH1 Current App RxBuffer Register end */

#define ETH_DMA_CH1_STS_REG_OFS     0x11E0 + DMAOFS
REGDEF_BEGIN(ETH_DMA_CH1_STS_REG)       /* DMA CH1 Status Register */
REGDEF_BIT(TI, 1)                   /* Transmit Interrupt */
REGDEF_BIT(TPS, 1)                  /* Transmit Process Stopped */
REGDEF_BIT(TBU, 1)                  /* Transmit buffer Unavailable */
REGDEF_BIT(, 3)
...
REGDEF_BIT(REB, 3)                  /* Rx DMA Error Bits */
REGDEF_BIT(, 10)
REGDEF_END(ETH_DMA_CH1_STS_REG)         /* DMA CH1 Status Register end */
...
#define ETH_IM_BUS_CTRL_REG_OFS           0x3040
REGDEF_BEGIN(ETH_IM_BUS_CTRL_REG)        /* BUS IO Control Register */
...
REGDEF_BIT(, 8)
REGDEF_END(ETH_IM_BUS_CTRL_REG)          /* BUS IO Control Register */

#define ETH_IM_PHY_TX_ROUT_REG_OFS      0x3B74
REGDEF_BEGIN(ETH_IM_PHY_TX_ROUT_REG)
REGDEF_BIT(TX_DAC_RFR, 3)
