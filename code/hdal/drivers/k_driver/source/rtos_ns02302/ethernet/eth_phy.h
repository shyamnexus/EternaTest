...
//
extern ER   ethPHY_open(ETH_ID id);
extern ER   ethPHY_close(ETH_ID id);

extern void ethPHY_reset(ETH_ID id);
extern BOOL ethPHY_verifyID(ETH_ID id);

extern ER   ethPHY_waitAutoNegotiation(ETH_ID id);
extern ER   ethPHY_getLinkCapability(ETH_ID id, PEXTPHY_CONTEXT pPhyContext);

extern ER   ethPHY_setLoopback(ETH_ID id, BOOL bEnable, BOOL bAutoNegotiation);
extern ER   ethPHY_setSpeed(ETH_ID id, ETHMAC_SPD_ENUM speed);
extern ER   ethPHY_setDuplex(ETH_ID id, ETHMAC_DUPLEX_ENUM duplex);
extern UINT32 ethPHY_getID(ETH_ID id);
extern void ethPHY_setTrim(ETH_ID id);
extern void ethPHY_bestsetting(ETH_ID id);
extern void ethInternalPHY_powerOn(ETH_ID id);
extern void ethInternalPHY_MDIX(ETH_ID id, UINT32 op);
extern void ethPHY_amoption(ETH_ID id);
