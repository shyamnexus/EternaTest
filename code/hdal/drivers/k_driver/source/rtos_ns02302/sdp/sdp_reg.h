...
REGDEF_BIT(dma_r_en, 1)           /* DMA transfer enable */
REGDEF_BIT(dma_w_en, 1)           /* DMA transfer enable */
REGDEF_BIT(, 2)
REGDEF_BIT(transfer_mode, 1)    /* transfer mode for 03H/02H command */
REGDEF_BIT(dma_mode, 2)         /* dma mode => 0: read mode 03H / 1: write mode 02H */
REGDEF_BIT(, 25)
...
REGDEF_BIT(fifo_rdy, 1)      /* FIFO loaded status  */
REGDEF_BIT(fifo_underrun, 1)    /* FIFO underrun status  */
REGDEF_BIT(dma_exhausted, 1)    /* DMA exhausted status */
REGDEF_BIT(dma_read_end, 1)          /* DMA end/complete status */
REGDEF_BIT(mrx_fifo_emptry, 1)  /* MRX FIFO empty */
REGDEF_BIT(mtx_fifo_full, 1)    /* MTX FIFO full */
REGDEF_BIT(data_cmd_not_align, 1)/* DMA read command length not align */
REGDEF_BIT(fifo_overrun, 1)     /* FIFO overrun status  */
REGDEF_BIT(rsv, 1)               
REGDEF_BIT(dma_write_end, 1)    /* DMA end/complete status */
REGDEF_BIT(cmd_unknown, 1)      /* command unknown */
REGDEF_BIT(, 21)
...
REGDEF_BIT(data_cmd_not_align, 1)/* DMA read command length not align */
REGDEF_BIT(fifo_overrun, 1)     /* FIFO overrun status  */
REGDEF_BIT(rsv, 1)   /* command 02H conflict; when slave is read mode 03H, but master issues 02H */
REGDEF_BIT(dma_write_end, 1)          /* DMA end/complete status */
REGDEF_BIT(cmd_unknown, 1)      /* command unknown */
REGDEF_BIT(, 21)
...
REGDEF_BIT(fifo_rdy, 1)         /* FIFO ready */
...
REGDEF_BIT(fifo_overrun, 1)     /* FIFO overrun */
REGDEF_BIT(cmd_unknown, 1)      /* command unknown */
REGDEF_BIT(, 25)
...
//read dma addr
#define SDP_DMA_R_ADDR_REG_OFS            0x20
REGDEF_BEGIN(SDP_DMA_R_ADDR_REG)          /* SDP DMA Start Address Register */
REGDEF_BIT(addr, 32)                    /* address  */
REGDEF_END(SDP_DMA_R_ADDR_REG)            /* SDP DMA Start Address Register */

//read dma size
#define SDP_DMA_R_SIZE_REG_OFS            0x24
REGDEF_BEGIN(SDP_DMA_R_SIZE_REG)          /* SDP DMA Buffer Size Register */
REGDEF_BIT(buf_size, 23)                /* DMA buffer size (unit: byte) */
REGDEF_BIT(, 9)
REGDEF_END(SDP_DMA_R_SIZE_REG)            /* SDP DMA Buffer Size Register */
...
//write dma addr
#define SDP_DMA_W_ADDR_REG_OFS          0x30
REGDEF_BEGIN(SDP_DMA_W_ADDR_REG)          /* SDP DMA Start Address Register */
REGDEF_BIT(addr, 32)                    /* address  */
REGDEF_END(SDP_DMA_W_ADDR_REG)            /* SDP DMA Start Address Register */

//write dma size
#define SDP_DMA_W_SIZE_REG_OFS            0x34
REGDEF_BEGIN(SDP_DMA_W_SIZE_REG)          /* SDP DMA Buffer Size Register */
REGDEF_BIT(buf_size, 23)                /* DMA buffer size (unit: byte) */
REGDEF_BIT(, 9)
REGDEF_END(SDP_DMA_W_SIZE_REG)            /* SDP DMA Buffer Size Register */
