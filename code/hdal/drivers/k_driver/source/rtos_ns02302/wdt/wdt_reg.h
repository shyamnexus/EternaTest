...
// WDT Control Register2
REGDEF_OFFSET(WDT_CTRL2_REG, 0x10)
REGDEF_BEGIN(WDT_CTRL2_REG)                 // --> Register "WDT_CONTROL2_REG" begin ---
REGDEF_BIT(, 8)
REGDEF_BIT(MSB2ND, 8)
REGDEF_BIT(Key_Ctrl2, 16)
REGDEF_END(WDT_CTRL2_REG)                   // --- Register "WDT_CONTROL2_REG" end   <--
