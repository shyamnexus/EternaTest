...
#define USB_SETREG(ofs, value)          OUTW(IOADDR_USB2_REG_BASE+(ofs), (value))
#define USB_GETREG(ofs)                 INW(IOADDR_USB2_REG_BASE+(ofs))
#define USBPHY_SETREG(ofs, value)       OUTW(IOADDR_USB2_PHY_APB_REG_BASE + 0x1000 + (ofs), (value))
#define USBPHY_GETREG(ofs)              INW(IOADDR_USB2_PHY_APB_REG_BASE + 0x1000 + (ofs))
#define USB3PHY_SETREG(ofs, value)      OUTW(IOADDR_USB3_PHY_REG_BASE + 0x2000 + (ofs), (value))
#define USB3PHY_GETREG(ofs)             INW(IOADDR_USB3_PHY_REG_BASE + 0x2000 + (ofs))
#define USB3_UTMI_PHY_SETREG(ofs, value)      OUTW(IOADDR_USB3_PHY_REG_BASE + 0x1000 + (ofs), (value))
#define USB3_UTMI_PHY_GETREG(ofs)             INW(IOADDR_USB3_PHY_REG_BASE + 0x1000 + (ofs))
...
#define FLGPTN_USB_EP_FREE      FLGPTN_BIT(24)     //  USB endpoint not busy, dma cmplt and fifo empty.
