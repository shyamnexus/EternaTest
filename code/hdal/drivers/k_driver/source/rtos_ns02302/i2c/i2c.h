...
#define I2C_GET_IC_VER_RDY ENABLE
...
*/
#define I2C_FW_MAX_SUPT_ID 11 // max number for [520/560 : 3 controller, 528: 5 controller]
typedef enum {
	I2C_ID_I2C,		///< I2C  Controller ID
	I2C_ID_I2C2,	///< I2C2 Controller ID
	I2C_ID_I2C3,	///< I2C3 Controller ID
	I2C_ID_I2C4,	///< I2C  Controller ID
	I2C_ID_I2C5,	///< I2C  Controller ID

	I2C_ID_MAX,		///< for 530 backward compatible
...
typedef struct {
	...
	I2C_STS(*transmitDMA)(uintptr_t uiAddr, UINT32 uiSize);
	I2C_STS(*receiveDMA)(uintptr_t uiAddr, UINT32 uiSize);

	I2C_STS(*waitSARMatch)(I2C_SAR_LEN SARLen);

	I2C_STS(*transmitDMA_En)(uintptr_t uiAddr, UINT32 uiSize);
	I2C_STS(*transmitDMA_Wait)(uintptr_t uiAddr, UINT32 uiSize);
...
extern I2C_STS      i2c_transmitDMA(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c_receiveDMA(uintptr_t uiAddr, UINT32 uiSize);

extern I2C_STS      i2c_transmitDMA_En(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c_transmitDMA_Wait(uintptr_t uiAddr, UINT32 uiSize);
...
extern I2C_STS      i2c2_transmitDMA(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c2_receiveDMA(uintptr_t uiAddr, UINT32 uiSize);

extern I2C_STS      i2c2_waitSARMatch(I2C_SAR_LEN SARLen);

extern I2C_STS      i2c2_transmitDMA_En(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c2_transmitDMA_Wait(uintptr_t uiAddr, UINT32 uiSize);
...
extern I2C_STS      i2c3_transmitDMA(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c3_receiveDMA(uintptr_t uiAddr, UINT32 uiSize);

extern I2C_STS      i2c3_waitSARMatch(I2C_SAR_LEN SARLen);

extern I2C_STS      i2c3_transmitDMA_En(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c3_transmitDMA_Wait(uintptr_t uiAddr, UINT32 uiSize);
...
extern I2C_STS      i2c4_transmitDMA(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c4_receiveDMA(uintptr_t uiAddr, UINT32 uiSize);

extern I2C_STS      i2c4_transmitDMA_En(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c4_transmitDMA_Wait(uintptr_t uiAddr, UINT32 uiSize);
...
extern I2C_STS      i2c5_transmitDMA(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c5_receiveDMA(uintptr_t uiAddr, UINT32 uiSize);

extern I2C_STS      i2c5_transmitDMA_En(uintptr_t uiAddr, UINT32 uiSize);
extern I2C_STS      i2c5_transmitDMA_Wait(uintptr_t uiAddr, UINT32 uiSize);
