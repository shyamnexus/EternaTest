...
#define DAI_TIMEOUT_CNT 1000000
...
typedef enum {
	...
	TSRX2,                          // Record Channel 2
	TSRX3,                          // Record Channel 3
	TSRX4,                          // Record Channel 4
	TSRX5,                          // Record Channel 5
	TSRX6,                          // Record Channel 6
	TSRX7,                          // Record Channel 7
	TSRX8,                          // Record Channel 8
	TSRX9,                          // Record Channel 9
	TSRX10,                         // Record Channel 10
	TSRX11,                         // Record Channel 11
	TSRX12,                         // Record Channel 12
	TSRX13,							// Record Channel 13
	TSRX14,							// Record Channel 14
	TSRX15,							// Record Channel 15
	TSRX16,							// Record Channel 16
	TSRX17,							// Record Channel 17
	TSRX18,							// Record Channel 18
	TSRX19,							// Record Channel 19
	TSRX20, 						// Record Channel 20


	TSTX1,                          // Playback Channel 1
	TSTX2,                          // Playback Channel 2

	TSTXLB,                         // Playback Loopback Channel 1
...
typedef enum {
	...
	AUD_DAI_ID_3,   	///< DAI 3
	AUD_DAI_ID_4,   	///< DAI 4
	AUD_DAI_ID_HDMI,    ///< DAI HDMI
	AUD_DAI_ID_1_EP,	///< DAI 1 EP
	AUD_DAI_ID_2_EP,	///< DAI 2 EP
	AUD_DAI_ID_3_EP,	///< DAI 3 EP
	AUD_DAI_ID_4_EP,	///< DAI 4 EP
	AUD_DAI_ID_HDMI_EP, ///< DAI HDMI EP
	AUD_DAI_ID_1_EP1,	///< DAI 1 EP
	AUD_DAI_ID_2_EP1,	///< DAI 2 EP
	AUD_DAI_ID_3_EP1,	///< DAI 3 EP
	AUD_DAI_ID_4_EP1,	///< DAI 4 EP
	AUD_DAI_ID_HDMI_EP1, ///< DAI HDMI EP	
	AUD_DAI_ID_1_EP2,	///< DAI 1 EP
	AUD_DAI_ID_2_EP2,	///< DAI 2 EP
	AUD_DAI_ID_3_EP2,	///< DAI 3 EP
	AUD_DAI_ID_4_EP2,	///< DAI 4 EP
	AUD_DAI_ID_HDMI_EP2, ///< DAI HDMI EP	

	AUD_DAI_ID_TOT,   	///<   Total AUD_DAI_ID count
	ENUM_DUMMY4WORD(AUD_DAI_ID)
} AUD_DAI_ID;
...
*/
typedef struct {
	AUD_DAI_ID	dai_id;             															///< Audio Transceive Channel DAI ID.
	void	(*dai_open)(int id, DRV_CB isr_hdl);														///< Open digital audio controller driver.
	void	(*dai_close)(int id);																	///< Close digital audio controller driver.
	void	(*dai_set_config)(int id, DAI_CONFIG_ID config_id, uintptr_t config_value);					///< Set Digital Audio interface(DAI) General Configurations.	
	UINT32	(*dai_get_config)(int id, DAI_CONFIG_ID config_id);											///< Get Digital Audio interface(DAI) General Configurations.
	void    (*dai_set_i2s_config)(int id, DAI_I2SCONFIG_ID config_id, UINT32 config_value);				///< Set Digital Audio I2S interface configurations
	UINT32  (*dai_get_i2s_config)(int id, DAI_I2SCONFIG_ID config_id);									///< Get Digital Audio I2S interface configurations
	void    (*dai_set_tx_config)(int id, DAI_TXCH channel, DAI_TXCFG_ID config_id, UINT32 config_value);///< Set DAI Playback Chaneels Configurations.
	UINT32  (*dai_get_tx_config)(int id, DAI_TXCH channel, DAI_TXCFG_ID config_id);						///< Get DAI Playback Chaneels Configurations.
	void    (*dai_set_txlb_config)(int id, DAI_TXLBCFG_ID config_id, UINT32 config_value);				///< Set DAI Playback Loopback Chaneel Configurations.
	UINT32  (*dai_get_txlb_config)(int id, DAI_TXLBCFG_ID config_id);									///< Get DAI Playback Loopback Chaneel Configurations.
	void    (*dai_set_rx_config)(int id, DAI_RXCFG_ID config_id, UINT32 config_value);					///< Set DAI Record Channels Configurations.
	UINT32  (*dai_get_rx_config)(int id, DAI_RXCFG_ID config_id);										///< Get DAI Record Channels Configurations.
	void    (*dai_enable_tx_dma)(int id, DAI_TXCH channel, BOOL en);									///< Enable/Disable DAI playback DMA Channel
	void    (*dai_enable_rx_dma)(int id, BOOL en);														///< Enable/Disable DAI record DMA Channel
	void    (*dai_enable_txlb_dma)(int id, BOOL en);													///< Enable/Disable DAI playback loopback DMA Channel
	void    (*dai_enable_tx)(int id, DAI_TXCH channel, BOOL en);										///< Start/Stop DAI Specified Channel Playback
	void    (*dai_enable_rx)(int id, BOOL en);															///< Start/Stop DAI Specified Channel Record
	void    (*dai_enable_txlb)(int id, BOOL en);														///< Start/Stop DAI Specified Channel playback loopback
	void    (*dai_enable_dai)(int id, BOOL en);															///< Set DAI module enable/disable
	BOOL    (*dai_is_dai_enable)(int id);															///< Check whether DAI is enabled or not
	BOOL    (*dai_is_tx_enable)(int id, DAI_TXCH channel);												///< Check if DAI Playback Channel is enabled
	BOOL    (*dai_is_rx_enable)(int id);															///< Check if DAI record Channel is enabled
	BOOL    (*dai_is_txlb_enable)(int id);														///< Check if DAI playback loopback Channel is enabled
	BOOL    (*dai_is_txrx_enable)(int id);														///< Check whether DAI is under tx/rx
	BOOL    (*dai_is_tx_dma_enable)(int id, DAI_TXCH channel);											///< Check if playback DMA Channel is Enabled
	BOOL    (*dai_is_rx_dma_enable)(int id);														///< Check if Record DMA Channel is Enabled
	BOOL    (*dai_is_txlb_dma_enable)(int id);													///< Check if Playback Loopback DMA Channel is Enabled
	BOOL    (*dai_is_dma_enable)(int id);															///< Check whether Tx or Rx DMA is enabled or not
	void    (*dai_set_tx_dma_para)(int id, int ddr_id,UINT32 channel, uintptr_t buf_addr, UINT32 buf_size);			///< Set Playback DMA parameter
	void    (*dai_set_rx_dma_para)(int id, int ddr_id,UINT32 channel, uintptr_t buf_addr, UINT32 buf_size);			///< Set Record DMA parameter
	void    (*dai_set_txlb_dma_para)(int id, int ddr_id,uintptr_t buf_addr, UINT32 buf_size);							///< Set Playback Loopback DMA parameter
	void    (*dai_get_tx_dma_para)(int id, UINT32 channel, UINT32 *p_buf_addr, UINT32 *p_buf_size);		///< Get Playback DMA parameter
	void    (*dai_get_rx_dma_para)(int id, UINT32 channel, UINT32 *p_buf_addr, UINT32 *p_buf_size);		///< Get Record DMA parameter
	void    (*dai_get_txlb_dma_para)(int id, UINT32 *p_buf_addr, UINT32 *p_buf_size);					///< Get Playback Loopback DMA parameter
	UINT32  (*dai_get_tx_dma_curaddr)(int id, UINT32 channel);											///< Get Playback DMA currrent address
	UINT32  (*dai_get_rx_dma_curaddr)(int id, UINT32 channel);											///< Get Record DMA currrent address
	UINT32  (*dai_get_txlb_dma_curaddr)(int id);													///< Get Playback Loopback DMA currrent address
	void    (*dai_clr_flg)(int id, DAI_INTERRUPT int_flag);												///< Clear DAI flag
	void	(*dai_set_rx_muti_ch_dma_para)(int id, int ddr_id,UINT32 dma_channel,uintptr_t dma_start_addr,UINT32 dma_buffer_size);
	void    (*dai_enableclk)(int id);
	void    (*dai_disableclk)(int id);
	void    (*dai_setclkrate)(int id, unsigned long clkrate);
	ER 		(*dai_lock)(int id);
	ER		(*dai_unlock)(int id);
	DAI_INTERRUPT (*dai_wait_interrupt)(int id, DAI_INTERRUPT waited_flag);
}DAI_OBJ, *PDAI_OBJ;
...
typedef enum {
    ...
    AUDTS_CFG_ID_SLAVE_CLK_MATCH, 	/// < Return the slave mode external clock status. 1: match 0: not match
...
typedef enum {
	...
	AUDIO_TDMCH_10CH,             ///< I2S TDM 10CH
	AUDIO_TDMCH_16CH = 7,             ///< I2S TDM 16CH
	AUDIO_TDMCH_20CH = 9,             ///< I2S TDM 20CH
...
typedef enum {
	...
	AUDIO_SR_96000  = 96000,    ///< 48 KHz
	AUDIO_SR_192000 = 192000,   ///< 192 KHz
...
typedef struct {
	...
	uintptr_t       uiDstBufAddr;       ///< buffer address for re-sampling (unit: byte) (Word alignment)
...
typedef struct _AUDIO_BUF_QUEUE {
	uintptr_t				uiAddress_va;
	uintptr_t               uiAddress;  ///< Buffer Starting Address (Unit: byte) (Word alignment)
...
typedef enum {
	...
	AUDIO_EVENT_DMALOAD             =   0x00000004,     ///< Time code hit event
...
#if 1
typedef enum {
	AUDIO_QUEUE_SEL_RX1 = 0,                     // Record Channel 1
	AUDIO_QUEUE_SEL_RX2,                        // Record Channel 2
	AUDIO_QUEUE_SEL_RX3,                          // Record Channel 3
	AUDIO_QUEUE_SEL_RX4,                          // Record Channel 4
	AUDIO_QUEUE_SEL_RX5,                          // Record Channel 5
	AUDIO_QUEUE_SEL_RX6,                          // Record Channel 6
	AUDIO_QUEUE_SEL_RX7,                          // Record Channel 7
	AUDIO_QUEUE_SEL_RX8,                          // Record Channel 8
	AUDIO_QUEUE_SEL_RX9,                          // Record Channel 9
	AUDIO_QUEUE_SEL_RX10,                         // Record Channel 10
	AUDIO_QUEUE_SEL_RX11,                         // Record Channel 11
	AUDIO_QUEUE_SEL_RX12,                         // Record Channel 12
	AUDIO_QUEUE_SEL_RX13,						  // Record Channel 13
	AUDIO_QUEUE_SEL_RX14,						  // Record Channel 14
	AUDIO_QUEUE_SEL_RX15,						  // Record Channel 15
	AUDIO_QUEUE_SEL_RX16,						  // Record Channel 16
	AUDIO_QUEUE_SEL_RX17,						  // Record Channel 17
	AUDIO_QUEUE_SEL_RX18,						  // Record Channel 18
	AUDIO_QUEUE_SEL_RX19,						  // Record Channel 19
	AUDIO_QUEUE_SEL_RX20, 						  // Record Channel 20
...
typedef struct {
	AUD_DAI_ID            AUD_DAI_ID;             ///< Audio Transceive Channel DAI ID.

    ER(*open)(AUD_DAI_ID dai_id);                            ///< Open Audio Transceive object.
	ER(*close)(AUD_DAI_ID dai_id);                           ///< Close Audio Transceive object.
	BOOL (*isOpened)(AUD_DAI_ID dai_id);                     ///< Check if Audio Transceive object is opened or not.
	BOOL (*isBusy)(AUD_DAI_ID dai_id);                       ///< Check if Audio Transceive object is Busy or not.

    ER(*playback)(AUD_DAI_ID dai_id);                        ///< Start playback. Valid for AUDTS_CH_TX1/AUDTS_CH_TX2 object only.
	ER(*recordPreset)(AUD_DAI_ID dai_id);                    ///< Start record pre-set. Valid for AUDTS_CH_RX object only.
	ER(*record)(AUD_DAI_ID dai_id);                          ///< Start record. Valid for AUDTS_CH_RX object only.
	ER(*stop)(AUD_DAI_ID dai_id);                            ///< Stop playback/record operation.
	ER(*pause)(AUD_DAI_ID dai_id);                           ///< Pause playback/record operation.
	ER(*resume)(AUD_DAI_ID dai_id);                          ///< Resume playback/record operation after pause.

    void (*setChannel)(AUD_DAI_ID dai_id,AUDIO_CH Channel);                                                               ///< Set Audio Channel as Left/Right/Stereo.
	void (*setTdmChannel)(AUD_DAI_ID dai_id,AUDIO_TDMCH TDM);                                                             ///< Set Audio Channel as
	ER(*setSamplingRate)(AUD_DAI_ID dai_id,AUDIO_SR SampleRate);                                                          ///< Set Audio Samplerate.
	BOOL (*setResampleInfo)(PAUDIO_RESAMPLE_INFO pResampleInfo);                                        ///< Set playback resample. Valid for Playback(TX1/TX2) Channel Only.
	void (*setFeature)(AUD_DAI_ID dai_id,AUDTS_FEATURE Feature, BOOL bEnable);                                            ///< Set Audio Feature.
	void (*setConfig)(AUD_DAI_ID dai_id,AUDTS_CFG_ID CfgSel, ULONG uiSetting);                                           ///< Set Audio Configuration.
	UINT32(*getConfig)(AUD_DAI_ID dai_id,AUDTS_CFG_ID CfgSel);                                                            ///< Get Audio Configuration.

	void (*resetBufferQueue)(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);                                                 ///< Reset Audio Buffer Queue
	BOOL (*addBufferToQueue)(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel, PAUDIO_BUF_QUEUE pAudioBufQueue);                ///< Add playback/record Buffer to Audio Buffer Queue
	BOOL (*isBufferQueueFull)(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);                                                ///< Check if Audio Buffer Queue is full or not.
	PAUDIO_BUF_QUEUE(*getDoneBufferFromQueue)(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);                                ///< Get Record Done Buffer from Audio Buffer Queue.
	PAUDIO_BUF_QUEUE(*getCurrentBufferFromQueue)(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);                             ///< Get Record Current Buffer from Audio Buffer Queue. May not finished.
...
typedef struct {
	...
	BOOL (*setParameter)(AUDIO_PARAMETER Parameter, ULONG uiSetting);
...
//
// aud2 dai1/2/4/5
extern PAUDIO_BUF_QUEUE     pAudioRealBufferFront[AUD_DAI_ID_TOT][AUDTSCH_TOT];
extern PAUDIO_BUF_QUEUE     pAudioRealBufferRear[AUD_DAI_ID_TOT][AUDTSCH_TOT];
extern PAUDIO_BUF_QUEUE     pAudioRealBufferDone[AUD_DAI_ID_TOT][AUDTSCH_TOT];

extern PAUDIO_BUF_QUEUE     pAudioPseudoBufferFront[AUD_DAI_ID_TOT][AUDTSCH_TOT];
extern PAUDIO_BUF_QUEUE     pAudioPseudoBufferRear[AUD_DAI_ID_TOT][AUDTSCH_TOT];
extern PAUDIO_BUF_QUEUE     pAudioPseudoBufferDone[AUD_DAI_ID_TOT][AUDTSCH_TOT];


extern void                 aud2_init_queue(void);
extern ER                   aud2_reset_queue(AUD_DAI_ID hdl, AUDTSCH tsCH);
extern ER                   aud2_is_queue_full(AUD_DAI_ID hdl, AUDTSCH tsCH);
extern ER                   aud2_add_to_queue(AUD_DAI_ID hdl, AUDTSCH tsCH, PAUDIO_BUF_QUEUE pAudioBufQueue);
extern PAUDIO_BUF_QUEUE     aud2_get_done_queue(AUD_DAI_ID hdl, AUDTSCH tsCH);
extern PAUDIO_BUF_QUEUE     aud2_get_cur_queue(AUD_DAI_ID hdl, AUDTSCH tsCH);


// total obj
extern DAI_OBJ 				dai_obj[AUD_DAI_ID_TOT];



// tx object
extern int					aud2_uibuffer_insert_number_tx1[AUD_DAI_ID_TOT];

// rx object
extern int					aud2_uibuffer_insert_number_rx[AUD_DAI_ID_TOT];

// txlb object
extern int					aud2_uibuffer_insert_number_txlb[AUD_DAI_ID_TOT];

// slave clock lost
extern int                  aud2_clock_lost_status_rx[AUD_DAI_ID_TOT];
extern int                  aud2_clock_lost_status_tx[AUD_DAI_ID_TOT];
extern int                  aud2_clock_lost_status_txlb[AUD_DAI_ID_TOT];

extern ER                   aud2_open_tx1(AUD_DAI_ID dai_id);
extern ER                   aud2_close_tx1(AUD_DAI_ID dai_id);
extern BOOL                 aud2_is_opened_tx1(AUD_DAI_ID dai_id);
extern BOOL                 aud2_is_busy_tx1(AUD_DAI_ID dai_id);
extern ER                   aud2_playback_tx1(AUD_DAI_ID dai_id);
extern ER                   aud2_record_preset_tx1(AUD_DAI_ID dai_id);
extern ER                   aud2_record_tx1(AUD_DAI_ID dai_id);
extern ER                   aud2_stop_tx1(AUD_DAI_ID dai_id);
extern ER                   aud2_pause_tx1(AUD_DAI_ID dai_id);
extern ER                   aud2_resume_tx1(AUD_DAI_ID dai_id);
extern void                 aud2_set_channel_tx1(AUD_DAI_ID dai_id,AUDIO_CH Channel);
extern void 				aud2_set_tdm_channel_tx1(AUD_DAI_ID dai_id,AUDIO_TDMCH TDM);
extern ER                   aud2_set_samplerate_tx1(AUD_DAI_ID dai_id,AUDIO_SR SamplingRate);
extern BOOL                 aud2_set_resampleinfo_tx1(PAUDIO_RESAMPLE_INFO pResampleInfo);
extern void                 aud2_set_feature_tx1(AUD_DAI_ID dai_id,AUDTS_FEATURE Feature, BOOL bEnable);
extern void                 aud2_set_config_tx1(AUD_DAI_ID dai_id,AUDTS_CFG_ID CfgSel, ULONG uiSetting);
extern UINT32               aud2_get_config_tx1(AUD_DAI_ID dai_id,AUDTS_CFG_ID Parameter);
extern void                 aud2_reset_buf_queue_tx1(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern BOOL                 aud2_add_buf_to_queue_tx1(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel, PAUDIO_BUF_QUEUE pAudioBufQueue);
extern BOOL                 aud2_is_buf_queue_full_tx1(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern PAUDIO_BUF_QUEUE     aud2_get_done_buf_from_queue_tx1(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern PAUDIO_BUF_QUEUE     aud2_get_cur_buf_from_queue_tx1(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);


// rx object
extern ER                   aud2_open_rx(AUD_DAI_ID dai_id);
extern ER                   aud2_close_rx(AUD_DAI_ID dai_id);
extern BOOL                 aud2_is_opened_rx(AUD_DAI_ID dai_id);
extern BOOL                 aud2_is_busy_rx(AUD_DAI_ID dai_id);
extern ER                   aud2_playback_rx(AUD_DAI_ID dai_id);
extern ER                   aud2_record_preset_rx(AUD_DAI_ID dai_id);
extern ER                   aud2_record_rx(AUD_DAI_ID dai_id);
extern ER                   aud2_stop_rx(AUD_DAI_ID dai_id);
extern ER                   aud2_pause_rx(AUD_DAI_ID dai_id);
extern ER                   aud2_resume_rx(AUD_DAI_ID dai_id);
extern void                 aud2_set_channel_rx(AUD_DAI_ID dai_id,AUDIO_CH Channel);
extern void 				aud2_set_tdm_channel_rx(AUD_DAI_ID dai_id,AUDIO_TDMCH TDM);
extern ER                   aud2_set_samplerate_rx(AUD_DAI_ID dai_id,AUDIO_SR SamplingRate);
extern BOOL                 aud2_set_resampleinfo_rx(PAUDIO_RESAMPLE_INFO pResampleInfo);
extern void                 aud2_set_feature_rx(AUD_DAI_ID dai_id,AUDTS_FEATURE Feature, BOOL bEnable);
extern void                 aud2_set_config_rx(AUD_DAI_ID dai_id,AUDTS_CFG_ID CfgSel, ULONG uiSetting);
extern UINT32               aud2_get_config_rx(AUD_DAI_ID dai_id,AUDTS_CFG_ID Parameter);
extern void                 aud2_reset_buf_queue_rx(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern BOOL                 aud2_add_buf_to_queue_rx(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel, PAUDIO_BUF_QUEUE pAudioBufQueue);
extern BOOL                 aud2_is_buf_queue_full_rx(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern PAUDIO_BUF_QUEUE     aud2_get_done_buf_from_queue_rx(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern PAUDIO_BUF_QUEUE     aud2_get_cur_buf_from_queue_rx(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);

//txlb object
extern ER                   aud2_open_txlb(AUD_DAI_ID dai_id);
extern ER                   aud2_close_txlb(AUD_DAI_ID dai_id);
extern BOOL                 aud2_is_opened_txlb(AUD_DAI_ID dai_id);
extern BOOL                 aud2_is_busy_txlb(AUD_DAI_ID dai_id);
extern ER                   aud2_playback_txlb(AUD_DAI_ID dai_id);
extern ER                   aud2_record_preset_txlb(AUD_DAI_ID dai_id);
extern ER                   aud2_record_txlb(AUD_DAI_ID dai_id);
extern ER                   aud2_stop_txlb(AUD_DAI_ID dai_id);
extern ER                   aud2_pause_txlb(AUD_DAI_ID dai_id);
extern ER                   aud2_resume_txlb(AUD_DAI_ID dai_id);
extern void                 aud2_set_channel_txlb(AUD_DAI_ID dai_id,AUDIO_CH Channel);
extern void 				aud2_set_tdm_channel_txlb(AUD_DAI_ID dai_id,AUDIO_TDMCH TDM);
extern ER                   aud2_set_samplerate_txlb(AUD_DAI_ID dai_id,AUDIO_SR SamplingRate);
extern BOOL                 aud2_set_resampleinfo_txlb(PAUDIO_RESAMPLE_INFO pResampleInfo);
extern void                 aud2_set_feature_txlb(AUD_DAI_ID dai_id,AUDTS_FEATURE Feature, BOOL bEnable);
extern void                 aud2_set_config_txlb(AUD_DAI_ID dai_id,AUDTS_CFG_ID CfgSel, ULONG uiSetting);
extern UINT32               aud2_get_config_txlb(AUD_DAI_ID dai_id,AUDTS_CFG_ID Parameter);
extern void                 aud2_reset_buf_queue_txlb(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern BOOL                 aud2_add_buf_to_queue_txlb(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel, PAUDIO_BUF_QUEUE pAudioBufQueue);
extern BOOL                 aud2_is_buf_queue_full_txlb(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern PAUDIO_BUF_QUEUE     aud2_get_done_buf_from_queue_txlb(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
extern PAUDIO_BUF_QUEUE     aud2_get_cur_buf_from_queue_txlb(AUD_DAI_ID dai_id,AUDIO_QUEUE_SEL QueueSel);
