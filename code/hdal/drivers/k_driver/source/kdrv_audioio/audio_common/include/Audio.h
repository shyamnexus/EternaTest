...
#ifdef __KERNEL__ 
#define au_delay_us(x) udelay(x)
#else
#define au_delay_us(x) vos_util_delay_us(x)
#endif
...
typedef enum {
    ...
    AUDTS_CH_TX1_EP,   ///< Playback Channel 1. (TimeCode Hit function Available)
	AUDTS_CH_TX2_EP,   ///< Playback Channel 2.
	AUDTS_CH_RX_EP,    ///< Record Channel.(TimeCode Hit function Available)(AVSYNC function Available)
	AUDTS_CH_TXLB_EP,  ///< Playback Loopback Channel.

    AUDTS_CH_TX1_EP1,   ///< Playback Channel 1. (TimeCode Hit function Available)
	AUDTS_CH_TX2_EP1,   ///< Playback Channel 2.
	AUDTS_CH_RX_EP1,    ///< Record Channel.(TimeCode Hit function Available)(AVSYNC function Available)
	AUDTS_CH_TXLB_EP1,  ///< Playback Loopback Channel.

    AUDTS_CH_TX1_EP2,   ///< Playback Channel 1. (TimeCode Hit function Available)
	AUDTS_CH_TX2_EP2,   ///< Playback Channel 2.
	AUDTS_CH_RX_EP2,    ///< Record Channel.(TimeCode Hit function Available)(AVSYNC function Available)
	AUDTS_CH_TXLB_EP2,  ///< Playback Loopback Channel.
...
typedef enum {
    ...
    AUDIO_I2SCLKR_320FS_320BIT, ///< SystemClk = 320 * FrameSync, FrameSync = 320 BitClk
...
typedef enum {
	...
	AUDIO_PARAMETER_PLAYBACK_DELAY,				///< [For default codec] After playback start(aud_playback), the speaker would be enabled and the external regulator needs some stable time before record really start.
												///<   This delay is used to prevent playing this pop noise. The default value is 25 (mini-seconds). This setting unit is mini-seconds.
...
typedef enum {
    ...
    AUDIO_EVENT_CLOCL_LOST          =   0X10000000,     ///< I2S Slave mode Clock status  
...
*/
typedef struct {
	AUDTS_CH            AudTSCH;              ///< Audio Transceive Channel DAI ID.
...
/**
    ...
    @return
        ...
        - @b Else: open fail
*/
extern ER               aud_open(AUD_DAI_ID dai_id, void* p_isr_handler);
...
/**
    ...
    @return
        ...
        - @b Else: close fail
*/
extern ER               aud_close(AUD_DAI_ID dai_id);
...
/**
    ...
    @return void
*/
extern void             aud_set_parameter(AUDIO_PARAMETER Parameter, ULONG uiSetting);
...
//extern void aud_isr_handler(ULONG uiAudioIntRegStatus);
