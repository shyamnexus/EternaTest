...
//@{
typedef enum {
	IFE_INPUT_FROM_DRAM        = 0,        ///< 
	IFE_INPUT_FROM_PRE         = 1,        ///< 
	ENUM_DUMMY4WORD(IFE_IN_SEL)
} IFE_IN_SRC_SEL;


/**
    IFE Output to IPE Selection.
*/
//@{
typedef enum {
	IFE_OUT2IPE_DISABLE        = 0,        ///< output to Dram
	IFE_OUT2IPE_ENABLE         = 1,        ///< output to IPE
	ENUM_DUMMY4WORD(IFE_OUT2IPE_SEL)
} IFE_OUT_DST_SEL;
...
/**
    IFE motion type define
*/
//@{
typedef enum {
	IFE_MOTION_TYPE_64    = 0,
	IFE_MOTION_TYPE_16    = 1,
	IFE_MOTION_TYPE_4     = 2,
	ENUM_DUMMY4WORD(IFE_MOTION_TYPE_SEL)
} IFE_MOTION_TYPE_SEL;
...
/**
    Struct IFE 2DNR Motion Setting.

    Parameters of 2DNR
*/
//@{
typedef struct _IFE_MOTIONSET {
	UINT8 motion_en;            ///< 2dnr consider motion
	UINT8 motion_type;          ///< diff size type of motion map
...
typedef struct _IFE_PARAM {
	...
	UINT8           wdr_bypass_mode; ///< wdr bypass mode
...
extern void ife_eng_set_in_src_sel_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_IN_SRC_SEL sel);

extern void ife_eng_set_out_dst_sel_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_OUT_DST_SEL sel);
...
extern void ife_eng_set_wdr_bypass_mode_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL wdr_bypass_mode);

extern void ife_eng_set_wdr_subout_enable_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL wdr_subout_enable);

extern void ife_eng_set_2dnr_nlm_search_range_buf_reg(IFE_ENG_HANDLE *p_eng, UINT8 search_range);

extern void ife_eng_set_2dnr_motion_control_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_MOTIONSET motion_ctrl);

extern void ife_eng_set_2dnr_motion_input_buf_reg(IFE_ENG_HANDLE *p_eng, UINT8 motion_int_sel);

extern void ife_eng_set_2dnr_nlm_parameter0_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_RANGESETA *p_range_set);

extern void ife_eng_set_2dnr_nlm_parameter1_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_RANGESETA *p_range_set);

extern void ife_eng_set_2dnr_nlm_parameter2_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_RANGESETA *p_range_set);
...
extern void ife_eng_set_2dnr_bilat_parameter0_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_RANGESETB *p_range_set);

extern void ife_eng_set_2dnr_bilat_parameter1_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_RANGESETB *p_range_set);

extern void ife_eng_set_2dnr_bilat_parameter2_buf_reg(IFE_ENG_HANDLE *p_eng, IFE_RANGESETB *p_range_set);
...
extern void ife_eng_set_2dnr_sram_shutdown_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL enable);

extern void ife_eng_set_gbal_sram_shutdown_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL enable);

extern void ife_eng_set_wdr_sram_shutdown_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL enable);

extern void ife_eng_set_dma_ll_addr_buf_reg(IFE_ENG_HANDLE *p_eng, UINT32 ll_addr, UINT32 ll_addr_msb);

extern void ife_eng_get_motion_buffer_size(IFE_MOTION_MAP_SIZE_INFO *size_info, IFE_MOTION_TYPE_SEL type_sel, UINT32 in_size_w, UINT32 in_size_h);
