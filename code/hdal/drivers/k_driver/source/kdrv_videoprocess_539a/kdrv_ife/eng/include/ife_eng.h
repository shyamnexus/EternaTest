...
extern void ife_eng_set_2dnr_shutdown_enable_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL enable);
extern void ife_eng_set_gbal_shutdown_enable_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL enable);
extern void ife_eng_set_wdr_shutdown_enable_buf_reg(IFE_ENG_HANDLE *p_eng, BOOL enable);
