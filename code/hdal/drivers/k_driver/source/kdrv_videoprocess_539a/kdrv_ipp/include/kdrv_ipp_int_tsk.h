...
/* ipp eng status bit */
#define KDRV_IPP_ENG_PRE_IDLE		FLGPTN_BIT(KDRV_IPP_ENG_PRE)
#define KDRV_IPP_ENG_IFE_IDLE		FLGPTN_BIT(KDRV_IPP_ENG_IFE)
/*#define KDRV_IPP_ENG_DCE_IDLE		FLGPTN_BIT(KDRV_IPP_ENG_DCE)*/ //690 removed
#define KDRV_IPP_ENG_IPE_IDLE		FLGPTN_BIT(KDRV_IPP_ENG_IPE)
#define KDRV_IPP_ENG_IME_IDLE		FLGPTN_BIT(KDRV_IPP_ENG_IME)
#define KDRV_IPP_ENG_STS_DEFAULT	(KDRV_IPP_ENG_PRE_IDLE | KDRV_IPP_ENG_IFE_IDLE |/* KDRV_IPP_ENG_DCE_IDLE |*/ KDRV_IPP_ENG_IPE_IDLE | KDRV_IPP_ENG_IME_IDLE)
#define KDRV_IPP_ENG_STS_FMD		FLGPTN_BIT(31)

/* ipp dumplog flag */
#define KDRV_IPP_DUMPLOG_HANG		FLGPTN_BIT(0)
#define KDRV_IPP_DUMPLOG_CFG		FLGPTN_BIT(1)
#define KDRV_IPP_DUMPLOG_ALL		(KDRV_IPP_DUMPLOG_HANG | KDRV_IPP_DUMPLOG_CFG)

INT32 kdrv_ipp_pre_isr(UINT32 chip_id, UINT32 eng_id, UINT32 msg, void *in , void *out);
INT32 kdrv_ipp_ife_isr(UINT32 chip_id, UINT32 eng_id, UINT32 msg, void *in , void *out);
#if 0 // removed
INT32 kdrv_ipp_dce_isr(UINT32 chip_id, UINT32 eng_id, UINT32 msg, void *in , void *out);
#endif
INT32 kdrv_ipp_ipe_isr(UINT32 chip_id, UINT32 eng_id, UINT32 msg, void *in , void *out);
INT32 kdrv_ipp_ime_isr(UINT32 chip_id, UINT32 eng_id, UINT32 msg, void *in , void *out);
