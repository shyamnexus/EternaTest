...
extern volatile NT98530_DCE_ENG_REG_STRUCT *p_dce_reg;
...
void dce_eng_int_restore_behavior_param_hw_reg(DCE_ENG_HANDLE *p_eng, DCE_ENG_CAL_STP_INFO *p_cal_info);
