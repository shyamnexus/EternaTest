...
extern VOID ime_eng_set_tmnr_temporal_filter_tf0_residual_threshold_buf_reg(IME_ENG_HANDLE *p_eng, UINT32 th);
...
extern VOID ime_eng_set_tmnr_temporal_filter_enable_buf_reg(IME_ENG_HANDLE *p_eng, UINT8 tf_y_set_en, UINT8 tf_c_set_en);
extern VOID ime_eng_set_tmnr_motion_estimation_enable_buf_reg(IME_ENG_HANDLE *p_eng, UINT8 set_en);
extern VOID ime_eng_set_tmnr_pre_filter_dc_ratio_buf_reg(IME_ENG_HANDLE *p_eng, UINT8 dc_ratio0, UINT8 dc_ratio1);
