...
REGDEF_BIT(,        2)
REGDEF_BIT(ime_lca_sram_sd_en,        1)
...
typedef struct _NT98538_IME_ENG_REG_STRUCT_ {
	...
	union {
		struct {
			...
			unsigned                           : 2;
			unsigned ime_lca_sram_sd_en        : 1;     // bits : 20
			unsigned                           : 10;
			unsigned ime_enc_dct_en            : 1;     // bits : 31
		} bit;
		UINT32 word;
	} reg_4; // 0x0010
	...
	union {
		struct {
			unsigned ime_p0_v_dram_msb_sao        : 4;      // bits : 31_0
		} bit;
		UINT32 word;
	} reg_51; // 0x00cc
	...
	union {
		struct {
			...
			unsigned                     : 7;
			unsigned dbcs_proc_lcon_sel  : 1;       // bits : 31
		} bit;
		UINT32 word;
	} reg_224; // 0x0380
	...
	union {
		struct {
			...
			unsigned ime_3dnr_nr_tf0_y_en                 : 1;      // bits : 24
			unsigned ime_3dnr_nr_tf0_c_en                 : 1;      // bits : 25
			unsigned ime_3dnr_mot_est_en                  : 1;      // bits : 26
		} bit;
		UINT32 word;
	} reg_448; // 0x0700
	...
	union {
		struct {
			...
			unsigned ime_3dnr_nr_c_tf0_tprot_th           : 4;      // bits : 11_8
		} bit;
		UINT32 word;
	} reg_523; // 0x082c
	...
	union {
		struct {
			...
			unsigned ime_3dnr_nr_pre_filtering_dc_ratio0       : 8;     // bits : 23_16
			unsigned ime_3dnr_nr_pre_filtering_dc_ratio1       : 8;     // bits : 31_24
		} bit;
		UINT32 word;
	} reg_564; // 0x08d0
	...
	union {
		struct {
			unsigned ime_axi_channel_en        : 32;        // bits : 31_0
		} bit;
		UINT32 word;
	} reg_634; // 0x09e8
	...
	union {
		struct {
			unsigned ime_axi_channel_en        : 4;     // bits : 3_0
			unsigned                           : 27;
			unsigned ime_axi_disable           : 1;     // bits : 31
		} bit;
		UINT32 word;
	} reg_635; // 0x09ec
	...
	union {
		struct {
			unsigned ime_axi_lock_dis        : 32;      // bits : 31_0
		} bit;
		UINT32 word;
	} reg_637; // 0x09f4
	...
	union {
		struct {
			unsigned ime_axi_lock_dis        : 4;       // bits : 3_0
		} bit;
		UINT32 word;
	} reg_638; // 0x09f8
	...
	union {
		struct {
			...
			unsigned                           : 18;
			unsigned lca_edge_detect_en        : 1;     // bits : 29
			unsigned lca_ref_center_en         : 1;     // bits : 30
			unsigned lca_motion_status_en      : 1;     // bits : 31
		} bit;
		UINT32 word;
	} reg_732; // 0x0b70
	...
	union {
		struct {
			unsigned nn_isp_p3_y_msb_sai         : 4;       // bits : 3_0
			unsigned                             : 12;
			unsigned nn_isp_p3_uv_msb_sai        : 4;       // bits : 19_16
		} bit;
		UINT32 word;
	} reg_789; // 0x0c54
