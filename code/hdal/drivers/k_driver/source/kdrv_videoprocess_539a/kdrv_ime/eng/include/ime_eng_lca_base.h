...
extern VOID ime_eng_set_lca_edge_detection_enable_buf_reg(IME_ENG_HANDLE *p_eng, UINT8 set_en);
extern VOID ime_eng_set_lca_reference_center_enable_buf_reg(IME_ENG_HANDLE *p_eng, UINT8 set_en);
extern VOID ime_eng_set_lca_motion_status_enable_buf_reg(IME_ENG_HANDLE *p_eng, UINT8 set_en);
