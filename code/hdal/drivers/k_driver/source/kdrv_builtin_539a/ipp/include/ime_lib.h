...
typedef struct _IME_DMA_ADDR_INFO {
	ULONG addr_y;    ///< DMA address of Y channel
	ULONG addr_cb;   ///< DMA address of Cb channel
	ULONG addr_cr;   ///< DMA address of Cr channel
} IME_DMA_ADDR_INFO;
...
typedef struct _IME_STL_INFO {
	...
	ULONG               stl_edge_map_addr; ///< edge map output address
	ULONG               stl_hist_addr;    ///< output address for edge statistic
...
typedef struct _IME_PM_INFO {
	...
	ULONG               pm_pxl_dma_addr;   ///< pixelation input imaeg buffer address
} IME_PM_INFO;
...
typedef struct _IME_TMNR_INFO_ {
	...
	ULONG               mot_sta_in_addr; ///< 3DNR motion status input DMA buffer address
	ULONG               mot_sta_out_addr; ///< 3DNR motion status output DMA buffer address
	...
	ULONG               mot_sta_roi_out_addr; ///< 3DNR motion status output DMA buffer address for ROI

	UINT32              mot_vec_ofs; ///< 3DNR motion vector input and output lineoffset
	ULONG               mot_vec_in_addr; ///< 3DNR motion vector input DMA buffer address
	ULONG               mot_vec_out_addr; ///< 3DNR motion vector output DMA buffer address

	UINT32              sta_out_ofs; ///< 3DNR statistic data output lineoffset
	ULONG               sta_out_addr; ///< 3DNR statistic data output DMA buffer address
...
extern ULONG ime_get_tmnr_ref_in_y_addr(VOID);
extern ULONG ime_get_tmnr_ref_in_uv_addr(VOID);
...
extern ULONG ime_get_tmnr_motion_status_in_addr(VOID);
extern ULONG ime_get_tmnr_motion_status_out_addr(VOID);
...
extern ULONG ime_get_tmnr_motion_status_roi_out_addr(VOID);
...
extern ULONG ime_get_tmnr_motion_vector_in_addr(VOID);
extern ULONG ime_get_tmnr_motion_vector_out_addr(VOID);


extern ER ime_chg_tmnr_statistic_out_lineoffset(UINT32 set_lofs);
extern ER ime_chg_tmnr_statistic_out_addr(UINT32 set_addr);
extern ULONG ime_get_tmnr_statistic_out_addr(VOID);
...
extern ULONG ime_get_tmnr_ref_out_y_addr(VOID);
extern ULONG ime_get_tmnr_ref_out_uv_addr(VOID);
