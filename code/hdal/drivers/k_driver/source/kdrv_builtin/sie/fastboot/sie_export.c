...
EXPORT_SYMBOL(sie_builtin_set_start);
EXPORT_SYMBOL(sie_builtin_set_stop);
EXPORT_SYMBOL(sie_builtin_rst);
EXPORT_SYMBOL(sie_fb_reg_buf_out_cb);
EXPORT_SYMBOL(sie_fb_reg_kdrv_isr_Cb);
EXPORT_SYMBOL(sie_fb_reg_isr_Cb);
EXPORT_SYMBOL(sie_fb_get_rdy_addr);
EXPORT_SYMBOL(sie_fb_buf_ctrl);
EXPORT_SYMBOL(sie_init_plat_read_dtsi_array);
EXPORT_SYMBOL(sie_fb_upd_timestp);
EXPORT_SYMBOL(sie_fb_get_out_size);
EXPORT_SYMBOL(kdrv_sie_builtin_plat_malloc);
EXPORT_SYMBOL(kdrv_sie_builtin_plat_free);
EXPORT_SYMBOL(sie_set_dbg_func);
EXPORT_SYMBOL(kdrv_sie_builtin_ioremap);
EXPORT_SYMBOL(sie_fb_get_clk);
EXPORT_SYMBOL(sie_fb_wait_vd);
EXPORT_SYMBOL(sie_fb_get_dbg_info);
#endif
