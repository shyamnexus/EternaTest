...
REGDEF_BIT(DAC_ZC_EN, 1)                    //0
REGDEF_BIT(, 1)                             //1
REGDEF_BIT(DAC_DATA_MIX, 1)                 //2
REGDEF_BIT(, 1)                             //3
REGDEF_BIT(DAC_DCCAN_EN, 1)                 //4
REGDEF_BIT(DAC_DCCAN_INIT_LOAD, 1)          //5
REGDEF_BIT(, 2)                             //6..7
REGDEF_BIT(DAC_OSR_SEL, 2)                  //8..9
//REGDEF_BIT(                       ,2)
//REGDEF_BIT(DWA_FORCE_ON           ,1)
REGDEF_BIT(, 2)                             //10..11
REGDEF_BIT(DAC_COMP_BYPASS, 1)              //12
REGDEF_BIT(, 2)                             //13..19
REGDEF_BIT(ANALOG_TEST_EN, 1)               //20
REGDEF_BIT(ANALOG_DEPOP_EN, 1)              //21
REGDEF_BIT(, 2)                             //22..23
REGDEF_BIT(DAC_DCCAN_RES, 4)                //24..27
REGDEF_BIT(, 4)                             //28..31
...
REGDEF_BIT(AD_DBG, 1)           //...0
REGDEF_BIT(DA_DBG, 1)           //...1
REGDEF_BIT(AUD_DET_DBG, 1)      //...2
REGDEF_BIT(, 1)                 //...3
REGDEF_BIT(DBG_TYPE, 4)         //...4~7
REGDEF_BIT(DBG_PORT_SEL, 4)     //...8~11
REGDEF_BIT(, 20)                //...24~31
...
REGDEF_BIT(VOS_ADC, 3)              //0 1 2
REGDEF_BIT(, 1)                     
REGDEF_BIT(PD_EXT_RP_ADC, 1)        //4
REGDEF_BIT(PD_BIAS, 1)              //5
REGDEF_BIT(, 2)                     
REGDEF_BIT(CS_COM_CTL, 2)           //8  9
REGDEF_BIT(CS_PGA_ADC, 2)           //10 11
REGDEF_BIT(CS_REF_ADC, 2)           //12 13
REGDEF_BIT(CS_SDM_ADC, 2)           //14 15
REGDEF_BIT(CS_COM_DAC, 2)           //16 17
REGDEF_BIT(CS_LN_DAC, 2)            //18 19
REGDEF_BIT(PD_ADAC_IU, 1)           //20
REGDEF_BIT(PD_ADAC_VCM, 1)          //21
REGDEF_BIT(PD_RC_ADAC, 1)           //22
REGDEF_BIT(ADAC_GATE, 1)            //23
REGDEF_BIT(SW_POP_R, 1)             //24
REGDEF_BIT(SW_POP_L, 1)             //25
REGDEF_BIT(PD_V2I, 1)               //26
REGDEF_BIT(PD_OP_COM, 1)            //27
REGDEF_BIT(CCR, 4)                  //28 29 30 31
REGDEF_END(EAC_PHYCTRL_REG)


/* DAC Comp Registers */
// DAC Comp Coef register
REGDEF_OFFSET(DAC_COMP_REG, 0x110)     //from 0x110 to 0x11C
REGDEF_BEGIN(DAC_COMP_REG)             
REGDEF_BIT(DAC_COMP_COEF0, 14)          // 0..13
REGDEF_BIT(, 2)                         // 14..15
REGDEF_BIT(DAC_COMP_COEF1, 14)          // 16..29
REGDEF_BIT(, 2)                         // 30..31
REGDEF_END(DAC_COMP_REG)
...
// EAC DMIC2 Detect Threshold
REGDEF_OFFSET(AUD_DET_TH_REG, 0x210)
REGDEF_BEGIN(AUD_DET_TH_REG)
REGDEF_BIT(DET_TH_L, 16)
REGDEF_BIT(DET_TH_R, 16)
REGDEF_END(AUD_DET_TH_REG)

// EAC DMIC2 Detect Resolution
REGDEF_OFFSET(AUD_DET_RES_REG, 0x214)
REGDEF_BEGIN(AUD_DET_RES_REG)
REGDEF_BIT(AUD_DET_RES_L, 3)
REGDEF_BIT(,1)
REGDEF_BIT(VOL_TH_OP_L,1)
REGDEF_BIT(,3)
REGDEF_BIT(AUD_DET_RES_R, 3)
REGDEF_BIT(,1)
REGDEF_BIT(VOL_TH_OP_R,1)
REGDEF_BIT(,10)
REGDEF_END(AUD_DET_RES_REG)

// EAC DMIC2 AWE Status
REGDEF_OFFSET(AUD_AWE_STS_REG, 0x21C)
REGDEF_BEGIN(AUD_AWE_STS_REG)
REGDEF_BIT(AWE_L, 16)
REGDEF_BIT(AWE_R, 16)
REGDEF_END(AUD_AWE_STS_REG)

// EAC DMIC2 VOL Status
REGDEF_OFFSET(AUD_VOL_STS_REG, 0x220)
REGDEF_BEGIN(AUD_VOL_STS_REG)
REGDEF_BIT(VOL_L, 16)
REGDEF_BIT(VOL_R, 16)
REGDEF_END(AUD_VOL_STS_REG)
