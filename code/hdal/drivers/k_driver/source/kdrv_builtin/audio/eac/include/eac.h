...
typedef enum {
	...
	EAC_CONFIG_DA_COMP_EN,			///< Configure DA(Playback) comp filter Enable/Disable
...
/**
	...
	@return void
*/
extern void eac_set_phypower(UINT32 mode, BOOL b_en);
...
extern void 	eac_checkclk(void);


extern void DAC_set_comp(DAC_COMP_COEF* coef_value);
