...
extern void __iomem *_EAC_REG_BASE_ADDR[EAC_REG_NUM];
#define EAC_SETREG(ofs, value)      writel(value, (_EAC_REG_BASE_ADDR[0] + (ofs)))
#define EAC_GETREG(ofs)             readl((_EAC_REG_BASE_ADDR[0] + (ofs)))
