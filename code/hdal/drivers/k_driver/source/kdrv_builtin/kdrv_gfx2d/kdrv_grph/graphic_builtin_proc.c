...
static struct proc_ops proc_cmd_fops = {
	.proc_open    = nvt_graphic_proc_cmd_open,
	.proc_read    = seq_read,
	.proc_lseek  = seq_lseek,
	.proc_release = single_release,
	.proc_write   = nvt_graphic_proc_cmd_write
};
...
static struct proc_ops proc_help_fops = {
	.proc_open   = nvt_graphic_proc_help_open,
	.proc_release = single_release,
	.proc_read   = seq_read,
	.proc_lseek = seq_lseek,
};
...
int nvt_graphic_proc_init(PXXX_DRV_INFO pdrv_info)
{
	...
	pmodule_root = proc_mkdir("ssdrv_grph", NULL);
