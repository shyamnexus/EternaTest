...
#include "graphic_builtin_reg.h"
#include "graphic_builtin_main.h"
#include "graphic_builtin_proc.h"
#include "graphic_builtin_dbg.h"

//=============================================================================
//Module parameter : Set module parameters when insert the module
//=============================================================================
#ifdef DEBUG
static unsigned int grph_debug_level = NVT_DBG_IND;
module_param_named(grph_debug_level, grph_debug_level, int, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(grph_debug_level, "Debug message level");
#endif

//=============================================================================
// Global variable
//=============================================================================
static struct of_device_id grph_match_table[] = {
...
//	nvt_dbg(IND, "%s\n", pdev->name);
	...
	match = of_match_device(grph_match_table, &pdev->dev);
	if (!match) {
...
static struct platform_driver nvt_graphic_driver = {
	.driver = {
			.name   = "nvt_graphic",
			.owner = THIS_MODULE,
			.of_match_table = grph_match_table,
		      },
