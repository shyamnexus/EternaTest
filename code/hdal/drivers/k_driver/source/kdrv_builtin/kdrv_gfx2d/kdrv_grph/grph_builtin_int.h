...
#include "rcw_macro.h"
#include "kwrap/type.h"
#include "grph_builtin_compatible.h"
#include "graphic_builtin_dbg.h"

#endif
#include <kwrap/error_no.h>
#include "grph_builtin_ll.h"

#include "grph_builtin_platform.h"
#include "plat/top.h"

#define GRPH_TEST_EFF		(DISABLE)	// verification: test ddr/axi efficiency
#define GRPH_TEST_YCC_SHIFT	(DISABLE)	// verification: test YCC shift mode pattern
...
#define GRPH_LL_BUF_SIZE            (8192)	// link-list depth 4

#define GRPH_LL_MAX_COUNT           (20)
...
#define GRPH3_REG_ADDR(ofs)      (IOADDR_GRAPHIC3_REG_BASE+(ofs))
