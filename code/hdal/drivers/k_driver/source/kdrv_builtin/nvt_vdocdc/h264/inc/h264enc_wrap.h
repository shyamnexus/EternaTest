...
extern void h264Enc_wrapSeqCfg(H26XENC_VAR *pVar, H26XEncAddr *pAddr, H26X_XVR_APP xvr_app);
...
extern void h264Enc_wrapBGRdoCfg(H26XRegSet *pRegSet, H264ENC_CTX *pVdoCtx);
