...
#define MAX_LOG_CHN             32
#define MAX_RC_PROC_PARAM_NUM   60
...
#endif
	unsigned int uiMaxSTBitrate;
	unsigned int uiMinLTBitrate;
	unsigned int uiLTMeasurePeriod; // unit: minute
	void *uiUserDataAddr;
	unsigned int uiUserDataSize;
}H26XEncRCParam;
...
typedef struct _H26XEncRCPreparePic
{
    ...
    unsigned int uiSkipFrameTrigger;
	unsigned int uiSkipFrame;
	unsigned int uiDynamicFREnable;
	unsigned int uiDynamicFRMinFps;
	unsigned int uiDynamicGOPTrigger;
	unsigned int uiDynamicGOPEnable;
	unsigned int uiDynamicGOPMaxGOP;
}H26XEncRCPreparePic;
...
typedef struct _H26XEncRCUpdatePic
{
	...
	unsigned int uiTileSize[2];
	unsigned int uiTileAvgQP[2];
}H26XEncRCUpdatePic;
...
typedef struct _H26XEncCVBRInfo
{
	unsigned int lt_bitrate;
	unsigned int lt_min_bitrate;
	unsigned int st_max_bitrate;
	unsigned int lt_period;
	unsigned int st_period;
	unsigned int cur_gop_bitrate;
