...
/**
    APP tag
*/
typedef _PACKED_BEGIN struct _TAG_APP {
	UINT8           tag_id[2];       ///< tag ID
	UINT8           tag_length[2];   ///< tag length
	UINT8           tag_data[4];     ///< tag data
} _PACKED_END TAG_APP;    // application
#endif
...
*/
typedef JPG_HEADER_ER (*PARSE_EXIF_CB)(uintptr_t buf, UINT32 *p_thumboffset, UINT32 *p_thumbsize);
...
*/
extern JPG_HEADER_ER jpg_parse_header(JPGHEAD_DEC_CFG *jdcfg_p, JPG_DEC_TYPE dec_type, PARSE_EXIF_CB parse_exif_cb, UINT32 header_size);
