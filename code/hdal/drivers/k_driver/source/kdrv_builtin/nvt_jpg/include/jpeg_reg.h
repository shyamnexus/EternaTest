...
#define NEW_64BIT_REG //64 or 32 doesn't matter
...
// Dummy Write DMA Addr
#define JPG_DUMMY_W_ADDR_OFS            0x08
REGDEF_BEGIN(JPG_DUMMY_W_ADDR)
REGDEF_BIT(dummy_w_addr, 32)
REGDEF_END(JPG_DUMMY_W_ADDR)
...
REGDEF_BIT(pad_right, 6)
REGDEF_BIT(, 10)
REGDEF_BIT(pad_bottom, 4)
REGDEF_BIT(, 12)
REGDEF_END(JPG_PAD)

#define JPG_HW_DBG_OFS                  0x34
REGDEF_BEGIN(JPG_HW_DBG)
REGDEF_BIT(, 24)
REGDEF_BIT(jpg_dma_ack, 4)
REGDEF_BIT(, 4)
REGDEF_END(JPG_HW_DBG)

// 0x38, Reserved Registers
...
#define JPG_TIMEOUT_TH_OFS                 0xC0
REGDEF_BEGIN(JPG_TIMEOUT_TH)
REGDEF_BIT(timeout_threshold, 32)
REGDEF_END(JPG_TIMEOUT_TH)
...
REGDEF_BIT(, 4)
REGDEF_BIT(bs_valid, 1)                 //whatever 32b or 64b
REGDEF_BIT(, 15)
REGDEF_BIT(dummy_w_msb_addr, 4)
REGDEF_BIT(, 4)
...
*/
//@{
#define JPG_SEC_BS_STADR_OFS				0x130
REGDEF_BEGIN(JPG_SEC_BS_STADR)
REGDEF_BIT(sec_bs_stadr, 32)
REGDEF_END(JPG_SEC_BS_STADR)

#define JPG_SEC_BS_MSB_STADR_OFS			0x134
REGDEF_BEGIN(JPG_SEC_BS_MSB_STADR)
REGDEF_BIT(sec_bs_msb_stadr, 4)
REGDEF_BIT(, 4)
REGDEF_BIT(sec_bs_valid, 1)
REGDEF_BIT(, 23)
REGDEF_END(JPG_SEC_BS_MSB_STADR)

#define JPG_SEC_BS_BUFLEN_OFS				0x138
REGDEF_BEGIN(JPG_SEC_BS_BUFLEN)
REGDEF_BIT(sec_bs_buflen, 25)
REGDEF_BIT(, 7)
REGDEF_END(JPG_SEC_BS_BUFLEN)
...
*/
//@{
#define ROI_XY_OFS			        	0x140
REGDEF_BEGIN(ROI_XY)
REGDEF_BIT(jpeg_roi_x, 13)
REGDEF_BIT(, 3)
REGDEF_BIT(jpeg_roi_y, 13)
REGDEF_BIT(, 3)
REGDEF_END(ROI_XY)

#define ROI_WH_OFS			        	0x144
REGDEF_BEGIN(ROI_WH)
REGDEF_BIT(jpeg_roi_width, 13)
REGDEF_BIT(, 3)
REGDEF_BIT(jpeg_roi_height, 13)
REGDEF_BIT(, 3)
REGDEF_END(ROI_WH)

#define ROI_AC_OFS			        	0x148
REGDEF_BEGIN(ROI_AC)
REGDEF_BIT(jpeg_roi_enable, 1)
REGDEF_BIT(, 3)
REGDEF_BIT(jpeg_roi_threshold, 6)
REGDEF_BIT(, 2)
REGDEF_BIT(jpeg_roi_threshold_ac1_ac2, 6)
REGDEF_BIT(, 2)
REGDEF_BIT(jpeg_roi_sub_ac1_en, 1)
REGDEF_BIT(, 11)
REGDEF_END(ROI_AC)
...
REGDEF_BIT(,3)
REGDEF_BIT(graph_stadr,29)		//3..31
...
#define OSG0_MOSAIC_OFS			0x1018
REGDEF_BEGIN(OSG0_MOSAIC)
REGDEF_BIT(mosaic_blk_sz,2)
REGDEF_BIT(,30)
REGDEF_END(OSG0_MOSAIC)
...
REGDEF_BIT(,2)
REGDEF_BIT(overlap_type,1)
REGDEF_BIT(,27)
REGDEF_END(OSG_CHROMA)

#define OSG0_GRAPHIC3_OFS		0x14D8
REGDEF_BEGIN(OSG0_GRAPHIC3)
REGDEF_BIT(graph_stadr_msb,4)
REGDEF_BIT(,28)
REGDEF_END(OSG0_GRAPHIC3)
