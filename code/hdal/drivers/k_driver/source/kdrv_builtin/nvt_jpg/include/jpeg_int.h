...
#define JPEG_MIN_W				(16)
#define JPEG_MIN_H				(16)
...
typedef uintptr_t      JPEG_BS_ADDR;

extern void jpeg_reg_init(uintptr_t io_addr);
extern void jpeg_setbaseidx_mincode(UINT8 *phufftab_lumac, UINT8 *phufftab_lumdc, UINT8 *phufftab_chrac, UINT8 *phufftab_chrdc, uintptr_t io_addr);
extern void jpeg_buildbaseidx_mincode(UINT8 *phuff_tab, UINT8 *pmin_tab, UINT8 *pbase_tab);
//base address
extern void jpeg_set_baseaddr(uintptr_t addr);
