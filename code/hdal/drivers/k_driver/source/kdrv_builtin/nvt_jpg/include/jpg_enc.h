...
typedef struct _JPG_ENC_CFG {
	uintptr_t image_addr[2];                ///< Raw Image address. Ex:RawImageAddr[0] for Y, RawImageAddr[1] for UV
	uintptr_t bs_hdr_addr;                      ///< Compressed data ouput location.
...
*/
extern ER       jpg_enc_one_img(PJPG_ENC_CFG p_jpg_param, UINT32 quality, uintptr_t io_addr);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER       jpg_async_enc_open(uintptr_t io_addr);
...
/**
    ...
    @param[in] process_cfg Specific JPEG_PROCESS_CFG
    @return JPEG header size.
*/
//extern UINT32   jpg_async_enc_setheader(PJPG_ENC_CFG p_jpg_param, UINT8 *p_q_tbl_y, UINT8 *p_q_tbl_uv);
// extern UINT32   jpg_async_enc_setheader(PJPG_ENC_CFG p_jpg_param, UINT8 *p_q_tbl_y, UINT8 *p_q_tbl_uv, UINT32 rotation, uintptr_t io_addr);
extern UINT32   jpg_async_enc_setheader(PJPG_ENC_CFG p_jpg_param, UINT8 *p_q_tbl_y, UINT8 *p_q_tbl_uv, void *process_cfg, uintptr_t io_addr);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER       jpg_async_enc_start(uintptr_t bs_bufaddr, UINT32 bs_bufsize, uintptr_t img_y_addr, uintptr_t img_uv_addr, uintptr_t io_addr);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER       jpg_async_enc_waitdone(UINT32 *p_jpg_size, uintptr_t io_addr);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER       jpg_async_enc_close(uintptr_t io_addr);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern void     jpg_async_set_brc_qtable(UINT32 qf, UINT8 *p_q_tbl_y, UINT8 *p_q_tbl_uv, uintptr_t io_addr);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern void     jpg_async_set_qtable(UINT32 quality, UINT8 *p_q_tbl_y, UINT8 *p_q_tbl_uv, uintptr_t io_addr);
...
*/
//extern void jpg_get_brc_qf(JPEG_RC_PARAM *p_rc, JPG_YUV_FORMAT yuv_fmt, UINT32 *p_qf, UINT32 bs_size, UINT32 eng_idx, uintptr_t io_addr);
