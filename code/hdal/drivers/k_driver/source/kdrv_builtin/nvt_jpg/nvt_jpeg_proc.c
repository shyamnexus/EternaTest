...
// Function define
//============================================================================
extern int nvt_jpg_api_write_reg(PJPG_MODULE_INFO pmodule_info, unsigned char ucargc, char **pucargv);
extern int nvt_jpg_api_write_pattern(PJPG_MODULE_INFO pmodule_info, unsigned char ucargc, char **pucargv);
extern int nvt_jpg_api_read_reg(PJPG_MODULE_INFO pmodule_info, unsigned char ucargc, char **pucargv);
...
static struct proc_ops proc_cmd_fops = {
	.proc_open    = nvt_jpg_proc_cmd_open,
	.proc_read    = seq_read,
	.proc_lseek  = seq_lseek,
	.proc_release = single_release,
	.proc_write   = nvt_jpg_proc_cmd_write
};
...
static struct proc_ops proc_help_fops = {
	.proc_open   = nvt_jpg_proc_help_open,
	.proc_release = single_release,
	.proc_read   = seq_read,
	.proc_lseek = seq_lseek,
};

int nvt_builtinjpg_proc_init(PJPG_DRV_INFO pdrv_info)
{
	int ret = 0;
...
int nvt_builtinjpg_proc_remove(PJPG_DRV_INFO pdrv_info)
{
