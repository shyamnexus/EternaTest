...
#define AWB_TUNING_TARGET_MAX 6
...
// extern variable
/////////////////////////////////////////
extern AWB_PARAM *awb_builtin_param[AWB_ID_MAX_NUM];
extern AWBALG_ER awb_builtin_alg_method(AWB_INFO *awb_info, AWB_PARAM *m1_par);
