...
// version
//=============================================================================
#define AE_BUILTIN_VERSION 0x00010000
...
typedef struct _AE_FLOW_INFO {
	...
	AE_SHDR_METER shdr_meter;
	AE_SHDR_INFO shdr_info;
	UINT32 la_fusion_weighting[LA_WIN_X*LA_WIN_Y];
...
extern INT32 ae_builtin_uninit_nvt(UINT32 id);
extern INT32 ae_builtin_trig_nvt(UINT32 id, ISP_BUILTIN_AE_TRIG_MSG msg);
extern void ae_builtin_get_param(UINT32 id, ULONG *param);

// ae_flow
void ae_builtin_curve_init(AE_FLOW_INFO *ae_info);

// ae_alg
void ae_builtin_alg_do_converge(AE_FLOW_INFO *AEInfo, AEALG_ARG *PrvInfo);
void ae_builtin_dbg_msg(AE_FLOW_INFO *aeinfo);
void ae_builtin_alg_cal_mfrm_exptime(AE_SHDR_PARAM *shdr_param);
INT32 ae_builtin_alg_op_intpl(INT32 idx, INT32 value_l, INT32 value_h, INT32 idx_l, INT32 idx_h);
UINT64 ae_builtin_uint64_div(UINT64 numerator, UINT64 denominator);
extern UINT32 ae_builtin_alg_get_add_gamma_value(UINT32 data, UINT16 *gamma_tbl, UINT32 bit);
