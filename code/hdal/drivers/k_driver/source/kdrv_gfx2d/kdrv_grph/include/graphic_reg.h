...
*/
typedef enum {
	LINE_ATTRIB_ARGB,                //< RGB only /ARGB(GOP9)
	LINE_ATTRIB_RGB,                  //< A only   /RGB only(GOP9)

	ENUM_DUMMY4WORD(Line_ARGB_ATTRIB_ENUM)
} Line_ARGB_ATTRIB_ENUM;
...
#define GRPH_GOP9_LINE_REG1_OFS            0x40
REGDEF_BEGIN(GRPH_GOP9_LINE_REG1)
REGDEF_BIT(A_PARAM, 14)
REGDEF_BIT(rsv1, 1)
REGDEF_BIT(A_PARAM_SIGN_BIT, 1)
REGDEF_BIT(B_PARAM, 14)
REGDEF_BIT(rsv2, 1)
REGDEF_BIT(B_PARAM_SIGN_BIT, 1)
REGDEF_END(GRPH_GOP9_LINE_REG1)
#define GRPH_GOP9_LINE_COORDI0_REG1_OFS    0x48
#define GRPH_GOP9_LINE_COORDI1_REG1_OFS    0x50
REGDEF_BEGIN(GRPH_GOP9_LINE_COORDI_REG1)
REGDEF_BIT(X, 14)
REGDEF_BIT(rsv1, 2)
REGDEF_BIT(Y, 14)
REGDEF_BIT(rsv2, 2)
REGDEF_END(GRPH_GOP9_LINE_COORDI_REG1)
...
#define GRPH_GOP9_LINE_REG2_OFS            0x44
REGDEF_BEGIN(GRPH_GOP9_LINE_REG2)
REGDEF_BIT(C_PARAM, 28)
REGDEF_BIT(rsv1, 3)
REGDEF_BIT(C_PARAM_SIGN_BIT, 1)
REGDEF_END(GRPH_GOP9_LINE_REG2)
...
REGDEF_BIT(IMG1_ADDR, 32)           // Starting Address of Image-1
...
REGDEF_BIT(ACT_WIDTH, 15)           // Active Width
REGDEF_BIT(, 1)
...
REGDEF_BIT(IMG2_ADDR, 32)           // Starting Address of Image-2
...
//0x8C Image Active Width2 Register
#define GRPH_XRGN2_REG_OFS                   0x8C
REGDEF_BEGIN(GRPH_XRGN2_REG)
REGDEF_BIT(ACT_WIDTH_B, 15)		// Active Width
REGDEF_BIT(, 17)
REGDEF_END(GRPH_XRGN2_REG)


//0x90 Image-3 Buffer Address Register
#define GRPH_IMG3_ADDR_REG_OFS              0x90
REGDEF_BEGIN(GRPH_IMG3_ADDR_REG)
REGDEF_BIT(IMG3_ADDR, 32)           // Starting Address of Image-1
...
//0x98 Image-4 Buffer Address Register
#define GRPH_IMG4_ADDR_REG_OFS              0x98
REGDEF_BEGIN(GRPH_IMG4_ADDR_REG)
REGDEF_BIT(IMG4_ADDR, 32)           // Starting Address of Image-4
REGDEF_END(GRPH_IMG4_ADDR_REG)

//0x9C Image-4 Buffer Line Offset Register
#define GRPH_IMG4_LOFF_REG_OFS              0x9C
REGDEF_BEGIN(GRPH_IMG4_LOFF_REG)
REGDEF_BIT(IMG4_LOFF, 17)           // Line Offset of Image-4
REGDEF_BIT(, 15)
REGDEF_END(GRPH_IMG4_LOFF_REG)
...
//0x384 AXI Control Register
#define GRPH_AXI_CTRL_REG_OFS			0x384
REGDEF_BEGIN(GRPH_AXI_CTRL_REG)
REGDEF_BIT(AXI_DISABLE, 1)
REGDEF_BIT(, 31)
REGDEF_END(GRPH_AXI_CTRL_REG)

//0x3F0 Usage Control Register
#define GRPH_USAGE_CTRL_REG_OFS			0x3F0
REGDEF_BEGIN(GRPH_USAGE_CTRL_REG)
REGDEF_BIT(USAGE_MONITOR_EN, 1)
REGDEF_BIT(, 31)
REGDEF_END(GRPH_USAGE_CTRL_REG)

//0x3F4 Usage Period Register
#define GRPH_USAGE_PERIOD_REG_OFS		0x3F4
REGDEF_BEGIN(GRPH_USAGE_PERIOD_REG)
REGDEF_BIT(PERIOD, 24)
REGDEF_BIT(, 8)
REGDEF_END(GRPH_USAGE_PERIOD_REG)

//0x3F8 Usage Period Register
#define GRPH_USAGE_STS_REG_OFS			0x3F8
REGDEF_BEGIN(GRPH_USAGE_STS_REG)
REGDEF_BIT(BUSY, 24)
REGDEF_BIT(UPDATE_COUNTER, 8)
REGDEF_END(GRPH_USAGE_STS_REG)

//0x400 YCC Control Register
#define GRPH_YCC_CTRL_REG_OFS			0x400
REGDEF_BEGIN(GRPH_YCC_CTRL_REG)
REGDEF_BIT(YCC_EN, 1)
REGDEF_BIT(DEC_SHIFT_MODE_EN, 1)
REGDEF_BIT(ENC_SHIFT_MODE_EN, 1)
REGDEF_BIT(, 29)
REGDEF_END(GRPH_YCC_CTRL_REG)

//0x408 YCC Byte Offset Register
#define GRPH_YCC_BOFS_REG_OFS			0x408
REGDEF_BEGIN(GRPH_YCC_BOFS_REG)
REGDEF_BIT(OFS, 6)
REGDEF_BIT(, 26)
REGDEF_END(GRPH_YCC_BOFS_REG)
