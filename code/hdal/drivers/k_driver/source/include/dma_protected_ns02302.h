...
*/
#define         dma_getPhyAddr(addr)            ((((ULONG)(addr))>=0x300000000UL)?((ULONG)(addr)-0x300000000UL):(ULONG)(addr))
...
*/
#define         dma_getNonCacheAddr(addr)       ((((ULONG)(addr))<0x300000000UL)?((ULONG)(addr)+0x300000000UL):(ULONG)(addr))
...
*/
extern BOOL             dma_flushReadCacheWithoutCheck(uintptr_t uiStartAddr, UINT32 uiLength);
...
/*
    ...
    @return void
*/
extern void 			dma_flushReadCacheDmaEndWithoutCheck(uintptr_t uiStartAddr, UINT32 uiLength);
...
/*
    ...
    @return Use clean and invalidate data cache all or not (cpu_cleanInvalidateDCacheAll)
        ...
        - @b FALSE:  Not use cpu_cleanInvalidateDCacheAll
*/
extern BOOL             dma_flushWriteCacheWithoutCheck(uintptr_t uiStartAddr, UINT32 uiLength);
...
*/
extern BOOL             dma_flushReadCacheWidthNEQLineOffsetWithoutCheck(uintptr_t uiStartAddr, UINT32 uiLength);
