...
#define JPEGE_WIDTH_MIN				(16)
#define JPEGE_HEIGHT_MIN			(16)
#define JPEGE_WIDTH_MAX				(65520)
#define JPEGE_HEIGHT_MAX			(65520)
#define JPEGE_WIDTH_ALIGN			(16)
#define JPEGE_HEIGHT_ALIGN			(2)
#define JPEGE_COMP_WIDTH_ALIGN		(32)
#define JPEGE_COMP_HEIGHT_ALIGN		(2)
#define JPEGE_OSG_WIN_MAX_NUM		(10)
#define JPEGE_OSG_WIDTH_ALIGN		2
#define JPEGE_OSG_HEIGHT_ALIGN		2
#define JPEGE_OSG_X_ALIGN			2
#define JPEGE_OSG_Y_ALIGN			2
#define JPEGE_OSG_LONEOFFSET_ALIGN	4
#define JPEGE_OSG_TYPE_MASK			0x7D
#define JPEGE_OSG_PAL_MAX_NUM		(8)
#define JPEGE_INPUT_FORMAT			(KDRV_BUFTYPE_YUV420_SP)
