...
typedef enum {
    ...
    ADC_CONFIG_ID_DATA_AVG_CNT,
    ADC_CONFIG_ID_DATA_AVG_ID,
    ADC_CONFIG_ID_RST_SING_WIDE,    ///< Set ADC Reset pluse single hight wide during n clocks.
	ADC_CONFIG_ID_RST,              ///< Set ADC Reset pluse single 1/0.
	ADC_CONFIG_ID_PD,               ///< Set ADC PD Power down single 1/0.
...
/**
    ADC DATA average counts

    Definition ADC DATA average counts every output sample.

    @note Used in adc_setConfig(ADC_CONFIG_ID_DATA_AVG, ADC_DATA_AVG_2 ~ 128).
*/
typedef enum {
	ADC_DATA_AVG_2 = 0,    ///<   2 times average.
	ADC_DATA_AVG_4,        ///<   4 times average.
	ADC_DATA_AVG_8,        ///<   8 times average.
	ADC_DATA_AVG_16,       ///<  16 times average.
	ADC_DATA_AVG_32,       ///<  32 times average.
	ADC_DATA_AVG_64,       ///<  64 times average.
	ADC_DATA_AVG_128,      ///< 128 times average.
	ADC_DATA_AVG_256,      ///< 256 times average.
} ADC_THERMAL_AVG;
...
extern ER               adc_setPD(BOOL bEn);
extern BOOL             adc_getPD(void);
...
extern UINT32           adc_avg_read_data(void);
extern UINT32           adc_avg_read_voltage(void);
