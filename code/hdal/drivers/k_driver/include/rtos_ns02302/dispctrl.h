...
//  DISPCTRL_SRCCLK_IDE2_PLL12,
	...
	DISPCTRL_SRCCLK_DEFAULT = DISPCTRL_SRCCLK_PLL9,///< Default display source clock selection for realchip
	DISPCTRL_SRCCLK_IDE2_DEFAULT = DISPCTRL_SRCCLK_IDE2_PLL10,///< Default display source clock selection for realchip IDE2	
...
typedef enum {
	...
	DISPCTRL_SET_LINE_MON,                  ///< Set display LINE monitor
	DISPCTRL_SET_LINE_MON2,                 ///< Set display LINE monitor2
...
typedef struct {
	union {
		...
		*/
		...
		struct { // DISPCTRL_SET_LINE_MON
			UINT32           ui_line_idx1;    ///< The line monitor 1
			UINT32           ui_line_idx2;    ///< The line monitor 2
		} SET_LINE_MON;
		/* GET control group */
