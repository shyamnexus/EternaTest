...
#define SDIO_SRC_CLK_PLL6      18   ///< Source clock PLL9
#define SDIO_SRC_CLK_END       SDIO_SRC_CLK_PLL6
//@}
...
typedef enum {
	...
	SDIO_CONFIG_ID_MMC_FAST_BOOT,           ///< Enable MMC fast boot
	///< Context can be any of:
	///< - @b TRUE: enable MMC fast boot to skip any parameter update(e.x. clk rate, bus width, driving, ...)
	///< - @b FALSE: disable MMC fast boot
...
extern ER                       sdio_setConfig(SDIO_CONFIG_ID configID, uintptr_t configContext);
...
extern ER                       sdio2_setConfig(SDIO_CONFIG_ID configID, uintptr_t configContext);
...
extern ER                       sdio2_send_power_on_wp(UINT32 curr_sector, UINT32 num_sector);
extern UINT8                    sdio2_get_wp_status(UINT32 addr);
...
extern ER                       sdio3_setConfig(SDIO_CONFIG_ID configID, uintptr_t configContext);
