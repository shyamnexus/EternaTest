...
*/
#define dma_isCacheAddr(addr)           (((uintptr_t)(addr) > 0x80000000UL) ? FALSE : TRUE)
...
/**
    ...
    @return valid or not
        ...
        - @b FALSE  : Not valid
*/
#define dma_is_valid_addr(addr)         (((((uintptr_t)(addr))<0x80000000UL) || ((((uintptr_t)(addr))>=0x300000000UL) && (((uintptr_t)(addr))<0x380000000UL)))?       \
                                            ((addr)!=0?TRUE:FALSE)              \
                                            :FALSE)
...
*/
#define dma_getCacheAddr(addr)          ((((uintptr_t)(addr))>=0x300000000UL)?((uintptr_t)(addr)-0x300000000UL):(uintptr_t)(addr))
