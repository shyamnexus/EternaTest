...
#define NAND_SRC_CLK_480   (24000000)	// Y6 *2
#define NAND_SRC_CLK_PLL9  (6000000)	// Y6 *0.5
#define NAND_SRC_CLK_320   (12000000)	// Y6 *1
#define NAND_SRC_CLK_PLL4  (24000000)	// Y6 *2

#else
#define NAND_SRC_CLK       (480000000)

#define NAND_SRC_CLK_480   (480000000)
#define NAND_SRC_CLK_PLL9  (300000000)	// PLL9 default: 300MHz
#define NAND_SRC_CLK_320   (320000000)
#define NAND_SRC_CLK_PLL4  (384000000)	// PLL4 default: 384MHz
#endif
...
typedef enum {
	...
	NAND_CONFIG_ID_NOR_DTR_DUMMY,           ///< Set SPINOR DTR mode dummy cycle:
	///< Context is UINT32 value
...
typedef enum {
	...
	SPI_FLASH_BUSWIDTH_QUAD_TYPE5   = 0x200,            //< Support quad read (0xEB)
                                                        //< But QE should be modified by 0x31 command
	/* Read operation Dummy clock setting */
	SPI_FLASH_BUSWIDTH_QUAD_DUMMY_6CYCLES   = 0x1000,    //< Require  6 dummy cycles in quad DTR mode
	SPI_FLASH_BUSWIDTH_QUAD_DUMMY_8CYCLES   = 0x2000,    //< Require  8 dummy cycles in quad DTR mode
	SPI_FLASH_BUSWIDTH_QUAD_DUMMY_10CYCLES  = 0x4000,    //< Require 10 dummy cycles in quad DTR mode
	SPI_FLASH_BUSWIDTH_QUAD_DUMMY_16CYCLES  = 0x8000,    //< Require 16 dummy cycles in quad DTR mode

	SPI_FLASH_BUSWIDTH_SINGLG_DUMMY_4CYCLES = 0x10000,   //< Require  4 dummy cycles in single DTR mode
	SPI_FLASH_BUSWIDTH_SINGLG_DUMMY_8CYCLES = 0x20000,   //< Require  8 dummy cycles in single DTR mode

	SPI_FLASH_BUSWIDTH_OCTAL                = 0x100000,  //< Support Octal IO Type1, read cmd 0x7C(1-1-8) or 0xFD(1-8D-8D)

	SPI_FLASH_BUSWIDTH_OCTAL_TYPE2          = 0x200000,  //< Support Octal IO Type2, MXIC OPI mode
	                                                     //< 1-bit SPI write , 8-bit OPI read
