...
typedef enum {
	...
	///< @note  Valid value: 699 ~ 17,895 , unit: ms, resolution about: 699 ms. Default 699 ms
	///<        Actual expired time might longer than your setting.
	///<        Please call wdt_getConfig(WDT_CONFIG_ID_TIMEOUT) to confirm.

	WDT_CONFIG_ID_TIMEOUT_RST,	///< WDT expired time for WDT_MODE_INT2RESET
	///< @note  Valid value: 699 ~ 17,895 , unit: ms, resolution about: 699 ms. Default 699 ms
	///<        In WDT_MODE_INT2RESET, after interrupt is triggered, system will be reset after WDT_CONFIG_ID_TIMEOUT_RST expired.
	///<        Please call wdt_getConfig(WDT_CONFIG_ID_TIMEOUT_RST) to confirm.
...
extern void     wdt_platform_init(void);
//@}
