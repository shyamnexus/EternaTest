...
extern BOOL i2c_descpack_write(uintptr_t desc_buf_addr, UINT32 *current_index, UINT32 max_buf_size, UINT64 data);
extern BOOL i2c_descpack_delay_us(uintptr_t desc_buf_addr, UINT32 *current_index, UINT32 max_buf_size, UINT32 delay_us);
extern BOOL i2c_descpack_set(uintptr_t desc_buf_addr, UINT32 *current_index, UINT32 max_buf_size, UINT64 data);
extern BOOL i2c_descpack_poll(uintptr_t desc_buf_addr, UINT32 *current_index, UINT32 max_buf_size, UINT64 data, UINT32 delay_us, UINT32 retry);
extern BOOL i2c_descpack_end(uintptr_t desc_buf_addr, UINT32 *current_index, UINT32 max_buf_size);
