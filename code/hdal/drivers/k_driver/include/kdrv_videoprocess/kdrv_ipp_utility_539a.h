...
#define KDRV_PQ_UPDATE 1
#define DUAL_IPP (0)
#define FUNC_MOVE2PRE 1
#define ipp_tmp_block_539A 1
#define SHDR_3_FRAME (0)

#define PER_DRAM_CHK_TAG 0x5a5a5a50

typedef INT32(*KDRV_IPP_ISR_CB)(UINT32, UINT32, UINT32, void *, void *);

typedef enum{
  KDRV_IPP_BIND_MODE_IFE2IME = 0,
  KDRV_IPP_BIND_MODE_IFE2IPE,
  KDRV_IPP_BIND_MODE_PRE2IME,
  KDRV_IPP_BIND_MODE_PRE2IPE,
  KDRV_IPP_BIND_MODE_IME,
  KDRV_IPP_BIND_MODE_PRE,
  KDRV_IPP_BIND_MODE_UNKNOWN,
} KDRV_IPP_BIND_MODE;

typedef enum{
  KDRV_IPP_BIND_QUEUE_0 = 0,
  KDRV_IPP_BIND_QUEUE_1,
  KDRV_IPP_BIND_QUEUE_2,
  KDRV_IPP_BIND_QUEUE_UNKNOWN,
} KDRV_IPP_BIND_QUEUE;

typedef enum {
	KDRV_IPP_OPMODE_NONE = 0,	///< Engine not operate
	KDRV_IPP_OPMODE_D2D,	    ///< Engine D2D
	KDRV_IPP_OPMODE_IFE2IME,	///< IFE -> IPE -> IME
	KDRV_IPP_OPMODE_DCE2IME, 	///< DCE -> IPE -> IME  // not support
	KDRV_IPP_OPMODE_SIE2IME,	///< SIE -> PRE -> IFE -> IPE -> IME
	KDRV_IPP_OPMODE_IFE2IPE,	///< IFE -> IPE
	KDRV_IPP_OPMODE_SIE2PRE,    ///< SIE -> PRE
    KDRV_IPP_OPMODE_PRE2IME,    ///< PRE->IFE->IPE->IME
    KDRV_IPP_OPMODE_PRE2IPE,    ///< PRE -> IFE -> IPE
	KDRV_IPP_OPMODE_MAX
} KDRV_IPP_OPMODE;
...
typedef enum {
	...
	KDRV_IPP_FMT_YUV420_MB2         = 0x510cc420, ///< 1 plane, 16x2 macro block format
	KDRV_IPP_FMT_YUV420_MB4         = 0x520ce420, ///< 2 plane, pixel=Y(w,h), UV(w/2,h/2), 32x8 macro block format
	...
	KDRV_IPP_FMT_YUV420_NVX5		= 0x610c5420, ///< novatek-yuv-compress-5 of YUV420 for VPE (using by NA51102)
...
typedef enum{
	KDRV_IPP_PXLFMT_RGGB              = 0x0100,
	KDRV_IPP_PXLFMT_RGGB_R            = 0x0100,
	KDRV_IPP_PXLFMT_RGGB_GR           = 0x0101,
	KDRV_IPP_PXLFMT_RGGB_GB           = 0x0102,
	KDRV_IPP_PXLFMT_RGGB_B            = 0x0103,
	KDRV_IPP_PXLFMT_RCCB              = 0x0200,
	KDRV_IPP_PXLFMT_RCCB_RC           = 0x0200,
	KDRV_IPP_PXLFMT_RCCB_CR           = 0x0201,
	KDRV_IPP_PXLFMT_RCCB_CB           = 0x0202,
	KDRV_IPP_PXLFMT_RCCB_BC           = 0x0203,
	KDRV_IPP_PXLFMT_RGBIR             = 0x0300,
	KDRV_IPP_PXLFMT_RGBIR_RIR         = 0x0300,
	KDRV_IPP_PXLFMT_RGBIR_RG          = 0x0301,
	KDRV_IPP_PXLFMT_RGBIR44           = 0x0400,
	KDRV_IPP_PXLFMT_RGBIR44_RGBG_GIGI = 0x0400,
	KDRV_IPP_PXLFMT_RGBIR44_GBGR_IGIG = 0x0401,
	KDRV_IPP_PXLFMT_RGBIR44_GIGI_BGRG = 0x0402,
	KDRV_IPP_PXLFMT_RGBIR44_IGIG_GRGB = 0x0403,
	KDRV_IPP_PXLFMT_RGBIR44_BGRG_GIGI = 0x0404,
	KDRV_IPP_PXLFMT_RGBIR44_GRGB_IGIG = 0x0405,
	KDRV_IPP_PXLFMT_RGBIR44_GIGI_RGBG = 0x0406,
	KDRV_IPP_PXLFMT_RGBIR44_IGIG_GBGR = 0x0407,
	KDRV_IPP_PXLFMT_PACK_LSB          = 0x0800,
	KDRV_IPP_PXLFMT_YCC_FULL          = 0x0000,
	KDRV_IPP_PXLFMT_YCC_BT601         = 0x1000,
	KDRV_IPP_PXLFMT_YCC_BT709         = 0x2000,
}KDRV_IPP_PXLFMT;
...
typedef struct {
	KDRV_IPP_FMT fmt;
	KDRV_IPP_PXLFMT pxl_fmt;
	USIZE size;
	ULONG addr[KDRV_IPP_PLANE];
	ULONG phyaddr[KDRV_IPP_PLANE];
	ULONG addr_ofs[KDRV_IPP_PLANE]; //538 not support
