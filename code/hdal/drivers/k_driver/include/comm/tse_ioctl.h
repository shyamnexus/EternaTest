...
// IOCTL command
//============================================================================
#define TSE_IOC_COMMON_TYPE 'M'
#define TSE_IOC_START                   _IO(TSE_IOC_COMMON_TYPE, 1)
#define TSE_IOC_STOP                    _IO(TSE_IOC_COMMON_TYPE, 2)

#define TSE_IOC_READ_REG                _IOWR(TSE_IOC_COMMON_TYPE, 3, void*)
#define TSE_IOC_WRITE_REG               _IOWR(TSE_IOC_COMMON_TYPE, 4, void*)
#define TSE_IOC_READ_REG_LIST           _IOWR(TSE_IOC_COMMON_TYPE, 5, void*)
#define TSE_IOC_WRITE_REG_LIST          _IOWR(STS_IOC_COMMON_TYPE, 6, void*)
