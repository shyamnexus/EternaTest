...
#define TSE_LIMIT_ADDR	0x40000000 // NA51102-2110
#if defined (__FREERTOS)
#if defined(__aarch64__)
#define TSEDATA_TYPE	UINT64
#else
#define TSEDATA_TYPE	UINT32
#endif
#else
#define TSEDATA_TYPE	UINT64
#endif
...
extern ER tse_setConfig(TSE_CFG_ID CfgID, TSEDATA_TYPE uiCfgValue);
extern TSEDATA_TYPE tse_getConfig(TSE_CFG_ID CfgID);
