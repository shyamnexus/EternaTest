...
*/
//@{
#define LDCF_UPDATE_FW      0x0000001 ///< BIT 00.UPDATE_FW (0=no,1=yes)
#define LDCF_UPDATE_LD      0x0000002 ///< BIT 01.UPDATE_LD (0=no,1=yes)
#define LDCF_BOOT_CARD      0x0000004 ///< BIT 02.BOOT_CARD (0=no,1=yes)
#define LDCF_BOOT_FLASH     0x0000008 ///< BIT 03.BOOT_FLASH (0=no,1=yes)
#define LDCF_UPDATE_CAL     0x0000010 ///< BIT 04.UPDATE_CAL (0=no,1=yes)
#define LDCF_UPDATE_FW_DONE 0x0000100 ///< BIT 08.UPDATE_FW_DONE (0=no,1=yes)
#define LDCF_S3_BOOT        0x0000200 ///< BIT 09.BOOT FROM S3 STATE (0=no,1=yes)
...
typedef struct _BOOTINFO {
	...
	///<        BIT 00.UPDATE_FW (0=no,1=yes)
	///<        BIT 01.UPDATE_LOADER (0=no,1=yes)
	///<        BIT 02.BOOT_CARD (0=no,1=yes)
	///<        BIT 03.BOOT_FLASH (0=no,1=yes)
	///<        BIT 04.UPDATE_CAL (0=no,1=yes)
	///<        BIT 08.UPDATE_FW_DONE (0=no,1=yes)
	///<        BIT 09.BOOT FROM S3 STATE (0=no,1=yes)
	///<        BIT 10.BOOT WITH FLASH DTR-80 SUPPORT (0=no,1=yes)
