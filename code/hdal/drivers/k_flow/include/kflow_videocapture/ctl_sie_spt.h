...
*/
typedef enum {
	CTL_SIE_SPT_BAYER_8         = (1UL << CTL_SIE_BAYER_8),       // 0x1
	CTL_SIE_SPT_BAYER_10        = (1UL << CTL_SIE_BAYER_10),      // 0x2
	CTL_SIE_SPT_BAYER_12        = (1UL << CTL_SIE_BAYER_12),      // 0x4
	CTL_SIE_SPT_BAYER_16        = (1UL << CTL_SIE_BAYER_16),      // 0x8
	CTL_SIE_SPT_BAYER_16_MSB    = (1UL << CTL_SIE_BAYER_16_MSB),  // 0x8
	CTL_SIE_SPT_BAYER_16_LSB    = (1UL << CTL_SIE_BAYER_16_LSB),  // 0x10
	CTL_SIE_SPT_Y_8             = (1UL << CTL_SIE_Y_8),
	CTL_SIE_SPT_DATAFORMAT_ALL  = (CTL_SIE_SPT_BAYER_8 | CTL_SIE_SPT_BAYER_10 | CTL_SIE_SPT_BAYER_12 | CTL_SIE_SPT_BAYER_16 | CTL_SIE_SPT_BAYER_16_LSB | CTL_SIE_SPT_Y_8),
...
typedef enum {
	...
	CTL_SIE_FUNC_SPT_DVI            = 0x00000004, ///< N.S.
...
typedef enum {
	...
	CTL_SIE_SPT_ITEM_LIMIT,             // data_type: CTL_SIE_LIMIT
