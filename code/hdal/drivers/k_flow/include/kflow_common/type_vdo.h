...
#define VDO_DATA_DESC_SIZE  64 ///< size of data desc in WORDS
#else
#define VDO_DATA_DESC_SIZE  46 ///< size of data desc in WORDS
#endif
...
typedef enum _VDO_PXLFMT
{
	...
	VDO_PXLFMT_BGR888			= 0x21280888, ///< 1 plane, pixel=BGR(w,h)
	...
	VDO_PXLFMT_YVU420			= 0x520d0420, ///< 2 plane, pixel=Y(w,h), VU(w/2,h/2)
	VDO_PXLFMT_YUV420_LEGACY    = 0x51100420, ///< 1 plane, YYUYYV(w,h), packed format with Y4U1V1
	...
	VDO_PXLFMT_YUV420_MB2       = 0x510cc420, ///< 1 plane, 16x2 macro block format
	VDO_PXLFMT_YUV420_MB3       = 0x510cd420, ///< 1 plane, 1 plane, pixel=Y(w,h), UV(w/2,h/2), semi-planer format 8x4
	VDO_PXLFMT_YUV420_MB4       = 0x520ce420, ///< 2 plane, pixel=Y(w,h), UV(w/2,h/2), 32x8 macro block format
	VDO_PXLFMT_YUV420_MB5       = 0x520cf420, ///< 2 plane, pixel=Y(w,h), UV(w/2,h/2), wx1 macro block format
	...
	VDO_PXLFMT_YUV420_NVX3      = 0x610c3420, ///< novatek-yuv-compress-3 of YUV420
	VDO_PXLFMT_YUV420_NVX4      = 0x610c4420, ///< novatek-yuv-compress-4 of YUV420 for h264/h265 LLC_8x4
	VDO_PXLFMT_YUV420_NVX5		= 0x610c5420, ///< novatek-yuv-compress-5 of YUV420 for VPE (using by NA51102)
	VDO_PXLFMT_YUV420_NVX6      = 0x610c6420, ///< novatek-yuv-compress-6 of YUV420 YCC for IDE
	VDO_PXLFMT_YUV422_NVX3      = 0x61103422, ///< novatek-yuv-compress-3 of YUV422
...
typedef struct _VDO_FRAME {
	...
	ULONG  addr[VDO_MAX_PLANE];     ///< address of each plane
	ULONG  phyaddr[VDO_MAX_PLANE];	///< physical address of each plane
	ULONG  reserved[8];			///< reserved info
	UINT32 reserved_32[8];      ///< reserved info u32
...
STATIC_ASSERT(sizeof(VDO_AIDED_MAP_INFO) <= 0x100);
...
/**
     @name resv1 of video
*/
#define VDO_DDR_ID_SHIFT            0
#define VDO_DDR_ID_MASK             0x000f

#define VDO_IPP_DIRECT_SHIFT        4
#define VDO_IPP_DIRECT_MASK         0x00f0

#define VDO_MULTI_FRAME_SHIFT       8
#define VDO_MULTI_FRAME_MASK        0x0f00

#define VDO_PIX_YCC_SHIFT           12
#define VDO_PIX_YCC_MASK            0xf000
#define VDO_PIX_YCC_FULL            0x0000
#define VDO_PIX_YCC_BT601           0x1000
#define VDO_PIX_YCC_BT709           0x2000
