...
#define AUD_DATA_DESC_SIZE  64 ///< size of data desc in WORDS
#else
#define AUD_DATA_DESC_SIZE  46 ///< size of data desc in WORDS
#endif
...
typedef struct _AUD_FRAME {
	...
	ULONG           addr[2];       ///< address of each channel
	ULONG           phyaddr[2];    ///< physical address of each channel
	...
	ULONG           reserved[12];  ///< reserved ulong
