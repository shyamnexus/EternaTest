...
#include "kdrv_audioio/kdrv_audio_lmt.h"
#include "kdrv_type.h"
...
#define AUDIO_RX_CACHE_SYNC              1
#define AUDIO_TX_CACHE_SYNC              1


#if defined(_BSP_NA51102_)
#define WAV_DEV_ENGINE_PLAY     KDRV_AUDOUT_ENGINE0             ///<< Play
#define WAV_DEV_ENGINE_PLAY2    KDRV_AUDOUT_ENGINE0_TX2         ///<< Play2
#define WAV_DEV_ENGINE_PLAY3    KDRV_AUDOUT_ENGINE1             ///<< Play3
#define WAV_DEV_ENGINE_REC      KDRV_AUDCAP_ENGINE0             ///<< Record
#define WAV_DEV_ENGINE_LB       KDRV_AUDCAP_ENGINE0_LOOPBACK    ///<< Loopback
#define WAV_DEV_ENGINE_REC3     KDRV_AUDCAP_ENGINE1             ///<< Record3
#define WAV_DEV_HANDLE_PLAY     KDRV_AUD_HANDLE_DAI0_TX         ///<< Play
#define WAV_DEV_HANDLE_PLAY2    KDRV_AUD_HANDLE_DAI0_TX2        ///<< Play2
#define WAV_DEV_HANDLE_PLAY3    KDRV_AUD_HANDLE_DAI1_TX         ///<< Play3
#define WAV_DEV_HANDLE_REC      KDRV_AUD_HANDLE_DAI0_RX         ///<< Record
#define WAV_DEV_HANDLE_LB       KDRV_AUD_HANDLE_DAI0_TXLB       ///<< Loopback
#define WAV_DEV_HANDLE_REC3     KDRV_AUD_HANDLE_DAI1_RX         ///<< Record3
#elif defined(_BSP_NS02201_)
#define WAV_DEV_ENGINE_PLAY     KDRV_AUDOUT_ENGINE2             ///<< Play
#define WAV_DEV_ENGINE_PLAY2    KDRV_AUDOUT_ENGINE2_TX2         ///<< Play2
#define WAV_DEV_ENGINE_PLAY3    KDRV_AUDOUT_ENGINE3             ///<< Play3
#define WAV_DEV_ENGINE_PLAY4    KDRV_AUDOUT_ENGINE0             ///<< Play4
#define WAV_DEV_ENGINE_PLAY5    KDRV_AUDOUT_ENGINE1             ///<< Play5
#define WAV_DEV_ENGINE_PLAY6    KDRV_AUDOUT_ENGINEHDMI          ///<< Play6
#define WAV_DEV_ENGINE_REC      KDRV_AUDCAP_ENGINE2             ///<< Record
#define WAV_DEV_ENGINE_LB       KDRV_AUDCAP_ENGINE2_LOOPBACK    ///<< Loopback
#define WAV_DEV_ENGINE_REC3     KDRV_AUDCAP_ENGINE3             ///<< Record3
#define WAV_DEV_ENGINE_LB3      KDRV_AUDCAP_ENGINE3_LOOPBACK    ///<< Loopback3
#define WAV_DEV_ENGINE_REC4     KDRV_AUDCAP_ENGINE0             ///<< Record4
#define WAV_DEV_ENGINE_LB4      KDRV_AUDCAP_ENGINE0_LOOPBACK    ///<< Loopback4
#define WAV_DEV_ENGINE_REC5     KDRV_AUDCAP_ENGINE1             ///<< Record5
#define WAV_DEV_ENGINE_LB5      KDRV_AUDCAP_ENGINE1_LOOPBACK    ///<< Loopback5
#define WAV_DEV_HANDLE_PLAY     KDRV_AUD_HANDLE_DAI2_TX         ///<< Play
#define WAV_DEV_HANDLE_PLAY2    KDRV_AUD_HANDLE_DAI2_TX2        ///<< Play2
#define WAV_DEV_HANDLE_PLAY3    KDRV_AUD_HANDLE_DAI3_TX         ///<< Play3
#define WAV_DEV_HANDLE_PLAY4    KDRV_AUD_HANDLE_DAI0_TX         ///<< Play4
#define WAV_DEV_HANDLE_PLAY5    KDRV_AUD_HANDLE_DAI1_TX         ///<< Play5
#define WAV_DEV_HANDLE_PLAY6    KDRV_AUD_HANDLE_DAIHDMI_TX      ///<< Play6
#define WAV_DEV_HANDLE_REC      KDRV_AUD_HANDLE_DAI2_RX         ///<< Record
#define WAV_DEV_HANDLE_LB       KDRV_AUD_HANDLE_DAI2_TXLB       ///<< Loopback
#define WAV_DEV_HANDLE_REC3     KDRV_AUD_HANDLE_DAI3_RX         ///<< Record3
#define WAV_DEV_HANDLE_LB3      KDRV_AUD_HANDLE_DAI3_TXLB       ///<< Loopback3
#define WAV_DEV_HANDLE_REC4     KDRV_AUD_HANDLE_DAI0_RX         ///<< Record4
#define WAV_DEV_HANDLE_LB4      KDRV_AUD_HANDLE_DAI0_TXLB       ///<< Loopback4
#define WAV_DEV_HANDLE_REC5     KDRV_AUD_HANDLE_DAI1_RX         ///<< Record5
#define WAV_DEV_HANDLE_LB5      KDRV_AUD_HANDLE_DAI1_TXLB       ///<< Loopback5
#else //defined(_BSP_NA51055_) , defined(_BSP_NA51089_) , defined(_BSP_NS02301_) , defined(_BSP_NS02302_)
#define WAV_DEV_ENGINE_PLAY     KDRV_AUDOUT_ENGINE0             ///<< Play
#define WAV_DEV_ENGINE_PLAY2    KDRV_AUDOUT_ENGINE0_TX2         ///<< Play2
#define WAV_DEV_ENGINE_REC      KDRV_AUDCAP_ENGINE0             ///<< Record
#define WAV_DEV_ENGINE_LB       KDRV_AUDCAP_ENGINE0_LOOPBACK    ///<< Loopback
...
typedef struct _AUDIO_BUF_QUEUE {
	ULONG                   uiAddress;  ///< Buffer Starting Address (Unit: byte) (Word alignment)
...
typedef enum _WAVSTUD_CFG {
	...
	WAVSTUD_CFG_HDMI_EN,
	WAVSTUD_CFG_GET_DEVICE_ID,
	WAVSTUD_CFG_VOL_P0 = 0x1000,        ///< Volume 0
...
typedef enum _WAVSTUD_ACT {
	...
	//	WAVSTUD_ACT_PLAY5,
	//	WAVSTUD_ACT_PLAY6,
	WAVSTUD_ACT_REC,                    ///< Record
	WAVSTUD_ACT_REC2,
	//	WAVSTUD_ACT_REC3,
	//	WAVSTUD_ACT_REC4,
	//	WAVSTUD_ACT_REC5,
	WAVSTUD_ACT_LB,                     ///< Loopback
	WAVSTUD_ACT_LB2,
	//	WAVSTUD_ACT_LB3,
	//	WAVSTUD_ACT_LB4,
	//	WAVSTUD_ACT_LB5,
...
typedef struct _WAVSTUD_MEM {
	ULONG  uiAddr;                      ///< Start Memory Address (va)
	UINT32 uiSize;                      ///< Start Memory Size
	ULONG  uiPAddr;                     ///< Start Memory Address (pa)
...
typedef void (*WAVSTUD_FILTCB)(ULONG inaddr, ULONG outaddr, UINT32 length);
...
typedef enum _WAVSTUD_BITS_PER_SAM {
	...
	WAVSTUD_BITS_PER_SAM_32 = 0x20,     ///< 32 bits PCM (extcodec)
...
typedef struct _WAVSTUD_AUD_KDRV_INFO {
	KDRV_DEV_CHIP chip;
	KDRV_DEV_ENGINE engine;
	KDRV_AUD_HANDLE handle;
	KDRV_AUDIO_TRIGGER_TYPE type;
} WAVSTUD_AUD_KDRV_INFO;
...
*/
extern UINT32 wavstudio_set_config(WAVSTUD_CFG cfg, ULONG p1, ULONG p2);
...
*/
extern UINT32 wavstudio_get_config(WAVSTUD_CFG cfg, ULONG p1, ULONG p2);
...
*/
extern BOOL wavstudio_push_buf_to_queue(ULONG addr, UINT32 *size);

extern BOOL wavstudio_push_buf_to_queue2(ULONG addr, UINT32 *size);

extern UINT32 wavstudio_get_remain_buf(WAVSTUD_ACT act_type);

extern UINT32 wavstudio_get_remain_buf2(WAVSTUD_ACT act_type);

extern void wavstudio_dump_module_info(WAVSTUD_ACT act_type, int (*dump)(const char *fmt, ...));
