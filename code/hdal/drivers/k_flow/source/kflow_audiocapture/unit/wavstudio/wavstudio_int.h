...
#define wavstudio_dbg_func(fmt, args...) { if (wavstudio_debug_level >= NVT_DBG_FUNC) { DBG_FUNC(fmt, ##args);  } }
#define wavstudio_dbg_ind(fmt, args...) { if (wavstudio_debug_level >= NVT_DBG_IND) { DBG_IND(fmt, ##args);  } }
...
#if LOG_BUFFER
#define WAVSTUD_ERR(fmt, args...) \
	{printm2("[wavstud]ERR: "   fmt , ##args);    \
	DBG_ERR(fmt, ##args);}
#define WAVSTUD_WRN(fmt, args...) \
	{printm2("[wavstud]WRN: "   fmt , ##args);    \
	DBG_WRN(fmt, ##args);}
#define WAVSTUD_DUMP(fmt, args...) \
	{printm2("[wavstud] "   fmt , ##args);    \
	DBG_DUMP(fmt, ##args);}
#else
#define WAVSTUD_ERR(fmt, args...) \
	{DBG_ERR(fmt, ##args);}
...
#define WAVSTUD_PLAY3_CB(p1, p2)   {if (gWavStudObj.pWavStudCB[WAVSTUD_ACT_PLAY3]){gWavStudObj.pWavStudCB[WAVSTUD_ACT_PLAY3](WAVSTUD_ACT_PLAY3, p1, p2);}}
#endif
#define WAVSTUD_PLAY_CB(p1, p2)   {if (gWavStudObj.pWavStudCB[WAVSTUD_ACT_PLAY]){gWavStudObj.pWavStudCB[WAVSTUD_ACT_PLAY](WAVSTUD_ACT_PLAY, p1, p2);}}
#define WAVSTUD_PLAY2_CB(p1, p2)   {if (gWavStudObj.pWavStudCB[WAVSTUD_ACT_PLAY2]){gWavStudObj.pWavStudCB[WAVSTUD_ACT_PLAY2](WAVSTUD_ACT_PLAY2, p1, p2);}}
#define WAVSTUD_REC_CB(p1, p2)    {if (gWavStudObj.pWavStudCB[WAVSTUD_ACT_REC]){gWavStudObj.pWavStudCB[WAVSTUD_ACT_REC](WAVSTUD_ACT_REC, p1, p2);}}
...
#define WAVSTUD_ALIGN_MUTI_CH_BUF       ENABLE
...
#define WAVMEM_VIRT2PHY(act_type, virt_addr) (gWavStudObj.actObj[act_type].mem.uiPAddr + (virt_addr - gWavStudObj.actObj[act_type].mem.uiAddr))
...
extern UINT32 WavStud_AddrToIdx(WAVSTUD_ACT actType, ULONG addr);

extern THREAD_DECLARE(WavStudio_RecordUpdateTsk, arglist);

extern UINT64 wavstudio_do_div(UINT64 dividend, UINT64 divisor);

extern UINT32 WavStud_GetTmpSize(AUDIO_SR audSR, UINT32 ch_num, WAVSTUD_BITS_PER_SAM bps, UINT32 sample_cnt);
...
extern void WavStud_UnlockQ(WAVSTUD_ACT actType, ULONG Addr);
...
extern int wavstudio_ctl_aud_chk_ver(void);
extern int wavstudio_api_chk_ver(void);
extern int wavstudio_inf_chk_ver(void);
extern int wavstudio_playtsk_chk_ver(void);
extern int wavstudio_playtsk2_chk_ver(void);
extern int wavstudio_recordtsk_chk_ver(void);
extern int wavstudio_util_chk_ver(void);
