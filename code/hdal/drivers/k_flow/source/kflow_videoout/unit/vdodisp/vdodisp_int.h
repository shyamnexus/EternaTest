...
#define THIS_DBGLVL         NVT_VDOOUT_DBG_WRN
...
#define VDOOUT_DBG_DUMP_VD           FLGPTN_BIT(1)   //dump vd
...
typedef struct _VDODISP_DBGINFO {
	...
	uintptr_t       last_caller_addr;  ///< last command caller address
...
ULONG           x_vdodisp_get_addr(void *io_addr);
