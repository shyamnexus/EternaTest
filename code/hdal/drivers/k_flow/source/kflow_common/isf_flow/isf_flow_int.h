...
#define _ATOI(str,pint32)  	    { int ret = kstrtoint((char*)str, 16, (int*)(pint32)); if (ret < 0) *pint32 = 0;}
...
extern void _isf_unit_debug_new(ISF_UNIT *p_thisunit, UINT32 nport, ISF_DATA *p_data, ULONG addr, UINT32 size, UINT32 probe);
