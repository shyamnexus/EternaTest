...
typedef struct NVTMPP_HEAP_LINK {
	...
	uintptr_t block_addr;           ///<  The block physical address.
	uintptr_t block_va;             ///<  The block virtual address.
...
extern BOOL  nvtmpp_heap_chk_addr_valid(uintptr_t addr);
