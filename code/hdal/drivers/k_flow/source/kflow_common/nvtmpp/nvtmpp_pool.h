...
typedef struct _NVTMPP_VB_POOL_S {
	...
	uintptr_t                   pool_addr;                              ///< pool physical address
	uintptr_t                   pool_va;                                ///< pool virtual address
...
extern void               nvtmpp_vb_pool_set_struct_range(uintptr_t start_addr, UINT32 size);
...
//extern BOOL               nvtmpp_vb_pool_chk_valid(uintptr_t pool_addr);
extern void               nvtmpp_vb_pool_set_dump_max_cnt(NVTMPP_VB_POOL_S *p_pool, UINT32 dump_max_cnt);

extern NVTMPP_VB_POOL_S  *nvtmpp_vb_get_free_pool(NVTMPP_VB_POOL_S  *vb_pools, UINT32 total_pools_cnt, UINT32 *pool_id);
