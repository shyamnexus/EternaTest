...
EXPORT_SYMBOL(gximg_init_buf_conv);
...
EXPORT_SYMBOL(gximg_line_with_flush);
EXPORT_SYMBOL(gximg_fill_data_no_flush);
EXPORT_SYMBOL(gximg_setup_copy_request);
EXPORT_SYMBOL(gximg_execute_request);
EXPORT_SYMBOL(gximg_arithmetic);
EXPORT_SYMBOL(gximg_set_force_no_flush);
EXPORT_SYMBOL(gximg_get_force_no_flush);
