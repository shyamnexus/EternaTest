...
typedef struct {
	...
	UINT32                      uiBgWidth;                              ///< Background width (codec parsing return)
	UINT32                      uiBgHeight;                             ///< Background height (codec parsing return)
	...
	uintptr_t                   uiDescAddr;                             ///< Desc addr
	UINT32                      uiDescSize;                             ///< Desc len
	uintptr_t                   uiDecoderBufAddr;                       ///< Buf addr of dec driver
	UINT32                      uiDecoderBufSize;                       ///< Buf size of dec driver
	UINT32                      uiGOPNumber;                            ///< Gop
	UINT32                      uiFrameRate;                            ///< Framerate
	uintptr_t                   uiRawStartAddr;                         ///< RAW data buffer start address
...
typedef struct {
	...
	PMP_VDODEC_H26X_DECODER     pMpH26xVideoDecoder;                     ///< Media Plug-in H26x object pointer
...
#endif
extern void     nmp_vdodec_decinfo(UINT32 pathID, int (*dump)(const char *fmt, ...));
extern ER       NMP_VdoDec_PutQ(UINT32 pathID, NMI_VDODEC_BS_INFO *pBsInfo);
