...
*/
#ifndef _ISF_VDODEC_INTERNAL_H
#define _ISF_VDODEC_INTERNAL_H
...
#if LOG_BUFFER
#define VDODEC_DBG_ERR(fmt, args...) \
	{printm2(fmt, ##args);    \
	DBG_ERR(fmt, ##args);}
#define VDODEC_DBG_WRN(fmt, args...) \
	{printm2(fmt, ##args);    \
	DBG_WRN(fmt, ##args);}
#define VDODEC_DBG_DUMP(fmt, args...) \
	{printm2(fmt, ##args);    \
	DBG_DUMP(fmt, ##args);}
#else
#define VDODEC_DBG_ERR(fmt, args...) \
...
#define ISF_VDODEC_IN_NUM           32
#define ISF_VDODEC_OUT_NUM          32
...
extern ISF_RV ISF_VdoDec_InputPort_PushImgBufToDest(ISF_PORT *pPort, ISF_DATA *pData, INT32 nWaitMs);

#endif//_ISF_VDODEC_INTERNAL_H
