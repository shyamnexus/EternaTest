...
#if defined(_BSP_NA51102_) || defined(_BSP_NS02302_) || defined(_BSP_NS02402_)
extern PMP_VDODEC_H26X_DECODER MP_H264Dec_getVideoObject(MP_VDODEC_ID VidDecId);
// for backward compatible
extern PMP_VDODEC_H26X_DECODER MP_H264Dec_getVideoDecodeObject(void);
#else
