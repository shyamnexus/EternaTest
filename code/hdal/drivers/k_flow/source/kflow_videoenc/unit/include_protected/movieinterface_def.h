...
typedef struct {
	uintptr_t           uiMemAddr;          ///< starting address for recording
	...
	UINT8               rev;
	uintptr_t           uiUserDataAddr;
	UINT32              uiUserDataSize;
	UINT32              uiTargetFramesize;
	uintptr_t           uiAudioBufferAddr;
...
typedef struct {
	...
	uintptr_t RawYAddr;        ///< thisBS Y address
...
typedef struct {
	uintptr_t Yaddr;             ///< y addr
	uintptr_t UVaddr;            ///< uv addr
...
typedef struct {
	uintptr_t     bsOutAddr;           //in: bitstream address
