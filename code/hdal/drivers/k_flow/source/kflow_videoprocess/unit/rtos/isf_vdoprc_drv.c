...
int kflow_videoproc_init(void)
{
	...
	isf_reg_unit(ISF_UNIT(VDOPRC,16), &isf_vdoprc16);
#endif
#if (VDOPRC_MAX_NUM > 17)
	isf_reg_unit(ISF_UNIT(VDOPRC,17), &isf_vdoprc17);
#endif
#if (VDOPRC_MAX_NUM > 18)
	isf_reg_unit(ISF_UNIT(VDOPRC,18), &isf_vdoprc18);
#endif
#if (VDOPRC_MAX_NUM > 19)
	isf_reg_unit(ISF_UNIT(VDOPRC,19), &isf_vdoprc19);
#endif
