...
typedef struct {
	...
	ULONG                       uiRawStartAddr;					///< RAW data buffer start address
...
typedef void (NMI_AUDDEC_CB)(UINT32 event, ULONG param);
...
extern void nmr_auddec_dump_info(UINT32 pathID, int (*dump)(const char *fmt, ...));
