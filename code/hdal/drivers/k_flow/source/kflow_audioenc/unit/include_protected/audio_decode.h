...
*/
typedef struct {
	ULONG  outRawAddr;                        ///< [out] Audio raw address
...
typedef struct {
	...
	ER(*GetInfo)(MP_AUDDEC_GETINFO_TYPE type, ULONG *pparam1, ULONG *pparam2, ULONG *pparam3);  ///< get information from decoder
	ER(*SetInfo)(MP_AUDDEC_SETINFO_TYPE type, ULONG param1, ULONG param2, ULONG param3);        ///< set information to decoder
	ER(*DecodeOne)(UINT32 type, ULONG BsAddr, UINT32 BsSize);                          ///< decode one frame
