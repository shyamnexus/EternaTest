...
#define NMR_AUDENC_MSG_ENCTIME     			BIT(0)   //0x00000001
#define NMR_AUDENC_MSG_RING_BUF				BIT(6)   //0x00000040
...
typedef struct {
	...
	ULONG                           uiBSStart;          //in: start address of audio BS data
	ULONG                       	uiBSEnd;            //in: end address of audio BS data
	ULONG                           uiBSMax;            //in: max address of audio BS data
	ULONG                           uiPrevBSAddr;       //out: previous AAC Bit-stream address
	ULONG                           uiLastLeftAddr;     //out: last g.711 addr (for g.711 fix sample)
