...
typedef struct _AUDOUT_CONTEXT_DEV {
	...
	AUDOUT_OUTPUT g_isf_audout_outdev;
} AUDOUT_CONTEXT_DEV;
...
extern UINT32 g_audout_init[ISF_FLOW_MAX];

extern ISF_RV _isf_audout_bindinput(struct _ISF_UNIT *p_thisunit, UINT32 iport, struct _ISF_UNIT *p_srcunit, UINT32 oport);
extern ISF_RV _isf_audout_setportparam(UINT32 id, ISF_UNIT  *p_thisunit, UINT32 nport, UINT32 param, ULONG value);
extern ULONG _isf_audout_getportparam(UINT32 id, ISF_UNIT *p_thisunit, UINT32 nport, UINT32 param);
extern ISF_RV _isf_audout_setportstruct(UINT32 id, struct _ISF_UNIT *p_thisunit, UINT32 nport, UINT32 param, ULONG* p_struct, UINT32 size);
extern ISF_RV _isf_audout_getportstruct(UINT32 id, struct _ISF_UNIT *p_thisunit, UINT32 nport, UINT32 param, ULONG* p_struct, UINT32 size);
