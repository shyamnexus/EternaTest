...
#define SIE_EVENT_ROOT_MAX		12
#define SIE_EVENT_ENTRY_MAX		4
...
/**
     ...
     @return Description of data returned.
		- @b 0:	open fail
*/
extern ULONG sie_event_open(CHAR *name);
...
/**
     ...
     @return Description of data returned.
		...
		- @b SIE_EVENT_NG: fail
*/
extern UINT32 sie_event_close(ULONG handle);
...
/**
     ...
     @return Description of data returned.
		...
		- @b SIE_EVENT_NG: fail
*/
extern UINT32 sie_event_register(ULONG handle, UINT32 event, CTL_SIE_EVENT_FP fp, CHAR *name);
...
/**
     ...
     @return Description of data returned.
		...
		- @b SIE_EVENT_NG: fail
*/
extern UINT32 sie_event_unregister(ULONG handle, UINT32 event, CTL_SIE_EVENT_FP fp);
...
/**
     ...
     @return Description of data returned.
		...
		- @b SIE_EVENT_NG: fail
*/
extern INT32 sie_event_proc(ULONG handle, UINT32 event, void *p_in, void *p_out);
...
/**
     ...
     @return Description of data returned.
		...
		- @b SIE_EVENT_NG: fail
*/
extern INT32 sie_event_proc_isr(ULONG handle, UINT32 event, void *p_in, void *p_out);
