...
#define KFLOW_SIE_BUF_FLAG 0x5a5a5a50
#define KFLOW_SIE_DMA_WP_ALIGN 	0x100 //530 dma wp need 64 word align
...
#define CTL_SIE_BUF_MSG_SW_RST      		0x00000008  //[0]: buf_io_fp, [1]: id
#define CTL_SIE_BUF_MSG_GET_GYRO    		0x00000010  //[0]: buf_io_fp, [1]: raw header address, [2]: reserve
#define CTL_SIE_BUF_MSG_DIRECT_PUSH_GYRO    0x00000020  //[0]: buf_io_fp, [1]: raw header address, [2]: reserve, direct mode push gyro data out and unlock buffer
...
INT32 ctl_sie_buf_msg_snd(UINT32 cmd, ULONG p1, ULONG p2, ULONG p3);
INT32 ctl_sie_buf_msg_rcv(UINT32 *cmd, ULONG *p1, ULONG *p2, ULONG *p3);
...
void ctl_sie_buf_update_out_size(CTL_SIE_HDL *ctrl_hdl, BOOL force_update);
void ctl_sie_buf_io_cfg(UINT32 id, CTL_SIE_BUF_IO_CFG io_cfg, UINT32 req_size, ULONG sie_header_addr);
UINT32 ctl_sie_buf_get_ca_out_size(CTL_SIE_ID id);
UINT32 ctl_sie_buf_get_la_out_size(CTL_SIE_ID id);
UINT32 ctl_sie_buf_get_roiacc_out_size(CTL_SIE_ID id);
/**********************************/
/*  header ctl                    */
/**********************************/
