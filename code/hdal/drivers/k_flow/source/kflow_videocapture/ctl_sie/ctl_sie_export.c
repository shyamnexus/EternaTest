...
EXPORT_SYMBOL(ctl_sie_direct_flow_ipp_cb);
EXPORT_SYMBOL(ctl_sie_get_dir_fp);
//dbg
...
EXPORT_SYMBOL(ctl_sie_get_is_open);
EXPORT_SYMBOL(kdf_sie_dump_intrpt_sts);
EXPORT_SYMBOL(kdf_sie_set_err_log_rate);
