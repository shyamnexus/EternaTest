...
typedef struct _ISF_VDOCAP_DRV_INFO {
	...
	struct proc_dir_entry *p_proc_dbglevel_entry;
	struct proc_dir_entry *p_proc_module_kflow_root;
	struct proc_dir_entry *p_proc_kflow_dbglevel_entry;
	struct proc_dir_entry *p_proc_kflow_engine_spec_entry;
