...
#define IPP_EVENT_ENTRY_MAX		CTL_IPP_CBEVT_MAX
...
typedef struct _IPP_EVENT_ROOT_ITEM {
	CHAR name[IPP_EVENT_NAME_MAX];
	UINT32 sts;
...
*/
extern UINT32 ipp_event_init(UINT32 num, CTL_IPP_BUF_ADDR buf_addr, UINT32 is_query);
...
/**
     ...
     @return Description of data returned.
		- @b 0: open fail
*/
extern IPP_EVENT_ROOT_ITEM *ipp_event_open(CHAR *name);
...
/**
     ...
     @return Description of data returned.
		...
		- @b IPP_EVENT_NG: fail
*/
extern UINT32 ipp_event_close(IPP_EVENT_ROOT_ITEM *p_root_item);
...
/**
     ...
     @return Description of data returned.
		...
		- @b IPP_EVENT_NG: fail
*/
extern UINT32 ipp_event_register(IPP_EVENT_ROOT_ITEM *p_root_item, UINT32 event, IPP_EVENT_FP fp, CHAR *name);
...
/**
     ...
     @return Description of data returned.
		...
		- @b IPP_EVENT_NG: fail
*/
extern UINT32 ipl_event_unregister(IPP_EVENT_ROOT_ITEM *p_root_item, UINT32 event, IPP_EVENT_FP fp);
...
/**
     ...
     @return Description of data returned.
		...
		- @b IPP_EVENT_NG: fail
*/
extern INT32 ipp_event_proc(IPP_EVENT_ROOT_ITEM *p_root_item, UINT32 event, void *p_in, void *p_out);
...
/**
     ...
     @return Description of data returned.
		...
		- @b IPP_EVENT_NG: fail
*/
extern INT32 ipp_event_proc_isr(IPP_EVENT_ROOT_ITEM *p_root_item, UINT32 event, void *p_in, void *p_out);
