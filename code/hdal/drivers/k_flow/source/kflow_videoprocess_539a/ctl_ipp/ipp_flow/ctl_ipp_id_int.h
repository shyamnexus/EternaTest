...
#define CTL_IPP_AI_TSK_PRI       3
#define CTL_IPP_AI_TSK_STKSIZE   4096
...
/**********************************************************/
#define CTL_IPP_RPO_END_USE_BIT 4
#define CTL_IPP_RPO_END_TIMEOUT_SHIFT 0
#define CTL_IPP_RPO_END_SHIFT 1
#define CTL_IPP_RPO_END_CFG_END 2
#define CTL_IPP_RPO_END_TRIG_START 3
...
#define CTL_IPP_TASK_CHK_BLOCKING 	FLGPTN_BIT(17)
#define CTL_IPP_QUEUE_PROC_STOP		FLGPTN_BIT(18)
#define CTL_IPP_QUEUE_CHK			FLGPTN_BIT(19)
...
/**********************************************************/
/*              ctl_ipl ai task flag pattern	          */
/**********************************************************/
#define CTL_IPP_AI_TASK_PAUSE             FLGPTN_BIT(0)
#define CTL_IPP_AI_TASK_PAUSE_END         FLGPTN_BIT(1)
#define CTL_IPP_AI_TASK_RESUME            FLGPTN_BIT(2)
#define CTL_IPP_AI_TASK_RESUME_END        FLGPTN_BIT(3)
#define CTL_IPP_AI_TASK_IDLE              FLGPTN_BIT(4)
#define CTL_IPP_AI_TASK_RESTART           FLGPTN_BIT(5)
#define CTL_IPP_AI_TASK_FLUSH             FLGPTN_BIT(6)
#define CTL_IPP_AI_TASK_RES               FLGPTN_BIT(7)
#define CTL_IPP_AI_TASK_CHK               FLGPTN_BIT(8)

#define CTL_IPP_AI_TASK_TRIG			  FLGPTN_BIT(9)
#define CTL_IPP_AI_TASK_TRIG_END		  FLGPTN_BIT(10)

#define CTL_IPP_AI_QUEUE_PROC			  FLGPTN_BIT(11)
#define CTL_IPP_AI_TASK_EXIT_END         FLGPTN_BIT(12)


#define CTL_IPP_AI_PROC_INIT       (CTL_IPP_AI_TASK_PAUSE_END|CTL_IPP_AI_TASK_TRIG_END)
...
#define CTL_IPP_ISP_GET_BNR_STA_READY	FLGPTN_BIT(17)

#define CTL_IPP_ISP_TASK_EXIT_END         FLGPTN_BIT(18)

#define CTL_IPP_ISP_PROC_INIT	(CTL_IPP_ISP_TASK_PAUSE_END | CTL_IPP_ISP_TASK_TRIG_END | CTL_IPP_ISP_CFG_LOCK | CTL_IPP_ISP_GET_YUV_END | CTL_IPP_ISP_GET_3DNR_STA_READY | CTL_IPP_ISP_GET_BNR_STA_READY)

/*************************************************/
extern THREAD_DECLARE(ctl_ipp_tsk, p1);
extern THREAD_DECLARE(ctl_ipp_buf_tsk, p1);
extern THREAD_DECLARE(ctl_ipp_ai_tsk, p1);
...
extern THREAD_HANDLE g_ctl_ipp_ai_tsk_id;
extern ID g_ctl_ipp_ai_flg_id;
