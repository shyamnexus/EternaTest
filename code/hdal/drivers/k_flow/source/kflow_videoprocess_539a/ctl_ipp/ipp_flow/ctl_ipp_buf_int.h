...
typedef enum {
	...
	CTRL_IPP_BUF_ITEM_PRE_VA,
	CTRL_IPP_BUF_ITEM_PRE_VA_DBG,
	...
	CTRL_IPP_BUF_ITEM_BNR_MO,
	CTRL_IPP_BUF_ITEM_BNR_MO_DBG,
	CTRL_IPP_BUF_ITEM_BNR_STA,
	CTRL_IPP_BUF_ITEM_BNR_STA_DBG,
...
typedef enum {
	...
	CTL_IPP_BUF_SHDR_1,
	CTL_IPP_BUF_SHDR_MAX,

	CTL_IPP_BUF_PRE_VA_1,
	CTL_IPP_BUF_PRE_VA_2,
	CTL_IPP_BUF_PRE_VA_3,
	CTL_IPP_BUF_PRE_VA_MAX,

	CTL_IPP_BUF_PRE_VA_DBG_1,
	CTL_IPP_BUF_PRE_VA_DBG_MAX,
	...
	CTL_IPP_BUF_BNR_MO_1,
	CTL_IPP_BUF_BNR_MO_2,
	CTL_IPP_BUF_BNR_MO_MAX,

	CTL_IPP_BUF_BNR_MO_DBG_1,
	CTL_IPP_BUF_BNR_MO_DBG_MAX,

	CTL_IPP_BUF_BNR_SIGMA_1,
	CTL_IPP_BUF_BNR_SIGMA_MAX,

	CTL_IPP_BUF_BNR_GAMMA_1,
	CTL_IPP_BUF_BNR_GAMMA_MAX,

	CTL_IPP_BUF_BNR_STA_1,
	CTL_IPP_BUF_BNR_STA_MAX,

	CTL_IPP_BUF_BNR_STA_DBG_1,
	CTL_IPP_BUF_BNR_STA_DBG_MAX,

	CTL_IPP_DBG_BUF_MAX_CNT,
} CTL_IPP_DBG_PRI_BUF_IDX;

#define CTL_IPP_BUF_INFO_DESC_LEN 48
typedef struct _CTL_IPP_BUF_INFO {
	...
	UINT8 busy;			// use to check if buf is dropped but may not actually release yet, or buf is start to use by posterior pipe and cant be dropped
} CTL_IPP_BUF_INFO;
...
void ctl_ipp_buf_set_dbg_msg(UINT8 en);
...
INT32 ctl_ipp_buf_info_release(CTL_IPP_BUF_INFO *p_buf_info, const CHAR *info_str, UINT32 *lock_cnt);
...
INT32 ctl_ipp_buf_aided_clear_old(CTL_IPP_HANDLE *p_hdl);
UINT8 ctl_ipp_buf_aided_chk_set_busy(CTL_IPP_BUF_INFO *subout_buf);
