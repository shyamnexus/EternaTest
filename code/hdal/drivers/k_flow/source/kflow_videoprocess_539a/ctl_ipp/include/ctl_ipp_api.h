...
BOOL nvt_ctl_ipp_api_dump_kdrv_job(unsigned char argc, char **pargv);
...
BOOL nvt_ctl_ipp_api_dbg_buf(unsigned char argc, char **pargv);
BOOL nvt_ctl_ipp_api_exam(unsigned char argc, char **pargv);

BOOL nvt_ctl_ipp_exam_cmd(unsigned char argc, char **pargv);
...
/* internal function */
int ctl_ipp_dbg_panic_printout_handler(uintptr_t data);
#endif
