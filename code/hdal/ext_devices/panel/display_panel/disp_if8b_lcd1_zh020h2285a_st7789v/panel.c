	...
	/***********       RGB 320 mode         *************/
	{
		// T_PANEL_PARAM
		{
			/* Old prototype */
	          ...
	          20500000,                           //!< fDCLK, 18MHz ~ 22MHz
                (0x3a+720),              //0x3C       //!< uiHSyncTotalPeriod , ST7789v spec, page 111, figure 24
                720,//960,                            //!< uiHSyncActivePeriod
                20,              // 0x3b             //!< uiHSyncBackPorch
                16+320,                        //!< uiVSyncTotalPeriod
                320,                            //!< uiVSyncActivePeriod
                0x08,                           //!< uiVSyncBackPorchOdd
                0x08,                           //!< uiVSyncBackPorchEven
                720,                            //!< uiBufferWidth
                320,                            //!< uiBufferHeight
                720,                            //!< uiWindowWidth
                320,                            //!< uiWindowHeight
...
#else
{
		// T_PANEL_PARAM
		{
			/* Old prototype */
       	   PINMUX_LCDMODE_RGB_SERIAL,      //!< LCDMode
	          20500000,                           //!< fDCLK, 18MHz ~ 22MHz
                (94+720),              //0x3C       //!< uiHSyncTotalPeriod , ST7789v spec, page 111, figure 24
                720,//960,                            //!< uiHSyncActivePeriod
		...
		{
			/* Old prototype */
       	       PINMUX_LCD_SEL_SERIAL_RGB_8BITS,// PINMUX_LCD_SEL_SERIAL_RGB_8BITS,//!< pinmux_select_lcd;
			ICST_CCIR601,                   //!< icst;
	             {FALSE,FALSE},                  //!< dithering[2];
	             DISPLAY_DEVICE_CASIO2G,         //!< **DONT-CARE**
			IDE_PDIR_RGB,                   //!< pdir;
