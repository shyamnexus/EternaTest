...
static const T_PANEL_CMD t_cmd_mode_through[] = {
	{0x00, 0x07},
	{0x00, 0x0F},
	{0x40, 0x03},
	{0x60, 0x00},
...
static const T_PANEL_CMD t_cmd_mode_rgbd320[] = {
	{0x00, 0x0F},
	{0x40, 0x03},
	{0x60, 0x01},
	{0xC0, 0x06},
...
static const T_PANEL_CMD t_cmd_mode_yuv640[] = {
	{0x00, 0x0F},
	{0x20, 0x03},
	{0x40, 0x03},
	{0x60, 0x03},
...
/*Used in CCIR656*/
static const T_PANEL_CMD t_cmd_mode_ccir656[] = {
	{0x00, 0x0F},
	{0x40, 0x03},
	{0x60, 0x07},
	{0xC0, 0x06},
...
static const T_PANEL_CMD t_cmd_standby[] = {
	{0x00, 0x08}
};

static const T_LCD_SIF_PARAM t_sif_param[] = {
	{
	// SIF mode 00
	0,
	//SIF_MODE_00,
...
static const T_LCD_PARAM t_mode[] = {
	/***********       CCIR601 MODE         *************/
	{
		// tPANEL_PARAM
		{
			...
			24550000,                       //!< fDCLK
#endif
			780*2,                           //!< uiHSyncTotalPeriod
			640*2,                           //!< uiHSyncActivePeriod
			126*2,                            //!< uiHSyncBackPorch
...
static const T_LCD_ROT *t_rotate = NULL;
