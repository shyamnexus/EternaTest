...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_mtr_ti8833, 1, 05, 000, 00);
...
#else
		pcmd->data[0] = ti8833_set_zoom_position_cali(id, pcmd->argu[0]);
#endif
		break;
...
static void do_motion_work(MOTOR_DRV_INFO *pmotor_info)
{
	...
	case MTR_ITEM_ZOOM_POSITION_CALI:
		mtr_mot_cmd.mtr_mot_arg.data[0] = ti8833_set_zoom_position_cali(mtr_mot_cmd.mtr_id, mtr_mot_cmd.mtr_mot_arg.argu[0]);
