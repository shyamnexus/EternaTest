...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc850sl, 1, 02, 000, 00);
...
static CTL_SENDRV_GET_SPEED_PARAM speed_param[SEN_MAX_MODE] = {
	...
	},
	{
		...
		27000000,
		288000000,
		144000000 // 1440*2/10/2*1000000 = 144000000
	}
};
...
static CTL_SEN_CMD sc850sl_mode_4[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
...
static UINT32 sen_get_cmd_tab_sc850sl(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_4:
		*cmd_tab = sc850sl_mode_4;
		return sizeof(sc850sl_mode_4) / sizeof(CTL_SEN_CMD);
...
static void sen_set_gain_sc850sl(CTL_SEN_ID id, void *param)
{
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_STAGGER_HDR) {
		...
		//Set digital gain
		cmd = sen_set_cmd_info_sc850sl(0x3E10, 1, data3[0] & 0xFF, 0x0);
		rt |= sen_write_reg_sc850sl(id, &cmd);
	}
