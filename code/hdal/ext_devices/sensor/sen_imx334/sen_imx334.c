...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_imx334, 1, 01, 000, 00);
...
static void sen_get_hdr_rhs_imx334(CTL_SEN_ID id, CTL_SENDRV_GET_MFR_OUTPUT_TIMING_PARAM *data);
//=============================================================================
// global variable
//=============================================================================
...
static ER sen_get_info_imx334(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_GET_MFR_OUTPUT_TIMING:
		sen_get_hdr_rhs_imx334(id, (CTL_SENDRV_GET_MFR_OUTPUT_TIMING_PARAM *)(data));
		break;
	default:
		rt = E_NOSPT;
	}
...
static void sen_set_expt_imx334(CTL_SEN_ID id, void *param)
{
	...
	UINT32 real_short_exp = 0, rhs1 = 0, shr0 = 0, shr1 = 0, fcs = 0, temp_max_short_line = 0;	
	...
	if (mode_basic_param[data->mode].mode_type == CTL_SEN_MODE_STAGGER_HDR) {
		if (((mode_basic_param[data->mode].frame_num) == data->num)  && ( mode_basic_param[data->mode].mode == (data->mode))) {
			if (2 == data->num) {
				...
				t_row = sen_calc_rowtime_imx334(id, data->mode);
