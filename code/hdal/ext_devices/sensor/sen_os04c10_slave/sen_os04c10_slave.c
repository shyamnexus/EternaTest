...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_os04c10_slave, 1, 01, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_OS04C10_SLAVE_MODULE_NAME     "sen_os04c10_slave"
#define SEN_OS04C10_SLAVE_MODULE_NAME_REG "nvt_sen_os04c10_slave"
...
#define HD_SYNC                    8
#define VD_SYNC                    2368
#define HD_HDR_SYNC                8
#define VD_HDR_SYNC                1681

#define SEN_I2C_ADDR 0x6C>>1
#define SEN_I2C_COMPATIBLE "nvt,sen_os04c10_slave"
...
//=============================================================================
static CTL_SEN_DRV_TAB *sen_get_drv_tab_os04c10_slave(void);
static void sen_pwr_ctrl_os04c10_slave(CTL_SEN_ID id, CTL_SEN_PWR_CTRL_FLAG flag, CTL_SEN_CLK_CB clk_cb);
static ER sen_open_os04c10_slave(CTL_SEN_ID id);
static ER sen_close_os04c10_slave(CTL_SEN_ID id);
static ER sen_sleep_os04c10_slave(CTL_SEN_ID id);
static ER sen_wakeup_os04c10_slave(CTL_SEN_ID id);
static ER sen_write_reg_os04c10_slave(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_read_reg_os04c10_slave(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_chg_mode_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj);
static ER sen_chg_fps_os04c10_slave(CTL_SEN_ID id, UINT32 fps);
static ER sen_set_info_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static ER sen_get_info_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static UINT32 sen_calc_chgmode_vd_os04c10_slave(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_calc_exp_vd_os04c10_slave(CTL_SEN_ID id, UINT32 fps);
static void sen_set_gain_os04c10_slave(CTL_SEN_ID id, void *param);
static void sen_set_expt_os04c10_slave(CTL_SEN_ID id, void *param);
static void sen_set_preset_os04c10_slave(CTL_SEN_ID id, ISP_SENSOR_PRESET_CTRL *ctrl);
static void sen_set_flip_os04c10_slave(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
static ER sen_get_flip_os04c10_slave(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
#if defined(__FREERTOS)
void sen_get_gain_os04c10_slave(CTL_SEN_ID id, void *param);
void sen_get_expt_os04c10_slave(CTL_SEN_ID id, void *param);
#else
static void sen_get_gain_os04c10_slave(CTL_SEN_ID id, void *param);
static void sen_get_expt_os04c10_slave(CTL_SEN_ID id, void *param);
#endif
static void sen_get_min_expt_os04c10_slave(CTL_SEN_ID id, void *param);
static void sen_get_mode_basic_os04c10_slave(CTL_SENDRV_GET_MODE_BASIC_PARAM *mode_basic);
static void sen_get_attr_basic_os04c10_slave(CTL_SENDRV_GET_ATTR_BASIC_PARAM *data);
static void sen_get_attr_signal_os04c10_slave(CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *data);
static ER sen_get_attr_cmdif_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_ATTR_CMDIF_PARAM *data);
static ER sen_get_attr_if_os04c10_slave(CTL_SENDRV_GET_ATTR_IF_PARAM *data);
static void sen_get_fps_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data);
static void sen_get_speed_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_SPEED_PARAM *data);
static void sen_get_mode_mipi_os04c10_slave(CTL_SENDRV_GET_MODE_MIPI_PARAM *data);
static void sen_ext_get_mode_tge_os04c10_slave(CTL_SENDRV_GET_MODE_TGE_PARAM *data);
static void sen_get_modesel_os04c10_slave(CTL_SENDRV_GET_MODESEL_PARAM *data);
static UINT32 sen_calc_rowtime_os04c10_slave(CTL_SEN_ID id, CTL_SEN_MODE mode);
static UINT32 sen_calc_rowtime_step_os04c10_slave(CTL_SEN_ID id, CTL_SEN_MODE mode);
static void sen_get_rowtime_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data);
static void sen_set_cur_fps_os04c10_slave(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_cur_fps_os04c10_slave(CTL_SEN_ID id);
static void sen_set_chgmode_fps_os04c10_slave(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_chgmode_fps_os04c10_slave(CTL_SEN_ID id);
//=============================================================================
// global variable
//=============================================================================
...
static CTL_SEN_CMD os04c10_slave_mode_1[] = {
	{0x0100, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0301, 1, {0x84, 0x0}},
	{0x0303, 1, {0x01, 0x0}},
	...
	{0x4c04, 1, {0x00, 0x0}},
	{0x4c05, 1, {0x00, 0x0}},
	{0x5000, 1, {0xf9, 0x0}},//Purpose: Enable OTP DPC function to fix sensor static cluster.
	{0x3624, 1, {0x00, 0x0}},
	//slave mode
	{0x3002, 1, {0x22, 0x0}},
	{0x3663, 1, {0x22, 0x0}},
...
static CTL_SEN_CMD os04c10_slave_mode_2[] = {
	{0x0100, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0301, 1, {0x84, 0x0}},
	{0x0303, 1, {0x01, 0x0}},
...
static CTL_SEN_CMD os04c10_slave_mode_3[] = {
	{0x0100, 1, {0x00 ,0x0}},
	{0x0103, 1, {0x01 ,0x0}},
	{0x0301, 1, {0x84 ,0x0}},
	{0x0303, 1, {0x01 ,0x0}},
...
static CTL_SEN_DRV_TAB os04c10_slave_sen_drv_tab = {
	sen_open_os04c10_slave,
	sen_close_os04c10_slave,
	sen_sleep_os04c10_slave,
	sen_wakeup_os04c10_slave,
	sen_write_reg_os04c10_slave,
	sen_read_reg_os04c10_slave,
	sen_chg_mode_os04c10_slave,
	sen_chg_fps_os04c10_slave,
	sen_set_info_os04c10_slave,
	sen_get_info_os04c10_slave,
};

static CTL_SEN_DRV_TAB *sen_get_drv_tab_os04c10_slave(void)
{
	return &os04c10_slave_sen_drv_tab;
}
...
static CTL_SEN_CMD sen_set_cmd_info_os04c10_slave(UINT32 addr, UINT32 data_length, UINT32 data0, UINT32 data1)
{
	CTL_SEN_CMD cmd;
...
#if defined(__KERNEL__)
static void sen_load_cfg_from_compatible_os04c10_slave(struct device_node *of_node)
{
...
static ER sen_open_os04c10_slave(CTL_SEN_ID id)
{
	...
	#if defined(__KERNEL__)
	sen_i2c_reg_cb(sen_load_cfg_from_compatible_os04c10_slave);
	#endif
...
static UINT32 sen_get_cmd_tab_os04c10_slave(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	switch (mode) {
	case CTL_SEN_MODE_1:
		*cmd_tab = os04c10_slave_mode_1;
		return sizeof(os04c10_slave_mode_1) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_2:
		*cmd_tab = os04c10_slave_mode_2;
		return sizeof(os04c10_slave_mode_2) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_3:
		*cmd_tab = os04c10_slave_mode_3;
		return sizeof(os04c10_slave_mode_3) / sizeof(CTL_SEN_CMD);
...
static ER sen_chg_mode_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj)
{
	...
	if (is_fastboot[id]) {
		...
		sen_set_chgmode_fps_os04c10_slave(id, isp_builtin_get_chgmode_fps(id));
		sen_set_cur_fps_os04c10_slave(id, isp_builtin_get_chgmode_fps(id));
		sen_set_gain_os04c10_slave(id, &sensor_ctrl);
		sen_set_expt_os04c10_slave(id, &sensor_ctrl);
		#endif
	...
	cmd_num = sen_get_cmd_tab_os04c10_slave(chgmode_obj.mode, &p_cmd_list);
	if (p_cmd_list == NULL) {
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os04c10_slave(id, chgmode_obj.frame_rate);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os04c10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os04c10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
	...
	sen_ext_get_mode_tge_os04c10_slave(&tge_info);
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {		
		new_tge_vd_sync = (mode_basic_param[cur_sen_mode[id]].dft_fps) * (tge_info.signal.vd_period) / sen_get_chgmode_fps_os04c10_slave(id) + VD_SYNC - (tge_info.signal.vd_period);
	} else if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_STAGGER_HDR) {		
		new_tge_vd_sync = (mode_basic_param[cur_sen_mode[id]].dft_fps) * (tge_info.signal.vd_period) / sen_get_chgmode_fps_os04c10_slave(id) + VD_HDR_SYNC - (tge_info.signal.vd_period);		
	}			
	new_tge_vd =(mode_basic_param[cur_sen_mode[id]].dft_fps) * (tge_info.signal.vd_period) / sen_get_chgmode_fps_os04c10_slave(id);
	ctl_sen_set(ctl_sen_get_senid(id, 0, SEN_OS04C10_SLAVE_MODULE_NAME_REG), CTL_SEN_CFGID_TGE_VD_SYNC, (void *)(&new_tge_vd_sync));	
	ctl_sen_set(ctl_sen_get_senid(id, 0, SEN_OS04C10_SLAVE_MODULE_NAME_REG), CTL_SEN_CFGID_TGE_VD_PERIOD, (void *)(&new_tge_vd));
	...
	for (idx = 0; idx < cmd_num; idx++) {
		if (p_cmd_list[idx].addr == SEN_CMD_DELAY) {
			...
			cmd = sen_set_cmd_info_os04c10_slave(0x380E, 1, (sensor_vd >> 8) & 0xFF, 0x00);
			rt |= sen_write_reg_os04c10_slave(id, &cmd);
			cmd = sen_set_cmd_info_os04c10_slave(0x380F, 1, sensor_vd & 0xFF, 0x00);
			rt |= sen_write_reg_os04c10_slave(id, &cmd);
			...
			sen_set_flip_os04c10_slave(id, &flip);
		} else {
			cmd = sen_set_cmd_info_os04c10_slave(p_cmd_list[idx].addr, p_cmd_list[idx].data_len, p_cmd_list[idx].data[0], p_cmd_list[idx].data[1]);
			rt |= sen_write_reg_os04c10_slave(id, &cmd);
		}
	}
...
static ER sen_chg_fps_os04c10_slave(CTL_SEN_ID id, UINT32 fps)
{
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os04c10_slave(id, fps);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os04c10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os04c10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
...
static ER sen_set_info_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_SET_EXPT:
		sen_set_expt_os04c10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_SET_GAIN:
		sen_set_gain_os04c10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		sen_set_flip_os04c10_slave(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE1:
		sen_set_preset_os04c10_slave(id, (ISP_SENSOR_PRESET_CTRL *)(data));
		break;
	default:
		return E_NOSPT;
	}
...
static ER sen_get_info_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_GET_EXPT:
		sen_get_expt_os04c10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_GAIN:
		sen_get_gain_os04c10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_BASIC:
		sen_get_attr_basic_os04c10_slave((CTL_SENDRV_GET_ATTR_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_SIGNAL:
		sen_get_attr_signal_os04c10_slave((CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_CMDIF:
		rt = sen_get_attr_cmdif_os04c10_slave(id, (CTL_SENDRV_GET_ATTR_CMDIF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_IF:
		rt = sen_get_attr_if_os04c10_slave((CTL_SENDRV_GET_ATTR_IF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_FPS:
		sen_get_fps_os04c10_slave(id, (CTL_SENDRV_GET_FPS_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_SPEED:
		sen_get_speed_os04c10_slave(id, (CTL_SENDRV_GET_SPEED_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_BASIC:
		sen_get_mode_basic_os04c10_slave((CTL_SENDRV_GET_MODE_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_MIPI:
		sen_get_mode_mipi_os04c10_slave((CTL_SENDRV_GET_MODE_MIPI_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODESEL:
		sen_get_modesel_os04c10_slave((CTL_SENDRV_GET_MODESEL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_ROWTIME:
		sen_get_rowtime_os04c10_slave(id, (CTL_SENDRV_GET_MODE_ROWTIME_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		rt = sen_get_flip_os04c10_slave(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_TGE:
		sen_ext_get_mode_tge_os04c10_slave((CTL_SENDRV_GET_MODE_TGE_PARAM *)(data));
		break;		
	case CTL_SENDRV_CFGID_USER_DEFINE2:
		sen_get_min_expt_os04c10_slave(id, data);
		break;
...
static UINT32 sen_calc_chgmode_vd_os04c10_slave(CTL_SEN_ID id, UINT32 fps)
{
	...
	sen_set_chgmode_fps_os04c10_slave(id, fps);
	sen_set_cur_fps_os04c10_slave(id, fps);
...
static void sen_set_gain_os04c10_slave(CTL_SEN_ID id, void *param)
{
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {	
		cmd = sen_set_cmd_info_os04c10_slave(0x320D, 1, 0x00, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
  	
		cmd = sen_set_cmd_info_os04c10_slave(0x3208, 1, 0x00, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);

		//Set A gain
		cmd = sen_set_cmd_info_os04c10_slave(0x3508, 1, (data1[0] >> 8) & 0x3F, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3509, 1, data1[0] & 0xFF, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
  	
		//Set D gain
		cmd = sen_set_cmd_info_os04c10_slave(0x350A, 1, (data2[0] >> 8) & 0x3F, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x350B, 1, (data2[0]) & 0xFF, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		
		cmd = sen_set_cmd_info_os04c10_slave(0x3880, 1, conversion_gain, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);

		cmd = sen_set_cmd_info_os04c10_slave(0x3503, 1, timing_reg, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		
		cmd = sen_set_cmd_info_os04c10_slave(0x3208, 1, 0x10, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		
		cmd = sen_set_cmd_info_os04c10_slave(0x320D, 1, 0x00, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);

		cmd = sen_set_cmd_info_os04c10_slave(0x3208, 1, 0xA0, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
	}
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_STAGGER_HDR) {
		...
		cmd = sen_set_cmd_info_os04c10_slave(0x3509, 1, data1[0] & 0xFF, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x350C, 1, (data1[1] >> 8) & 0x3F, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x350D, 1, data1[1] & 0xFF, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		...
		cmd = sen_set_cmd_info_os04c10_slave(0x350B, 1, (data2[0]) & 0xFF, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x350E, 1, (data2[1] >> 8) & 0x3F, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x350F, 1, data2[1] & 0xFF, 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
	
		cmd = sen_set_cmd_info_os04c10_slave(0x3698, 1, conversion_gain_reg[0], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3699, 1, conversion_gain_reg[1], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x369A, 1, conversion_gain_reg[2], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x369B, 1, conversion_gain_reg[3], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x369C, 1, conversion_gain_reg[4], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x369D, 1, conversion_gain_reg[5], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x369E, 1, conversion_gain_reg[6], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x369F, 1, conversion_gain_reg[7], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x35A0, 1, conversion_gain_reg[8], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x36A1, 1, conversion_gain_reg[9], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x370E, 1, conversion_gain_reg[10], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3713, 1, conversion_gain_reg[11], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x379C, 1, conversion_gain_reg[12], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x379D, 1, conversion_gain_reg[13], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x37BE, 1, conversion_gain_reg[14], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x37C7, 1, conversion_gain_reg[15], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3881, 1, conversion_gain_reg[16], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3681, 1, conversion_gain_reg[17], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3682, 1, conversion_gain_reg[18], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3683, 1, conversion_gain_reg[19], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3684, 1, conversion_gain_reg[20], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x370F, 1, conversion_gain_reg[21], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x379F, 1, conversion_gain_reg[22], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x37AC, 1, conversion_gain_reg[23], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x37BF, 1, conversion_gain_reg[24], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3880, 1, conversion_gain_reg[25], 0x0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
...
static void sen_set_expt_os04c10_slave(CTL_SEN_ID id, void *param)
{
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		t_row = sen_calc_rowtime_os04c10_slave(id, cur_sen_mode[id]);
		if (0 == t_row) {
	...
	// Write exposure line
	// Get fps
	chgmode_fps = sen_get_chgmode_fps_os04c10_slave(id);
	...
	sen_set_cur_fps_os04c10_slave(id, cur_fps);

	// Calculate new vd
	sensor_vd = sen_calc_exp_vd_os04c10_slave(id, cur_fps);
	...
	cmd = sen_set_cmd_info_os04c10_slave(0x380E, 1, (sensor_vd >> 8) & 0xFF, 0);
	rt |= sen_write_reg_os04c10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os04c10_slave(0x380F, 1, sensor_vd & 0xFF, 0);
	rt |= sen_write_reg_os04c10_slave(id, &cmd);
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
		...
		cmd = sen_set_cmd_info_os04c10_slave(0x3501, 1, (line[0] >> 8) & 0xFF, 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3502, 1, line[0] & 0xFF , 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		//set MAWB
		cmd = sen_set_cmd_info_os04c10_slave(0x5102, 1, (mawb_l_g >> 8) & 0xFF, 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x5103, 1, mawb_l_g & 0xFF , 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x5142, 1, (mawb_s_g >> 8) & 0xFF, 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x5143, 1, mawb_s_g & 0xFF , 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
	} else if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_STAGGER_HDR) {
		...
		cmd = sen_set_cmd_info_os04c10_slave(0x3502, 1, line[0] & 0xFF , 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3511, 1, (line[1] >> 8) & 0xFF, 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os04c10_slave(0x3512, 1, line[1] & 0xFF , 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
		//set MAWB
		cmd = sen_set_cmd_info_os04c10_slave(0x5102, 1, (mawb_l_g >> 8) & 0xFF, 0);
		rt |= sen_write_reg_os04c10_slave(id, &cmd);
...
static void sen_set_flip_os04c10_slave(CTL_SEN_ID id, CTL_SEN_FLIP *flip)
{
	...
	cmd = sen_set_cmd_info_os04c10_slave(0x3820, 1, 0x0, 0x0);
	rt |= sen_read_reg_os04c10_slave(id, &cmd);

	cmd2 = sen_set_cmd_info_os04c10_slave(0x3716, 1, 0x0, 0x0);
	rt |= sen_read_reg_os04c10_slave(id, &cmd2);
	...
	cmd = sen_set_cmd_info_os04c10_slave(0x0100, 1, 0x00, 0x0);
	rt |= sen_write_reg_os04c10_slave(id, &cmd);

	cmd = sen_set_cmd_info_os04c10_slave(0x3820, 1, temp, 0x0);
	rt |= sen_write_reg_os04c10_slave(id, &cmd);

	cmd2 = sen_set_cmd_info_os04c10_slave(0x3716, 1, cmd2.data[0], 0x0);
	rt |= sen_write_reg_os04c10_slave(id, &cmd2);

	cmd = sen_set_cmd_info_os04c10_slave(0x0100, 1, 0x01, 0x0);
	rt |= sen_write_reg_os04c10_slave(id, &cmd);
...
static void sen_get_fps_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data)
{
	data->cur_fps = sen_get_cur_fps_os04c10_slave(id);
	data->chg_fps = sen_get_chgmode_fps_os04c10_slave(id);
}
...
static void sen_ext_get_mode_tge_os04c10_slave(CTL_SENDRV_GET_MODE_TGE_PARAM *data)
{
	if ((data->mode == CTL_SEN_MODE_1) || (data->mode == CTL_SEN_MODE_3)) {
		data->signal.hd_sync = HD_SYNC;
		data->signal.hd_period = 338;
		data->signal.vd_sync = VD_SYNC;
		data->signal.vd_period = 2369;
	} else if (data->mode == CTL_SEN_MODE_2) {
		data->signal.hd_sync = HD_HDR_SYNC;
		data->signal.hd_period = 475;
		data->signal.vd_sync = VD_HDR_SYNC;
		data->signal.vd_period = 1682;		
	}
}
...
static void sen_get_rowtime_os04c10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data)
{
	data->row_time_step = sen_calc_rowtime_step_os04c10_slave(id, data->mode);
	data->row_time = sen_calc_rowtime_os04c10_slave(id, data->mode) * (data->row_time_step);
}
...
#if defined(__FREERTOS)
void sen_get_i2c_id_os04c10_slave(CTL_SEN_ID id, UINT32 *i2c_id)
{
	*i2c_id = sen_i2c[id].id;
}

void sen_get_i2c_addr_os04c10_slave(CTL_SEN_ID id, UINT32 *i2c_addr)
{
	*i2c_addr = sen_i2c[id].addr;
}

int sen_init_os04c10_slave(SENSOR_DTSI_INFO *info)
{
	...
	sprintf(compatible, "nvt,sen_os04c10_slave");
	if (sen_common_check_compatible(compatible)) {
		...
		sprintf(node_path, "/sensor/sen_cfg/sen_os04c10_slave");
	...
	reg_obj.pwr_ctrl = sen_pwr_ctrl_os04c10_slave;
	reg_obj.det_plug_in = NULL;
	reg_obj.drv_tab = sen_get_drv_tab_os04c10_slave();
	rt = ctl_sen_reg_sendrv(SEN_OS04C10_SLAVE_MODULE_NAME_REG, &reg_obj);
	if (rt != E_OK) {
...
void sen_exit_os04c10_slave(void)
{
	ctl_sen_unreg_sendrv(SEN_OS04C10_SLAVE_MODULE_NAME_REG);
}

#else
static int __init sen_init_os04c10_slave(void)
{
...
static void __exit sen_exit_os04c10_slave(void)
{
	ctl_sen_unreg_sendrv(SEN_OS04C10_SLAVE_MODULE_NAME_REG);
}

module_init(sen_init_os04c10_slave);
module_exit(sen_exit_os04c10_slave);

MODULE_AUTHOR("Novatek Corp.");
MODULE_DESCRIPTION(SEN_OS04C10_SLAVE_MODULE_NAME);
MODULE_LICENSE("GPL");
#endif
