...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc2335_slave, 1, 01, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_SC2335_SLAVE_MODULE_NAME      "sen_sc2335_slave"
#define SEN_SC2335_SLAVE_MODULE_NAME_REG  "nvt_sen_sc2335_slave"
...
static ER sen_chg_mode_sc2335_slave(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj)
{
	...
	ctl_sen_set(ctl_sen_get_senid(id, 0, SEN_SC2335_SLAVE_MODULE_NAME_REG), CTL_SEN_CFGID_TGE_VD_SYNC, (void *)(&new_tge_vd_sync));	
	ctl_sen_set(ctl_sen_get_senid(id, 0, SEN_SC2335_SLAVE_MODULE_NAME_REG), CTL_SEN_CFGID_TGE_VD_PERIOD, (void *)(&new_tge_vd));
...
int sen_init_sc2335_slave(SENSOR_DTSI_INFO *info)
{
	...
	rt = ctl_sen_reg_sendrv("SEN_SC2335_SLAVE_MODULE_NAME_REG", &reg_obj);
	if (rt != E_OK) {
...
{
	ctl_sen_unreg_sendrv("SEN_SC2335_SLAVE_MODULE_NAME_REG");
}
