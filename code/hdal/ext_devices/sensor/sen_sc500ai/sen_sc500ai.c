...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc500ai, 1, 01, 000, 00);
...
static CTL_SEN_CMD sc500ai_mode_1[] = {
	...
	{0x36e9, 1, {0x80, 0x0}},
	{0x36f9, 1, {0x80, 0x0}},
	{0x3018, 1, {0x72, 0x0}}, // MIPI lane: 4-lane mode (bit[7:5]=011)
	{0x3031, 1, {0x0a, 0x0}}, // MIPI output: RAW10 mode (bit[3:0]=1010)
	{0x3037, 1, {0x20, 0x0}}, // PHY data mode: 10-bit (bit[6:5]=01)
	{0x303f, 1, {0x01, 0x0}}, // MIPI clock: DVP_pclk (bit[7]=1)
	{0x3c00, 1, {0x41, 0x0}}, // MIPI data enable: read disabled (bit[2]=1)
	{0x301f, 1, {0x01, 0x0}},
	{0x320b, 1, {0x58, 0x0}},
	{0x3211, 1, {0x03, 0x0}},
	{0x3213, 1, {0x01, 0x0}},
...
static CTL_SEN_CMD sc500ai_mode_3[] = {
	...
	{0x36e9, 1, {0x80, 0x0}},
	{0x36f9, 1, {0x80, 0x0}},
	{0x3018, 1, {0x32, 0x0}}, // MIPI lane: 2-lane mode (bit[7:5]=001)
	{0x3019, 1, {0x0c, 0x0}},
	{0x3031, 1, {0x0a, 0x0}}, // MIPI output: RAW10 mode (bit[3:0]=1010)
	{0x3037, 1, {0x20, 0x0}}, // PHY data mode: 10-bit (bit[6:5]=01)
	{0x303f, 1, {0x01, 0x0}}, // MIPI clock: DVP_pclk (bit[7]=1)
