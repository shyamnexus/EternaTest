...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_imx415, 1, 01, 000, 00);
...
static CTL_SEN_CMD imx415_mode_6[] = {
	// MCLK=27Mhz MIPI 4lane 3840*2160 90.896FPS 10bit
	{0x3000, 1, {0x01, 0x0}}, // standby
	{0x3002, 1, {0x01, 0x0}}, //Master mode stop
	{0x3008, 1, {0x5D, 0x0}},
	{0x300A, 1, {0x42, 0x0}},
...
static CTL_SEN_CMD imx415_mode_7[] = {
	// MCLK=24Mhz MIPI 4lane 3840x2160 30FPS 10bit 2-frame dol hdr
	{0x3000, 1, {0x01, 0x0}}, // standby
	{0x3002, 1, {0x01, 0x0}}, //Master mode stop
	{0x3024, 1, {0xD4, 0x0}},
...
static UINT32 sen_get_cmd_tab_imx415(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_6:
		*cmd_tab = imx415_mode_6;
		return sizeof(imx415_mode_6) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_7:
		*cmd_tab = imx415_mode_7;
		return sizeof(imx415_mode_7) / sizeof(CTL_SEN_CMD);
