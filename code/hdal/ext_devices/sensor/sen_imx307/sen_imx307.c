...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_imx307, 1, 01, 000, 00);
...
static CTL_SEN_CMD imx307_mode_6[] = {
	// MCLK=37.125Mhz MIPI 4lane 1080p 30FPS 12bit
	{0x3000, 1, {0x01, 0x0}},// standby
	{SEN_CMD_DELAY, 1, { 20, 0x0}},
	{0x3002, 1, {0x01, 0x0}},// Master mode stop
	{SEN_CMD_DELAY, 1, {20, 0x0}},
...
static UINT32 sen_get_cmd_tab_imx307(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_6:
		*cmd_tab = imx307_mode_6;
		return sizeof(imx307_mode_6) / sizeof(CTL_SEN_CMD);
