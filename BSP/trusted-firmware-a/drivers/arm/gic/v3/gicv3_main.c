...
void write_icc_ctlr_el3(uint64_t value) {
    __asm__ volatile("msr S3_6_C12_C12_4, %0" : : "r" (value));
}
...
void gicv3_cpuif_enable(unsigned int proc_num)
{
	...
	write_icc_sre_el1(ICC_SRE_SRE_BIT);
	isb();
	icc_ctrl_el3 = read_icc_ctlr_el3();
	icc_ctrl_el3 |= (1<<6);
	write_icc_ctlr_el3(icc_ctrl_el3);
