...
#include <plat/nvt-ep.h>

// porting setting flow from 52x, 56x, default disable
// refer to IVOT_N12087_CO-219
#define CLK_DSSC_SETTING_APPLY      1
#define CLK_SSC_NEW_MODE_ENABLE     0
...
/* For pcie architecture to distinguish which side of the cg base */
#define CG_EP0_BASE 1
#define CG_RC_BASE  0
...
/* PLL SSC*/
#define SSC_BOUND   0x4000
#define SSC_BOUND_END   SSC_BOUND + 0x1000
#define SSC_RST      BIT1
#define SSC_NEW_MODE BIT2
#define SSC_STEP     BIT4
#define SSC_DSSC     BIT7
...
#define PLL_CONF(_name, _pll_ratio, _rate_reg_offset, \
				 _gate_reg_offset, _gate_bit_idx, \
				 _is_ep_base)\
{\
	.name           =   _name,\
...
#define COMP_GATE_CONF(_name, _parent_name, _current_rate, \
					   ...
					   _autogating_reg_offset, _autogating_bit_idx, _do_autogating, \
					   _is_ep_base) \
{\
	.name           =   _name,\
...
#define COMP_GPWM_CONF(_parent_name, _current_rate, \
					   _div_reg_offset, _div_bit_idx, _div_bit_width, \
					   _gate_reg_offset, _gate_bit_start_idx, _gate_bit_end_idx, _do_enable, \
...
void __iomem *nvt_get_cg_base(void);
void nvt_cg_ep_base_remap(void __iomem *, int ep_idx);
