...
#define IOADDR_STBC_REG_BASE_ENUM       0
//#define IOADDR_STBC_CG_REG_BASE_ENUM  1
//#define IOADDR_CORE_REG_BASE_ENUM     1
...
int nvt_stbc_drv_init(PMODULE_INFO pmodule_info);
int nvt_stbc_drv_remove(PMODULE_INFO pmodule_info);
int nvt_stbc_drv_suspend(MODULE_INFO *pmodule_info);
int nvt_stbc_drv_resume(MODULE_INFO *pmodule_info);
//int nvt_stbc_drv_ioctl(unsigned char if_id, MODULE_INFO *pmodule_info, unsigned int cmd, unsigned long argc);
#endif
