...
{
    {PAD_DS_CGPIO11, PAD_DS_CGPIO12,                                        // SDIO_PIN_CLK, SDIO_PIN_CMD
     PAD_DS_CGPIO13, PAD_DS_CGPIO14, PAD_DS_CGPIO15, PAD_DS_CGPIO16,        // SDIO_PINDATA0 ~ SDIO_PIN_DATA3
...
{
    {PAD_DS_CGPIO17, PAD_DS_CGPIO18,                                        // SDIO_PIN_CLK, SDIO_PIN_CMD
     PAD_DS_CGPIO19, PAD_DS_CGPIO20, PAD_DS_CGPIO21, PAD_DS_CGPIO22,        // SDIO_PINDATA0 ~ SDIO_PIN_DATA3
     SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED}                    // SDIO_PINDATA4 ~ SDIO_PIN_DATA7
};
...
{
    {PAD_PIN_CGPIO11, PAD_PIN_CGPIO12,                                      // SDIO_PIN_CLK, SDIO_PIN_CMD
     PAD_PIN_CGPIO13, PAD_PIN_CGPIO14, PAD_PIN_CGPIO15, PAD_PIN_CGPIO16,    // SDIO_PINDATA0 ~ SDIO_PIN_DATA3
     SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED}                    // SDIO_PINDATA4 ~ SDIO_PIN_DATA7
};
...
{
    {PAD_PIN_CGPIO17, PAD_PIN_CGPIO18,                                      // SDIO_PIN_CLK, SDIO_PIN_CMD
     PAD_PIN_CGPIO19, PAD_PIN_CGPIO20, PAD_PIN_CGPIO21, PAD_PIN_CGPIO22,    // SDIO_PINDATA0 ~ SDIO_PIN_DATA3
     SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED}                    // SDIO_PINDATA4 ~ SDIO_PIN_DATA7
};
...
{
    {C_GPIO(11), C_GPIO(12),                                                // SDIO_PIN_CLK, SDIO_PIN_CMD
     C_GPIO(13), C_GPIO(14), C_GPIO(15), C_GPIO(16),                        // SDIO_PINDATA0 ~ SDIO_PIN_DATA3
     SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED}                    // SDIO_PINDATA4 ~ SDIO_PIN_DATA7
};
...
{
    {C_GPIO(17), C_GPIO(18),                                                // SDIO_PIN_CLK, SDIO_PIN_CMD
     C_GPIO(19), C_GPIO(20), C_GPIO(21), C_GPIO(22),                        // SDIO_PINDATA0 ~ SDIO_PIN_DATA3
     SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED, SDIO_UNUSED}                    // SDIO_PINDATA4 ~ SDIO_PIN_DATA7
};
