...
typedef enum {
	EFUSE_SATA_1_TRIM_DATA = 0x100,

	EFUSE_HDMI_H_PHY_1_4_VLANE_TRIM_DATA,
	EFUSE_HDMI_H_PHY_2_0_VLANE_TRIM_DATA,
	EFUSE_HDMI_H_PHY_RESISTOR_TRIM_DATA,

	EFUSE_HDMI_V_PHY_1_4_VLANE_TRIM_DATA,
	EFUSE_HDMI_V_PHY_2_0_VLANE_TRIM_DATA,
	EFUSE_HDMI_V_PHY_RESISTOR_TRIM_DATA,


	EFUSE_DDRP_TRIM_DATA,

	EFUSE_USB3_1_TRIM_DATA,
	EFUSE_USB3_2_SATA2_TRIM_DATA,
	EFUSE_USB_RINT_TRIM_DATA,

	EFUSE_THERMAL_TRIM_DATA,
	EFUSE_IDDQ_TRIM_DATA,

	EFUSE_CSI_1_I_TRIM_R_TERM_TRIM_DATA,        //CSI v1.2 H-PHY Group1 (I-term/R-term)
	EFUSE_CSI_2_I_TRIM_R_TERM_TRIM_DATA,        //CSI v1.2 H-PHY Group2 (I-term/R-term)
	EFUSE_CSI_3_I_TRIM_R_TERM_TRIM_DATA,        //CSI v1.2 V-PHY Group1 (I-term/R-term)
	EFUSE_CSI_4_I_TRIM_R_TERM_TRIM_DATA,        //CSI v1.2 V-PHY Group2 (I-term/R-term)

	EFUSE_DSITXPLL_RG_LEVEL_LDO_TRIM_DATA,
	EFUSE_SLVSEC_TRIM_DATA,                     //SLVSEC trim data

	EFUSE_PCIE_RINT_TRIM_DATA,                  //PCIe internal reference resistor
	EFUSE_PCIE0_ODT_TRIM_DATA,                  //PCIe0 ODT
	EFUSE_PCIE1_ODT_TRIM_DATA,                  //PCIe1 ODT

	EFUSE_H_ZQK_LPDDR4X_CKE_RST_TRIM_DATA,
	EFUSE_H_ZQK_LPDDR4X_DQ_DQS_CLK_CS_CA_TRIM_DATA,

	EFUSE_H_ZQK_LPDDR4_CKE_RST_TRIM_DATA,
	EFUSE_H_ZQK_LPDDR4_DQ_DQS_CLK_CS_CA_TRIM_DATA,

	EFUSE_H_ZQK_DDR4_CLK_CS_CKE_CA_RST_TRIM_DATA,
	EFUSE_H_ZQK_DDR4_DQ_DQS_TRIM_DATA,

	EFUSE_V_ZQK_LPDDR4X_CKE_RST_TRIM_DATA,
	EFUSE_V_ZQK_LPDDR4X_DQ_DQS_CLK_CS_CA_TRIM_DATA,

	EFUSE_V_ZQK_LPDDR4_CKE_RST_TRIM_DATA,
	EFUSE_V_ZQK_LPDDR4_DQ_DQS_CLK_CS_CA_TRIM_DATA,

	EFUSE_V_ZQK_DDR4_CLK_CS_CKE_CA_RST_TRIM_DATA,
	EFUSE_V_ZQK_DDR4_DQ_DQS_TRIM_DATA,
...
typedef enum {
	...
	SECUREBOOT_DSP_AVAILABLE,           ///< Quary if DSP is disabled
	...
	SECUREBOOT_CONV_LOWER_CLOCKING,		
	SECUREBOOT_LCD2_4KP60_ENABLE,
...
#define OTP_CONV_OVER_CLOCKING_BIT      20
#define OTP_CPU_LOWER_CLOCKING_BIT		16
#define OTP_CONV_LOWER_CLOCKING_BIT     17
#define OTP_LCD2_4KP60_ENABLE_BIT		21
...
#define OTP_CONV_OVER_CLOCKING          (1 << OTP_CONV_OVER_CLOCKING_BIT)
#define OTP_CPU_LOWER_CLOCKING          (1 << OTP_CPU_LOWER_CLOCKING_BIT)
#define OTP_CONV_LOWER_CLOCKING         (1 << OTP_CONV_LOWER_CLOCKING_BIT)
#define OTP_LCD2_4KP60_ENABLE			(1 << OTP_LCD2_4KP60_ENABLE_BIT)
...
/*
     ...
     @return IC success or fail
        ...
        - @b    EFUSE_OPS_ERR       fail
*/
extern ER efuse_get_unique_id_2(UINT32 *id_L, UINT32 *id_H);
...
extern void otp_trim_dump(void);
/*
     otp_version
