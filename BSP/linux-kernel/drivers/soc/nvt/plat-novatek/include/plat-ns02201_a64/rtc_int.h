...
#define RTC_CLK_DIV_DEFAULT		0x000000A0
...
#define RTC_INT_OSD_ANALOG_ORIGINAL 0x5545 /*Original*/
...
extern int nvt_rtc_read_time(struct device *dev, struct rtc_time *tm);
extern int nvt_rtc_set_time(struct device *dev, struct rtc_time *tm);
extern int nvt_rtc_set_alarm(struct device *dev, struct rtc_wkalrm *alrm);
extern void rtc_set_pwralarm_en(int en);
