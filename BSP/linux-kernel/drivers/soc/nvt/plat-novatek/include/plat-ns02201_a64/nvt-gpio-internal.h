...
#define INVALID_GPIO(pin) ( (pin >= C_GPIO(C_GPIO_NUM) && pin < P_GPIO(0)) || \
		...
		(pin >= D_GPIO(D_GPIO_NUM) && pin < L_GPIO(0)) || \
		(pin >= L_GPIO(L_GPIO_NUM) && pin < S_GPIO(0)) || \
		(pin >= S_GPIO(S_GPIO_NUM) && pin < DSI_GPIO(0)) || \
		(pin >= DSI_GPIO(DSI_GPIO_NUM) && pin < A_GPIO(0)) || \
...
int nvt_gpio_irq_table[GPIO_IRQ_TOTAL] = {
	...
	P_GPIO(30),    P_GPIO(31),    P_GPIO(32),    P_GPIO(33),    P_GPIO(34),
                                      P_GPIO(38),    P_GPIO(39),    P_GPIO(40),   P_GPIO(41),
        P_GPIO(42),    P_GPIO(43),
	...
	L_GPIO(24),    L_GPIO(25),    L_GPIO(26),    L_GPIO(27),    L_GPIO(28),   L_GPIO(29),
	L_GPIO(30),

	DSI_GPIO(0),   DSI_GPIO(1),   DSI_GPIO(2),   DSI_GPIO(3),   DSI_GPIO(4),  DSI_GPIO(5),
	DSI_GPIO(6),   DSI_GPIO(7),   DSI_GPIO(8),   DSI_GPIO(9),   DSI_GPIO(10), DSI_GPIO(11),
	DSI_GPIO(12),  DSI_GPIO(13),
	...
	P_GPIO(35),    P_GPIO(36),    P_GPIO(37),
    	                                             P_GPIO(44),    P_GPIO(45),    P_GPIO(46),
	INTERNAL_GPIO(0)
};
