...
union SPI_CTRL_REG {		     /* SPI Control Register */
	...
	unsigned int spi_gyro_update_even:1;	/* Update GYRO settings on even-numbered VD */
	unsigned int spi_gyro_update_odd:1;	    /* Update GYRO settings on odd-numbered VD */
...
union SPI_CONFIG_REG {   		/* SPI Configuration Register */
	...
	unsigned int spi_dma_path_sel:1;	        /* 0: normal DMA, 1: gyro DMA */
	unsigned int spi_gyro_offset_dly_en:1;	    /* enable bit for 0x114 */  
...
union SPI_DLY_CHAIN_REG {		/* SPI Delay Chain Register */
	...
	unsigned int latch_clk_shift:2;   /* 0x0: normal, 0x1: 1T latch delay, 0x2: 2T latch delay */
	unsigned int reserved1:2;
	unsigned int latch_clk_edge:1;    /* 0x0: rising edge, 0x1: falling edge */
...
union SPI_STATUS_REG {			/* SPI Status Register */
	...
	unsigned int gyro_update_done_even_sts:1;
	unsigned int gyro_trs_abort_done_sts:1;
	unsigned int gyro_dma_abort_done_sts:1;
    unsigned int gyro_dma_addr_done_even_sts:1;
	unsigned int gyro_dma_addr_done_odd_sts:1;
    unsigned int gyro_update_done_odd_sts:1;
	unsigned int reserved0:16;
	} bit;
};

#define SPI_INTEN_REG_OFS	0x1C
union SPI_INTEN_REG {			/* SPI int enable Register */
	uint32_t reg;
	struct {
	unsigned int reserved0:1;
	unsigned int spi_rdr_full:1;	/* Receive data register full.  */
	...
	unsigned int gyro_update_done_even_en:1;
	unsigned int gyro_trs_abort_done_en:1;
	unsigned int gyro_dma_abort_done_en:1;
    unsigned int gyro_dma_addr_done_even_en:1;
	unsigned int gyro_dma_addr_done_odd_en:1;
    unsigned int gyro_update_done_odd_en:1;
...
union SPI_DMA_CTRL_REG {	/* SPI DMA Control Register */
	uint32_t reg;
	struct {
	unsigned int dma_dir:1;	    /* 0: SPI 2 DMA, 1: DMA 2 SPI */
...
#define SPI_DMA_STARTADDR_H_REG_OFS	0x3C
union SPI_DMA_STARTADDR_H_REG {			/* SPI DMA Control Register */
	uint32_t reg;
	struct {
	unsigned int spi_dma_start_addr_h:4;	/* DMA DRAM starting address high bits*/
...
union SPI_GYROSEN_CONFIG_REG {		/* SPI Gyro sensor Configuration Register */
	uint32_t reg;
	struct {
	unsigned int trscnt:7;		/* NOT use: gyro transfer count per trigger */
	unsigned int reserved0:1;
	unsigned int trslen:2;		/* gyro transfer length: how many OPs */
	unsigned int reserved1:2;
    unsigned int vd_src:4;
...
union SPI_GYROSEN_COUNTER_REG {		/* SPI Gyro sensor Transfer and OP Counter Register */
	uint32_t reg;
	struct {
	unsigned int transfer_counter:8;
	unsigned int reserved0:8;
...
//0x100, 0x104, 0x108, 0x10c, 0x110, 0x114, 0x118, 0x11C, 0x120, 0x124, 0x128, 0x12C, 0x130, 0x134
//0x138, 0x13C
//are gyro config registers
#define SPI_GYROSEN_CONFIG2_REG_OFS	0x100
union SPI_GYROSEN_CONFIG2_REG {	/* SPI Gyro sensor Transfer Data Register 8 */
	uint32_t reg;
	struct {
	unsigned int trscnt:8;
	unsigned int reserved0:8;
	unsigned int total_op_count:11;
	unsigned int reserved1:5;
	} bit;
};

#define SPI_GYROSEN_TRS_STS2_REG_OFS	0x104
union SPI_GYROSEN_TRS_STS2_REG {	/* SPI Gyro Transfer Interrupt Enable Register */
	uint32_t reg;
	struct {
	unsigned int trsSts_32:1;
	unsigned int trsSts_33:1;
	unsigned int trsSts_34:1;
	unsigned int trsSts_35:1;
	unsigned int trsSts_36:1;
	unsigned int trsSts_37:1;
	unsigned int trsSts_38:1;
	unsigned int trsSts_39:1;
	unsigned int trsSts_40:1;
	unsigned int trsSts_41:1;
	unsigned int trsSts_42:1;
	unsigned int trsSts_43:1;
	unsigned int trsSts_44:1;
	unsigned int trsSts_45:1;
	unsigned int trsSts_46:1;
	unsigned int trsSts_47:1;
	unsigned int trsSts_48:1;
	unsigned int trsSts_49:1;
	unsigned int trsSts_50:1;
	unsigned int trsSts_51:1;
	unsigned int trsSts_52:1;
	unsigned int trsSts_53:1;
	unsigned int trsSts_54:1;
	unsigned int trsSts_55:1;
	unsigned int trsSts_56:1;
	unsigned int trsSts_57:1;
	unsigned int trsSts_58:1;
	unsigned int trsSts_59:1;
	unsigned int trsSts_60:1;
	unsigned int trsSts_61:1;
	unsigned int trsSts_62:1;
	unsigned int trsSts_63:1;
	} bit;
};

#define SPI_GYROSEN_TRS_INTEN2_REG_OFS	0x108
union SPI_GYROSEN_TRS_INTEN2_REG {	/* SPI Gyro Transfer Interrupt Enable Register */
	uint32_t reg;
	struct {
	unsigned int trsInten_32:1;
	unsigned int trsInten_33:1;
	unsigned int trsInten_34:1;
	unsigned int trsInten_35:1;
	unsigned int trsInten_36:1;
	unsigned int trsInten_37:1;
	unsigned int trsInten_38:1;
	unsigned int trsInten_39:1;
	unsigned int trsInten_40:1;
	unsigned int trsInten_41:1;
	unsigned int trsInten_42:1;
	unsigned int trsInten_43:1;
	unsigned int trsInten_44:1;
	unsigned int trsInten_45:1;
	unsigned int trsInten_46:1;
	unsigned int trsInten_47:1;
	unsigned int trsInten_48:1;
	unsigned int trsInten_49:1;
	unsigned int trsInten_50:1;
	unsigned int trsInten_51:1;
	unsigned int trsInten_52:1;
	unsigned int trsInten_53:1;
	unsigned int trsInten_54:1;
	unsigned int trsInten_55:1;
	unsigned int trsInten_56:1;
	unsigned int trsInten_57:1;
	unsigned int trsInten_58:1;
	unsigned int trsInten_59:1;
	unsigned int trsInten_60:1;
	unsigned int trsInten_61:1;
	unsigned int trsInten_62:1;
	unsigned int trsInten_63:1;
	} bit;
};

#define SPI_GYROSEN_TRS_STS3_REG_OFS	0x10C
union SPI_GYROSEN_TRS_STS3_REG {	/* SPI Gyro Transfer Interrupt Enable Register */
	uint32_t reg;
	struct {
	unsigned int trsSts_64:1;
	unsigned int trsSts_65:1;
	unsigned int trsSts_66:1;
	unsigned int trsSts_67:1;
	unsigned int trsSts_68:1;
	unsigned int trsSts_69:1;
	unsigned int trsSts_70:1;
	unsigned int trsSts_71:1;
	unsigned int trsSts_72:1;
	unsigned int trsSts_73:1;
	unsigned int trsSts_74:1;
	unsigned int trsSts_75:1;
	unsigned int trsSts_76:1;
	unsigned int trsSts_77:1;
	unsigned int trsSts_78:1;
	unsigned int trsSts_79:1;
	unsigned int trsSts_80:1;
	unsigned int trsSts_81:1;
	unsigned int trsSts_82:1;
	unsigned int trsSts_83:1;
	unsigned int trsSts_84:1;
	unsigned int trsSts_85:1;
	unsigned int trsSts_86:1;
	unsigned int trsSts_87:1;
	unsigned int trsSts_88:1;
	unsigned int trsSts_89:1;
	unsigned int trsSts_90:1;
	unsigned int trsSts_91:1;
	unsigned int trsSts_92:1;
	unsigned int trsSts_93:1;
	unsigned int trsSts_94:1;
	unsigned int trsSts_95:1;
	} bit;
};

#define SPI_GYROSEN_TRS_INTEN3_REG_OFS	0x110
union SPI_GYROSEN_TRS_INTEN3_REG {	/* SPI Gyro Transfer Interrupt Enable Register */
	uint32_t reg;
	struct {
	unsigned int trsInten_64:1;
	unsigned int trsInten_65:1;
	unsigned int trsInten_66:1;
	unsigned int trsInten_67:1;
	unsigned int trsInten_68:1;
	unsigned int trsInten_69:1;
	unsigned int trsInten_70:1;
	unsigned int trsInten_71:1;
	unsigned int trsInten_72:1;
	unsigned int trsInten_73:1;
	unsigned int trsInten_74:1;
	unsigned int trsInten_75:1;
	unsigned int trsInten_76:1;
	unsigned int trsInten_77:1;
	unsigned int trsInten_78:1;
	unsigned int trsInten_79:1;
	unsigned int trsInten_80:1;
	unsigned int trsInten_81:1;
	unsigned int trsInten_82:1;
	unsigned int trsInten_83:1;
	unsigned int trsInten_84:1;
	unsigned int trsInten_85:1;
	unsigned int trsInten_86:1;
	unsigned int trsInten_87:1;
	unsigned int trsInten_88:1;
	unsigned int trsInten_89:1;
	unsigned int trsInten_90:1;
	unsigned int trsInten_91:1;
	unsigned int trsInten_92:1;
	unsigned int trsInten_93:1;
	unsigned int trsInten_94:1;
	unsigned int trsInten_95:1;
	} bit;
};

#define SPI_GYROSEN_OFFSET_DLY_REG_OFS	0x114
union SPI_GYROSEN_OFFSET_DLY_REG {	 
	uint32_t reg;
	struct {
	unsigned int offset_dly:21;       /* SPI Gyro sensor Even Offset Delay Register */
	unsigned int reserved0:11;
	} bit;
};


#define SPI_GYROSEN_ODD_OFFSET_DLY_REG_OFS	0x118
union SPI_GYROSEN_ODD_OFFSET_DLY_REG {	 
	uint32_t reg;
	struct {
	unsigned int odd_offset_dly:21;   /* SPI Gyro sensor Odd Offset Delay Register */
	unsigned int reserved0:11;
	} bit;
};
...
#define SPI_GYROSEN_DMA_STARTADDR_EVEN_REG_OFS	0x120
union SPI_GYROSEN_DMA_STARTADDR_EVEN_REG {	 
	uint32_t reg;
	struct {
	unsigned int gyro_dma_start_addr_even:32;    /* Gyro DMA DRAM low starting address 0 */
	} bit;
};

#define SPI_GYROSEN_DMA_STARTADDR_EVEN_H_REG_OFS	0x124
union SPI_GYROSEN_DMA_STARTADDR_EVEN_H_REG {	 
	uint32_t reg;
	struct {
	unsigned int gyro_dma_start_addr_even_h:4;    /* Gyro DMA DRAM high starting address 0 */
	unsigned int reserved0:28;
	} bit;
};
...
#define SPI_GYROSEN_DMA_STARTADDR_ODD_REG_OFS	0x128
union SPI_GYROSEN_DMA_STARTADDR_ODD_REG {	 
	uint32_t reg;
	struct {
	unsigned int gyro_dma_start_addr_odd:32;    /* Gyro DMA DRAM low starting address 1 */
	} bit;
};

#define SPI_GYROSEN_DMA_STARTADDR_ODD_H_REG_OFS	0x12C
union SPI_GYROSEN_DMA_STARTADDR_ODD_H_REG {	 
	uint32_t reg;
	struct {
	unsigned int gyro_dma_start_addr_odd_h:4;    /* Gyro DMA DRAM high starting address 1 */
	unsigned int reserved0:28;
	} bit;
};

#define SPI_GYROSEN_ODD_CONFIG_REG_OFS	0x130
union SPI_GYROSEN_ODD_CONFIG_REG {	 
	uint32_t reg;
	struct {
	unsigned int reserved0:8;
	unsigned int trslen_odd:2;    /* gyro transfer length: how many OPs */
	unsigned int reserved1:6;
	unsigned int len_op0_odd:3;
	unsigned int reserved2:1;
	unsigned int len_op1_odd:3;
	unsigned int reserved3:1;
	unsigned int len_op2_odd:3;
	unsigned int reserved4:1;
	unsigned int len_op3_odd:3;
	unsigned int reserved5:1;
	} bit;
};

#define SPI_GYROSEN_ODD_OP_INTERVAL_REG_OFS 	0x134
union SPI_GYROSEN_ODD_OP_INTERVAL_REG {	 
	uint32_t reg;
	struct {
	unsigned int op_interval_odd:21;   /* SPI Gyro sensor Odd OP interval Register */
	unsigned int reserved0:11;    
	} bit;
};

#define SPI_GYROSEN_ODD_TRS_INTERVAL_REG_OFS 	0x138
union SPI_GYROSEN_ODD_TRS_INTERVAL_REG {	 
	uint32_t reg;
	struct {
	unsigned int trs_interval_odd:21;  /* SPI Gyro sensor Odd Transfer interval Register */
	unsigned int reserved0:11;    
	} bit;
};

#define SPI_GYROSEN_CONFIG2_ODD_REG_OFS 	0x13C
union SPI_GYROSEN_CONFIG2_ODD_REG {	 
	uint32_t reg;
	struct {
	unsigned int trscnt_odd:8;                 /* SPI Gyro sensor Configuration Register 2 */
	unsigned int reserved0:8;
	unsigned int total_op_count_odd:11;        /* SPI Gyro sensor Configuration Register 2 */
	unsigned int reserved1:5;    
	} bit;
};
