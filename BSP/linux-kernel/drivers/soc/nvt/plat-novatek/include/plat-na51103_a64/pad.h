...
*/
typedef enum {
	PAD_DRIVINGSINK_LEVEL_0     =    0x00,     ///< 4mA  / 4mA  / 4mA  / 4mA
	PAD_DRIVINGSINK_LEVEL_1     =    0x01,     ///< 8mA / 8mA  / 10mA
	PAD_DRIVINGSINK_LEVEL_2     =    0x02,     ///< 12mA
	PAD_DRIVINGSINK_LEVEL_3     =    0x03,     ///< 16mA
	PAD_DRIVINGSINK_LEVEL_4     =    0x04,     ///< not support
	PAD_DRIVINGSINK_LEVEL_5     =    0x05,     ///< not support
	PAD_DRIVINGSINK_LEVEL_6     =    0x06,     ///< not support
	PAD_DRIVINGSINK_LEVEL_7     =    0x07,     ///< not support
