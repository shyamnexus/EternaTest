...
typedef struct fttmr010_clocksource{
	struct clocksource	clocksource;
	void __iomem		*base;
	unsigned int		id;	/* one of 3 counters */
	unsigned int		freq;
}*fttmr010_clocksource;

fttmr010_clocksource fttmr010_get_clocksource(void);
void __init fttmr010_init(void __iomem *base, int irq, unsigned long clk_freq);
