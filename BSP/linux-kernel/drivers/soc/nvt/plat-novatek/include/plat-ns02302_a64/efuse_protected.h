...
typedef enum {
	...
	EFUSE_USB3_1_TRIM_DATA = EFUSE_USBC_TRIM_DATA,
...
typedef enum {
	...
	SECUREBOOT_CONV_OVER_CLOCKING_TURBO,///< Quary if CONV can over clocking or not
	...
	SECUREBOOT_VENC_OVER_CLOCKING_TURBO,///< Quary if CONV can over clocking or not

	//NT98539A
	SECUREBOOT_VPE_OVER_CLOCKING,       ///< Quary if VPE can over clocking or not
	SECUREBOOT_VPE_OVER_CLOCKING_TURBO,	///< Quary if VPE can over clocking or not
	SECUREBOOT_LVDS_OVER_CLOCKING,      ///< Quary if LVDS can over clocking or not
	SECUREBOOT_LVDS_OVER_CLOCKING_TURBO,///< 
...
#define OTP_CONV_OVER_CLOCKING_TURBO_BIT	9

#define OTP_VENC_OVER_CLOCKING_BIT      	12
#define OTP_VENC_OVER_CLOCKING_TURBO_BIT	8

//539A only
#define OTP_VPE_OVER_CLOCKING_BIT      		11
#define OTP_VPE_OVER_CLOCKING_TURBO_BIT		7

#define OTP_LVDS_OVER_CLOCKING_BIT      	10
#define OTP_LVDS_OVER_CLOCKING_TURBO_BIT	6
...
#define OTP_LVDS_OVER_CLOCKING_TURBO   		(1 << OTP_LVDS_OVER_CLOCKING_TURBO_BIT)	//bit[06]
//bit[10][6]	=00 Turbo 	1.5Gbps		NT98539A
//				=01	Normal 	1.2Gbps		NT98539G
//				=10 Low 	1.0Gbps		NT98538A/NC98538A

#define OTP_VPE_OVER_CLOCKING      			(1 << OTP_VPE_OVER_CLOCKING_BIT)		//bit[11]
#define OTP_VPE_OVER_CLOCKING_TURBO      	(1 << OTP_VPE_OVER_CLOCKING_TURBO_BIT)	//bit[07]
//bit[11][7]	=00 Turbo 	600MHz		NT98539A
//				=01	Normal 	500MHz		NT98539G
//				=10 Low 	450MHz		NT98538A/NC98538A

//539A only
#define OTP_VENC_OVER_CLOCKING          	(1 << OTP_VENC_OVER_CLOCKING_BIT)   	//bit[12]
#define OTP_VENC_OVER_CLOCKING_TURBO        (1 << OTP_VENC_OVER_CLOCKING_TURBO_BIT)	//bit[08]
//bit[12][8]	=00 Turbo 	530MHz		16MP30 NT98539A 
//				=01 Normal 	530MHz		13MP30 NT98538A/NC98538A/NT98539G
//				=10 low 	400MHz		10MP30 NT98538A/NC98538A/NT98539G


#define OTP_CONV_OVER_CLOCKING          	(1 << OTP_CONV_OVER_CLOCKING_BIT)   	//bit[13]
#define OTP_CONV_OVER_CLOCKING_TURBO		(1 << OTP_CONV_OVER_CLOCKING_TURBO_BIT)	//bit[09]
//bit[13][9]	=00 Turbo 	650MHz		NT98539A
//				=01	Normal 	600MHz		NT98539G/NC98538A
//				=10 Low 	400MHz		NT98538A
