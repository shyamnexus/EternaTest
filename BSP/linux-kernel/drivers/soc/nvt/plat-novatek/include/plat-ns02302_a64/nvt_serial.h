...
#define UART0_CLOCK_FREQ                 24000000
#define UART_HIGH_ADDR_MASK              0xF00000000
...
/* 0x1C RX idle register */
#define UART_SPR_REG                     0x1C
#define RX_IDLE_BIT                      BIT(11)
...
/* 0x70 Tx DMA Starting High Address Register */
#define UART_TX_DMA_ADDR_H_REG           0x70
#define TX_DMA_ADDRESS_H_MASK            GENMASK(3, 0)

/* 0x74 Tx DMA Current High Address Register */
#define UART_TX_CUR_ADDR_H_REG           0x74
#define TX_CUR_ADDRESS_H_MASK            GENMASK(3, 0)

/* 0x78 Rx DMA Starting High Address Register */
#define UART_RX_DMA_ADDR_H_REG           0x78
#define RX_DMA_ADDRESS_H_MASK            GENMASK(3, 0)

/* 0x7C Rx DMA Current High Address Register */
#define UART_RX_CUR_ADDR_H_REG           0x7C
#define RX_CUR_ADDRESS_H_MASK            GENMASK(3, 0)
...
#define TX_DMA_ADDRESS_MASK              GENMASK(31, 0)
...
#define TX_CUR_ADDRESS_MASK              GENMASK(31, 0)
...
#define RX_DMA_ADDRESS_MASK              GENMASK(31, 0)
...
#define RX_CUR_ADDRESS_MASK              GENMASK(31, 0)

/* 0x9C, Rx DMA Control Register */
#define UART_RX_DMA_CTRL_REG             0x9C
#define RX_DMA_EN_BIT                    BIT(0)
#define DMA_RXFIFO_TRGL_MASK             GENMASK(2, 1) 
#define _DMA_RXFIFO_TRGL_SHIFT           1
#define DMA_TRGL_EN_BIT                  BIT(3)
#define RX_DMA_PINPON_EN_BIT             BIT(4)
#define RX_DMA_PINPON_TERMINATE_BIT      BIT(5)
...
/* 0xA8, Timeout Setting  Register */
#define UART_TIMEOUT_SETTING_REG         0xA8
#define TIMEOUT_TIME_MASK                GENMASK(16, 0)
#define TIMEOUT_TIME_SETTING_EN_BIT      BIT(20)

/* 0xAC, Rx DMA Starting Address2 Register */
#define UART_RX_DMA_ADDR2_REG            0xAC
#define RX_DMA_ADDRESS2_MASK             GENMASK(31, 0)

/* 0xB0 Rx DMA Starting High Address2 Register */
#define UART_RX_DMA_ADDR2_H_REG          0xB0
#define RX_DMA_ADDRESS2_H_MASK           GENMASK(3, 0)

/* 0xB4, Rx DMA Current Address Register */
#define UART_RX_CUR_ADDR2_REG            0xB4
#define RX_CUR_ADDRESS2_MASK             GENMASK(31, 0)
...
struct nvt_port {
	...
	unsigned char       *rx_virt_addr1;
	unsigned char       *rx_virt_addr2;
	dma_addr_t          rx_dma_addr1;
	dma_addr_t          rx_dma_addr2;
	unsigned int		pin_pon_flag;
	unsigned int        rx_size;
	struct tasklet_struct   rx_dma_tasklet;

	/* DMA RX timeout feature*/
	struct tasklet_struct   timeout_tasklet;
	unsigned char 		*ch;
	unsigned int		FIFO_Counter;
	unsigned int		DMA_Counter;
	struct spinlock     rx_timeout_lock;
