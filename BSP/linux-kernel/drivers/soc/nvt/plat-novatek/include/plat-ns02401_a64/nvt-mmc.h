...
#define SDIO_HOST_ID_COUNT                  (2)     /* SDIO host count*/
...
#define SDIO_SUP_MASK                   (SDIO1_SUPPORTED | SDIO2_SUPPORTED)
#define SDIO_SUP_BUS_WIDTH_MASK         (SDIO2_SUPPORTED)
#define SDIO1_PINMUX_NUM                3
