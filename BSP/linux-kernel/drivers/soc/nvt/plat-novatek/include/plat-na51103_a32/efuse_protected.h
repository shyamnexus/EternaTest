...
typedef enum {
	EFUSE_ETHERNET_TRIM_DATA = 0x100,				//Normal
	EFUSE_USBC_TRIM_DATA_1ST,						//internal 12K trimming(2ND)
	EFUSE_DDR_RZQ_TRIM_DATA_1ST,					//RZQ trim bit [4..0](1st)
	EFUSE_DDR_LDO_TRIM_DATA_2ND,					//LDO trim bit[11..8](2nd)
	EFUSE_SATA_TRIM_DATA,
	EFUSE_HDMI_LANE_VL_TRIM_DATA,					//HDMI LANE VL fine tune trim addr[3]
													// [11..0]
													//	->Per Lane VL fine tune Trimming

	EFUSE_THERMAL_TRIM_DATA,
	EFUSE_CORE_POWER_ADJ_TRIM_DATA_1ST,				//1ST
	EFUSE_CORE_POWER_LEAKAGE_TRIM_DATA_2ND,			//2ND
	EFUSE_HDMI_TRIM_DATA,							//HDMI resistor
...
typedef enum {
	...
	EFUSE_ABILITY_VCAP1_AVL 		= 0x1005,		//< VCAP1 available
	EFUSE_ABILITY_CVBS_AVL 			= 0x1006,		//< VCAP1 available
