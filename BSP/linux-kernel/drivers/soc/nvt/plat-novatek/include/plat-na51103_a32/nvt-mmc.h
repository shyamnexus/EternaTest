...
*/
#ifndef __SOC_NVT_PLAT_NA51103_NVT_MMC_H
#define __SOC_NVT_PLAT_NA51103_NVT_MMC_H
...
#define SDIO_HOST_ID_COUNT                  (1)     /* SDIO host count*/
...
#define SDIO_SUP_MASK                   (SDIO1_SUPPORTED)
#define SDIO_SUP_BUS_WIDTH_MASK         (0)
#define SDIO1_PINMUX_NUM                2
...
#define SDIO_DELAY_PHASE_SEL_MAX        0  // max frequency 48MHz will not use tuning flow
#define SDIO_DELAY_PHASE_UNIT_MAX       0  // max frequency 48MHz will not use tuning flow
...
#endif /* __SOC_NVT_PLAT_NA51103_NVT_MMC_H */
