...
#define CG_CHARGE_PUMP_REG_OFFSET			0x4104

/* shift SATA frequency */
#define CG_SHIFT_SATA_FREQ_REG0_OFFSET		0x4560
#define CG_SHIFT_SATA_FREQ_REG1_OFFSET		0x4564
#define CG_SHIFT_SATA_FREQ_REG2_OFFSET		0x4568
