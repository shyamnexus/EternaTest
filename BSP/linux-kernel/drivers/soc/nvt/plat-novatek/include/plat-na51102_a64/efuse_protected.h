...
typedef enum {
	...
	EFUSE_ZQK_LPDDR4X_CKE_RST_TRIM_DATA,
	EFUSE_ZQK_LPDDR4X_DQ_DQS_CLK_CS_CA_TRIM_DATA,

	EFUSE_ZQK_LPDDR4_CKE_RST_TRIM_DATA,
	EFUSE_ZQK_LPDDR4_DQ_DQS_CLK_CS_CA_TRIM_DATA,

	EFUSE_ZQK_DDR4_CLK_CS_CKE_CA_RST_TRIM_DATA,
	EFUSE_ZQK_DDR4_DQ_DQS_TRIM_DATA,
...
#define OTP_DSP_DISABLE                 (1<<OTP_DSP_DISABLE_BIT)
...
#define is_dsp_available()                  quary_secure_boot(SECUREBOOT_DSP_AVAILABLE)
#endif
