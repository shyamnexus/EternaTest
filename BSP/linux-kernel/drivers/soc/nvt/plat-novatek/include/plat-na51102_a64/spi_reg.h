...
union SPI_CTRL_REG {		     /* SPI Control Register */
	...
	unsigned int spi_gyro_update:1; /* Trigger SPI GYRO to update setting in next VD */
...
union SPI_GYROSEN_CONFIG_REG {		/* SPI Gyro sensor Configuration Register */
	...
	unsigned int reserved1:2;
	unsigned int spi_gyro_vdsrc:3;
	unsigned int reserved2:1;
	unsigned int len_op0:3;		/* OP1 byte length */
	unsigned int reserved3:1;
	unsigned int len_op1:3;		/* OP2 byte length */
	unsigned int reserved4:1;
	unsigned int len_op2:3;		/* OP3 byte length */
