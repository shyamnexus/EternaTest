...
#define NVT_GPIO_NUMBER                 (A_GPIO(A_GPIO_NUM))

/* GPIO Storage Data Register */
#define GPIO_DATA_NUM                   9
...
#define INVALID_GPIO(pin) ( (pin < C_GPIO(0)) || \
		(pin >= C_GPIO(C_GPIO_NUM) && pin < L_GPIO(0)) || \
		(pin >= L_GPIO(L_GPIO_NUM) && pin < P_GPIO(0)) || \
...
int nvt_gpio_irq_table[GPIO_IRQ_TOTAL] = {
	...
	C_GPIO(18),    C_GPIO(19),    C_GPIO(20),    C_GPIO(21),    C_GPIO(22),
	...
	DSI_GPIO(6),   DSI_GPIO(7),   DSI_GPIO(8),   DSI_GPIO(9),   DSI_GPIO(10),
