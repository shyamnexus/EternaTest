...
#define NVT_GIC_CPU_PHYS_BASE	(0xfff00100)
...
#define NVT_PR_8051_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x0100000)
#define NVT_PR_8051_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x0100000)

#define NVT_RTC_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x0142000)
#define NVT_RTC_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x0142000)
...
#define NVT_USB1_APB_BASE_PHYS	(NVT_PERIPHERAL_PHYS_BASE + 0x0600000)
#define NVT_USB1_APB_BASE_VIRT	(NVT_PERIPHERAL_VIRT_BASE + 0x0600000)

#define NVT_MAU_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x0000000)
...
#define NVT_CC_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x001E0000)
#define NVT_CC_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x001E0000)

#define NVT_TZPC_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x00FF0000)
#define NVT_TZPC_BASE_VIRT		(NVT_PERIPHERAL_PHYS_BASE + 0x00FF0000)

#define NVT_SCE_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x00620000)
#define NVT_SCE_BASE_VIRT		(NVT_PERIPHERAL_PHYS_BASE + 0x00620000)

#define NVT_ETH_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x002B0000)
#define NVT_ETH_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x002B0000)

#define NVT_WDT_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x00141000)
#define NVT_WDT_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x00141000)
...
#define NVT_SATA_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x00251000)
#define NVT_SATA_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x00251000)

#define NVT_SENPHY_BASE_PHYS    (NVT_PERIPHERAL_PHYS_BASE + 0x006B0000)
#define NVT_SENPHY_BASE_VIRT    (NVT_PERIPHERAL_VIRT_BASE + 0x006B0000)

#define NVT_PR_SRAM_BASE_PHYS           (NVT_PERIPHERAL_PHYS_BASE + 0x011011C)
#define NVT_PR_SRAM_BASE_VIRT           (NVT_PERIPHERAL_VIRT_BASE + 0x011011C)

#define NVT_PR_TOP_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x0110000)
#define NVT_PR_TOP_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x0110000)

#define NVT_PR_CG_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x0120000)
#define NVT_PR_CG_BASE_VIRT		(NVT_PERIPHERAL_VIRT_BASE + 0x0120000)

#define NVT_IFE_SRAM_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x007c0000)
#define NVT_IFE_SRAM_BASE_VIRT		(NVT_PERIPHERAL_PHYS_BASE + 0x007c0000)
#define NVT_IFE_SRAM_SIZE		0x16000

#define NVT_PR_TCM_SRAM_BASE_PHYS		(NVT_PERIPHERAL_PHYS_BASE + 0x0900000)
#define NVT_PR_TCM_SRAM_BASE_VIRT		(NVT_PERIPHERAL_PHYS_BASE + 0x0900000)
#define NVT_PR_TCM_SRAM_SIZE		0x16000
