...
#define TOP_ROMVER_A            0x00000109
#define TOP_ROMVER_B            0x00000111
#define TOP_NS02402_ROMVER_A	0x00000106

uint32_t nvt_get_chip_ver(void)
    {
    void __iomem *top_reg_addr = NULL;
    unsigned int chip_ver;
    phys_addr_t top_pa = NVT_PERIPHERAL_PHYS_BASE + 0xBFFC;
	...
	if (nvt_get_chip_id() == CHIP_NS02402) {
		if(chip_ver == TOP_NS02402_ROMVER_A) {
			return CHIPVER_A;
		} else {
			pr_info("force to Ver A\n");
			return CHIPVER_A;
		}
	} else {
...
//	local_top_reg_hgpio0.reg = TOP_GETREG(info, TOP_REGHSIGPIO0_OFS);
    ...
    if (local_top_reg3.bit.ETH_LED == MUX_1) {
        value |= PIN_ETH_CFG_ETH_LED_1;
    } else if (local_top_reg3.bit.ETH_LED == MUX_2) {
	...
	if (chip_id == CHIP_NS02402) {
		if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_1) {
			value |= PIN_SN_TIMER_SET_MUX_1;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_2) {
			value |= PIN_SN_TIMER_SET_MUX_2;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_3) {
			value |= PIN_SN_TIMER_SET_MUX_3;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_4) {
			value |= PIN_SN_TIMER_SET_MUX_4;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_5) {
			value |= PIN_SN_TIMER_SET_MUX_5;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_6) {
			value |= PIN_SN_TIMER_SET_MUX_6;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_7) {
			value |= PIN_SN_TIMER_SET_MUX_7;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_8) {
			value |= PIN_SN_TIMER_SET_MUX_8;
		} else if (local_top_reg9.bit.SN_TIMER_SET_MUX == MUX_9) {
			value |= PIN_SN_TIMER_SET_MUX_9;
		}

		if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_1) {
			value |= PIN_SN_TIMER_SET_2_MUX_1;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_2) {
			value |= PIN_SN_TIMER_SET_2_MUX_2;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_3) {
			value |= PIN_SN_TIMER_SET_2_MUX_3;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_4) {
			value |= PIN_SN_TIMER_SET_2_MUX_4;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_5) {
			value |= PIN_SN_TIMER_SET_2_MUX_5;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_6) {
			value |= PIN_SN_TIMER_SET_2_MUX_6;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_7) {
			value |= PIN_SN_TIMER_SET_2_MUX_7;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_8) {
			value |= PIN_SN_TIMER_SET_2_MUX_8;
		} else if (local_top_reg9.bit.SN_TIMER_SET_2_MUX == MUX_9) {
			value |= PIN_SN_TIMER_SET_2_MUX_9;
		}
	}
	...
	} else if (local_top_reg8.bit.SENSOR2 == MUX_6) {
		value |= PIN_SENSOR2_CFG_TSENSOR3BITS;
	} else if (local_top_reg8.bit.SENSOR2 == MUX_7) {
		value |= PIN_SENSOR2_CFG_TSENSOR7BITS;
	}
	...
	if (chip_id == CHIP_NS02402) {
		if (local_top_reg16.bit.SPI2_RDY == MUX_1) {
...
static int pinmux_config_sensor(uint32_t config)
{
	if (config == PIN_SENSOR_CFG_NONE) {
		...
		if (chip_id == CHIP_NS02402) {
			if (config & PIN_SN_TIMER_SET_MUX_1) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_1;
			} else if (config & PIN_SN_TIMER_SET_MUX_2) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_2;
			} else if (config & PIN_SN_TIMER_SET_MUX_3) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_3;
			} else if (config & PIN_SN_TIMER_SET_MUX_4) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_4;
			} else if (config & PIN_SN_TIMER_SET_MUX_5) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_5;
			} else if (config & PIN_SN_TIMER_SET_MUX_6) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_6;
			} else if (config & PIN_SN_TIMER_SET_MUX_7) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_7;
			} else if (config & PIN_SN_TIMER_SET_MUX_8) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_8;
			} else if (config & PIN_SN_TIMER_SET_MUX_9) {
				top_reg9.bit.SN_TIMER_SET_MUX = MUX_9;
			}

			if (config & PIN_SN_TIMER_SET_2_MUX_1) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_1;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_2) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_2;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_3) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_3;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_4) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_4;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_5) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_5;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_6) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_6;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_7) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_7;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_8) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_8;
			} else if (config & PIN_SN_TIMER_SET_2_MUX_9) {
				top_reg9.bit.SN_TIMER_SET_2_MUX = MUX_9;
			}
		}
	}
...
static int pinmux_config_sensor2(uint32_t config)
{
	if (config == PIN_SENSOR2_CFG_NONE) {
		...
		if (config & PIN_SENSOR2_CFG_12BITS) {
			...
			gpio_func_keep(HSIGPIO_8, 16, func_SENSOR2);
			gpio_func_keep(SGPIO_7, 1, func_SENSOR2);
		} else if (config & PIN_SENSOR2_CFG_TSENSOR3BITS) {

			confl_detect += gpio_conflict_detect(HSIGPIO_10, 14, func_SENSOR2);
			confl_detect += gpio_conflict_detect(SGPIO_1, 5, func_SENSOR2);
			confl_detect += gpio_conflict_detect(SGPIO_7, 1, func_SENSOR2);
			if (confl_detect > 0) {
				return E_PAR;
			}

			top_reg8.bit.SENSOR2 = MUX_6;
			top_reg_hsigpio0.bit.HSIGPIO_10 = GPIO_ID_EMUM_FUNC;
			top_reg_hsigpio0.bit.HSIGPIO_11 = GPIO_ID_EMUM_FUNC;
			top_reg_hsigpio0.bit.HSIGPIO_12 = GPIO_ID_EMUM_FUNC;
			top_reg_hsigpio0.bit.HSIGPIO_13 = GPIO_ID_EMUM_FUNC;
			...
			gpio_func_keep(HSIGPIO_10, 14, func_SENSOR2);
			gpio_func_keep(SGPIO_1, 5, func_SENSOR2);
			gpio_func_keep(SGPIO_7, 1, func_SENSOR2);
		} else if (config & PIN_SENSOR2_CFG_TSENSOR7BITS) {

			confl_detect += gpio_conflict_detect(HSIGPIO_10, 14, func_SENSOR2);
			confl_detect += gpio_conflict_detect(SGPIO_1, 5, func_SENSOR2);
			confl_detect += gpio_conflict_detect(SGPIO_7, 3, func_SENSOR2);
			confl_detect += gpio_conflict_detect(SGPIO_14, 2, func_SENSOR2);
			if (confl_detect > 0) {
				return E_PAR;
			}

			top_reg8.bit.SENSOR2 = MUX_7;
			top_reg_hsigpio0.bit.HSIGPIO_10 = GPIO_ID_EMUM_FUNC;
			top_reg_hsigpio0.bit.HSIGPIO_11 = GPIO_ID_EMUM_FUNC;
			top_reg_hsigpio0.bit.HSIGPIO_12 = GPIO_ID_EMUM_FUNC;
			top_reg_hsigpio0.bit.HSIGPIO_13 = GPIO_ID_EMUM_FUNC;
			...
			gpio_func_keep(SGPIO_1, 5, func_SENSOR2);
			gpio_func_keep(SGPIO_7, 3, func_SENSOR2);
			gpio_func_keep(SGPIO_14, 2, func_SENSOR2);
		}
	...
	if (config == PIN_SPI_CFG_NONE) {
		...
		if (chip_id == CHIP_NS02402) {
			if (config & PIN_SPI_CFG_SPI2_RDY_1) {
				...
				confl_detect += gpio_conflict_detect(PGPIO_21, 1, func_SPI2_RDY);
				if (confl_detect > 0) {
					return E_PAR;
				}

				top_reg16.bit.SPI2_RDY = MUX_1;
				top_reg_pgpio0.bit.PGPIO_21 = GPIO_ID_EMUM_FUNC;
				gpio_func_keep(PGPIO_21, 1, func_SPI2_RDY);
			}
		}
...
ER pinmux_init(struct nvt_pinctrl_info *info)
{
	...
	if (boot_hint && logoboot) {
		...
		info->top_pinmux[PIN_FUNC_SEL_LCD].config = lcd_type;
		info->top_pinmux[PIN_FUNC_SEL_LCD].pin_function = PIN_FUNC_SEL_LCD;
		boot_hint = 0;
	}
