...
int pad_suspend(struct nvt_pinctrl_info *info)
{
	...
	PAD_DS pin_ds_end[7] = {PAD_DS_CGPIO23, PAD_DS_PGPIO25, PAD_DS_SYS_RST, PAD_DS_LGPIO24, PAD_DS_SGPIO15, PAD_DS_HSIGPIO23, PAD_DS_AGPIO2};
	PAD_DS pin_ds_base[7] = {PAD_DS_CGPIO_BASE, PAD_DS_PGPIO_BASE, PAD_DS_DGPIO_BASE, PAD_DS_LGPIO_BASE, PAD_DS_SGPIO_BASE, PAD_DS_HSIGPIO_BASE, PAD_DS_AGPIO_BASE};

	PAD_DS pin_end[7] = {PAD_PIN_CGPIO23, PAD_PIN_PGPIO25, PAD_PIN_SYS_RST, PAD_PIN_LGPIO24, PAD_PIN_SGPIO15, PAD_PIN_HSIGPIO23, PAD_PIN_AGPIO2};
	PAD_DS pin_base[7] = {PAD_CGPIO_BASE, PAD_PGPIO_BASE, PAD_DGPIO_BASE, PAD_LGPIO_BASE, PAD_SGPIO_BASE, PAD_HSIGPIO_BASE, PAD_AGPIO_BASE};
