...
extern void nvt_pinmux_show(void);
...
#if (LINUX_VERSION_CODE > KERNEL_VERSION(5, 10, 0))
static struct proc_ops proc_efuse_fops = {
	.proc_open   = nvt_pinmux_proc_efuse_open,
	.proc_release = single_release,
	.proc_read   = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write  = nvt_pinmux_proc_efuse_otp_write,
};
#else
...
#else
static struct file_operations proc_pinmux_fops = {
	.owner  = THIS_MODULE,
	.open   = nvt_pinmux_proc_show_open,
	.release = single_release,
	.read   = seq_read,
	.llseek = seq_lseek,
};
