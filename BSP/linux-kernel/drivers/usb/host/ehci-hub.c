...
int ehci_hub_control(
	...
	unsigned	selector;
#ifdef CONFIG_USB_NVTIVOT_HCD
	void __iomem *phy_reg = ehci->phy_reg;
#endif
	...
	case SetPortFeature:
		...
		case USB_PORT_FEAT_TEST:
			...
			{
				case 1: //J
					writel(0xE2, phy_reg + 0xD4);
					writel(0xFF, phy_reg + 0xD0);
					writel(0, phy_reg + 0x88);
					writel(0xFF, phy_reg + 0x8C);
					writel(0x31, phy_reg + 0x80);
					break;
				case 2: //k
					writel(0xE2, phy_reg + 0xD4);
					writel(0xFF, phy_reg + 0xD0);
					writel(0, phy_reg + 0x88);
					writel(0, phy_reg + 0x8C);
					writel(0x31, phy_reg + 0x80);
					break;
				case 4:
					writel(0xE2, phy_reg + 0xD4);
					writel(0xFF, phy_reg + 0xD0);
					writel(0x2A, phy_reg + 0x50);
					writel(0x2B, phy_reg + 0x50);
					break;
				default:
					break;
			}
