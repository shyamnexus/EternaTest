...
/* NVT vendor-specific STOP EP. */
#define TRB_NVT_STOP 	50

#if defined(CONFIG_NVT_IVOT_PLAT_NS02302) || defined(CONFIG_NVT_IVOT_PLAT_NS02401)
/* SE1 handle */
#define NVT_SE1_EN (0x1 << 4)
#define NVT_SE1_OFS (0xC)
#define NVT_SE1_STS (0x1 << 5)
#endif
...
struct xhci_hcd {
...
#if defined(CONFIG_NVT_IVOT_PLAT_NS02201) || defined(CONFIG_NVT_IVOT_PLAT_NA51102) || defined(CONFIG_NVT_IVOT_PLAT_NS02302) || defined(CONFIG_NVT_IVOT_PLAT_NA51090) || defined(CONFIG_NVT_IVOT_PLAT_NS02401)
	int                 ep_id;
	unsigned long       phy_reg;
	int                 power_gpio[2];
	int                 ssc_ofs[3];
	int                 ssc_value[3];
	struct clk          *phyclk;
	struct clk          *phyclk_ss;
	...
	u8 				rx_term_trim_val;
	u8 				force_hs;
	u8				USB_SATA_Internal_12K_resistor;
	u8				u3_channel;
#endif
