...
#define PRJ_FIFONUM_16		0
#define PRJ_FIFONUM_4		1
#else
#define PRJ_FIFONUM_16		1
#define PRJ_FIFONUM_4		0
#endif

#ifdef PRJ_FIFONUM_16
#define FOTG210_DEFAULT_NUM_EP	8
#define FOTG210_MAX_NUM_EP	16 /* ep0...ep15 */
#define FOTG210_MAX_FIFO_NUM	16 /* fifo0...fifo15 */
#elif PRJ_FIFONUM_4
#define FOTG210_DEFAULT_NUM_EP	5
#define FOTG210_MAX_NUM_EP	5 /* ep0...ep8 */
...
#define DCFESR_FIFO_EMPTY(fifo)	((fifo < 8) ? (1 << 8 << (fifo)) : (1 << 16 << (fifo-8))) /* (fifo < 8) at (0x120) and (fifo >= 8) at (0x124) */
...
#define DMISGR1_MF_OUTSPK_INT(fifo)	((fifo < 8) ? (0x3 << ((fifo) * 2)) : (0x3 << 16 << ((fifo-8) * 2))) /* (fifo < 8) at (0x138) and (fifo >= 8) at (0x13C) */
...
#define RX0BYTE_EP15		(1 << 14)
#define RX0BYTE_EP14		(1 << 13)
#define RX0BYTE_EP13		(1 << 12)
#define RX0BYTE_EP12		(1 << 11)
#define RX0BYTE_EP11		(1 << 10)
#define RX0BYTE_EP10		(1 << 9)
#define RX0BYTE_EP9		(1 << 8)
...
#define TX0BYTE_EP15		(1 << 14)
#define TX0BYTE_EP14		(1 << 13)
#define TX0BYTE_EP13		(1 << 12)
#define TX0BYTE_EP12		(1 << 11)
#define TX0BYTE_EP11		(1 << 10)
#define TX0BYTE_EP10		(1 << 9)
#define TX0BYTE_EP9		(1 << 8)
...
#define DMACPSR1_CLR_FIFO_DMA_ABORT      (1 << 4)
...
/* Device DMA Controller Parameter setting 4 Register (0x1D4) */
#define FOTG210_DMA_RM_LEN      0x1D4

/* Device VDMA Complete And FIFO empty interrupt (0x3A8) */
#define VDMA_CMPLT_EMPTY_FX_INT 0x3A8

/* Device VDMA Complete And FIFO empty interrupt Mask (0x3AC) */
#define VDMA_CMPLT_EMPTY_FX_INT_MASK 0x3AC

/* AXI Monitor Register (0x404)*/
#define AXI_MONI_REG 0x404
#define MONI_CH_DIS (1 << 16)
#define MONI_CHANNEL_IDLE (1 << 17)
#define BUF_WCH_BYPASS (1 << 20)
#define BUF_RCH_BYPASS (1 << 21)
#define BUF_RESP_MODE (1 << 30)

/* PHY TOP Register*/
#ifdef CONFIG_NVT_IVOT_PLAT_NA51103
#define PHY_TOP_SET_REG 0x1D8
#else
#define PHY_TOP_SET_REG 0x400
#endif
