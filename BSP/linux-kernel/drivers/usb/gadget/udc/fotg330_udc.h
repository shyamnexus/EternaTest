...
#define FUSB300_HSCR_HS_LPM_BESL_PERMIT_MAX 17
#define FUSB300_HSCR_HS_LPM_BESL_PERMIT_MIN 13
#define FUSB300_HSCR_HS_LPM_BESL	9
#define BESL_MASK			0xF
#define BESL_MIN_DEFAULT                9
...
#define SS_CTL_MAX_PACKET_SIZE		0x800 /* this is tmep solution for desc > 512B, need to check reason*/
...
//SSC
#define SSC_PERIOD						0xBE
#define SSC_MULFAC						0x6

/*(1i+15e)*/
#define FOTG330_PRD_NUM	16
...
struct fusb300_ep {
	...
	unsigned char		type;
	unsigned		disable;
	unsigned		dma_ongoing;
	unsigned long   dma_timeout_jiffies;
	/*For SGDMA*/
	struct sg_prd		*prd_pool;
	dma_addr_t		prd_pool_dma;
};
...
struct fusb300 {
	...
	struct fusb300_ep	*ep[FUSB330_MAX_NUM_EP + 1];	/* FUSB330_MAX_NUM_EP + ep0*/
	...
	void __iomem            *u3_utmi_phy_reg;
	void __iomem            *u3phy_reg;
	void __iomem            *u3cg_reg;
	struct task_struct  *polling_thread_task;
	struct task_struct  *fsm_polling_thread_task;
	struct task_struct  *dma_monitor;
	u32 disconnect_det;
	u32 get_power_gpio;
};
...
/**************************************************************/
//0x0
#define FUSB300_TOP_CHG_CTRL_REG           0x00
//0x4
#define FUSB300_TOP_DCD_CNT_REG            0x04
//0x8
#define FUSB300_TOP_BUS_STS_REG            0x08
//0xC
#define FUSB300_TOP_UTMI_MON_REG           0x0C
#define FUSB300_TOP_UTMI_MON_EN        (0)
#define FUSB300_TOP_UTMI_MON_STS       (1)
#define FUSB300_TOP_UTMI_MON_UB        (8)
#define FUSB300_TOP_UTMI_MON_TAR       (16)
#define FUSB300_TOP_UTMI_MON_CMP       (24)
#define FUSB300_TOP_UTMI_MON_BITCNT    (8)
//0x10
#define FUSB300_TOP_MISC_1_REG             0x10
#define FUSB300_TOP_VBUS_VALID         (0)
#define FUSB300_TOP_USB_ID             (1)
#define FUSB300_TOP_UTMI_PHY_SUSPEND   (2)
#define FUSB300_TOP_FORCE_HS           (3)
#define FUSB300_TOP_ELEC_BUF_MODE      (4)
#define FUSB300_TOP_BYPASS_RXDET       (5)
#define FUSB300_TOP_PP_PATCH           (6)
#define FUSB300_TOP_PPC_VAL            (7)
#define FUSB300_TOP_PIPE_MARGIN        (8)
#define FUSB300_TOP_RXTERM_EN_MSK      (11)
#define FUSB300_TOP_U3PHY_RST_CTL0     (16)
#define FUSB300_TOP_U3PHY_RST_CTL1     (17)
#define FUSB300_TOP_U3PHY_RST_CTL2     (18)
#define FUSB300_TOP_PD3_PHYSTS_PATCH   (19)
#define FUSB300_TOP_TXIDLE_MSK         (20)
#define FUSB300_TOP_U3TOU0_PATCH       (21)
#define FUSB300_TOP_U2PHY_RST_CTL0     (24)
#define FUSB300_TOP_U2PHY_RST_CTL1     (25)
#define FUSB300_TOP_U2PHY_RST_CTL2     (26)
#define FUSB300_TOP_VER_CTRL           (28)
//0x14
#define FUSB300_TOP_MISC_2_REG             0x14
#define FUSB300_TOP_EP0_DATAPORT_REMAP (0)
#define FUSB300_TOP_BUF_RESP_MODE      (1)
#define FUSB300_TOP_BUF_RCH_BYPASS     (2)
#define FUSB300_TOP_BUF_WCH_BYPASS     (3)
#define FUSB300_TOP_BUF_PHY_INT_EN     (8)
#define FUSB300_TOP_BUF_CH_DIS         (9)
#define FUSB300_TOP_BUF_PHY_INT_STS    (12)
#define FUSB300_TOP_BUF_CH_IDLE        (13)
#define FUSB300_TOP_BUF_PHY_CH_R_OSTD  (16)
#define FUSB300_TOP_BUF_PHY_CH_W_OSTD  (24)
//0x18
#define FUSB300_TOP_SOF_1_REG              0x18
//0x1C
#define FUSB300_TOP_SOF_2_REG              0x1C
//0x20
#define FUSB300_TOP_U1U2_REG               0x20
//0x28
#define FUSB300_TOP_DBG_SEL_REG            0x28
//0x2C
#define FUSB300_TOP_DBG_RESULT_REG         0x2C
//0x30
#define FUSB300_TOP_CH_STS_REG             0x30
//0x34
#define FUSB300_TOP_PHY_DLY_REG            0x34
//0x38
#define FUSB300_TOP_PHY_12K_REG            0x38
//0x3C
#define FUSB300_TOP_UVC_PATCH_REG          0x3C
//0x40
#define FUSB300_TOP_WAK_CTRL_1_REG         0x40
//0x44
#define FUSB300_TOP_WAK_CTRL_2_REG         0x44
//0xC0
#define FUSB300_TOP_SE1_DET_REG            0xC0
#endif
