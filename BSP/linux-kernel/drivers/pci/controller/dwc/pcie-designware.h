...
#define PCIE_ATU_UNR_UPPER_LIMIT	0x20
#define IATU_OUTBOUND_TOTAL_SEG_SIZE	16
#define IATU_INBOUND_TOTAL_SEG_SIZE	8
/* inbound group Offset is 100 */
#define PCIE_ATU_UNR_REGION_CTRL_1_OFF_INBOUND_0		(0x00)
#define PCIE_ATU_UNR_REGION_CTRL_2_OFF_INBOUND_0		(0x04)
#define PCIE_ATU_UNR_LWR_BASE_ADDR_OFF_INBOUND_0		(0x08)
#define PCIE_ATU_UNR_UPPER_BASE_ADDR_OFF_INBOUND_0		(0x0c)
#define PCIE_ATU_UNR_LIMIT_ADDR_OFF_INBOUND_0			(0x10)
#define PCIE_ATU_UNR_LWR_TARGET_ADDR_OFF_INBOUND_0		(0x14)
#define PCIE_ATU_UNR_UPPER_TARGET_ADDR_OFF_INBOUND_0		(0x18)
#define PCIE_ATU_UNR_UPPER_LIMIT_ADDR_OFF_INBOUND_0		(0x20)
#endif
