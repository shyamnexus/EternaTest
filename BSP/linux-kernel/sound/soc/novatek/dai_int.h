...
#ifdef __KERNEL__
extern void __iomem *_DAI_REG_BASE_ADDR[1];
...
#else
#define DAI_SETREG(ofs, value)       OUTW((uintptr_t *)(IOADDR_DAI_REG_BASE+(ofs)), (value))
#define DAI_GETREG(ofs)              INW((uintptr_t *)(IOADDR_DAI_REG_BASE+(ofs)))
#endif
...
extern void             dai_set_debug_dma_para(uintptr_t buf_addr, UINT32 buf_size);
