/*
    Embedded Audio Codec Driver register header

    Header file for Embedded Audio Codec register
    This file is the header file that define register for Embedded Audio Codec
...
REGDEF_OFFSET(DMIC2_VLMN_REG, 0x208)
