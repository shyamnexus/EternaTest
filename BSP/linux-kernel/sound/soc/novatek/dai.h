...
/**
    ...
    @return void
*/
extern void     dai_open(DRV_CB isr_hdl, int dai_id);
...
/**
    ...
    @return void
*/
extern void     dai_close(int dai_id);
...
/**
    ...
    @return void
*/
extern void     dai_set_config(DAI_CONFIG_ID config_id, uintptr_t config_value);
...
/**
    Set Digital Audio interface(DAI) I2S TDM DATA Order Configurations.

    Set Digital Audio interface(DAI)  I2S TDM DATA Order configuration.
    Use DAI_I2S_DATAORDERPOS as configuration selection and config_value is the configuration parameter.
    ...
    @return void
*/
extern void  dai_set_i2s_order(DAI_I2S_DATAORDERPOS config_id, UINT32 config_value);
extern void  dai2_set_i2s_order(DAI_I2S_DATAORDERPOS config_id, UINT32 config_value);

/**
    Get Digital Audio interface(DAI) I2S TDM DATA Order Configurations.

    Get Digital Audio interface(DAI)  I2S TDM DATA Order configuration.
    Use DAI_I2S_DATAORDERPOS as configuration selection and config_value is the configuration parameter.

    @param[in] config_id     Configuration selection. Please refer to  DAI_I2S_DATAORDERPOS for details.
    @return    UINT32        Please refer to DAI_I2S_DATAORDERPOS for details.

*/
extern UINT32 dai_get_i2s_order(DAI_I2S_DATAORDERPOS config_id);
extern UINT32 dai2_get_i2s_order(DAI_I2S_DATAORDERPOS config_id);
...
/**
    ...
    @return void
*/
extern void     dai_set_rx_dma_para(int id, int ddr_id,UINT32 dma_channel, uintptr_t dma_start_addr, UINT32 dma_buffer_size);
...
/**
    ...
    @return void
*/
extern void     dai_set_txlb_dma_para(uintptr_t buf_addr, UINT32 buf_size);
...
/**
    ...
    @return void
*/
extern void     dai_get_tx_dma_para(UINT32 channel, uintptr_t *p_buf_addr, UINT32 *p_buf_size);
...
/**
    ...
    @return void
*/
extern void     dai_get_rx_dma_para(UINT32 channel, uintptr_t *p_buf_addr, UINT32 *p_buf_size);
...
/**
    ...
    @return void
*/
extern void     dai_get_txlb_dma_para(uintptr_t *p_buf_addr, UINT32 *p_buf_size);
...
*/
extern void     dai_enableclk(int dai_id);
extern void     dai_disableclk(int dai_id);
extern void     dai_setclkrate(unsigned long clkrate, int dai_id);
extern uintptr_t dai_get_rx_muti_ch_dma_curaddr(int id, int ddr_id,UINT32 dma_channel);
