...
*/
#ifndef __SOC_NVT_IVOT_NVT_IO_H
#define __SOC_NVT_IVOT_NVT_IO_H
...
#define nvt_readq(offset)		readq((void __iomem *)(offset))
#endif
...
#if defined(CONFIG_ARM64)
#define nvt_writeq(val, offset)		writeq(val, (void __iomem *)(offset))
#endif

#endif /* __SOC_NVT_IVOT_NVT_IO_H */
