...
#if defined(CONFIG_PLAT_NOVATEK) && defined(CONFIG_NVT_DCACHE_FLUSH_ALL)
extern void __dma_flush_all(void);
#endif /* CONFIG_PLAT_NOVATEK && CONFIG_NVT_DCACHE_FLUSH_ALL */
