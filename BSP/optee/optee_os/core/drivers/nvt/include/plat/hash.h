...
typedef enum {
    ...
    HASH_CLOCK_PLL2 = 0,              ///< Select HASH clock rate PLL2 (400MHz)
    HASH_CLOCK_PLL13,                 ///< Select HASH clock rate PLL13(350MHz)
#else
    HASH_CLOCK_240MHz = 0,            ///< Select HASH clock rate 240 MHz
    HASH_CLOCK_320MHz,                ///< Select HASH clock rate 320 MHz
    HASH_CLOCK_Reserved,              ///< Select HASH clock rate Reserved
    HASH_CLOCK_PLL13,                 ///< Select HASH clock rate PLL13
#endif
...
*/
typedef enum {
    HASH_MODE_SHA1 = 0,               ///< Select HASH mode SHA1
...
typedef enum {
    HASH_CONFIG_ID_CLOCK_RATE,          ///< Select HASH engine internal clock rate usage
                                        ...
                                        ///< - @b HASH_CLOCK_PLL2:      Internal clock rate 400MHz
                                        ///< - @b HASH_CLOCK_PLL13:     Internal clock rate 350MHz
...
extern void hash_dma_enable(vaddr_t addr, UINT32 size, UINT32 pad_len);
