...
*/
typedef enum {
	HASH_RSTN 		= 32+20, 	    //< Reset HASH controller
	RSA_RSTN 		= 32+21, 	    //< Reset RSA controller
	CRYPTO_RSTN     = 32+22,   		//< Reset CRYPTO controller
	TMR_RSTN		= 96+6, 	    //< Reset TMR controller
	TRNG_RSTN   	= 96+8, 	    //< Reset TRNG controller
	WDT_RSTN		= 96+12,		//< Reset WDT controller
	RTC_RSTN		= 96+24,  	    //< Reset RTC controller
