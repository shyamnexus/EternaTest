...
typedef enum {
	...
	EFUSE_OTP_6TH_KEY_SET_FIELD     = 0x5,
	EFUSE_OTP_TOTAL_KEY_SET_FIELD   = 0x6,
} EFUSE_OTP_KEY_SET_FIELD;

STATIC_ASSERT(EFUSE_OTP_TOTAL_KEY_SET_FIELD <= 6);

#define EFUSE_OTP_KEY_FIELD_CNT         6
...
typedef enum {
	...
	SECUREBOOT_6TH_KEY_SET_PROGRAMMED,  ///< Quary if 6th key set programmed or not
	...
	SECUREBOOT_6TH_KEY_SET_READ_LOCK,                                       ///< Quary if 5th key read lock already or not
	SECUREBOOT_READ_LOCK_KEY_SET_END = SECUREBOOT_6TH_KEY_SET_READ_LOCK,
...
#define OTP_6TH_KEY_PROGRAMMED_BIT              31
...
#define OTP_6TH_KEY_PROGRAMMED                  (1 << OTP_6TH_KEY_PROGRAMMED_BIT)
...
//2nd
#define OTP_6TH_KEY_BIT_START                   (0xF << 00)
