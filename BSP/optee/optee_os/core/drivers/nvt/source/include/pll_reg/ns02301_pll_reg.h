...
REGDEF_BIT(reserved1, 14)
REGDEF_BIT(MPLL480MD_CHG_REQ, 1)
REGDEF_BIT(MPLL480MD_VAL, 1)
REGDEF_BIT(MPLLAPLL_480_MODE, 1)
REGDEF_BIT(reserved2, 8)
...
#define PLL528_PLL03_BASE_REG_OFS        0x4440	//560(DMA)
...
#define PLL528_PLL11_BASE_REG_OFS        0x4480	//560(ISP,Codec)
...
//0x4008 PLL11 (For DMA/ISP,Codec) Mux SEL
//
#define PLL_PLL_GOP_REG2_REG_OFS         0x4008
REGDEF_BEGIN(PLL_PLL_GOP_REG2_REG)
REGDEF_BIT(PLL11_SEL, 2)
REGDEF_BIT(reserved1, 30)
REGDEF_END(PLL_PLL_GOP_REG2_REG)



//PR CG

//0x0 FLL power enable reg
//
#define PR_PLL_FLL_POWER_REG0_REG_OFS         0x0
REGDEF_BEGIN(PR_PLL_FLL_POWER_REG0_REG)
REGDEF_BIT(FLL_EN, 1)
REGDEF_BIT(FLL_DIS, 1)
REGDEF_BIT(FLL_READY, 1)
REGDEF_BIT(FLL_LOCK_APHY, 1)
REGDEF_BIT(FLL_EN_STS, 1)
REGDEF_BIT(reserved1, 27)
REGDEF_END(PR_PLL_FLL_POWER_REG0_REG)

//0x4008 FLL 6M magnification reg
//
#define PR_PLL_FLL_6M_MAGNI_REG0_REG_OFS         0x4008
REGDEF_BEGIN(PR_PLL_FLL_6M_MAGNI_REG0_REG)
REGDEF_BIT(FLL_6M_MAGNI_0, 8)
REGDEF_BIT(reserved1, 24)
REGDEF_END(PR_PLL_FLL_6M_MAGNI_REG0_REG)

//0x400C FLL 6M magnification reg
//
#define PR_PLL_FLL_6M_MAGNI_REG1_REG_OFS         0x400C
REGDEF_BEGIN(PR_PLL_FLL_6M_MAGNI_REG1_REG)
REGDEF_BIT(FLL_6M_MAGNI_1, 8)
REGDEF_BIT(reserved1, 24)
REGDEF_END(PR_PLL_FLL_6M_MAGNI_REG1_REG)

//0x4044 FLL open slow down reg
//
#define PR_PLL_FLL_OPEN_SLOW_DOWN_REG_OFS         0x4044
REGDEF_BEGIN(PR_PLL_FLL_OPEN_SLOW_DOWN_REG)
REGDEF_BIT(FLL_OPEN_SLOW_DOWN_EN, 8)
REGDEF_BIT(reserved1, 24)
REGDEF_END(PR_PLL_FLL_OPEN_SLOW_DOWN_REG)
