...
#define vk_pr_warn(...) trace_printf_helper(0, false, __VA_ARGS__)
#define vk_printk(...) trace_printf_helper(0, false, __VA_ARGS__)
#define vk_print_isr(...) dtrace_printf_helper(0, false, __VA_ARGS__)
