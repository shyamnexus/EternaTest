...
typedef enum {
	...
	KDRV_VDOCAP_VIE_ENGINE0  = 0x1008,
	KDRV_VDOCAP_VIE_ENGINE1  = 0x1009,

	KDRV_VDOOUT_ENGINE0 = 0x2000,
	KDRV_VDOOUT_ENGINE1 = 0x2001,
	KDRV_VDOOUT_ENGINE2 = 0x2002,
	KDRV_VDOOUT_GPE_ENGINE0 = 0x2003,
	KDRV_VDOOUT_GPE_ENGINE1 = 0x2004,

	KDRV_VIDEODEC_ENGINE0 = 0x3000,
	KDRV_VIDEODEC_ENGINE_H264 = 0x3100,
	KDRV_VIDEODEC_ENGINE_H265 = 0x3200,
	...
	KDRV_VIDEOPROCS_VPE_ENGINE1 = 0x5007,
	KDRV_VIDEOPROCS_DRE_ENGINE0 = 0x5008,

	KDRV_AUDCAP_ENGINE0 = 0x6000,	///< DAI0 ,Audio Capture from normal record path. <mic/dmic/i2s><TimeCode Hit function Available>
	KDRV_AUDCAP_ENGINE1 = 0x6001,	///< DAI0, Audio Capture from output data loopback.
									///< This channel is used in the AEC(Acoustic Echo Cancellation) application usgae.
	KDRV_AUDCAP_ENGINE2 = 0x6002,	///< DAI1, Audio Capture from normal record path. <mic/dmic/i2s><TimeCode Hit function Available>

	KDRV_AUDOUT_ENGINE0 = 0x7000,	///< DAI0, Audio output engine ID 1.<TimeCode Hit function Available>
	KDRV_AUDOUT_ENGINE1 = 0x7001,	///< DAI0, Audio output engine ID 2.
	KDRV_AUDOUT_ENGINE2 = 0x7002,	///< DAI1, Audio output engine ID 1.<TimeCode Hit function Available>
	KDRV_AUDOUT_ENGINE3 = 0x7003,	///< DAI1, Audio output engine ID 2.
...
typedef enum {
	KDRV_VDODEC_TYPE_JPEG = 0,
	KDRV_VDODEC_TYPE_H264,
...
typedef struct {
	INT32 ddr_id;
	IDEDATA_TYPE addr_pa;
	IDEDATA_TYPE addr_va;
	INT32 size;
} KDRV_BUFFER_INFO;
...
typedef enum {
	...
	KDRV_BUFTYPE_RGB565,
	KDRV_BUFTYPE_RGB_CV,
	KDRV_BUFTYPE_YUV420_SP,    //420SP, SM420
	KDRV_BUFTYPE_YUV420_8x4,
	KDRV_BUFTYPE_YUV420_LLC_8x4,
} KDRV_PIX_FMT;
...
typedef struct {
	...
	INT32 (*reserve_buf)(IDEDATA_TYPE phy_addr, VOID *user_data);
	INT32 (*free_buf)(IDEDATA_TYPE phy_addr, VOID *user_data);
} KDRV_CALLBACK_FUNC;

typedef struct {
	void (*VdoDec_RefFrmDo)(UINT32 pathID, IDEDATA_TYPE uiYAddr, BOOL bIsRef);
	UINT32 id;
