...
// TZPC
#define IOADDR_TZPC_REG_BASE        (IOADDR_GLOBAL_BASE+0x000C0000)

// TRNG
#define IOADDR_TRNG_REG_BASE        (IOADDR_GLOBAL_BASE+0x00680000)
...
// SPI
#define IOADDR_SPI_REG_BASE         (IOADDR_GLOBAL_BASE+0x00158000)
...
// ADC
#define IOADDR_ADC_REG_BASE         (IOADDR_GLOBAL_BASE+0x00BB0000)
...
// Ethernet
#define IOADDR_ETH_REG_BASE         (IOADDR_GLOBAL_BASE+0x004A0000)

#define IOADDR_ETH1_REG_BASE         (IOADDR_GLOBAL_BASE+0x004B0000)
...
// SPI2
#define IOADDR_SPI2_REG_BASE        (IOADDR_GLOBAL_BASE+0x00159000)

// MIPI - CSI2
#define IOADDR_CSI2_REG_BASE        (IOADDR_GLOBAL_BASE+0x00330000)

// SPI3
#define IOADDR_SPI3_REG_BASE        (IOADDR_GLOBAL_BASE+0x0015A000)

// I2C2
#define IOADDR_I2C2_REG_BASE        (IOADDR_GLOBAL_BASE+0x00141000)

// SPI4
#define IOADDR_SPI4_REG_BASE        (IOADDR_GLOBAL_BASE+0x0015B000)
...
// NAND
#define IOADDR_NAND_REG_BASE        (IOADDR_GLOBAL_BASE+0x00990000)

// SDIO
#define IOADDR_SDIO_REG_BASE        (IOADDR_GLOBAL_BASE+0x00F30000)
...
// SDIO2
#define IOADDR_SDIO2_REG_BASE       (IOADDR_GLOBAL_BASE+0x00F40000)

// SDIO3
#define IOADDR_SDIO3_REG_BASE       (IOADDR_GLOBAL_BASE+0x00980000)
...
// USB3
#define IOADDR_USB3_REG_BASE        (IOADDR_GLOBAL_BASE+0x00970000)
#define IOADDR_USB3_2_REG_BASE      (IOADDR_GLOBAL_BASE+0x00B80000)

// USB PHY
#define IOADDR_USBPHY_REG_BASE      (IOADDR_GLOBAL_BASE+0x00940000)

// USB3 PHY
#define IOADDR_USB3PHY_REG_BASE     (IOADDR_GLOBAL_BASE+0x00950000)
#define IOADDR_USB3_2PHY_REG_BASE   (IOADDR_GLOBAL_BASE+0x00B10000)

// Crypto
#define IOADDR_CRYPTO_REG_BASE      (IOADDR_GLOBAL_BASE+0x00250000)
...
// eFUSE
#define IOADDR_EFUSE_REG_BASE       (IOADDR_GLOBAL_BASE+0x00240000)

// USB3-CTRL
#define IOADDR_USB3CTRL_REG_BASE    (IOADDR_GLOBAL_BASE+0x00950000)
#define IOADDR_USB3_2CTRL_REG_BASE  (IOADDR_GLOBAL_BASE+0x00B10000)
// TSDEMux
#define IOADDR_TSDEMUX_REG_BASE     (IOADDR_GLOBAL_BASE+0x00680000)

// RSA
#define IOADDR_RSA_REG_BASE         (IOADDR_GLOBAL_BASE+0x00270000)

// Hash
#define IOADDR_HASH_REG_BASE        (IOADDR_GLOBAL_BASE+0x00260000)
...
// MIPI-DSI phy
#define IOADDR_DSIPHY_REG_BASE      (IOADDR_GLOBAL_BASE+0x009E0000)
