...
#ifndef __ASM_ARCH_NS02301_TOP_H
#define __ASM_ARCH_NS02301_TOP_H

#include <asm/nvt-common/nvt_types.h>
#include <asm/nvt-common/rcw_macro.h>
#include <dt-bindings/pinctrl/nvt-ns02301-pinctrl.h>
#if !defined(__LINUX)
#include <stdio.h>
#endif

typedef uint32_t  PIN_FUNC;                  ///< For top.h usage reference
typedef uint32_t  PINMUX_LCD_SEL;            ///< For panel driver reference
...
typedef enum {
	...
	PINMUX_DEBUGPORT_AUDIO =        0x0004,     ///< AUDIO
	PINMUX_DEBUGPORT_DAI =          0x0005,     ///< DAI
	PINMUX_DEBUGPORT_DRTC = 		0x0006,		///< DRTC
	PINMUX_DEBUGPORT_ECDSA = 		0x0007,		///< ECDSA

	PINMUX_DEBUGPORT_EFUSE =        0x0008,     ///< EFUSE
	PINMUX_DEBUGPORT_ETH =          0x0009,     ///< ETH
	PINMUX_DEBUGPORT_GRAPHIC =      0x000A,     ///< GRAPHIC
	PINMUX_DEBUGPORT_GRAPHIC2 =     0x000B,     ///< GRAPHIC2

	PINMUX_DEBUGPORT_GRAPHIC3 =     0x000C,     ///< GRAPHIC3
	PINMUX_DEBUGPORT_HASH =         0x000D,     ///< HASH
	PINMUX_DEBUGPORT_HRTIMER =      0x000E,     ///< HR Timer
	PINMUX_DEBUGPORT_HRTIMER2 = 	0x000F,		///< HR Timer2

	PINMUX_DEBUGPORT_HRTIMER3 = 	0x0010,		///< HR Timer2
	PINMUX_DEBUGPORT_HRTIMER4 = 	0x0011,		///< HR Timer2
	PINMUX_DEBUGPORT_HRTIMER5 = 	0x0012,		///< HR Timer2
	PINMUX_DEBUGPORT_HRTIMER6 = 	0x0013,		///< HR Timer2

	PINMUX_DEBUGPORT_HRTIMER7 = 	0x0014,		///< HR Timer2
	PINMUX_DEBUGPORT_HRTIMER8 = 	0x0015,		///< HR Timer2
	PINMUX_DEBUGPORT_HRTIMER9 = 	0x0016,		///< HR Timer2
	PINMUX_DEBUGPORT_HRTIMER10 = 	0x0017,		///< HR Timer2

	PINMUX_DEBUGPORT_HVYLD =        0x0018,     ///< HVYLD
	PINMUX_DEBUGPORT_HVYLD2 =       0x0019,     ///< HVYLD2
	PINMUX_DEBUGPORT_HVYLD3 =       0x001A,     ///< HVYLD3
	PINMUX_DEBUGPORT_HWCP =         0x001B,     ///< HWCP
	...
	PINMUX_DEBUGPORT_IDE =          0x0021,     ///< IDE
	PINMUX_DEBUGPORT_IVE =          0x0022,     ///< IVE
	PINMUX_DEBUGPORT_JPEG =         0x0023,     ///< JPEG

	PINMUX_DEBUGPORT_MPU =          0x0024,     ///< MPU
	PINMUX_DEBUGPORT_NUE2 =         0x0025,     ///< NUE2
	PINMUX_DEBUGPORT_PWM =          0x0026,     ///< PWM
	PINMUX_DEBUGPORT_RMT =          0x0027,     ///< RMT

	PINMUX_DEBUGPORT_RSA =          0x0028,     ///< RSA
	PINMUX_DEBUGPORT_SCE =          0x0029,     ///< SCE
	PINMUX_DEBUGPORT_SDP =          0x002A,     ///< SDP
	PINMUX_DEBUGPORT_SIF =          0x002B,     ///< SIF

	PINMUX_DEBUGPORT_SPI =          0x002C,     ///< SPI
	PINMUX_DEBUGPORT_SPI2 =         0x002D,     ///< SPI2
	PINMUX_DEBUGPORT_SPI3 =         0x002E,     ///< SPI3
	PINMUX_DEBUGPORT_SPI4 =         0x002F,     ///< SPI4

	PINMUX_DEBUGPORT_SPI5 =         0x0030,     ///< SPI5
	PINMUX_DEBUGPORT_TIMER =        0x0031,     ///< Timer
	PINMUX_DEBUGPORT_TRKE =         0x0032,     ///< TRKE
	PINMUX_DEBUGPORT_TRNG =         0x0033,     ///< TRNG

	PINMUX_DEBUGPORT_TSE =          0x0034,     ///< TSE
	PINMUX_DEBUGPORT_UART2 =        0x0035,     ///< UART2
	PINMUX_DEBUGPORT_UART3 =        0x0036,     ///< UART3
	PINMUX_DEBUGPORT_UART4 =        0x0037,     ///< UART4

	PINMUX_DEBUGPORT_UART5 =        0x0038,     ///< UART5
	PINMUX_DEBUGPORT_UART6 =        0x0039,     ///< UART6
	PINMUX_DEBUGPORT_UVCP =         0x003A,     ///< UVCP

	PINMUX_DEBUGPORT_CC =         	0x0040,     ///< CC
	PINMUX_DEBUGPORT_MCU =         	0x0041,     ///< MCU
	PINMUX_DEBUGPORT_DSI =          0x0042,     ///< DSI
	PINMUX_DEBUGPORT_CSITX =        0x0043,     ///< CSITX

	PINMUX_DEBUGPORT_USB3 =         0x0044,     ///< USB3
	PINMUX_DEBUGPORT_WDT =          0x0045,     ///< WDT
	PINMUX_DEBUGPORT_STBCG =        0x0046,     ///< STBCG

	PINMUX_DEBUGPORT_CSIRX =        0x0050,     ///< CSIRX
	PINMUX_DEBUGPORT_CSIRX2 =       0x0051,     ///< CSIRX2
	PINMUX_DEBUGPORT_CSIRX3 =       0x0052,     ///< CSIRX3
	PINMUX_DEBUGPORT_CSIRX4 =       0x0053,     ///< CSIRX4

	PINMUX_DEBUGPORT_DRE =          0x0054,     ///< DRE
	PINMUX_DEBUGPORT_IFE =          0x0055,     ///< IFE
	PINMUX_DEBUGPORT_ISE =          0x0056,     ///< ISE
	PINMUX_DEBUGPORT_SDIO3 =        0x0057,     ///< SDIO3
	PINMUX_DEBUGPORT_SIE =          0x0058,     ///< SIE
	PINMUX_DEBUGPORT_SIE2 =         0x0059,     ///< SIE2
	PINMUX_DEBUGPORT_SIE3 =         0x005A,     ///< SIE3
	PINMUX_DEBUGPORT_SIE4 =         0x005B,     ///< SIE4
	PINMUX_DEBUGPORT_SIE5 =         0x005C,     ///< SIE5
	PINMUX_DEBUGPORT_SMC =          0x005D,     ///< NAND/SMC
	PINMUX_DEBUGPORT_TGE =          0x005E,     ///< TGE
	PINMUX_DEBUGPORT_VIE =          0x005F,     ///< VIE

	PINMUX_DEBUGPORT_RS3 =          0x0060,     ///< RS3
	PINMUX_DEBUGPORT_IME =          0x0070,     ///< IME
	PINMUX_DEBUGPORT_IPE =          0x0071,     ///< IPE

	PINMUX_DEBUGPORT_SDIO =         0x0072,     ///< SDIO
	PINMUX_DEBUGPORT_SDIO2 =        0x0073,     ///< SDIO2
	PINMUX_DEBUGPORT_RS =          	0x0074,     ///< RS
	PINMUX_DEBUGPORT_RS2 =          0x0075,     ///< RS3

	PINMUX_DEBUGPORT_ADM =          0x0080,     ///< ADM
	PINMUX_DEBUGPORT_VPE =          0x0081,     ///< VPE

	PINMUX_DEBUGPORT_CAL =          0x0090,     ///< CAL
	PINMUX_DEBUGPORT_JM =          	0x0091,     ///< JM
	PINMUX_DEBUGPORT_JMISP =       	0x0092,     ///< JMISP
	PINMUX_DEBUGPORT_LSU =       	0x0093,     ///< JMISP
	PINMUX_DEBUGPORT_PPU =       	0x0094,     ///< PPU
	PINMUX_DEBUGPORT_ROU =       	0x0095,     ///< ROU
	PINMUX_DEBUGPORT_UTL =       	0x0096,     ///< UTL
	PINMUX_DEBUGPORT_CONV =       	0x00A0,     ///< UTL
