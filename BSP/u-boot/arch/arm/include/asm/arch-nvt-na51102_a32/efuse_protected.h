...
#define EFUSE_RTC_TRIM_DATA						0
#define EFUSE_HDMI_2_0_VLANE_TRIM_DATA			1
#define EFUSE_HDMI_RESISTOR_TRIM_DATA			2
#define EFUSE_USB_SATA_TRIM_DATA				5
#define EFUSE_THERMAL_TRIM_DATA					6
#define EFUSE_HDMI_1_4_VLANE_TRIM_DATA			9
#define EFUSE_USB_LDO_TRIM_DATA					59
#define EFUSE_CSI_1_5G_D7_D2_TRIM_DATA			60
#define EFUSE_CSI_1_5G_D1_D0_C3_C0_TRIM_DATA	61
#define EFUSE_CSI_2_5G_I_TRIM_R_TERM_TRIM_DATA	62
