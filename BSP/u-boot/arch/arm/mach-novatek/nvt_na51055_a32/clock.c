	...
	if(nvt_get_chip_id() == CHIP_NA51084) {
		...
		case 2:
			...
			case 1350:
				...
				//CPU 1350 MHz -> CPU-MPLL-125Mhz = 0x14D555
				writel(0x00, IOADDR_CG_REG_BASE + CPU_CLOCK_RATE_RATIO0_528_OFS); // B0
				writel(0x20, IOADDR_CG_REG_BASE + CPU_CLOCK_RATE_RATIO1_528_OFS); // B1
				writel(0x1C, IOADDR_CG_REG_BASE + CPU_CLOCK_RATE_RATIO2_528_OFS); // B2
