...
extern int nvt_pcie_dts_load_refclk_out(char *rc_dts_name);
extern int nvt_pcie_dts_load_tx_boost(char *rc_dts_name);
extern int nvt_pcie_dts_load_auto_preset(char *rc_dts_name);
extern int nvt_pcie_dts_load_l1_det(char *rc_dts_name);
