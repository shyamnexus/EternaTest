 ...
 * ns02201:
 *    NOVATEK's NS02201 chip. This configuration uses an AXI master/DMA bus, an
...
static int eqos_probe_resources_core(struct udevice *dev)
{
    ...
    if((ulong)eqos->rx_dma_buf > REG32_MASK ){
...
typedef enum {
	...
	PIN_ETH_CFG_ETH_RGMII_1     = 0x001,        ///< RGMII (L_GPIO[19..30],D_GPIO[6..7])  @L_GPIO19[]|L_GPIO20[]|L_GPIO21[]|L_GPIO22[]|L_GPIO23[]|L_GPIO24[]|L_GPIO25[]|L_GPIO26[]|L_GPIO27[]|L_GPIO28[]|L_GPIO29[]|L_GPIO30[]|D_GPIO6[]|D_GPIO7[]
	PIN_ETH_CFG_ETH_RGMII_2     = 0x002,        ///< RGMII (S_GPIO[16..29] @S_GPIO16[]|S_GPIO17[]|S_GPIO18[]|S_GPIO19[]|S_GPIO20[]|S_GPIO21[]|S_GPIO22[]|S_GPIO23[]|S_GPIO24[]|S_GPIO25[]|S_GPIO26[]|S_GPIO27[]|S_GPIO28[]|S_GPIP29[]
	PIN_ETH_CFG_ETH_RMII_1      = 0x010,        ///< RMII  (L_GPIO[19..21],L_GPIO[25..28],D_GPIO[6..7])  @L_GPIO19[]|L_GPIO20[]|L_GPIO21[]|L_GPIO25[]|L_GPIO26[]|L_GPIO27[]|L_GPIO28[]|D_GPIO6[]|D_GPIO7[]
	PIN_ETH_CFG_ETH_RMII_2      = 0x020,        ///< RMII  (S_GPIO[16..18],S_GPIO[22..25],S_GPIO[28..29])  @S_GPIO16[]|S_GPIO17[]|S_GPIO18[]|S_GPIO22[]|S_GPIO23[]|S_GPIO24[]|S_GPIO25[]|S_GPIO28[]|S_GPIO29[]
	PIN_ETH_CFG_ETH_EXTPHYCLK   = 0x100,        ///< ETH_EXT_PHY_CLK (D_GPIO[8]) @D_GPIO7[]
	PIN_ETH_CFG_ETH_PTP         = 0x200,        ///< ETH_PTP (P_GPIO[28]) @P_GPIO28[]

	PIN_ETH_CFG_ETH2_RGMII_1    = 0x001000,       ///< RGMII2 (L_GPIO[3..16])  @L_GPIO3[]|L_GPIO4[]|L_GPIO5[]|L_GPIO6[]|L_GPIO7[]|L_GPIO8[]|L_GPIO9[]|L_GPIO10[]|L_GPIO11[]|L_GPIO12[]|L_GPIO13[]|L_GPIO14[]|L_GPIO15[]|L_GPIO16[]
	PIN_ETH_CFG_ETH2_RGMII_2    = 0x002000,       ///< RGMII2 (S_GPIO[0..13])  @S_GPIO0[]|S_GPIO1[]|S_GPIO2[]|S_GPIO3[]|S_GPIO4[]|S_GPIO5[]|S_GPIO6[]|S_GPIO7[]|S_GPIO8[]|S_GPIO9[]|S_GPIO10[]|S_GPIO111[]|S_GPIO12[]|S_GPIO13[]
	PIN_ETH_CFG_ETH2_RMII_1     = 0x010000,       ///< RMII2  (L_GPIO[3..5],L_GPIO[9..12],L_GPIO[15..16])   @L_GPIO3[]|L_GPIO4[]|L_GPIO5[]|L_GPIO9[]|L_GPIO10[]|L_GPIO11[]|L_GPIO12[]|L_GPIO15[]|L_GPIO16[]
	PIN_ETH_CFG_ETH2_RMII_2     = 0x020000,       ///< RMII2  (S_GPIO[0..2],S_GPIO[6..9],S_GPIO[12..13])   @S_GPIO0[]|S_GPIO1[]|S_GPIO2[]|S_GPIO6[]|S_GPIO7[]|S_GPIO8[]|S_GPIO9[]|S_GPIO12[]|S_GPIO13[]
	PIN_ETH_CFG_ETH2_EXTPHYCLK  = 0x100000,       ///< ETH2_EXT_PHY_CLK(L_GPIO[17]) @L_GPIO17[]
	PIN_ETH_CFG_ETH2_PTP        = 0x200000,       ///< ETH2_PTP(P_GPIO[24])  @P_GPIO24[]
...
static void extphy0_clk_en(phy_interface_t phy_intf, int phy_clk, int ref_clk_out, int pin_num)
{
    ...
    if (pin_num == 1) {
	// reset external phy
	gpio_request(D_GPIO(9), "PHY0_RST");
	gpio_direction_output(D_GPIO(9), 0);
	mdelay(10);	// assert low at least 10ms
	gpio_set_value(D_GPIO(9), 1);
	mdelay(50);	// wait 50ms before access phy register
	gpio_free(D_GPIO(9));
    } else if (pin_num == 2) {
	// reset external phy
	gpio_request(S_GPIO(31), "PHY0_RST");
	gpio_direction_output(S_GPIO(31), 0);
	mdelay(10);	// assert low at least 10ms
	gpio_set_value(S_GPIO(31), 1);
	mdelay(50);	// wait 50ms before access phy register
	gpio_free(S_GPIO(31));
    }
...
static void extphy1_clk_en(phy_interface_t phy_intf, int phy_clk, int ref_clk_out , int pin_num)
{
	...
	// reset external phy
	gpio_request(S_GPIO(15), "PHY1_RST"); //L_GPIO(18)
	gpio_direction_output(S_GPIO(15), 0);
	mdelay(10);	// assert low at least 10ms
	gpio_set_value(S_GPIO(15), 1);
	mdelay(50);	// wait 50ms before access phy register
	gpio_free(S_GPIO(15));
...
static void mac0_pinmux_en(phy_interface_t phy_intf, int pin_num)
{
	...
	case PHY_INTERFACE_MODE_RMII:
		// set pad driving
		if (pin_num == 1) {
			reg = readl(IOADDR_PAD_REG_BASE + 0x134);
			// PHYCLK
			reg &= ~ (0xf<<0);
			reg |= (0xa<<0);
			writel(reg, IOADDR_PAD_REG_BASE + 0x134);
			...
			reg = readl(IOADDR_PAD_REG_BASE + 0x16C);
			// PHYCLK
			reg &= ~ (0xf<<24);
			reg |= (0xa<<24);
			writel(reg, IOADDR_PAD_REG_BASE + 0x16C);

			reg = readl(IOADDR_PAD_REG_BASE + 0x168);

			// TX CLK TXD0 TXD1
			reg &= ~ ((0xf<<8) | (0xf<<4) | (0xf<<0));
			reg |= (0xa<<8) | (0xa<<4) | (0xa<<0);
			writel(reg, IOADDR_PAD_REG_BASE + 0x168);
...
static const struct NVT_PLAT_INFO v_nvt_plat_info[2] = {
	...
	// MAC1 (0xF043_0000)
	{
		...
		PIN_ETH_CFG_ETH2_RGMII_2,

		PIN_ETH_CFG_ETH2_RMII_1,
		PIN_ETH_CFG_ETH2_RMII_2,
...
*/
	...
	if (!cell) {
		printf("%s: ref-clk-out not found\n", __func__);
		return -1;
	}
...
//	eqos_probe_hwinit();
	...
	eqos->mii->priv = eqos;
	strncpy(eqos->mii->name, dev->name, sizeof(eqos->mii->name) - 1);
...
U_BOOT_DRIVER(ns02201_eth_eqos) = {
	.name = "ns02201_eth_eqos",
	.id = UCLASS_ETH,
	.of_match = eqos_ids,
	.probe = eqos_probe,
	.remove = eqos_remove,
