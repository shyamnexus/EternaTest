...
#define XGMAC_MAC_CONF_LM           BIT(10)
...
#define XGMAC_DMA_SYSBUS_MODE_AALE          BIT(10)
...
#define XGMAC_DMA_CH0_TX_CONTROL_TSE            BIT(12)
...
#define XGMAC_DMA_CH0_RX_CONTROL_RBSZ_SHIFT     1
#define XGMAC_DMA_CH0_RX_CONTROL_RBSZ_MASK      GENMASK(13, 0)
...
#define XGMAC_DESCRIPTOR_BYTES   16
#define XGMAC_DESCRIPTOR_DUMMY   (ARCH_DMA_MINALIGN - XGMAC_DESCRIPTOR_BYTES)
#define XGMAC_DESCRIPTOR_SIZE    (XGMAC_DESCRIPTOR_BYTES + XGMAC_DESCRIPTOR_DUMMY)

#define XGMAC_DESCRIPTORS_NUM    (XGMAC_DESCRIPTORS_TX + XGMAC_DESCRIPTORS_RX)
#define XGMAC_DESCRIPTORS_SIZE   ALIGN(XGMAC_DESCRIPTORS_NUM * \
									   XGMAC_DESCRIPTOR_SIZE, ARCH_DMA_MINALIGN)
...
#define XGMAC_DESC3_CIC     BIT(16) | BIT(17)
