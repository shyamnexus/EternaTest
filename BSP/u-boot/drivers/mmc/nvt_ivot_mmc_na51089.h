/*
 *  driver/mmc/nvt_ivot_mmc_na51089.h
 *
 *  Copyright:	Novatek Inc.
 *
 */

#ifndef __NVT_IVOT_MMC_NA51089_H__
#define __NVT_IVOT_MMC_NA51089_H__
...
#define TOP_SDIO2_2_EN_GPIO_REG         (IOADDR_TOP_REG_BASE + 0xA0)
#define TOP_SDIO2_2_EN_GPIO_MASK        BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(7) | BIT(8)
...
#define	PAD_DS_SGPIO_BASE               PAD_REG_TO_BASE(0x4C)         
...
#define PAD_DS_SGPIO0                   (PAD_DS_SGPIO_BASE + 0)
#define PAD_DS_SGPIO1                   (PAD_DS_SGPIO_BASE + 2)
#define PAD_DS_SGPIO2                   (PAD_DS_SGPIO_BASE + 4)
#define PAD_DS_SGPIO3                   (PAD_DS_SGPIO_BASE + 6)
#define PAD_DS_SGPIO7                   (PAD_DS_SGPIO_BASE + 14)
#define PAD_DS_SGPIO8                   (PAD_DS_SGPIO_BASE + 16)
...
#define PAD_DS_SDIO2_2_CLK              PAD_DS_SGPIO0
#define PAD_DS_SDIO2_2_CMD              PAD_DS_SGPIO1
#define PAD_DS_SDIO2_2_D0               PAD_DS_SGPIO2
#define PAD_DS_SDIO2_2_D1               PAD_DS_SGPIO3
#define PAD_DS_SDIO2_2_D2               PAD_DS_SGPIO7
#define PAD_DS_SDIO2_2_D3               PAD_DS_SGPIO8
...
#define GPIO_SDIO2_2_CLK                S_GPIO(0)
#define GPIO_SDIO2_2_CMD                S_GPIO(1)
#define GPIO_SDIO2_2_D0                 S_GPIO(2)
#define GPIO_SDIO2_2_D1                 S_GPIO(3)
#define GPIO_SDIO2_2_D2                 S_GPIO(7)
#define GPIO_SDIO2_2_D3                 S_GPIO(8)
...
#define PAD_PUPD_SDIO2_2_CLK_REG        (IOADDR_PAD_REG_BASE + 0x0C)
#define PAD_PUPD_SDIO2_2_CLK_MASK       GENMASK(1, 0)
#define PAD_PUPD_SDIO2_2_CLK_SHIFT      (0)
#define PAD_PUPD_SDIO2_2_CMD_REG        (IOADDR_PAD_REG_BASE + 0x0C)
#define PAD_PUPD_SDIO2_2_CMD_MASK       GENMASK(3, 2)
#define PAD_PUPD_SDIO2_2_CMD_SHIFT      (2)
#define PAD_PUPD_SDIO2_2_D0_REG         (IOADDR_PAD_REG_BASE + 0x0C)
#define PAD_PUPD_SDIO2_2_D0_MASK        GENMASK(5, 4)
#define PAD_PUPD_SDIO2_2_D0_SHIFT       (4)
#define PAD_PUPD_SDIO2_2_D1_REG         (IOADDR_PAD_REG_BASE + 0x0C)
#define PAD_PUPD_SDIO2_2_D1_MASK        GENMASK(7, 6)
#define PAD_PUPD_SDIO2_2_D1_SHIFT       (6)
#define PAD_PUPD_SDIO2_2_D2_REG         (IOADDR_PAD_REG_BASE + 0x0C)
#define PAD_PUPD_SDIO2_2_D2_MASK        GENMASK(17, 16)
#define PAD_PUPD_SDIO2_2_D2_SHIFT       (16)
#define PAD_PUPD_SDIO2_2_D3_REG         (IOADDR_PAD_REG_BASE + 0x0C)
#define PAD_PUPD_SDIO2_2_D3_MASK        GENMASK(19, 18)
#define PAD_PUPD_SDIO2_2_D3_SHIFT       (18)
