/*
 *  driver/mmc/nvt_ivot_mmc_ns02302.h
 *
 *  Copyright:	Novatek Inc.
 *
 */

#ifndef __NVT_IVOT_MMC_NS02302_H__
#define __NVT_IVOT_MMC_NS02302_H__

#include <asm/arch/ns02302_regs.h>
...
#define TOP_SDIO_EN_GPIO_MASK           BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17)
...
#define TOP_SDIO2_EN_GPIO_MASK          BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23)
...
#define PAD_DS_SDIO_CLK                 PAD_DS_CGPIO12
#define PAD_DS_SDIO_CMD                 PAD_DS_CGPIO13
#define PAD_DS_SDIO_D0                  PAD_DS_CGPIO14
#define PAD_DS_SDIO_D1                  PAD_DS_CGPIO15
#define PAD_DS_SDIO_D2                  PAD_DS_CGPIO16
#define PAD_DS_SDIO_D3                  PAD_DS_CGPIO17

#define PAD_DS_SDIO2_CLK                PAD_DS_CGPIO18
#define PAD_DS_SDIO2_CMD                PAD_DS_CGPIO19
#define PAD_DS_SDIO2_D0                 PAD_DS_CGPIO20
#define PAD_DS_SDIO2_D1                 PAD_DS_CGPIO21
#define PAD_DS_SDIO2_D2                 PAD_DS_CGPIO22
#define PAD_DS_SDIO2_D3                 PAD_DS_CGPIO23
...
/* Controlled as GPIO */
#define GPIO_SDIO_CLK                   C_GPIO(12)
#define GPIO_SDIO_CMD                   C_GPIO(13)
#define GPIO_SDIO_D0                    C_GPIO(14)
#define GPIO_SDIO_D1                    C_GPIO(15)
#define GPIO_SDIO_D2                    C_GPIO(16)
#define GPIO_SDIO_D3                    C_GPIO(17)

#define GPIO_SDIO2_CLK                  C_GPIO(18)
#define GPIO_SDIO2_CMD                  C_GPIO(19)
#define GPIO_SDIO2_D0                   C_GPIO(20)
#define GPIO_SDIO2_D1                   C_GPIO(21)
#define GPIO_SDIO2_D2                   C_GPIO(22)
#define GPIO_SDIO2_D3                   C_GPIO(23)
...
#define PAD_PUPD_SDIO_D0_MASK           GENMASK(29, 28)
#define PAD_PUPD_SDIO_D0_SHIFT          (28)
#define PAD_PUPD_SDIO_D1_REG            (IOADDR_PAD_REG_BASE + 0x00)
#define PAD_PUPD_SDIO_D1_MASK           GENMASK(31, 30)
#define PAD_PUPD_SDIO_D1_SHIFT          (30)
#define PAD_PUPD_SDIO_D2_REG            (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO_D2_MASK           GENMASK(1, 0)
#define PAD_PUPD_SDIO_D2_SHIFT          (0)
#define PAD_PUPD_SDIO_D3_REG            (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO_D3_MASK           GENMASK(3, 2)
#define PAD_PUPD_SDIO_D3_SHIFT          (2)

#define PAD_PUPD_SDIO2_CLK_REG          (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO2_CLK_MASK         GENMASK(5, 4)
#define PAD_PUPD_SDIO2_CLK_SHIFT        (4)
#define PAD_PUPD_SDIO2_CMD_REG          (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO2_CMD_MASK         GENMASK(7, 6)
#define PAD_PUPD_SDIO2_CMD_SHIFT        (6)
#define PAD_PUPD_SDIO2_D0_REG           (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO2_D0_MASK          GENMASK(9, 8)
#define PAD_PUPD_SDIO2_D0_SHIFT         (8)
#define PAD_PUPD_SDIO2_D1_REG           (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO2_D1_MASK          GENMASK(11, 10)
#define PAD_PUPD_SDIO2_D1_SHIFT         (10)
#define PAD_PUPD_SDIO2_D2_REG           (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO2_D2_MASK          GENMASK(13, 12)
#define PAD_PUPD_SDIO2_D2_SHIFT         (12)
#define PAD_PUPD_SDIO2_D3_REG           (IOADDR_PAD_REG_BASE + 0x04)
#define PAD_PUPD_SDIO2_D3_MASK          GENMASK(15, 14)
#define PAD_PUPD_SDIO2_D3_SHIFT         (14)
