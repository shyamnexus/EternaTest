...
{
	if ((pin > C_GPIO(25) && pin < P_GPIO(0)) || \
	(pin > P_GPIO(46) && pin < D_GPIO(0)) || \
	(pin > D_GPIO(14) && pin < L_GPIO(0)) || \
	(pin > L_GPIO(30) && pin < S_GPIO(0)) || \
	(pin > S_GPIO(31) && pin < DSI_GPIO(0)) || \
	(pin > DSI_GPIO(13) && pin < A_GPIO(0)) || \
	 (pin > A_GPIO(3))) {
