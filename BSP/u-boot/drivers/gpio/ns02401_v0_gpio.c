...
{
	if ((pin < C_GPIO(0)) || ((pin > C_GPIO(17) && pin < P_GPIO(0))) || \
	(pin > P_GPIO(46) && pin < D_GPIO(0)) || \
	(pin > D_GPIO(11) && pin < J_GPIO(0)) || \
	(pin > J_GPIO(5) && pin < E_GPIO(0))  || \
	(pin > E_GPIO(31) && pin < B_GPIO(0)) || \
	(pin > B_GPIO(16) && pin < A_GPIO(0)) || \
	(pin > A_GPIO(3))) {
