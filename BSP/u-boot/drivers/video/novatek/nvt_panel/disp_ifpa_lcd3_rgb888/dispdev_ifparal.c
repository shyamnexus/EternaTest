...
*/
#include "./../include/dispdev_ifparal.h"
...
*/
#if 1
static DISPDEV_OBJ     disp_dev_ifparal_obj3 = { dispdev_open_ifparal, dispdev_close_ifparal, dispdev_set_device_rotate, dispdev_write_lcd_reg, dispdev_read_lcd_reg, dispdev_get_lcd_size, dispdev_set_ifparal_ioctrl, {NULL, NULL, NULL}};
static volatile DISPDEV_IOCTRL  p_if_paral_io_control3;
#endif
...
#if 1
	DISPDEV_IOCTRL          p_disp_dev_control = p_if_paral_io_control3;
#endif
...
static ER dispdev_open_ifparal(void)
{
	...
	//
#if 1
	pin_func_id = PINMUX_FUNC_ID_LCD3;
#endif
	...
	if (lcd_mode == PINMUX_LCDMODE_CCIR656) {
		...
		*/
		...
		if (p_mode->ide.interlace == TRUE) {
			...
			dev_io_ctrl.SEL.SET_CCIR656_SYNCCODE.ui_odd_start    = (ui_odd_start << 1) - 1;  //ide odd,even = 0x24, 0x25
...
{
#if 1
	p_if_paral_io_control3 = (DISPDEV_IOCTRL)p_io_ctrl_func;
#endif
}
...
#if 1
/**
    Get LCD 3 Device Object

    Get LCD 3 Device Object. This Object is used to control the LCD Device.

    @return The pointer of LCD Display Device object.
*/
PDISPDEV_OBJ dispdev_get_lcd3_dev_obj(void)
{
	return &disp_dev_ifparal_obj3;
}
#endif
