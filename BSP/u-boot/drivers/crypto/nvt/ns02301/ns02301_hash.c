...
// #define NVT_HASH_DMA_36BIT_SUPPORT      0
...
static void nvt_hash_platform_init(void)
{
	...
	/* Hash clock select, 0:fix(240MHz) 1:fix(320MHz) */
	...
	tmp = IO_REG_RD(IOADDR_CG_REG_BASE, 0xE4);
	tmp |= (0x1<<9);
	IO_REG_WR(IOADDR_CG_REG_BASE, 0xE4, tmp);
