...
$(1): $(2) $(filter-out %.d,$(MAKEFILE_LIST)) | bl$(3)_dirs
	$$(ECHO) "  PP      $$<"
	$$(Q)$$(CPP) $$(CPPFLAGS) $(TF_CFLAGS_$(ARCH)) -P -x assembler-with-cpp -D__LINKER__ $(MAKE_DEP) -D$(IMAGE) -D_BOARD_BL31_ADDR_=$(BOARD_ATF_ADDR) -D_BOARD_BL31_SIZE_=$(BOARD_ATF_SIZE) -o $$@ $$<
