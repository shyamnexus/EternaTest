 ...
 */
#ifndef __DT_BINDINGS_INTERRUPT_NS02302_INTERRUPT_H
#define __DT_BINDINGS_INTERRUPT_NS02302_INTERRUPT_H
...
#define INT_ID_JM                  (INT_GIC_SPI_START_ID +   7)
#define INT_ID_IFE                 (INT_GIC_SPI_START_ID +   8)
#define INT_ID_JMISP               (INT_GIC_SPI_START_ID +   9)
#define INT_ID_LSU                 (INT_GIC_SPI_START_ID +  10)
...
#define INT_ID_CAL                 (INT_GIC_SPI_START_ID +  14)
...
#define INT_ID_HWCP                (INT_GIC_SPI_START_ID +  39)
...
#define INT_ID_CSI_TX              (INT_GIC_SPI_START_ID +  49)
#define INT_ID_DSI                 (INT_GIC_SPI_START_ID +  50)
#define INT_ID_PPU                 (INT_GIC_SPI_START_ID +  51)
#define INT_ID_MI                  (INT_GIC_SPI_START_ID +  52)
...
#define INT_ID_HRTIMER             (INT_GIC_SPI_START_ID +  70)
...
#define INT_ID_UVCP                (INT_GIC_SPI_START_ID +  74)
#define INT_ID_ECDSA 	           (INT_GIC_SPI_START_ID +  75)
#define INT_ID_ETHERNET_TX0        (INT_GIC_SPI_START_ID +  76)
#define INT_ID_ETHERNET_RX0        (INT_GIC_SPI_START_ID +  77)
#define INT_ID_GRAPHIC3            (INT_GIC_SPI_START_ID +  78)
#define INT_ID_HRTIMER2            (INT_GIC_SPI_START_ID +  79)
#define INT_ID_HRTIMER3            (INT_GIC_SPI_START_ID +  80)
#define INT_ID_HRTIMER4            (INT_GIC_SPI_START_ID +  81)
#define INT_ID_HRTIMER5            (INT_GIC_SPI_START_ID +  82)
#define INT_ID_HRTIMER6            (INT_GIC_SPI_START_ID +  83)
#define INT_ID_HRTIMER7            (INT_GIC_SPI_START_ID +  84)
#define INT_ID_HRTIMER8            (INT_GIC_SPI_START_ID +  85)
#define INT_ID_HRTIMER9            (INT_GIC_SPI_START_ID +  86)
#define INT_ID_HRTIMER10           (INT_GIC_SPI_START_ID +  87)
#define INT_ID_LVDS3               (INT_GIC_SPI_START_ID +  88)
#define INT_ID_LVDS4               (INT_GIC_SPI_START_ID +  89)
#define INT_ID_VIE                 (INT_GIC_SPI_START_ID +  90)
#define INT_ID_DRE                 (INT_GIC_SPI_START_ID +  91)
#define INT_ID_CC                  (INT_GIC_SPI_START_ID +  92)
#define INT_ID_CC2                 (INT_GIC_SPI_START_ID +  92)
#define INT_ID_TRKE                (INT_GIC_SPI_START_ID +  94)
#define INT_ID_PWBC                (INT_GIC_SPI_START_ID +  95)
#define INT_ID_ROU                 (INT_GIC_SPI_START_ID +  96)
#define INT_ID_UTL 	               (INT_GIC_SPI_START_ID +  97)
#define INT_ID_TIMER2              (INT_GIC_SPI_START_ID +  98)
#define INT_ID_CNT                 (INT_GIC_SPI_START_ID + 99)
