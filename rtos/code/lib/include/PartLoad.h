...
typedef enum _PARTLOAD_DATA_TYPE {
	...
	PARTLOAD_DATA_TYPE_SIGN_UNCOMPRESS,  ///< signature uncompress data
...
typedef struct _PARTLOAD_INIT {
	...
	ULONG uiAddrBegin;     ///< Part-1 finish address, set it to 0 means full load
	ULONG uiWorkingAddr;   ///< Working Buffer Address (have to non-cachable)
