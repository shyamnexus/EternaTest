...
extern UINT32 Get32BitsData(ULONG Addr, BOOL bIsLittleEndian);
extern UINT16 Get16BitsData(ULONG Addr, BOOL bIsLittleEndian);
extern void   Set32BitsData(ULONG Addr, UINT32 Value, BOOL bIsLittleEndian);
extern void   Set16BitsData(ULONG Addr, UINT16 Value, BOOL bIsLittleEndian);
