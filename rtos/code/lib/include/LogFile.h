...
typedef struct {
	...
	uintptr_t				LogBuffAddr;								///<  the core1 log buffer address
	UINT32					LogBuffSize;								///<  the core1 log buffer size
	uintptr_t				LogBuffAddr2;								///<  the core2 log buffer address
...
typedef struct {
	...
	uintptr_t               lastTimeSysErrLogBuffAddr;					///<  the last time system error log buffer address
...
*/
extern ER         LogFile_DumpToMem(uintptr_t Addr, UINT32 Size);
