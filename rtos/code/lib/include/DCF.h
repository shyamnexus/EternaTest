...
typedef struct _DCF_OPEN_PARM {
	...
	uintptr_t            WorkbuffAddr;                           ///<  The work buffer address for storing DCF objects info.
...
extern ULONG  DCF_GetDBInfoEx2(DCF_HANDLE DcfHandle, DCF_INFOID infoID);
...
#define DCF_GetDBInfo2(parm1) DCF_GetDBInfoEx2(0, parm1)
