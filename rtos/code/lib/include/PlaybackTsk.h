...
typedef struct _PB_EDIT_CONFIG {
	...
	ULONG        puiParam[4];      ///< The parameters for the specific editing operation
...
*/
extern PB_ERR PB_GetParam(PB_PRMID ParamID, VOID* puiVal);
...
/**
    ...
    @return
        ...
        - @b PBERR_PAR: Parameters are not valid.
*/
extern PB_ERR PB_SetParam(PB_PRMID ParamID, ULONG uiValue);
