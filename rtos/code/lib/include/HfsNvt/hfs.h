...
// Typedefs
//------------------------------------------------------------------------------
typedef unsigned int        HFS_U32;                ///<  Unsigned 32 bits data type
typedef unsigned long       HFS_ULONG;              ///<  Unsigned long data type
...
typedef int  cyg_hfs_getCustomData(char *path, char *argument, HFS_ULONG bufAddr, HFS_U32 *bufSize, char *mimeType, HFS_U32 segmentCount);///< Callback function for get custom data.
...
typedef int  cyg_hfs_gen_dirlist_html(const char *path, HFS_ULONG bufAddr, HFS_U32 *bufSize, const char *usr, const char *pwd, HFS_U32 segmentCount);
typedef int  cyg_hfs_client_query(char *path, char *argument, HFS_ULONG bufAddr, HFS_U32 *bufSize, char *mimeType, HFS_U32 segmentCount); ///< Callback function for client query
typedef int  cyg_hfs_upload_result_cb(int result, HFS_ULONG bufAddr, HFS_U32 *bufSize, char *mimeType);///< Callback function for upload command complete
typedef int  cyg_hfs_delete_result_cb(int result, HFS_ULONG bufAddr, HFS_U32 *bufSize, char *mimeType);///< Callback function for delete command complete
typedef int  cyg_hfs_putCustomData(char *path, char *argument, HFS_ULONG bufAddr, HFS_U32 bufSize, HFS_U32 segmentCount, HFS_PUT_STATUS putStatus);///< Callback function for put custom data.
typedef int  cyg_hfs_header_cb(HFS_ULONG headerAddr, HFS_U32 headerSize, char *filepath, char *mimeType, void *reserved);  ///< Callback function for http header parse custom.
...
typedef struct {
	...
	HFS_ULONG               sharedMemAddr;                               ///<  shared memory address
...
typedef struct _HFS_IPC_MSG {
	...
	HFS_ULONG shareMem;               ///<   share memory address
} HFS_IPC_MSG;
...
typedef struct _HFS_IPC_GET_CUSTOM_S {
	HFS_ULONG bufAddr;                                      ///<   buffer to put custom data
...
typedef struct _HFS_IPC_GEN_DIRLIST_S {
	HFS_ULONG bufAddr;                                      ///<   buffer to put dirlist data
	HFS_U32   bufSize;                                      ///<   buffer size
	HFS_U32   segmentCount;                                 ///<   the buffer may be not enough to put custom data on time, so need to separate to several segments.
...
typedef struct _HFS_IPC_CLIENT_QUERY_S {
	HFS_ULONG bufAddr;                                      ///<   buffer to put data
	HFS_U32   bufSize;                                      ///<   buffer size
	HFS_U32   segmentCount;                                 ///<   the buffer may be not enough to put custom data on time, so need to separate to several segments.
...
typedef struct _HFS_IPC_UPLOAD_RESULT_S {
	HFS_ULONG bufAddr;                                      ///<   buffer to put upload result page data
	HFS_U32   bufSize;                                      ///<   buffer size
...
typedef struct _HFS_IPC_DELETE_RESULT_S {
	HFS_ULONG bufAddr;                                      ///<   buffer to put delete result page data
	HFS_U32   bufSize;                                      ///<   buffer size
...
typedef struct _HFS_IPC_HEADER_S {
	HFS_ULONG       headerAddr;                                   ///<   buffer to put custom data
