...
/**
    ...
    @return ER
*/
extern ER MovReadLib_Parse1stVideo(uintptr_t hdrAddr, UINT32 hdrSize, void *pobj);
...
/**
    ...
    @return ER
*/
extern ER MovReadLib_ParseThumbnail(uintptr_t hdrAddr, UINT32 hdrSize, void *pobj);
...
/**
    ...
    @return ER
*/
extern ER MovReadLib_ParseVideoInfo(uintptr_t hdrAddr, UINT32 hdrSize, void *pobj);
/**
