...
// Typedefs
//------------------------------------------------------------------------------
typedef unsigned int        LVIEWD_U32;               ///<   Unsigned 32 bits data type
typedef unsigned char       LVIEWD_U8;                ///<   Unsigned 8 bits data type
typedef unsigned long       LVIEWD_ULONG;             ///<   Unsigned long data type
...
*/
//@{
typedef int cyg_lviewd_getJpg(ULONG *jpgAddr, int *jpgSize); ///< Callback function for get one jpg frame.
typedef void cyg_lviewd_notify(int status);                ///< Callback function for notify the lviewd status.
typedef void cyg_lviewd_hwmem_memcpy(ULONG uiDst, ULONG uiSrc, LVIEWD_U32 uiSize);///< Callback function for doing HW memcpy.
//@}
...
typedef struct{
    ...
    ULONG                   shareMemAddr;   ///<   the share memory address for put jpg frames
