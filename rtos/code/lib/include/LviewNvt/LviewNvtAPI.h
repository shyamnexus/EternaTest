...
typedef UINT32(*LVIEWNVT_GETVIDEOBUFCB)(ULONG *yAddr, ULONG *cbAddr, ULONG *crAddr, ULONG *lineOfsY);       ///< Callback for getting video buffer.
...
typedef UINT32(*LVIEWNVT_DRAWCB)(ULONG  yAddr, ULONG cbAddr, ULONG crAddr, ULONG lineOfsY);                 ///< Callback for draw image.
//@}
