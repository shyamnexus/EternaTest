...
*/
typedef INT32(* NVTEVT_EVENT_FUNC_PTR)(VControl *pCtrl, UINT32 paramNum, ULONG *paramArray);
...
/**
    ...
    @return
        ...
        - @b NVTEVT_PASS:            pass to next flow.
*/
extern INT32 Ux_DefaultEvent(VControl *pCtrl, NVTEVT evt, UINT32 paramNum, ULONG *paramArray);
