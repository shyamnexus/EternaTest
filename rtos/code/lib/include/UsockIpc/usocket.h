...
__externC int usocket_install_multi( usocket_install_obj_multi*  pObj,unsigned long obj_index); ///return obj_index, if return -1 means error.

__externC void usocket_uninstall_multi(unsigned long obj_index);

__externC void usocket_open_multi(unsigned long obj_index);

__externC void usocket_close_multi(unsigned long obj_index);

__externC int usocket_send_multi(char* buf, int* size, unsigned long obj_index);
