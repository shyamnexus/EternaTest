...
static ER ad_nvp6188_det_video_info(UINT32 chip_id, UINT32 vin_id, AD_NVP6188_DET_VIDEO_INFO *video_info)
{
	...
	static nc_decoder_s ncde_rp5 = {0};
...
static ER ad_nvp6188_init(UINT32 chip_id, void *ext_data)
{
	...
	ad_nvp6188_nc_drv_decoder_init_set(NC_MIPI_LANE_2, AD_NVP6188_NC_MIPI_BPS_1188Mbps);
#else
...
#if defined(CONFIG_NVT_FPGA_EMULATION) || defined(_NVT_FPGA_)
					ad_nvp6188_nc_drv_decoder_init_set(NC_MIPI_LANE_2, bps);
#else
