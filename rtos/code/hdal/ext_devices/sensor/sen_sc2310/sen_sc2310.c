...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc2310, 1, 01, 000, 00);
...
static CTL_SEN_CMD sc2310_mode_3[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
...
static UINT32 sen_get_cmd_tab_sc2310(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_3:
		*cmd_tab = sc2310_mode_3;
		return sizeof(sc2310_mode_3) / sizeof(CTL_SEN_CMD);
