...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc401ai, 1, 01, 000, 00);
...
static CTL_SEN_CMD sc401ai_mode_1[] = {
	...
	{0x320f, 1, {0xdc, 0x0}},
	{0x3210, 1, {0x00, 0x0}},
	{0x3211, 1, {0x03, 0x0}},//0x04 for start pixel R
	{0x3212, 1, {0x00, 0x0}},
	{0x3213, 1, {0x01, 0x0}},//0x02 for start pixel R
	{0x3214, 1, {0x11, 0x0}},
	{0x3215, 1, {0x11, 0x0}},
	{0x3223, 1, {0x80, 0x0}},
	{0x3250, 1, {0x00, 0x0}},
...
static CTL_SEN_CMD sc401ai_mode_3[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
	...
	{0x320a, 1, {0x05, 0x0}},
	{0x320b, 1, {0xa4, 0x0}},
	{0x320c, 1, {0x0A, 0x0}},//x2, 15FPS
	{0x320d, 1, {0xF0, 0x0}},//x2, 15FPS	
	{0x320e, 1, {0x05, 0x0}},
	{0x320f, 1, {0xdc, 0x0}},
	{0x3211, 1, {0x03, 0x0}},//0x04 for start pixel R
	{0x3213, 1, {0x01, 0x0}},//0x02 for start pixel R
...
static UINT32 sen_get_cmd_tab_sc401ai(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_3:
		*cmd_tab = sc401ai_mode_3;
		return sizeof(sc401ai_mode_3) / sizeof(CTL_SEN_CMD);
