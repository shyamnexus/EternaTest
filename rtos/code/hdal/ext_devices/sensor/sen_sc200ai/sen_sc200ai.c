...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc200ai, 1, 01, 001, 00);
...
static ER sen_sleep_sc200ai(CTL_SEN_ID id)
{
	...
	cmd = sen_set_cmd_info_sc200ai(0x0100, 1, 0x00, 0x0);
	rt |= sen_write_reg_sc200ai(id, &cmd);

	DBG_DUMP("enter sen_sleep_sc200ai\r\n"); 
...
static ER sen_wakeup_sc200ai(CTL_SEN_ID id)
{
	...
	cmd = sen_set_cmd_info_sc200ai(0x0100, 1, 0x01, 0x0);
	rt |= sen_write_reg_sc200ai(id, &cmd);

	DBG_DUMP("enter sen_wakeup_sc200ai\r\n");
