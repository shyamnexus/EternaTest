...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc3338_slave, 1, 01, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_SC3338_SLAVE_MODULE_NAME      "sen_sc3338_slave"
#define SEN_SC3338_SLAVE_MODULE_NAME_REG  "nvt_sen_sc3338_slave"
...
#define RB_ROWS                     4 //0x3218 0x3219
#define HD_SYNC                     8
#define VD_SYNC                     1349
...
static ER sen_chg_mode_sc3338_slave(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj)
{
	...
	ctl_sen_set(ctl_sen_get_senid(id, 0, SEN_SC3338_SLAVE_MODULE_NAME_REG), CTL_SEN_CFGID_TGE_VD_SYNC, (void *)(&new_tge_vd_sync));	
	ctl_sen_set(ctl_sen_get_senid(id, 0, SEN_SC3338_SLAVE_MODULE_NAME_REG), CTL_SEN_CFGID_TGE_VD_PERIOD, (void *)(&new_tge_vd));
	first_flag[id] = 0;
	...
	for (idx = 0; idx < cmd_num; idx++) {
		if (p_cmd_list[idx].addr == SEN_CMD_DELAY) {
			...
			rt |= sen_write_reg_sc3338_slave(id, &cmd);
			cmd = sen_set_cmd_info_sc3338_slave(0x322E, 1, ((sensor_vd - RB_ROWS) >> 8)& 0x7F, 0x0);
			rt |= sen_write_reg_sc3338_slave(id, &cmd);
			cmd = sen_set_cmd_info_sc3338_slave(0x322F, 1, (sensor_vd - RB_ROWS) & 0xFF, 0x0);
			rt |= sen_write_reg_sc3338_slave(id, &cmd);			
...
int sen_init_sc3338_slave(SENSOR_DTSI_INFO *info)
{
	...
	rt = ctl_sen_reg_sendrv("SEN_SC3338_SLAVE_MODULE_NAME_REG", &reg_obj);
	if (rt != E_OK) {
...
{
	ctl_sen_unreg_sendrv("SEN_SC3338_SLAVE_MODULE_NAME_REG");
}
