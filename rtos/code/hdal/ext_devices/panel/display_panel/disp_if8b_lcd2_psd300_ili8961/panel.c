...
*/
//@{
const T_PANEL_CMD t_cmd_standby_2[] = {
	{0x2B, 0x00}
};

const T_PANEL_CMD t_cmd_mode_rgb320_2[] = {
    {0x05, 0x1E},
    {CMDDELAY_MS, 50},
    {0x05, 0x5D},
    {CMDDELAY_MS, 50},
...
const T_LCD_PARAM t_mode_2[] = {
	/***********       RGB 320 mode         *************/
	{
		...
		(T_PANEL_CMD *)t_cmd_mode_rgb320_2,                 //!< p_cmd_queue
		sizeof(t_cmd_mode_rgb320_2) / sizeof(T_PANEL_CMD),  //!< n_cmd
	}

};
const T_PANEL_CMD t_cmd_rotate_none_2[] = {
	//{0x04,0x18}
};
const T_PANEL_CMD t_cmd_rotate_180_2[] = {
	//{0x04,0x1b}
};
const T_LCD_ROT t_rotate_2[] = {
	{DISPDEV_LCD_ROTATE_NONE, (T_PANEL_CMD *)t_cmd_rotate_none_2, 1},
	{DISPDEV_LCD_ROTATE_180, (T_PANEL_CMD *)t_cmd_rotate_180_2, 1}
};

const T_LCD_SIF_PARAM t_sif_param_2[] = {
	{
	// SIF mode 00
	0,
	//SIF_MODE_00,
...
T_LCD_ROT *dispdev_get_lcd_rotate_cmd2(UINT32 *mode_number)
{
	...
	*mode_number = sizeof(t_rotate_2) / sizeof(T_LCD_ROT);

	return (T_LCD_ROT *)t_rotate_2;
}

T_LCD_PARAM *dispdev_get_config_mode2(UINT32 *mode_number)
{
	*mode_number = sizeof(t_mode_2) / sizeof(T_LCD_PARAM);
	return (T_LCD_PARAM *)t_mode_2;
}

T_PANEL_CMD *dispdev_get_standby_cmd2(UINT32 *cmd_number)
{
	*cmd_number = sizeof(t_cmd_standby_2) / sizeof(T_PANEL_CMD);
	return (T_PANEL_CMD *)t_cmd_standby_2;
}
...
T_LCD_SIF_PARAM *dispdev_get_lcd_sif_param2(void)
{
	return (T_LCD_SIF_PARAM *)t_sif_param_2;
}
