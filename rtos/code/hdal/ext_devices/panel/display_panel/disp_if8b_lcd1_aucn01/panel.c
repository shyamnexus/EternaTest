...
const T_LCD_PARAM t_mode[] = {
	...
	/***********       RGB Dummy-320 MODE         *************/
	{
		// tPANEL_PARAM
		{
			...
			4000000,                          //!< fDCLK
#else
			12000000,                       //!< fDCLK, if source = 480MHz
#endif
	...
	/***********       THROUGH MODE         *************/
	{
		// tPANEL_PARAM
		{
			...
			4000000,                           //!< fDCLK
#else
			16000000,                          	//!< fDCLK: IDE clock = 1/3X out I/F clock
#endif
	...
	/***********       YUV640 MODE         *************/
	{
		...
		{
			/* Old prototype */
			PINMUX_LCD_SEL_SERIAL_YCbCr_8BITS | PINMUX_LCD_SEL_DE_ENABLE,//!< pinmux_select_lcd;
			ICST_CCIR601,                   //!< icst;
			{FALSE, FALSE},                 //!< dithering[2];
			DISPLAY_DEVICE_AU,              //!< **DONT-CARE**
			IDE_PDIR_RGB,                   //!< pdir;
