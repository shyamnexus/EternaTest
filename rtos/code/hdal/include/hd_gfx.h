...
/**
     parameters for hd_gfx_draw_polygon.
*/
typedef struct _HD_GFX_DRAW_POLYGON {
	HD_GFX_IMG_BUF          dst_img;   ///< destination image
	UINT32                  color;     ///< polygon color
	HD_GFX_RECT_TYPE        type;      ///< solid or hollow polygon
	UINT32                  thickness; ///< border size for hollow polygon
	HD_IPOINT               *points;   ///< all corners' coordinate
	UINT32                  point_cnt; ///< how many points
} HD_GFX_DRAW_POLYGON;
...
/**
    ...
    @param p_param: parameter for polygon drawing operation.

    @return HD_OK for success, other value indicates an error.
*/
HD_RESULT hd_gfx_draw_polygon(HD_GFX_DRAW_POLYGON *p_param);
