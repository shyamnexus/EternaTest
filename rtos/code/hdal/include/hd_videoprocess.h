...
********************************************************************/
#define HD_DAL_VIDEOPROC_CHIP_DEV_COUNT         512 ///< total number of device per chip
...
typedef enum _HD_VIDEOPROC_CTRLFUNC {
	...
	HD_VIDEOPROC_FUNC_BNR =             0x20000000, ///< enable Bayer 3DNR effect
	HD_VIDEOPROC_FUNC_BNR_STA =         0x40000000, ///< enable Bayer 3DNR statistic for ISP tools
...
typedef enum _HD_VIDEOPROC_PIPE {
	...
	HD_VIDEOPROC_PIPE_RAWCOLOR =        0x0000003E, ///< 1 RAW frame to 1 YUV frame, support in-crop, WDR/SHDR, NR, DEFOG, color and gamma tuning.
	HD_VIDEOPROC_PIPE_BNR_RAWALL =      0x000600F8, ///< 1 RAW frame to 5 YUV frame, do RAW-domain pre-process and YUV-domain process, support in-crop, in-direct, BNR, WDR/SHDR, NR, DEFOG, color and gamma tuning, out-scaling, out-crop
	HD_VIDEOPROC_PIPE_BNR_RAWCOLOR =    0x00060038, ///< 1 RAW frame to 1 YUV frame, do RAW-domain pre-process and YUV-domain process, support in-crop, BNR, WDR/SHDR, NR, DEFOG, color and gamma tuning.
	HD_VIDEOPROC_PIPE_VPE =             0x000000F2, ///< do YUV-domain scale process by VPE engine
	HD_VIDEOPROC_PIPE_VSP =             0x000000F4, ///< Video Stitching Process
