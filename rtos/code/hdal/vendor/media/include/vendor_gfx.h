...
typedef struct _VENDOR_GFX_ISE_SCALE_Y8 {
	HD_DIM                   src_dim;
	HD_DIM                   dst_dim;
	uintptr_t                p_src_phy_addr;
	UINT32                   src_loff;
	uintptr_t                p_dst_phy_addr;
	UINT32                   dst_loff;
...
typedef struct _VENDOR_GFX_ALPHA_BLEND_EX {
	HD_GFX_IMG_BUF             src_img;
	HD_GFX_IMG_BUF             src2_img;
	HD_GFX_IMG_BUF             dst_img;
	HD_IPOINT                  dst_pos;
	uintptr_t                  p_alpha;
    UINT32                     flush;
} VENDOR_GFX_ALPHA_BLEND_EX;
...
typedef enum _VENDOR_GFX_GRPH_CMD {
	...
	VENDOR_GRPH_CMD_Draw_line = 9,                      ///< Draw Line
	...
	VENDOR_GRPH_CMD_YCC_ENC,                    	///< YCC encode (compress)
	VENDOR_GRPH_CMD_YCC_DEC,                    	///< YCC decode (decompress)
	VENDOR_GRPH_CMD_Non_uni_correction,
...
typedef enum _GRPH_VENDOR_GFX_FORMAT {
	...
	VENDOR_GFX_GRPH_FORMAT_8BITS_YPACK,
	...
	VENDOR_GFX_GRPH_FORMAT_32BITS_ARGB8888_ARGB,       ///< 32 bits ARGB8888 pack data
	VENDOR_GFX_GRPH_FORMAT_16BITS_ARGB1555_RGB,
	VENDOR_GFX_GRPH_FORMAT_16BITS_ARGB1555_A,
	VENDOR_GFX_GRPH_FORMAT_16BITS_ARGB1555_ARGB,       ///< 16 bits ARGB1555 pack data
	VENDOR_GFX_GRPH_FORMAT_16BITS_ARGB4444_RGB,
	VENDOR_GFX_GRPH_FORMAT_16BITS_ARGB4444_A,
	VENDOR_GFX_GRPH_FORMAT_16BITS_ARGB4444_ARGB,       ///< 16 bits ARGB4444 pack data
...
typedef enum _VENDOR_GFX_GRPH_PROPERTY_ID {
	...
	VENDOR_GFX_GRPH_PROPERTY_ID_LINE_PTR,
	VENDOR_GFX_GRPH_PROPERTY_ID_UV_SUBSAMPLE,
	VENDOR_GFX_GRPH_PROPERTY_ID_GOP_DIR,
	VENDOR_GFX_GRPH_PROPERTY_ID_YCC_EN,
	VENDOR_GFX_GRPH_PROPERTY_ID_MB_EN,
