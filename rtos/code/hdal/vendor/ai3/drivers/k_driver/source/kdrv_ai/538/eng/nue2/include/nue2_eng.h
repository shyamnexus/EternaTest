...
typedef void (*NUE2_ISR_CB)(void *eng, UINT32 status, void *reserve, UINT32 ll_idx);
...
extern void nue2_eng_trig_ll_hw_reg(NUE2_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb, UINT32 ll_idx);
...
extern UINT32 nue2_eng_get_ll_cycle(NUE2_ENG_HANDLE *p_eng, UINT32 ll_idx);
...
extern VOID nue2_eng_wait_framend_ll(NUE2_ENG_HANDLE *p_eng, UINT32 ll_idx);
