...
#define LSU_ENG_REG_NUMS  ((0x128>>2)+1)
...
typedef enum {
	...
	LSU_ENG_INTERRUPT_ALL                 = (LSU_ENG_INTERRUPT_FRM_END | LSU_ENG_INTERRUPT_LL_END | LSU_ENG_INTERRUPT_LL_ERR | LSU_ENG_INTERRUPT_JOB_END),
} LSU_ENG_INTERRUPT;
...
extern VOID lsu_eng_trig_ll_hw_reg(LSU_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb, UINT32 ll_idx);
...
extern VOID lsu_eng_wait_framend_ll(LSU_ENG_HANDLE *p_eng, UINT32 ll_idx);
...
extern UINT32 lsu_eng_get_ll_cycle(LSU_ENG_HANDLE *p_eng, UINT32 ll_idx);
