...
/*
VOID jmisp_eng_set_img_size(IVE_ENG_HANDLE *p_eng, UINT32 img_w, UINT32 img_h)
{
...
VOID jmisp_eng_set_func_mode(IVE_ENG_HANDLE *p_eng, IVE_ENG_PATH_SEL path)
{
...
VOID ive_eng_set_ccl_path(IVE_ENG_HANDLE *p_eng, IVE_ENG_CCL_PATH ccl_path)
{
    ...
    p_eng->p_ive_reg_st->reg_104.bit.ccl_foregjmispnd_val = ccl_path.foregjmispnd_val;
