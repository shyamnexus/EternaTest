...
#define JOBM_ENG_REG_NUMS  (0xA10/4+1)  // for NT98690
...
extern INT32 jobm_eng_set_arb_dbg_en(JOBM_ENG_HANDLE *p_eng, UINT32 enable_eng);
extern INT32 jobm_eng_run_arb_dbg(JOBM_ENG_HANDLE *p_eng, UINT32 enable_eng);
...
extern UINT32 jobm_eng_get_conv0_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_conv1_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_conv2_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_conv3_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_lsu_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_util_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_rou_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_cal_busy_cnt(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_arb_status(JOBM_ENG_HANDLE *p_eng);
extern UINT32 jobm_eng_get_eng_arb_info(JOBM_ENG_HANDLE *p_eng, UINT32 eng, UINT32 *jl_idx, UINT32 *dispatch_sel, UINT32 *net_id, UINT64 *job_addr);
