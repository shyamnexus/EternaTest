...
REGDEF_BEGIN(NUE2_LL_BASE_ADDRESS_MSB_REGISTER0)
    REGDEF_BIT(LL_BASE_MSB_ADDR0,        8)
...
REGDEF_BEGIN(NUE2_LL_BASE_ADDRESS_MSB_REGISTER1)
    REGDEF_BIT(LL_BASE_MSB_ADDR1,        8)
...
REGDEF_BEGIN(NUE2_LL_BASE_ADDRESS_MSB_REGISTER2)
    REGDEF_BIT(LL_BASE_MSB_ADDR2,        8)
...
REGDEF_BEGIN(NUE2_LL_BASE_ADDRESS_MSB_REGISTER3)
    REGDEF_BIT(LL_BASE_MSB_ADDR3,        8)
...
REGDEF_BEGIN(NUE2_LL_BASE_ADDRESS_MSB_REGISTER4)
    REGDEF_BIT(LL_BASE_MSB_ADDR4,        8)
...
typedef struct
{
	...
	union
	{
		struct
		{
			unsigned DRAM_MSB_SAILL        : 8;		// bits : 7_0
		} Bit;
		UINT32 Word;
	...
	union
	{
		struct
		{
			unsigned LL_BASE_MSB_ADDR0        : 8;		// bits : 7_0
		} Bit;
		UINT32 Word;
	...
	union
	{
		struct
		{
			unsigned LL_BASE_MSB_ADDR1        : 8;		// bits : 7_0
		} Bit;
		UINT32 Word;
	...
	union
	{
		struct
		{
			unsigned LL_BASE_MSB_ADDR2        : 8;		// bits : 7_0
		} Bit;
		UINT32 Word;
	...
	union
	{
		struct
		{
			unsigned LL_BASE_MSB_ADDR3        : 8;		// bits : 7_0
		} Bit;
		UINT32 Word;
	...
	union
	{
		struct
		{
			unsigned LL_BASE_MSB_ADDR4        : 8;		// bits : 7_0
		} Bit;
		UINT32 Word;
	} NUE2_Register_100; // 0x0190

} NT98635_NUE2_REGISTER_STRUCT;
