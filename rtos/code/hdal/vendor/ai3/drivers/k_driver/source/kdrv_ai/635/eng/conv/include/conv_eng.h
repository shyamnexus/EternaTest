...
typedef enum {
	...
	CONV_ENG_INTERRUPT_LL0_END            = 0x01000000,
    CONV_ENG_INTERRUPT_LL0_ERR            = 0x02000000,
    CONV_ENG_INTERRUPT_JOB0_END           = 0x04000000,
	CONV_ENG_INTERRUPT_LL1_END            = 0x10000000,
    CONV_ENG_INTERRUPT_LL1_ERR            = 0x20000000,
    CONV_ENG_INTERRUPT_JOB1_END           = 0x40000000,
	CONV_ENG_INTERRUPT_ALL                = (CONV_ENG_INTERRUPT_FRM_END | CONV_ENG_INTERRUPT_LL0_END | CONV_ENG_INTERRUPT_LL0_ERR | CONV_ENG_INTERRUPT_JOB0_END
											| CONV_ENG_INTERRUPT_LL1_END | CONV_ENG_INTERRUPT_LL1_ERR | CONV_ENG_INTERRUPT_JOB1_END),
} CONV_ENG_INTERRUPT;
...
extern void conv_eng_trig_ll_hw_reg(CONV_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb, UINT32 ll_idx);
...
extern UINT32 conv_eng_get_ll_cycle(CONV_ENG_HANDLE *p_eng, UINT32 ll_idx);
...
extern VOID conv_eng_wait_framend_ll(CONV_ENG_HANDLE *p_eng, UINT32 ll_idx);
extern INT32 conv_eng_set_ll_setting(CONV_ENG_HANDLE *p_eng, CONV_LL_SETTING *ll_param);
extern UINT32 conv_eng_get_qos_setting(CONV_ENG_HANDLE *p_eng);
extern UINT32 conv_eng_get_ll_sta_acc_cycle(CONV_ENG_HANDLE *p_eng, UINT32 ll_idx);
