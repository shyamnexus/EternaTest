...
/*
    ...
    INTE_PRELOAD_TIMEOUT_CASE1  :    [0x0, 0x1],			bits : 8
	INTE_PRELOAD_TIMEOUT_CASE2  :    [0x0, 0x1],			bits : 9
...
REGDEF_BEGIN(LSU_INTERRUPT_ENABLE_REGISTER_OFS)
    ...
    REGDEF_BIT(               ,        7)
    REGDEF_BIT(INTE_PRELOAD_TIMEOUT_CASE1 ,   1)
	REGDEF_BIT(INTE_PRELOAD_TIMEOUT_CASE2 ,   1)
    REGDEF_BIT(               ,        14)
...
/*
    ...
    INTS_PRELOAD_TIMEOUT_CASE1 :    [0x0, 0x1],	bits : 8
	INTS_PRELOAD_TIMEOUT_CASE2 :    [0x0, 0x1],	bits : 9
...
REGDEF_BEGIN(LSU_INTERRUPT_STATUS_REGISTER_OFS)
    ...
    REGDEF_BIT(               ,        7)
    REGDEF_BIT(INTS_PRELOAD_TIMEOUT_CASE1 ,   1)
	REGDEF_BIT(INTS_PRELOAD_TIMEOUT_CASE2 ,   1)
    REGDEF_BIT(               ,        14)
...
REGDEF_BEGIN(LSU_SUB_MODE_REGISTER0_OFS)
    REGDEF_BIT(		      ,         16)
    REGDEF_BIT(LSU_PRELOAD_BLOCK_SIZE, 2)     // bits : 17_16
    REGDEF_BIT(		      ,         2)
    REGDEF_BIT(LSU_PRELOAD_TIMEOUT_CASE1_CHK_EN, 1)     // bits : 20
	REGDEF_BIT(LSU_PRELOAD_TIMEOUT_CASE2_CHK_EN, 1)     // bits : 21
...
REGDEF_BEGIN(LSU_LL_BASE_ADDR_REGISTER_1_OFS)
	REGDEF_BIT(BASE_MSB_ADDR0	       , 8)    // bits : 7_0	
...
REGDEF_BEGIN(LSU_LL_BASE_ADDR_REGISTER_3_OFS)
	REGDEF_BIT(BASE_MSB_ADDR1	       , 8)    // bits : 7_0	
...
REGDEF_BEGIN(LSU_LL_BASE_ADDR_REGISTER_5_OFS)
	REGDEF_BIT(BASE_MSB_ADDR2	       , 8)    // bits : 7_0	
...
REGDEF_BEGIN(LSU_LL_BASE_ADDR_REGISTER_7_OFS)
	REGDEF_BIT(BASE_MSB_ADDR3	       , 8)    // bits :7_0	
...
REGDEF_BEGIN(LSU_LL_JOB_CHANNEL_REGISTER_1_OFS)
	REGDEF_BIT(DRAMUB_MSB_SAIJOB	, 8)	   // bits : 7_0
...
REGDEF_BEGIN(LSU_LL_BASE_ADDR_REGISTER_9_OFS)
	REGDEF_BIT(BASE_MSB_ADDR4	, 8)	       // bits : 7_0
...
#define LSU_DRAMUB_IO_REGISTER_4_OFS 0x0060
REGDEF_BEGIN(LSU_DRAMUB_IO_REGISTER_4_OFS)
	REGDEF_BIT(DRAMUB_SAI1	, 32)	           // bits : 31_0
REGDEF_END(LSU_DRAMUB_IO_REGISTER_4_OFS)

	
#define LSU_DRAMUB_IO_REGISTER_5_OFS 0x0064
REGDEF_BEGIN(LSU_DRAMUB_IO_REGISTER_5_OFS)
	REGDEF_BIT(DRAMUB_MSB_SAI1	, 8)	// bits : 7_0
	REGDEF_BIT(					, 20)	// bits : 27_8
	REGDEF_BIT(DRAMUB_MODE_SAI1	, 4)	// bits : 31_28
REGDEF_END(LSU_DRAMUB_IO_REGISTER_5_OFS)


#define LSU_RESERVED_REGISTER_2_OFS 0x0068
REGDEF_BEGIN(LSU_RESERVED_REGISTER_2_OFS)
	REGDEF_BIT(    	, 32)	// bits , 31_0
REGDEF_END(LSU_RESERVED_REGISTER_2_OFS)


#define LSU_RESERVED_REGISTER_3_OFS 0x006c
...
REGDEF_BEGIN(LSU_SIZE_REGISTER_0_OFS)
	REGDEF_BIT(LSU_WIDTH,        22)	// bits : 21_0
...
#define LSU_RESERVED_REGISTER_9_OFS 0x00b0
REGDEF_BEGIN(LSU_RESERVED_REGISTER_9_OFS)
	REGDEF_BIT(    	, 32)	// bits , 31_0
REGDEF_END(LSU_RESERVED_REGISTER_9_OFS)


#define LSU_RESERVED_REGISTER_10_OFS 0x00b4
REGDEF_BEGIN(LSU_RESERVED_REGISTER_10_OFS)
	REGDEF_BIT(    	, 32)	// bits , 31_0
REGDEF_END(LSU_RESERVED_REGISTER_10_OFS)


#define LSU_Preload_REGISTER_0_OFS 0x00b8
REGDEF_BEGIN(LSU_Preload_REGISTER_0_OFS)
	REGDEF_BIT(LSU_PRELOAD_TABLE_LEN,      14)	// bits : 13_0
REGDEF_END(LSU_Preload_REGISTER_0_OFS)


#define LSU_Preload_REGISTER_1_OFS 0x00bc
REGDEF_BEGIN(LSU_Preload_REGISTER_1_OFS)
	REGDEF_BIT(LSU_PRELOAD_FRAME_CNT,      16)	// bits : 15_0
REGDEF_END(LSU_Preload_REGISTER_1_OFS)
...
#define LSU_Preload_REGISTER_2_OFS 0x00cc
REGDEF_BEGIN(LSU_Preload_REGISTER_2_OFS)
	REGDEF_BIT(LSU_PRELOAD_TIMEOUT_CASE1_CYCLE,      32)	// bits : 31_0
REGDEF_END(LSU_Preload_REGISTER_2_OFS)


#define LSU_Preload_REGISTER_3_OFS 0x00d0
REGDEF_BEGIN(LSU_Preload_REGISTER_3_OFS)
	REGDEF_BIT(LSU_PRELOAD_TIMEOUT_CASE2_CYCLE,      32)	// bits : 31_0
REGDEF_END(LSU_Preload_REGISTER_3_OFS)


#define LSU_Preload_REGISTER_4_OFS 0x00d4
REGDEF_BEGIN(LSU_Preload_REGISTER_4_OFS)
	REGDEF_BIT(LSU_PRELOAD_SAFE_MODE,      1)	// bits : 0
REGDEF_END(LSU_Preload_REGISTER_4_OFS)
...
REGDEF_BEGIN(LSU_DISIGN_DEBUG_REGISTER_OFS)
	...
	REGDEF_BIT(IN1_BURST_LENGTH	, 	2)	// bits : 7_6
	REGDEF_BIT(OUT0_BURST_LENGTH, 	2)	// bits : 9_8
	REGDEF_BIT(					, 	3)	// bits : 12_10
	REGDEF_BIT(CYCLE_COUNT_EN, 		1)	// bits : 13
...
REGDEF_BEGIN(LSU_AXI_REGISTER_0_OFS)
	...
	REGDEF_BIT(IN1_LOCK_DISABLE , 	1)	// bits : 9
...
#define LSU_RESERVED_REGISTER_11_OFS 0x00fc
...
#define LSU_RESERVED_REGISTER_12_OFS 0x0108
...
#define LSU_BUSY_COUNT_REGISTER_0_OFS 0x0120
REGDEF_BEGIN(LSU_BUSY_COUNT_REGISTER_0_OFS)
	REGDEF_BIT(LL0_BUSY_COUNT_CLR,		 1)	// bits , 1
	REGDEF_BIT(LL1_BUSY_COUNT_CLR,		 1)	// bits , 1
REGDEF_END(LSU_BUSY_COUNT_REGISTER_0_OFS)


#define LSU_BUSY_COUNT_REGISTER_1_OFS 0x0124
REGDEF_BEGIN(LSU_BUSY_COUNT_REGISTER_1_OFS)
	REGDEF_BIT(LL0_BUSY_COUNT,		 32)	// bits , 31_0
REGDEF_END(LSU_BUSY_COUNT_REGISTER_1_OFS)


#define LSU_BUSY_COUNT_REGISTER_2_OFS 0x0124
REGDEF_BEGIN(LSU_BUSY_COUNT_REGISTER_2_OFS)
	REGDEF_BIT(LL1_BUSY_COUNT,		 32)	// bits , 31_0
REGDEF_END(LSU_BUSY_COUNT_REGISTER_2_OFS)
...
typedef struct
{
  ...
  union
  {
    struct
    {
	 ...
	 unsigned                       : 7;
	 unsigned INTE_PRELOAD_TIMEOUT_CASE1   : 1;	// bits : 8
	 unsigned INTE_PRELOAD_TIMEOUT_CASE2   : 2;	// bits : 9
	 unsigned                       : 14;
  ...
  union
  {
    struct
    {
	 ...
	 unsigned                       : 7;
	 unsigned INTS_PRELOAD_TIMEOUT_CASE1   : 1;	// bits : 8
	 unsigned INTS_PRELOAD_TIMEOUT_CASE2   : 1;	// bits : 9
	 unsigned                       : 14;
  ...
  union
  {
    ...
    {
	 unsigned                       : 16;
	 unsigned LSU_PRELOAD_BLOCK_SIZE				: 2;	// bits : 17_16
	 unsigned                       : 2;
	 unsigned LSU_PRELOAD_TIMEOUT_CASE1_CHK_EN	: 1;	// bits : 20
	 unsigned LSU_PRELOAD_TIMEOUT_CASE2_CHK_EN	: 1;	// bits : 21
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LSU_WIDTH             : 22;		// bits : 21_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LSU_PRELOAD_TABLE_LEN     	: 14;	// bits : 13_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LSU_PRELOAD_FRAME_CNT 	: 16;    // bits : 15_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LSU_PRELOAD_TIMEOUT_CASE1_CYCLE     : 32;	// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LSU_PRELOAD_TIMEOUT_CASE2_CYCLE     : 32;	// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LSU_PRELOAD_SAFE_MODE     : 1;	// bits : 0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
	  ...
	  unsigned IN1_BURST_LENGTH     : 2;		// bits : 7_6
      unsigned OUT0_BURST_LENGTH    : 2;		// bits : 9_8
	  unsigned                      : 3;		// bits : 12_10
      unsigned CYCLE_COUNT_EN       : 1;		// bits : 13
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
	  ...
	  unsigned IN1_LOCK_DISABLE     : 1;		// bits : 9
  ...
  union
  {
    ...
    UINT32 Word;
  } LSU_Register_72; // 0x0120
  
  union
  {
    struct
    {
      unsigned LL0_BUSY_COUNT    	: 32;		// bits : 0
    } Bit;
    UINT32 Word;
  } LSU_Register_73; // 0x0124
  
  union
  {
    struct
    {
      unsigned LL1_BUSY_COUNT    	: 32;		// bits : 0
    } Bit;
    UINT32 Word;
  } LSU_Register_74; // 0x0128
  
} NT98635_LSU_REGISTER_STRUCT;
