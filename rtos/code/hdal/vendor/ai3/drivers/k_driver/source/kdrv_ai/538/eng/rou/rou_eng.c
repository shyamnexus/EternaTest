...
{
    p_eng->p_rou_reg_st = (NT98538_ROU_REGISTER_STRUCT *)reg_base_addr;
...
{
    return rou_eng_platform_get_busy_count(p_eng, ll_idx);
}

VOID rou_eng_clr_busy_count(ROU_ENG_HANDLE *p_eng, UINT32 ll_idx)
{
    rou_eng_platform_clr_busy_count(p_eng, ll_idx);
}
