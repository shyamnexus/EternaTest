...
{
    p_eng->p_lsu_reg_st = (NT98635_LSU_REGISTER_STRUCT *)reg_base_addr;
...
VOID lsu_eng_trig_ll_hw_reg(LSU_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb, UINT32 ll_idx)
{
...
VOID lsu_eng_wait_framend_ll(LSU_ENG_HANDLE *p_eng, UINT32 ll_idx)
{
    FLGPTN uiflag;
    ER er_return = E_OK;
...
UINT32 lsu_eng_get_ll_cycle(LSU_ENG_HANDLE *p_eng, UINT32 ll_idx)
{
	if (p_eng == NULL) {
		DBG_ERR("LSU handle null\r\n");
		return 0;
