...
typedef VOID (*PPU_ISR_CB)(VOID *eng, UINT32 status, VOID *reserve, UINT32 ll_idx);
...
extern VOID ppu_eng_trig_ll_hw_reg(PPU_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb, UINT32 ll_idx);
...
extern VOID ppu_eng_wait_framend_ll(PPU_ENG_HANDLE *p_eng, UINT32 ll_idx);
...
extern UINT32 ppu_eng_get_ll_cycle(PPU_ENG_HANDLE *p_eng, UINT32 ll_idx);
