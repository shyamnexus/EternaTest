...
/*
    ...
    CONV_BIAS_MODE         :    [0x0, 0x1],			bits : 3
    CONV_BN_W_MODE         :    [0x0, 0x1],			bits : 4
    CONV_ELT_MODE          :    [0x0, 0x3],			bits : 9_8
    CONV_ELT_ROTATE_HALF_EN:    [0x0, 0x1],			bits : 10
    ...
    CONV_ACT_LUT_5TABLE_EN :    [0x0, 0x1],			bits : 23
...
REGDEF_BEGIN(CONV_SUB_FUNCTION_FLOW_CONTROL_REGISTER0)
    ...
    REGDEF_BIT(CONV_BIAS_MODE         ,        1)
    REGDEF_BIT(CONV_BN_W_MODE         ,        1)
    REGDEF_BIT(                       ,        3)
    REGDEF_BIT(CONV_ELT_MODE          ,        2)
    REGDEF_BIT(CONV_ELT_ROTATE_HALF_EN,        1)
    REGDEF_BIT(                       ,        1)
    ...
    REGDEF_BIT(CONV_ACT_LUT_5TABLE_EN ,        1)
...
/*
    ...
    CONV_POST_DIRECTSRC_EN      :    [0x0, 0x1],			bits : 7
    CONV_OUT0_DATA_MODE         :    [0x0, 0x3],			bits : 9_8
    CONV_DUAL_OUTPUT_EN         :    [0x0, 0x1],			bits : 10
    CONV_CONV_ACC_LINE_MODE_EN  :    [0x0, 0x1],			bits : 11
    CONV_CONV_ACC_OUT_RESHAPE_EN:    [0x0, 0x1],			bits : 12
    CONV_W_MODE                 :    [0x0, 0x1],			bits : 16
    CONV_W_DMA_MODE             :    [0x0, 0x1],			bits : 17
	CONV_W_OC4_MODE_EN          :    [0x0, 0x1],			bits : 18
...
REGDEF_BEGIN(CONV_SUB_FUNCTION_FLOW_CONTROL_REGISTER1)
    ...
    REGDEF_BIT(CONV_POST_DIRECTSRC_EN      ,        1)
    REGDEF_BIT(CONV_OUT0_DATA_MODE          ,        2)
    REGDEF_BIT(CONV_DUAL_OUTPUT_EN          ,        1)
    REGDEF_BIT(CONV_CONV_ACC_LINE_MODE_EN  ,        1)
    REGDEF_BIT(CONV_CONV_ACC_OUT_RESHAPE_EN,        1)
    REGDEF_BIT(                            ,        3)
    REGDEF_BIT(CONV_W_MODE                  ,        1)
    REGDEF_BIT(CONV_W_DMA_MODE              ,        1)
    REGDEF_BIT(CONV_W_OC4_MODE_EN          ,        1)
    REGDEF_BIT(                            ,        1)
...
/*
    ...
    CONV_OUT1_LOFS_EN         :    [0x0, 0x1],			bits : 20
    CONV_OUT1_CHOFS_EN        :    [0x0, 0x1],			bits : 21
    CONV_OUT1_BOFS_EN         :    [0x0, 0x1],			bits : 22
*/
...
REGDEF_BEGIN(DMA_TO_CONV_OFFSET_ENABLE_REGISTER0)
    ...
    REGDEF_BIT(                          ,        1)
    REGDEF_BIT(CONV_OUT1_LOFS_EN         ,        1)
    REGDEF_BIT(CONV_OUT1_CHOFS_EN        ,        1)
    REGDEF_BIT(CONV_OUT1_BOFS_EN         ,        1)
...
/*
    CONV_OUT1_LOFS:    [0x0, 0x1fffffff],			bits : 28_0
*/
#define DMA_TO_CONV_OFFSET_REGISTER16_OFS 0x0190
REGDEF_BEGIN(DMA_TO_CONV_OFFSET_REGISTER16)
    REGDEF_BIT(CONV_OUT1_LOFS,        29)
REGDEF_END(DMA_TO_CONV_OFFSET_REGISTER16)


/*
    CONV_OUT1_CHOFS:    [0x0, 0x1fffffff],			bits : 28_0
*/
#define DMA_TO_CONV_OFFSET_REGISTER17_OFS 0x0194
REGDEF_BEGIN(DMA_TO_CONV_OFFSET_REGISTER17)
    REGDEF_BIT(CONV_OUT1_CHOFS,        29)
REGDEF_END(DMA_TO_CONV_OFFSET_REGISTER17)


/*
    CONV_OUT1_BOFS:    [0x0, 0x1fffffff],			bits : 28_0
*/
#define DMA_TO_CONV_OFFSET_REGISTER18_OFS 0x0198
REGDEF_BEGIN(DMA_TO_CONV_OFFSET_REGISTER18)
    REGDEF_BIT(CONV_OUT1_BOFS,        29)
REGDEF_END(DMA_TO_CONV_OFFSET_REGISTER18)
...
/*
    ...
    CONV_CONV_MAC_CORE             :    [0x0, 0x1],			bits : 5
    CONV_CONV_MAC_UNIVERSAL_MODE_EN:    [0x0, 0x1],			bits : 6
...
REGDEF_BEGIN(CONV_CONVOLUTION_REGISTER5)
    ...
    REGDEF_BIT(CONV_CONV_MAC_CORE             ,        1)
    REGDEF_BIT(CONV_CONV_MAC_UNIVERSAL_MODE_EN,        1)
    REGDEF_BIT(                               ,        1)
...
/*
    CONV_ELT2_SUB_EN       :    [0x0, 0x1],			bits : 0
    CONV_ELT2_SQUARE_EN    :    [0x0, 0x1],			bits : 1
    CONV_ELT2_OUT_SHIFT_DIR:    [0x0, 0x1],			bits : 4
    CONV_ELT2_ONE_SHIFT    :    [0x0, 0x1f],			bits : 12_8
    CONV_ELT2_SQUARE_SHIFT :    [0x0, 0xf],			bits : 19_16
    CONV_ELT2_OUT_SHIFT    :    [0x0, 0x3f],			bits : 25_20
*/
#define CONV_ELTWISE2_REGISTER0_OFS 0x0258
REGDEF_BEGIN(CONV_ELTWISE2_REGISTER0)
    REGDEF_BIT(CONV_ELT2_SUB_EN       ,        1)
    REGDEF_BIT(CONV_ELT2_SQUARE_EN    ,        1)
    REGDEF_BIT(                       ,        2)
    REGDEF_BIT(CONV_ELT2_OUT_SHIFT_DIR,        1)
    REGDEF_BIT(                       ,        3)
    REGDEF_BIT(CONV_ELT2_ONE_SHIFT    ,        5)
    REGDEF_BIT(                       ,        3)
    REGDEF_BIT(CONV_ELT2_SQUARE_SHIFT ,        4)
    REGDEF_BIT(CONV_ELT2_OUT_SHIFT    ,        6)
REGDEF_END(CONV_ELTWISE2_REGISTER0)
...
/*
    ...
    CONV_ACT_LUT3_OUT_SHIFT_DIR:    [0x0, 0x1],			bits : 27
    CONV_ACT_LUT4_OUT_SHIFT_DIR:    [0x0, 0x1],			bits : 28
*/
...
REGDEF_BEGIN(CONV_ACT_REGISTER19)
    ...
    REGDEF_BIT(CONV_ACT_LUT3_OUT_SHIFT_DIR,        1)
    REGDEF_BIT(CONV_ACT_LUT4_OUT_SHIFT_DIR,        1)
...
/*
    ...
    CONV_ACT_LUT3_GAP_BIT_NUM:    [0x0, 0x1f],			bits : 28_24
*/
...
REGDEF_BEGIN(CONV_ACT_REGISTER20)
    ...
    REGDEF_BIT(                         ,        3)
    REGDEF_BIT(CONV_ACT_LUT3_GAP_BIT_NUM,        5)
REGDEF_END(CONV_ACT_REGISTER20)


/*
    CONV_ACT_LUT4_START_ENTRY_IDX:    [0x0, 0x7f],			bits : 6_0
*/
#define CONV_ACT_REGISTER21_OFS 0x02b4
REGDEF_BEGIN(CONV_ACT_REGISTER21)
    REGDEF_BIT(CONV_ACT_LUT4_START_ENTRY_IDX,        7)
REGDEF_END(CONV_ACT_REGISTER21)


/*
    CONV_ACT_LUT_BOUNDARY4:    [0x0, 0xffffffff],			bits : 31_0
*/
#define CONV_ACT_REGISTER22_OFS 0x02b8
REGDEF_BEGIN(CONV_ACT_REGISTER22)
    REGDEF_BIT(CONV_ACT_LUT_BOUNDARY4,        32)
REGDEF_END(CONV_ACT_REGISTER22)


/*
    CONV_ACT_LUT_BOUNDARY5:    [0x0, 0xffffffff],			bits : 31_0
*/
#define CONV_ACT_REGISTER23_OFS 0x02bc
REGDEF_BEGIN(CONV_ACT_REGISTER23)
    REGDEF_BIT(CONV_ACT_LUT_BOUNDARY5,        32)
REGDEF_END(CONV_ACT_REGISTER23)


/*
    CONV_ACT_LUT3_OUT_SHIFT  :    [0x0, 0x1f],			bits : 4_0
    CONV_ACT_LUT4_OUT_SHIFT  :    [0x0, 0x1f],			bits : 12_8
    CONV_ACT_LUT4_GAP_BIT_NUM:    [0x0, 0x1f],			bits : 20_16
*/
#define CONV_ACT_REGISTER24_OFS 0x02c0
REGDEF_BEGIN(CONV_ACT_REGISTER24)
    REGDEF_BIT(CONV_ACT_LUT3_OUT_SHIFT  ,        5)
    REGDEF_BIT(                         ,        3)
    REGDEF_BIT(CONV_ACT_LUT4_OUT_SHIFT  ,        5)
    REGDEF_BIT(                         ,        3)
    REGDEF_BIT(CONV_ACT_LUT4_GAP_BIT_NUM,        5)
REGDEF_END(CONV_ACT_REGISTER24)
...
/*
    CONV_WCD_VLC_OFFSET:    [0x0, 0xffff],			bits : 15_0
*/
#define CONV_WCD_REGISTER13_OFS 0x0370
REGDEF_BEGIN(CONV_WCD_REGISTER13)
    REGDEF_BIT(CONV_WCD_VLC_OFFSET,        16)
REGDEF_END(CONV_WCD_REGISTER13)
...
/*
    CONV_LL1_CYCLE:    [0x0, 0xffffffff],			bits : 31_0
*/
#define CYCLE_COUNT_REGISTER0_OFS 0x038c
REGDEF_BEGIN(CYCLE_COUNT_REGISTER0)
    REGDEF_BIT(CONV_LL1_CYCLE,        32)
...
*/
#define CYCLE_COUNT_REGISTER1_OFS 0x0390
...
/*
    CONV_LL0_CYCLE:    [0x0, 0xffffffff],			bits : 31_0
*/
#define CYCLE_COUNT_REGISTER2_OFS 0x0394
REGDEF_BEGIN(CYCLE_COUNT_REGISTER2)
    REGDEF_BIT(CONV_LL0_CYCLE,        32)
...
*/
#define CYCLE_COUNT_REGISTER3_OFS 0x0398
...
*/
#define CYCLE_COUNT_REGISTER4_OFS 0x039c
...
*/
#define CYCLE_COUNT_REGISTER5_OFS 0x03a0
REGDEF_BEGIN(CYCLE_COUNT_REGISTER5)
    REGDEF_BIT(CONV_WAIT_DRAM_CYCLE,        32)
REGDEF_END(CYCLE_COUNT_REGISTER5)
...
/*
    ...
    CONV_OUT_LAST_BUFFERABLE:    [0x0, 0x1],			bits : 4
...
REGDEF_BEGIN(DMA_DISABLE_REGISTER0)
    ...
    REGDEF_BIT(                        ,        3)
    REGDEF_BIT(CONV_OUT_LAST_BUFFERABLE,        1)
    REGDEF_BIT(                        ,        10)
...
/*
    ...
    DMACH18_BURST_LENGTH:    [0x0, 0x3],			bits : 9_8
*/
...
REGDEF_BEGIN(DESIGN_DEBUG_REGISTER3)
    ...
    REGDEF_BIT(                    ,        2)
    REGDEF_BIT(DMACH18_BURST_LENGTH,        2)
...
/*
    ...
    DMACH2_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 23_16
    DMACH3_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 31_24
*/
...
REGDEF_BEGIN(DESIGN_DEBUG_REGISTER4)
    ...
    REGDEF_BIT(DMACH2_MAX_OUTSTANDING_NUM,        8)
    REGDEF_BIT(DMACH3_MAX_OUTSTANDING_NUM,        8)
REGDEF_END(DESIGN_DEBUG_REGISTER4)


/*
    DMACH4_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 7_0
    DMACH5_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 15_8
    DMACH6_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 23_16
    DMACH7_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 31_24
*/
#define DESIGN_DEBUG_REGISTER5_OFS 0x03cc
REGDEF_BEGIN(DESIGN_DEBUG_REGISTER5)
    REGDEF_BIT(DMACH4_MAX_OUTSTANDING_NUM,        8)
    REGDEF_BIT(DMACH5_MAX_OUTSTANDING_NUM,        8)
    REGDEF_BIT(DMACH6_MAX_OUTSTANDING_NUM,        8)
    REGDEF_BIT(DMACH7_MAX_OUTSTANDING_NUM,        8)
REGDEF_END(DESIGN_DEBUG_REGISTER5)


/*
    DMACH8_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 7_0
    DMACH9_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 15_8
*/
#define DESIGN_DEBUG_REGISTER6_OFS 0x03d0
REGDEF_BEGIN(DESIGN_DEBUG_REGISTER6)
    REGDEF_BIT(DMACH8_MAX_OUTSTANDING_NUM,        8)
    REGDEF_BIT(DMACH9_MAX_OUTSTANDING_NUM,        8)
REGDEF_END(DESIGN_DEBUG_REGISTER6)


/*
    Reserved                   :    [0x0, 0xff],			bits : 7_0
    DMACH13_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 15_8
    DMACH14_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 23_16
    DMACH15_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 31_24
*/
#define DESIGN_DEBUG_REGISTER7_OFS 0x03d4
REGDEF_BEGIN(DESIGN_DEBUG_REGISTER7)
    REGDEF_BIT(Reserved                   ,        8)
    REGDEF_BIT(DMACH13_MAX_OUTSTANDING_NUM,        8)
    REGDEF_BIT(DMACH14_MAX_OUTSTANDING_NUM,        8)
    REGDEF_BIT(DMACH15_MAX_OUTSTANDING_NUM,        8)
REGDEF_END(DESIGN_DEBUG_REGISTER7)


/*
    DMACH16_MAX_OUTSTANDING_NUM:    [0x0, 0xff],			bits : 7_0
*/
#define DESIGN_DEBUG_REGISTER8_OFS 0x03d8
REGDEF_BEGIN(DESIGN_DEBUG_REGISTER8)
    REGDEF_BIT(DMACH16_MAX_OUTSTANDING_NUM,        8)
REGDEF_END(DESIGN_DEBUG_REGISTER8)
...
/*
    ...
    DMACH18_LOCK_DISABLE:    [0x0, 0x1],			bits : 8
...
REGDEF_BEGIN(AXI_REGISTER5)
    ...
    REGDEF_BIT(                    ,        3)
    REGDEF_BIT(DMACH18_LOCK_DISABLE,        1)
    REGDEF_BIT(                    ,        15)
...
/*
    AXI0_STATUS:    [0x0, 0xffffffff],			bits : 31_0
*/
#define AXI_REGISTER8_OFS 0x0408
REGDEF_BEGIN(AXI_REGISTER8)
    REGDEF_BIT(AXI0_STATUS,        32)
REGDEF_END(AXI_REGISTER8)


/*
    AXI1_STATUS:    [0x0, 0xffffffff],			bits : 31_0
*/
#define AXI_REGISTER9_OFS 0x040c
REGDEF_BEGIN(AXI_REGISTER9)
    REGDEF_BIT(AXI1_STATUS,        32)
REGDEF_END(AXI_REGISTER9)


/*
    DMA0_AXI_MODE:    [0x0, 0x1],			bits : 0
    DMA1_AXI_MODE:    [0x0, 0x1],			bits : 4
    DMA6_AXI_MODE:    [0x0, 0x1],			bits : 24
    DMA7_AXI_MODE:    [0x0, 0x1],			bits : 28
*/
#define AXI_REGISTER10_OFS 0x0410
REGDEF_BEGIN(AXI_REGISTER10)
    REGDEF_BIT(DMA0_AXI_MODE,        1)
    REGDEF_BIT(             ,        3)
    REGDEF_BIT(DMA1_AXI_MODE,        1)
    REGDEF_BIT(             ,        19)
    REGDEF_BIT(DMA6_AXI_MODE,        1)
    REGDEF_BIT(             ,        3)
    REGDEF_BIT(DMA7_AXI_MODE,        1)
REGDEF_END(AXI_REGISTER10)


/*
    DMA8_AXI_MODE:    [0x0, 0x1],			bits : 0
    DMA9_AXI_MODE:    [0x0, 0x1],			bits : 4
*/
#define AXI_REGISTER11_OFS 0x0414
REGDEF_BEGIN(AXI_REGISTER11)
    REGDEF_BIT(DMA8_AXI_MODE,        1)
    REGDEF_BIT(             ,        3)
    REGDEF_BIT(DMA9_AXI_MODE,        1)
REGDEF_END(AXI_REGISTER11)
...
/*
    LL0C_ERR_CMD_ADR0:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LLC_DEBUG_RESISTER0_OFS 0x042c
REGDEF_BEGIN(LLC_DEBUG_RESISTER0)
    REGDEF_BIT(LL0C_ERR_CMD_ADR0,        32)
REGDEF_END(LLC_DEBUG_RESISTER0)


/*
    LL0C_ERR_CMD_ADR1:    [0x0, 0xf],			bits : 3_0
*/
#define LLC_DEBUG_RESISTER1_OFS 0x0430
REGDEF_BEGIN(LLC_DEBUG_RESISTER1)
    REGDEF_BIT(LL0C_ERR_CMD_ADR1,        4)
REGDEF_END(LLC_DEBUG_RESISTER1)


/*
    LL1C_ERR_CMD_ADR0:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LLC_DEBUG_RESISTER2_OFS 0x0434
REGDEF_BEGIN(LLC_DEBUG_RESISTER2)
    REGDEF_BIT(LL1C_ERR_CMD_ADR0,        32)
REGDEF_END(LLC_DEBUG_RESISTER2)


/*
    LL1C_ERR_CMD_ADR1:    [0x0, 0xf],			bits : 3_0
*/
#define LLC_DEBUG_RESISTER3_OFS 0x0438
REGDEF_BEGIN(LLC_DEBUG_RESISTER3)
    REGDEF_BIT(LL1C_ERR_CMD_ADR1,        4)
REGDEF_END(LLC_DEBUG_RESISTER3)
...
/*
    CONV_ACCSHF_OUT_CHKSUM:    [0x0, 0xffffffff],			bits : 31_0
*/
#define CHECKSUM_REGISTER1_OFS 0x0458
REGDEF_BEGIN(CHECKSUM_REGISTER1)
    REGDEF_BIT(CONV_ACCSHF_OUT_CHKSUM,        32)
...
/*
    CONV_AUTO_UNLOCK_CYCLE:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LOCK_STATUS_REGISTER_OFS 0x04ac
REGDEF_BEGIN(LOCK_STATUS_REGISTER)
    REGDEF_BIT(CONV_AUTO_UNLOCK_CYCLE,        32)
REGDEF_END(LOCK_STATUS_REGISTER)


/*
    JOB1_BASE_ADDR0:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LL_BASE_ADDRESS_REGISTER10_OFS 0x04b0
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER10)
    REGDEF_BIT(JOB1_BASE_ADDR0,        32)
REGDEF_END(LL_BASE_ADDRESS_REGISTER10)


/*
    JOB1_BASE_MSB_ADDR0:    [0x0, 0xf],			bits : 3_0
*/
#define LL_BASE_ADDRESS_REGISTER11_OFS 0x04b4
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER11)
    REGDEF_BIT(JOB1_BASE_MSB_ADDR0,        4)
REGDEF_END(LL_BASE_ADDRESS_REGISTER11)


/*
    JOB1_BASE_ADDR1:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LL_BASE_ADDRESS_REGISTER12_OFS 0x04b8
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER12)
    REGDEF_BIT(JOB1_BASE_ADDR1,        32)
REGDEF_END(LL_BASE_ADDRESS_REGISTER12)


/*
    JOB1_BASE_MSB_ADDR1:    [0x0, 0xf],			bits : 3_0
*/
#define LL_BASE_ADDRESS_REGISTER13_OFS 0x04bc
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER13)
    REGDEF_BIT(JOB1_BASE_MSB_ADDR1,        4)
REGDEF_END(LL_BASE_ADDRESS_REGISTER13)


/*
    JOB1_BASE_ADDR2:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LL_BASE_ADDRESS_REGISTER14_OFS 0x04c0
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER14)
    REGDEF_BIT(JOB1_BASE_ADDR2,        32)
REGDEF_END(LL_BASE_ADDRESS_REGISTER14)


/*
    JOB1_BASE_MSB_ADDR2:    [0x0, 0xf],			bits : 3_0
*/
#define LL_BASE_ADDRESS_REGISTER15_OFS 0x04c4
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER15)
    REGDEF_BIT(JOB1_BASE_MSB_ADDR2,        4)
REGDEF_END(LL_BASE_ADDRESS_REGISTER15)


/*
    JOB1_BASE_ADDR3:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LL_BASE_ADDRESS_REGISTER16_OFS 0x04c8
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER16)
    REGDEF_BIT(JOB1_BASE_ADDR3,        32)
REGDEF_END(LL_BASE_ADDRESS_REGISTER16)


/*
    JOB1_BASE_MSB_ADDR3:    [0x0, 0xf],			bits : 3_0
*/
#define LL_BASE_ADDRESS_REGISTER17_OFS 0x04cc
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER17)
    REGDEF_BIT(JOB1_BASE_MSB_ADDR3,        4)
REGDEF_END(LL_BASE_ADDRESS_REGISTER17)


/*
    DRAMUB_SAIJOB1:    [0x0, 0xffffffff],			bits : 31_0
*/
#define DMA_TO_CONV_JOB_CHANNEL_REGISTER2_OFS 0x04d0
REGDEF_BEGIN(DMA_TO_CONV_JOB_CHANNEL_REGISTER2)
    REGDEF_BIT(DRAMUB_SAIJOB1,        32)
REGDEF_END(DMA_TO_CONV_JOB_CHANNEL_REGISTER2)


/*
    DRAMUB_MSB_SAIJOB1:    [0x0, 0xf],			bits : 3_0
*/
#define DMA_TO_CONV_JOB_CHANNEL_REGISTER3_OFS 0x04d4
REGDEF_BEGIN(DMA_TO_CONV_JOB_CHANNEL_REGISTER3)
    REGDEF_BIT(DRAMUB_MSB_SAIJOB1,        4)
REGDEF_END(DMA_TO_CONV_JOB_CHANNEL_REGISTER3)


/*
    JOB1_BASE_ADDR4:    [0x0, 0xffffffff],			bits : 31_0
*/
#define LL_BASE_ADDRESS_REGISTER18_OFS 0x04d8
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER18)
    REGDEF_BIT(JOB1_BASE_ADDR4,        32)
REGDEF_END(LL_BASE_ADDRESS_REGISTER18)


/*
    JOB1_BASE_MSB_ADDR4:    [0x0, 0xf],			bits : 3_0
*/
#define LL_BASE_ADDRESS_REGISTER19_OFS 0x04dc
REGDEF_BEGIN(LL_BASE_ADDRESS_REGISTER19)
    REGDEF_BIT(JOB1_BASE_MSB_ADDR4,        4)
REGDEF_END(LL_BASE_ADDRESS_REGISTER19)
...
*/
#define JOB_PRIORITY_REGISTER0_OFS 0x04e8
REGDEF_BEGIN(JOB_PRIORITY_REGISTER0)
    REGDEF_BIT(JOB_PRIORITY_MODE,        1)
    REGDEF_BIT(                 ,        3)
    REGDEF_BIT(CUR_JOB_EXE      ,        1)
    REGDEF_BIT(                 ,        3)
    REGDEF_BIT(JOB_LOCK_STATUS  ,        2)
REGDEF_END(JOB_PRIORITY_REGISTER0)


/*
    QOS_TOTAL_TIME:    [0x0, 0xffffffff],			bits : 31_0
*/
#define QOS_REGISTER0_OFS 0x04ec
REGDEF_BEGIN(QOS_REGISTER0)
    REGDEF_BIT(QOS_TOTAL_TIME,        32)
REGDEF_END(QOS_REGISTER0)


/*
    QOS_LOW_OCCUPY_TIME:    [0x0, 0xffffffff],			bits : 31_0
*/
#define QOS_REGISTER1_OFS 0x04f0
REGDEF_BEGIN(QOS_REGISTER1)
    REGDEF_BIT(QOS_LOW_OCCUPY_TIME,        32)
REGDEF_END(QOS_REGISTER1)


/*
    STATISTIC_JOB0_ACC_ENG_CYCLE:    [0x0, 0xffffffff],			bits : 31_0
*/
#define STATISTIC_QOS_REGISTER0_OFS 0x04f4
REGDEF_BEGIN(STATISTIC_QOS_REGISTER0)
    REGDEF_BIT(STATISTIC_JOB0_ACC_ENG_CYCLE,        32)
REGDEF_END(STATISTIC_QOS_REGISTER0)


/*
    STATISTIC_JOB1_ACC_ENG_CYCLE:    [0x0, 0xffffffff],			bits : 31_0
*/
#define STATISTIC_QOS_REGISTER1_OFS 0x04f8
REGDEF_BEGIN(STATISTIC_QOS_REGISTER1)
    REGDEF_BIT(STATISTIC_JOB1_ACC_ENG_CYCLE,        32)
REGDEF_END(STATISTIC_QOS_REGISTER1)


/*
    STATISTIC_QOS_PERIOD_TIMES:    [0x0, 0xffff],			bits : 15_0
*/
#define STATISTIC_QOS_REGISTER2_OFS 0x04fc
REGDEF_BEGIN(STATISTIC_QOS_REGISTER2)
    REGDEF_BIT(STATISTIC_QOS_PERIOD_TIMES,        16)
REGDEF_END(STATISTIC_QOS_REGISTER2)
...
/*
    ...
    CONV_PRE_IN0_CONV_MAC_UNIVERSAL_MODE_EN:    [0x0, 0x1],			bits : 6
*/
...
REGDEF_BEGIN(PRE_IN0_CONV_CONVOLUTION_REGISTER4)
    ...
    REGDEF_BIT(                                       ,        3)
    REGDEF_BIT(CONV_PRE_IN0_CONV_MAC_UNIVERSAL_MODE_EN,        1)
...
typedef struct
{
  ...
  union
  {
    struct
    {
      ...
      unsigned CONV_ELT2_EN              : 1;		// bits : 16
      unsigned                           : 8;
  ...
  union
  {
    struct
    {
      ...
      unsigned CONV_BIAS_MODE                 : 1;		// bits : 3
      unsigned CONV_BN_W_MODE                 : 1;		// bits : 4
      unsigned                                : 3;
      unsigned CONV_ELT_MODE                  : 2;		// bits : 9_8
      unsigned CONV_ELT_ROTATE_HALF_EN        : 1;		// bits : 10
      unsigned                                : 1;
      ...
      unsigned CONV_ACT_LUT_5TABLE_EN         : 1;		// bits : 23
  ...
  union
  {
    struct
    {
      ...
      unsigned CONV_POST_DIRECTSRC_EN              : 1;		// bits : 7
      unsigned CONV_OUT0_DATA_MODE                 : 2;		// bits : 9_8
      unsigned CONV_DUAL_OUTPUT_EN                 : 1;		// bits : 10
      unsigned CONV_CONV_ACC_LINE_MODE_EN          : 1;		// bits : 11
      unsigned CONV_CONV_ACC_OUT_RESHAPE_EN        : 1;		// bits : 12
      unsigned                                     : 3;
      unsigned CONV_W_MODE                         : 1;		// bits : 16
      unsigned CONV_W_DMA_MODE                     : 1;		// bits : 17
      unsigned CONV_W_OC4_MODE_EN                  : 1;		// bits : 18
      unsigned                                     : 1;
  ...
  union
  {
    struct
    {
      unsigned DRAMUB_SAIJOB0        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned DRAMUB_MSB_SAIJOB0        : 4;		// bits : 3_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                                   : 1;
      unsigned CONV_OUT1_LOFS_EN                 : 1;		// bits : 20
      unsigned CONV_OUT1_CHOFS_EN                : 1;		// bits : 21
      unsigned CONV_OUT1_BOFS_EN                 : 1;		// bits : 22
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_OUT1_LOFS        : 29;		// bits : 28_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_OUT1_CHOFS        : 29;		// bits : 28_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_OUT1_BOFS        : 29;		// bits : 28_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                         : 4;
      unsigned CONV_IN0_BATCH          : 12;		// bits : 31_20
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned CONV_CONV_MAC_CORE                     : 1;		// bits : 5
      unsigned CONV_CONV_MAC_UNIVERSAL_MODE_EN        : 1;		// bits : 6
      unsigned                                        : 1;
  ...
  union
  {
    struct
    {
      ...
      unsigned                              : 15;
      unsigned CONV_CONV_W_VAL              : 16;		// bits : 31_16
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_ELT2_SUB_EN               : 1;		// bits : 0
      unsigned CONV_ELT2_SQUARE_EN            : 1;		// bits : 1
      unsigned                                : 2;
      unsigned CONV_ELT2_OUT_SHIFT_DIR        : 1;		// bits : 4
      unsigned                                : 3;
      unsigned CONV_ELT2_ONE_SHIFT            : 5;		// bits : 12_8
      unsigned                                : 3;
      unsigned CONV_ELT2_SQUARE_SHIFT         : 4;		// bits : 19_16
      unsigned CONV_ELT2_OUT_SHIFT            : 6;		// bits : 25_20
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_ACT_TOTAL_ENTRY_NUM             : 8;		// bits : 7_0
      unsigned                                      : 8;
  ...
  union
  {
    struct
    {
      ...
      unsigned                                      : 9;
      unsigned CONV_ACT_LUT3_START_ENTRY_IDX        : 7;		// bits : 22_16
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned CONV_ACT_LUT3_OUT_SHIFT_DIR        : 1;		// bits : 27
      unsigned CONV_ACT_LUT4_OUT_SHIFT_DIR        : 1;		// bits : 28
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                                  : 3;
      unsigned CONV_ACT_LUT3_GAP_BIT_NUM        : 5;		// bits : 28_24
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_ACT_LUT4_START_ENTRY_IDX        : 7;		// bits : 6_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_ACT_LUT_BOUNDARY4        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_ACT_LUT_BOUNDARY5        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_ACT_LUT3_OUT_SHIFT          : 5;		// bits : 4_0
      unsigned                                  : 3;
      unsigned CONV_ACT_LUT4_OUT_SHIFT          : 5;		// bits : 12_8
      unsigned                                  : 3;
      unsigned CONV_ACT_LUT4_GAP_BIT_NUM        : 5;		// bits : 20_16
    } Bit;
    UINT32 Word;
  ...
  union
  {
    ...
    {
      unsigned                                  : 8;
      unsigned CONV_DW_ACC_OUT_SHIFT            : 6;		// bits : 13_8
      unsigned                                  : 14;
  ...
  union
  {
    struct
    {
      unsigned CONV_WCD_VLC_OFFSET        : 16;		// bits : 15_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_LL1_CYCLE        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_LL0_CYCLE        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                                 : 3;
      unsigned CONV_OUT_LAST_BUFFERABLE        : 1;		// bits : 4
      unsigned                                 : 10;
  ...
  union
  {
    struct
    {
      ...
      unsigned                             : 2;
      unsigned DMACH18_BURST_LENGTH        : 2;		// bits : 9_8
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned DMACH2_MAX_OUTSTANDING_NUM        : 8;		// bits : 23_16
      unsigned DMACH3_MAX_OUTSTANDING_NUM        : 8;		// bits : 31_24
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned DMACH4_MAX_OUTSTANDING_NUM        : 8;		// bits : 7_0
      unsigned DMACH5_MAX_OUTSTANDING_NUM        : 8;		// bits : 15_8
      unsigned DMACH6_MAX_OUTSTANDING_NUM        : 8;		// bits : 23_16
      unsigned DMACH7_MAX_OUTSTANDING_NUM        : 8;		// bits : 31_24
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned DMACH8_MAX_OUTSTANDING_NUM        : 8;		// bits : 7_0
      unsigned DMACH9_MAX_OUTSTANDING_NUM        : 8;		// bits : 15_8
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned Reserved                           : 8;		// bits : 7_0
      unsigned DMACH13_MAX_OUTSTANDING_NUM        : 8;		// bits : 15_8
      unsigned DMACH14_MAX_OUTSTANDING_NUM        : 8;		// bits : 23_16
      unsigned DMACH15_MAX_OUTSTANDING_NUM        : 8;		// bits : 31_24
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned DMACH16_MAX_OUTSTANDING_NUM        : 8;		// bits : 7_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                             : 3;
      unsigned DMACH18_LOCK_DISABLE        : 1;		// bits : 8
      unsigned                             : 15;
  ...
  union
  {
    struct
    {
      unsigned AXI0_STATUS        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned AXI1_STATUS        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned DMA0_AXI_MODE        : 1;		// bits : 0
      unsigned                      : 3;
      unsigned DMA1_AXI_MODE        : 1;		// bits : 4
      unsigned                      : 19;
      unsigned DMA6_AXI_MODE        : 1;		// bits : 24
      unsigned                      : 3;
      unsigned DMA7_AXI_MODE        : 1;		// bits : 28
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned DMA8_AXI_MODE        : 1;		// bits : 0
      unsigned                      : 3;
      unsigned DMA9_AXI_MODE        : 1;		// bits : 4
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LL0C_ERR_CMD_ADR0        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LL0C_ERR_CMD_ADR1        : 4;		// bits : 3_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LL1C_ERR_CMD_ADR0        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned LL1C_ERR_CMD_ADR1        : 4;		// bits : 3_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_ACCSHF_OUT_CHKSUM        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                             : 3;
      unsigned CONV_DUMMY_LINE_FLAG        : 1;		// bits : 4
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                          : 4;
      unsigned CONV_OUT0_BATCH          : 12;		// bits : 31_20
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned CONV_AUTO_UNLOCK_CYCLE        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned DRAMUB_MSB_SAIJOB1        : 4;		// bits : 3_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned STATISTIC_JOB1_ACC_ENG_CYCLE        : 32;		// bits : 31_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      unsigned STATISTIC_QOS_PERIOD_TIMES        : 16;		// bits : 15_0
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                             : 4;
      unsigned CONV_PRE_IN0_BATCH          : 12;		// bits : 31_20
    } Bit;
    UINT32 Word;
  ...
  union
  {
    struct
    {
      ...
      unsigned                                                : 3;
      unsigned CONV_PRE_IN0_CONV_MAC_UNIVERSAL_MODE_EN        : 1;		// bits : 6
    } Bit;
    UINT32 Word;
  } CONV_Register_457; // 0x0724

} NT98538_CONV_REGISTER_STRUCT;
