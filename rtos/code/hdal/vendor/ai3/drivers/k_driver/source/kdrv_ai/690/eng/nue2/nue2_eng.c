...
{
    p_eng->p_nue2_reg_st = (NT98690_NUE2_REGISTER_STRUCT *)reg_base_addr;
...
void nue2_eng_trig_ll_hw_reg(NUE2_ENG_HANDLE *p_eng, uintptr_t ll_addr_msb, uintptr_t ll_addr_lsb)
{
...
void nue2_eng_wait_framend_ll(NUE2_ENG_HANDLE *p_eng)
{
    FLGPTN uiflag;
    ER er_return = E_OK;
...
UINT32 nue2_eng_get_ll_cycle(NUE2_ENG_HANDLE *p_eng)
{
