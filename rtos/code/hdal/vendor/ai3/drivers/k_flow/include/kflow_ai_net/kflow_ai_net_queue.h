...
extern ER nvt_ai_proc_queue_put(PAI_PROC_QUEUE p_queue, uintptr_t data);
extern ER nvt_ai_proc_queue_cancel(PAI_PROC_QUEUE p_queue);
extern ER nvt_ai_proc_queue_get(PAI_PROC_QUEUE p_queue, uintptr_t* p_data, INT32 wait_ms);
