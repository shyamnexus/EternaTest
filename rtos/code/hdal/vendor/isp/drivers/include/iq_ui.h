...
typedef enum _IQ_UI_ITEM {
	...
	IQ_UI_ITEM_TONE_LV,                 ///<Tone level, data type #IQ_UI_TONE_LV
...
typedef enum _IQ_UI_IMAGEEFFECT {
	...
	IQ_UI_IMAGEEFFECT_RESERVED,
	IQ_UI_IMAGEEFFECT_NEGATIVE_DEFOG,
	IQ_UI_IMAGEEFFECT_CCID,
	IQ_UI_IMAGEEFFECT_THERMAL_RED,
	IQ_UI_IMAGEEFFECT_THERMAL_COLOR,
...
typedef enum _IQ_UI_HUE_SHIFT {
	IQ_UI_HUE_SHIFT_MIN_CNT     = -181,
	IQ_UI_HUE_SHIFT_CLOCK_60    = -180,   ///< HUE clockwise 60 degrees
	IQ_UI_HUE_SHIFT_CLOCK_40    = -120,   ///< HUE clockwise 40 degrees
	IQ_UI_HUE_SHIFT_CLOCK_20    =  -60,   ///< HUE clockwise 20 degrees
	IQ_UI_HUE_SHIFT_0           =    0,   ///< HUE Normal
	IQ_UI_HUE_SHIFT_COUNTER_20  =   60,   ///< HUE counterclockwise 20 degrees
	IQ_UI_HUE_SHIFT_COUNTER_40  =  120,   ///< HUE counterclockwise 40 degrees
	IQ_UI_HUE_SHIFT_COUNTER_60  =  179,   ///< HUE counterclockwise 60 degrees
	IQ_UI_HUE_SHIFT_MAX_CNT     =  180,
...
/**
	SHDR Tone
*/
typedef enum _IQ_UI_TONE_LV {
	IQ_UI_TONE_LV_MIN_CNT  = -1,
	IQ_UI_TONE_LV_N1       = 25,     ///< SHDR TONE 25
	IQ_UI_TONE_LV_NORMAL   = 50,     ///< SHDR TONE 50
	IQ_UI_TONE_LV_P1       = 75,     ///< SHDR TONE 75
	IQ_UI_TONE_LV_MAX_CNT  = 101,
	ENUM_DUMMY4WORD(IQ_UI_TONE_LV)
} IQ_UI_TONE_LV;
