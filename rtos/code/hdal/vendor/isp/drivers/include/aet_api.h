...
typedef enum _AET_ITEM {
	...
	AET_ITEM_OPERATION                                 = 20,///< data_type: [Set/Get] AET_OPERATION
	AET_ITEM_DCIRIS,                                        ///< data_type: [Set/Get] AET_DCIRIS
	AET_ITEM_SHDR_HBS,                                      ///< data_type: [Set/Get] AET_SHDR_HBS
	AET_ITEM_SHDR_METER,                                    ///< data_type: [Set/Get] AET_SHDR_METER
	...
	AET_ITEM_RESERVE_50                                = 50,
	AET_ITEM_RESERVE_51,
	AET_ITEM_RESERVE_52,
	AET_ITEM_RESERVE_53,
	AET_ITEM_RESERVE_54,
	AET_ITEM_RESERVE_55                                = 55,
	AET_ITEM_RESERVE_56,
	AET_ITEM_RESERVE_57,
	AET_ITEM_RESERVE_58,
	AET_ITEM_RESERVE_59,
...
typedef struct _AET_SHDR_METER {
	AE_ID id;
