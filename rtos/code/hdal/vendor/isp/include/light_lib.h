...
typedef int (*LIGHT_INFO_CB_FP)(LIGHT_INFO*);

typedef struct _LIGHT_INIT_ITEM {
	INT night_ev;
	INT day_ev;
	INT sensitive;
	INT open_device;

	LIGHT_INFO_CB_FP light_info_cb_fp;
...
extern INT sw_cds_init(UINT32 id, LIGHT_INIT_ITEM item);
