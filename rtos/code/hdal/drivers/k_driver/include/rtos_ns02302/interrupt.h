...
typedef enum {
	...
	INT_ID_UVCP,                            //74
	INT_ID_ECDSA,	                        //75
	INT_ID_ETHERNET_TX0,                    //76
	INT_ID_ETHERNET_RX0,                    //77
	INT_ID_GRAPHIC3,                        //78
	INT_ID_HRTIMER2,                        //79
	INT_ID_HRTIMER3,                        //80
	INT_ID_HRTIMER4,                        //81
	...
	/*below compatible use*/
	INT_ID_LVDS5 = INT_ID_GIC_TOTAL+1,                    
	INT_ID_GPENC,                          
	INT_ID_GPENC2,                         
	INT_ID_IDE2,
	INT_ID_VTR,                           
	...
	INT_ID_ETHERNET_TX2,                
	INT_ID_ETHERNET_TX3,                 
	INT_ID_ETHERNET2_RX1,          
	INT_ID_ETHERNET2_RX2,        
	INT_ID_ETHERNET2_RX3,         
	INT_ID_ETHERNET2_TX0,           
	INT_ID_ETHERNET2_TX1,        
	INT_ID_ETHERNET2_TX2,         
	INT_ID_ETHERNET2_TX3,      
	INT_ID_ETHERNET2_RX0,             
	INT_ID_UVCP2,
	INT_ID_USB,
	INT_ID_DSP,
	INT_ID_DIS,
...
extern int  kick_bh(unsigned int irq, unsigned long event, ULONG *data);
