...
//@{
typedef struct {
	uintptr_t   b0_y;          ///<Buffer0 Y starting address
	uintptr_t   b0_cb;         ///<Buffer0 Cb/CbCrPack starting address
	uintptr_t   b0_cr;         ///<Buffer0 Cr starting address (not used in CbCr packed format)
	uintptr_t   b1_y;          ///<Buffer1 Y starting address
	uintptr_t   b1_cb;         ///<Buffer1 Cb/CbCrPack starting address
	uintptr_t   b1_cr;         ///<Buffer1 Cr starting address (not used in CbCr packed format)
	uintptr_t   b2_y;          ///<Buffer2 Y starting address
	uintptr_t   b2_cb;         ///<Buffer2 Cb/CbCrPack starting address
	uintptr_t   b2_cr;         ///<Buffer2 Cr starting address (not used in CbCr packed format)
	uintptr_t   B3_Y;          ///<Buffer3 Y starting address
	uintptr_t   B3_CB;         ///<Buffer3 Cb/CbCrPack starting address
	uintptr_t   B3_CR;         ///<Buffer3 Cr starting address (not used in UVP format)
...
void idec_get_line_cnt(IDE_ID id, UINT32 *ui_line_cnt);
UINT8 ide_get_load_ready(IDE_ID id);
void idec_wait_line_mon(IDE_ID id);
void idec_wait_line2_mon(IDE_ID id);
void idec_set_line_mon1(IDE_ID id, UINT32 ui_idx);
void idec_set_line_mon2(IDE_ID id, UINT32 ui_idx);
void idec_wait_vsync(IDE_ID id);
...
void idec_set_bt656_sync(IDE_ID id, BOOL b_bt656);
...
BOOL idec_get_bt656_sync(IDE_ID id);
...
// Video buffer
void idec_set_v1_buf0_addr(IDE_ID id, uintptr_t ui_y_addr, uintptr_t ui_cb_addr, uintptr_t ui_cr_addr);
void idec_set_v1_buf1_addr(IDE_ID id, uintptr_t ui_y_addr, uintptr_t ui_cb_addr, uintptr_t ui_cr_addr);
void idec_set_v1_buf2_addr(IDE_ID id, uintptr_t ui_y_addr, uintptr_t ui_cb_addr, uintptr_t ui_cr_addr);
...
void idec_set_v2_buf0_addr(IDE_ID id, uintptr_t ui_y_addr, uintptr_t ui_cb_addr, uintptr_t ui_cr_addr);
void idec_set_v2_buf1_addr(IDE_ID id, uintptr_t ui_y_addr, uintptr_t ui_cb_addr, uintptr_t ui_cr_addr);
void idec_set_v2_buf2_addr(IDE_ID id, uintptr_t ui_y_addr, uintptr_t ui_cb_addr, uintptr_t ui_cr_addr);
...
void idec_get_v1_buf0_addr(IDE_ID id, uintptr_t *pui_y_addr, uintptr_t *pui_cb_addr, uintptr_t *pui_cr_addr);
void idec_get_v1_buf1_addr(IDE_ID id, uintptr_t *pui_y_addr, uintptr_t *pui_cb_addr, uintptr_t *pui_cr_addr);
void idec_get_v1_buf2_addr(IDE_ID id, uintptr_t *pui_y_addr, uintptr_t *pui_cb_addr, uintptr_t *pui_cr_addr);
...
void idec_get_v2_buf0_addr(IDE_ID id, uintptr_t *pui_y_addr, uintptr_t *pui_cb_addr, uintptr_t *pui_cr_addr);
void idec_get_v2_buf1_addr(IDE_ID id, uintptr_t *pui_y_addr, uintptr_t *pui_cb_addr, uintptr_t *pui_cr_addr);
void idec_get_v2_buf2_addr(IDE_ID id, uintptr_t *pui_y_addr, uintptr_t *pui_cb_addr, uintptr_t *pui_cr_addr);
...
// OSD buffer
void idec_set_o1_buf_addr(IDE_ID id, uintptr_t ui_addr);
void idec_set_o1_buf_alpha_addr(IDE_ID id, uintptr_t ui_addr);
...
void idec_get_o1_buf_addr(IDE_ID id, uintptr_t *ui_addr);
void idec_get_o1_alpha_buf_addr(IDE_ID id, uintptr_t *ui_addr);
...
BOOL idec_set_osd_buf_addr(IDE_ID id, IDE_OSDID osd_id, uintptr_t ui_osd_addr);
BOOL idec_get_osd_buf_addr(IDE_ID id, IDE_OSDID osd_id, uintptr_t *pui_osd_addr);
...
#define ide_set_dram_out(b_en)                   idec_set_dram_out(IDE_ID_1, b_en)
...
#define ide_set_axien(b_en)                       idec_set_axien(IDE_ID_1, b_en)
...
#define ide_get_dram_out()                       idec_get_dram_out(IDE_ID_1)
#define ide_get_dram_out_uvswap()                idec_get_dram_out_uvswap(IDE_ID_1)
