...
#define hdmiddc_set_config       i2c_set_config
...
typedef enum {
	HDMI_IDE_0,              ///< HDMI source IDE_0.
	HDMI_IDE_1,                ///< HDMI source IDE_1.
...
typedef enum {
	...
	HDMI_CONFIG_ID_FORCE_YUV422,    ///< Set ENABLE would force the HDMI output as YUV444 format. If set to DISABLE, the HDMI would output RGB or YUV format accrording to the EDID information.
	...
	HDMI_CONFIG_ID_AVI_RGB_SEL,	    ///< Set HDMI AVI info frame RGB Quantization select  0x0: default 0x1: limited 0x2: full range 
