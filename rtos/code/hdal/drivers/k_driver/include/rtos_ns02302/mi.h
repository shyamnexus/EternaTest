...
#define MIDATA_TYPE	UINT32
#else
#define MIDATA_TYPE	UINT64
#endif

#define TEST_TE_PIN			0
...
extern void mi_create_resource(void);
extern void mi_release_resource(void);
extern void mi_set_base_addr(MIDATA_TYPE addr);
...
#if TEST_TE_PIN
extern void mi_set_te_time(UINT32 time);
#endif
//@}
#endif
