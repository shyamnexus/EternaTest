...
typedef enum {
	...
	RTC_WAKEUP_SRC_PWR_SW3  = 0x00000008,
	RTC_WAKEUP_SRC_PWR_SW4  = 0x00000010,
...
extern BOOL             rtc_getPWRAlarmEn(void);
extern BOOL             rtc_isPWRAlarmEnabled(void);
extern BOOL             rtc_isPWRAlarm(void);


//RTC Fast Cset
extern UINT32           rtc_setFastCset(BOOL value);
extern BOOL             rtc_getFastCset(void);

// RTC Adjust
extern UINT32           rtc_setDivValueSel(UINT32 value);
extern UINT32           rtc_getDivValueSel(void);

extern UINT32           rtc_setClkDivDefault(UINT32 value);
extern UINT32           rtc_getClkDivDefault(void);

extern UINT32           rtc_setClkDivOffset(UINT32 value);
extern UINT32           rtc_getClkDivOffset(void);

extern UINT32           rtc_setClkDivOffset(UINT32 value);
extern UINT32           rtc_getClkDivOffset(void);

//RTC Adjust PSS
extern UINT32           rtc_setAdjMode(UINT32 value);
extern UINT32           rtc_getAdjMode(void);

extern UINT32           rtc_setStartPSSCnt(UINT32 value);
extern UINT32           rtc_getStartPSSCnt(void);

extern UINT32           rtc_setPSSCntSTS(UINT32 value);
extern UINT32           rtc_getPSSCntSTS(void);

extern UINT32           rtc_getPSSExtCntVal(void);
extern UINT32           rtc_getPSSInterCNTVal(void);



// Power button control
extern ER               pwbc_open(void);
extern BOOL             pwbc_isOpened(void);
extern void             pwbc_reset(void);
extern BOOL             pwbc_getCSET(void);
extern BOOL             pwbc_waitCSET(void);

extern void             pwbc_triggerCSET(void);
extern void             pwbc_waitCSETDone(void);
...
extern UINT32           rtc_set_pwr_en2(BOOL value);
extern BOOL             rtc_get_pwr_en2(void);

extern UINT32           rtc_set_pwr_analog(BOOL value);
extern BOOL             rtc_get_pwr_analog(void);

extern ER               rtc_set_pwronseq_time1(UINT32 time);
extern UINT32           rtc_get_pwronseq_time1(void);
extern ER               rtc_set_pwronseq_time2(UINT32 time);
extern UINT32           rtc_get_pwronseq_time2(void);

extern ER               rtc_set_pwroffseq_time1(UINT32 time);
extern UINT32           rtc_get_pwroffseq_time1(void);
extern ER               rtc_set_pwroffseq_time2(UINT32 time);
extern UINT32           rtc_get_pwroffseq_time2(void);
