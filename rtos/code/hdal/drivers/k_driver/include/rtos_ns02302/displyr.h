...
#define DISPBUFFORMAT_V1_CAP  (1<<DISPBUFFORMAT_YUV422PACK)|(1<<DISPBUFFORMAT_YUV420PACK)
#define DISPBUFFORMAT_V2_CAP  (1<<DISPBUFFORMAT_YUV422PACK)|(1<<DISPBUFFORMAT_YUV420PACK)
#define DISPBUFFORMAT_O1_CAP  (1<<DISPBUFFORMAT_ARGB8565)|(1<<DISPBUFFORMAT_ARGB8888)|(1<<DISPBUFFORMAT_ARGB4444)|(1<<DISPBUFFORMAT_ARGB1555)|\
	                          (1<<DISPBUFFORMAT_PAL8)
...
typedef enum {
	...
	DISPLAYER_OP_GET_CAP,                   ///< Get Layer's capability
	...
	union {
		...
		*/
		struct { // DISPLAYER_OP_SET_VDOBUFADDR
			...
			uintptr_t          ui_addr_y0;       ///< Buffer 0 Starting Address for  Y/RGB565/RGB888 plane
			uintptr_t          ui_addr_cb0;      ///< Buffer 0 Starting Address for Cb/Alpha  plane
			uintptr_t          ui_addr_cr0;      ///< Buffer 0 Starting Address for Cr        plane

			uintptr_t          ui_addr_y1;       ///< Buffer 1 Starting Address for  Y/RGB565/RGB888 plane
			uintptr_t          ui_addr_cb1;      ///< Buffer 1 Starting Address for Cb/Alpha  plane
			uintptr_t          ui_addr_cr1;      ///< Buffer 1 Starting Address for Cr        plane

			uintptr_t          ui_addr_y2;       ///< Buffer 2 Starting Address for  Y/RGB565/RGB888 plane
			uintptr_t          ui_addr_cb2;      ///< Buffer 2 Starting Address for Cb/Alpha  plane
			uintptr_t          ui_addr_cr2;      ///< Buffer 2 Starting Address for Cr        plane

			uintptr_t          ui_addr_y3;       ///< Buffer 3 Starting Address for  Y/RGB565/RGB888 plane
			uintptr_t          ui_addr_cb3;      ///< Buffer 3 Starting Address for Cb/Alpha  plane
			uintptr_t          ui_addr_cr3;      ///< Buffer 3 Starting Address for Cr        plane
		...
		*/
		struct { // DISPLAYER_OP_SET_OSDBUFADDR
			...
			uintptr_t          ui_addr_buf0;     ///< Buffer 0 Starting Address for OSD layer
			uintptr_t          ui_addr_buf1;     ///< Buffer 1 Starting Address for OSD layer
			uintptr_t          ui_addr_buf2;     ///< Buffer 2 Starting Address for OSD layer

#if 1// 96220 has no ARGB buffer format
			uintptr_t          ui_addr_alpha0;
			uintptr_t          ui_addr_alpha1;
			uintptr_t          ui_addr_alpha2;
#endif
		} SET_OSDBUFADDR;
		...
		*/
		...
		struct {
			UINT32     format;      ///< the format bit define is in DISPBUFFORMAT
            BOOL       rld;
			BOOL       ycc;
			BOOL       afbc;
		} GET_CAP;
