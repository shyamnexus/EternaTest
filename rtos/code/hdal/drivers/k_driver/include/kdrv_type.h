...
typedef enum {
	...
	KDRV_VDOOUT_GPE_ENGINE0 = 0x2002,
	KDRV_VDOOUT_GPE_ENGINE1 = 0x2003,
	...
	KDRV_VIDEOPROCS_PRE_ENGINE0 = 0x5009,

    KDRV_AUDCAP_ENGINE0          = 0x6000,  //< DAI0, RX >
	KDRV_AUDCAP_ENGINE0_LOOPBACK = 0x6010,  //< DAI0, TXLB >
	KDRV_AUDCAP_ENGINE1          = 0x6001,  //< DAI1, RX >
	KDRV_AUDCAP_ENGINE1_LOOPBACK = 0x6011,  //< DAI1, TXLB >
	KDRV_AUDCAP_ENGINE2          = 0x6002,  //< DAI2, RX >
	KDRV_AUDCAP_ENGINE2_LOOPBACK = 0x6012,  //< DAI2, TXLB >
	KDRV_AUDCAP_ENGINE3          = 0x6003,  //< DAI3, RX >
	KDRV_AUDCAP_ENGINE3_LOOPBACK = 0x6013,  //< DAI3, TXLB >
	KDRV_AUDCAP_ENGINEHDMI       = 0x6004,  //< DAI4, HDMI >

	KDRV_AUDOUT_ENGINE0     = 0x7000, //< DAI0, TX >
	KDRV_AUDOUT_ENGINE0_TX2 = 0x7010, //< DAI0, TX2 >
	KDRV_AUDOUT_ENGINE1     = 0x7001,
	KDRV_AUDOUT_ENGINE1_TX2 = 0x7011, //< DAI1, TX2 >
	KDRV_AUDOUT_ENGINE2     = 0x7002,
	KDRV_AUDOUT_ENGINE2_TX2 = 0x7012, //< DAI2, TX2 >
	KDRV_AUDOUT_ENGINE3     = 0x7003,
	KDRV_AUDOUT_ENGINE3_TX2 = 0x7013, //< DAI3, TX2 >
	KDRV_AUDOUT_ENGINEHDMI  = 0x7004,
...
typedef struct {
	...
	INT32 (*reserve_buf)(uintptr_t phy_addr, VOID *user_data);
	INT32 (*free_buf)(uintptr_t phy_addr, VOID *user_data);
} KDRV_CALLBACK_FUNC;

typedef struct {
	void (*VdoDec_RefFrmDo)(UINT32 pathID, uintptr_t uiYAddr, BOOL bIsRef);
	UINT32 id;
