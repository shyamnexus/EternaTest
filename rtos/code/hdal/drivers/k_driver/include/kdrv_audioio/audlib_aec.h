...
typedef struct {
	...
	ULONG      bitstream_buffer_play_in;			///< Audio Playback buffer address for AEC input.
	ULONG      bitstream_buffer_record_in;		///< Audio Record buffer address for AEC input.
	ULONG      bitstram_buffer_out;	///< AEC output BitStream buffer Address.
...
extern void     audlib_aec_set_config(AEC_CONFIG_ID aec_sel, ULONG aec_cfg_value);
extern BOOL     audlib_aec_init(void);
extern BOOL     audlib_aec_run(PAEC_BITSTREAM p_aec_io);
extern ULONG    audlib_aec_get_config(AEC_CONFIG_ID aec_sel);
...
*/
typedef struct {
	ULONG      bitstram_buffer_in;         ///< Audio Recorded buffer address for AudNS input.
	ULONG      bitstram_buffer_out;        ///< AudNS output BitStream buffer Address.
...
extern void     audlib_ns_set_config(AUDNS_CONFIG_ID ns_sel, ULONG ns_cfg_value);
