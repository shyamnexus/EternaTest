...
#define JPEGD_WIDTH_MIN				(16)
#define JPEGD_HEIGHT_MIN			(16)
#define JPEGD_WIDTH_MAX				(32768)
#define JPEGD_HEIGHT_MAX			(32768)
#define JPEGD_WIDTH_ALIGN			(64)
#define JPEGD_HEIGHT_ALIGN			(16)
#define JPEGD_BS_BUF_ADDR_ALIGN		(DRV_LIMIT_ALIGN_WORD)
#define JPEGD_OUT_BUF_ADDR_ALIGN	(DRV_LIMIT_ALIGN_WORD)
#define JPEGD_OUTPUT_FORMAT			(KDRV_BUFTYPE_YUV420_SP)
