...
typedef enum {
	...
	KDRV_IPE_INTE_MOTION_END			= 0x00020000,
	KDRV_IPE_INTERRUPT_ALL              = (KDRV_IPE_INTERRUPT_FMD | KDRV_IPE_INTERRUPT_STP | KDRV_IPE_INTERRUPT_FMS | KDRV_IPE_INTERRUPT_YCC_OUT_END | KDRV_IPE_INTERRUPT_GAMMA_IN_END |
											...
											KDRV_IPE_INTERRUPT_LL_ERR2 | KDRV_IPE_INTERRUPT_FRAMEERR | KDRV_IPE_INTERRUPT_CFA_SUBOUT_END | KDRV_IPE_INTE_DMAIN1END | KDRV_IPE_INTE_ENC_OUTOVFL | KDRV_IPE_INTE_MOTION_END)
} KDRV_IPE_INTERRUPT;
...
typedef struct {
	UINT8 static_symbol;
	UINT8 transition_symbol;
	UINT8 motion_symbol;
} KDRV_IPE_IQ_MOTION_SYMBOL_PARAM;

typedef struct {
	UINT8 static_str;
	UINT8 transition_str;
	UINT8 motion_str;
} KDRV_IPE_IQ_MOTION_STR_PARAM;
...
typedef struct {
	...
	//539A add
	BOOL motion_enable;
	KDRV_IPE_IQ_MOTION_SYMBOL_PARAM motion_symbol;
	KDRV_IPE_IQ_MOTION_STR_PARAM 	motion_str;
	UINT8 edge_ker_mode;
	UINT8 edge_mode;
} KDRV_IPE_IQ_EEXT;
...
typedef struct {
	BOOL enable;												///< enable function
	UINT32 mode;												///< Interpolation method
	union {
...
typedef enum{
	KDRV_IPE_MOTION_TYPE_1_64 = 0,
	KDRV_IPE_MOTION_TYPE_1_16,
	KDRV_IPE_MOTION_TYPE_1_4,
}KDRV_IPE_MOTION_TYPE;
...
//#endif
	...
	KDRV_IPE_BUF_ADDR edge_motion_addr;
	UINT32	edge_motion_in_lofs;
	UINT32	edge_motion_in_addr_lofs;

	KDRV_IPE_MOTION_TYPE motion_type;
