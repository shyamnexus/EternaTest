...
typedef enum _SDP_EVENTS {
	...
	SDP_EVENTS_FIFO_OVERRUN = 0x80,     ///< SDP DMA FIFO overrun

	SDP_EVENTS_CMD02_CONFLICT = 0x100,  ///< SDP Master sent command 02H conflict
	SDP_EVENTS_CMD03_CONFLICT = 0x200,  ///< SDP Master sent command 03H conflict
	SDP_EVENTS_CMD_UNKNOWN = 0x400,     ///< SDP Slave received a command that is not supported
...
void sdp_isr(void);
void sdp_init(uintptr_t BaseAddr);
