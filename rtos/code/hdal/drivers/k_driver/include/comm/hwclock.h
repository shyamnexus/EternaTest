...
/**
     Set additional offset for system long counter us.

     @param[in] offset      long counter offset.
*/
extern void hwclock_set_longcounter_offset(UINT64 offset);
...
*/
void hwclock_set_time(UINT32 timeID, struct tm ctv, ULONG param);
