...
typedef enum {
	...
	KDRV_SSENIF_CAP_VIE0 	= 0x01000000,	// To VIE0
	KDRV_SSENIF_CAP_VIE1 	= 0x02000000,	// To VIE1
...
*/
#define KDRV_SSENIF_CAP_CSILVDS0	(KDRV_SSENIF_CAP_EXIST | KDRV_SSENIF_CAP_SIE0 | KDRV_SSENIF_CAP_SIE1 | KDRV_SSENIF_CAP_SIE2 | KDRV_SSENIF_CAP_SIE3 \
									| KDRV_SSENIF_CAP_CK0 | KDRV_SSENIF_CAP_CK1 \
									| KDRV_SSENIF_CAP_DL0 | KDRV_SSENIF_CAP_DL1 | KDRV_SSENIF_CAP_DL2 | KDRV_SSENIF_CAP_DL3 \
									| KDRV_SSENIF_CAP_DL4 | KDRV_SSENIF_CAP_DL5 | KDRV_SSENIF_CAP_DL6 | KDRV_SSENIF_CAP_DL7)
...
*/
#define KDRV_SSENIF_CAP_CSILVDS1	(KDRV_SSENIF_CAP_EXIST | KDRV_SSENIF_CAP_SIE0 | KDRV_SSENIF_CAP_SIE1 | KDRV_SSENIF_CAP_SIE2 | KDRV_SSENIF_CAP_SIE3 \
									| KDRV_SSENIF_CAP_CK1 \
...
*/
#define KDRV_SSENIF_CAP_CSILVDS2	(KDRV_SSENIF_CAP_EXIST | KDRV_SSENIF_CAP_SIE2 | KDRV_SSENIF_CAP_SIE3 | KDRV_SSENIF_CAP_SIE4 | KDRV_SSENIF_CAP_VIE0 \
									| KDRV_SSENIF_CAP_CK2 \
									| KDRV_SSENIF_CAP_DL4 | KDRV_SSENIF_CAP_DL5 | KDRV_SSENIF_CAP_DL6 | KDRV_SSENIF_CAP_DL7)
...
*/
#define KDRV_SSENIF_CAP_CSILVDS3	(KDRV_SSENIF_CAP_EXIST | KDRV_SSENIF_CAP_SIE2 | KDRV_SSENIF_CAP_SIE3 | KDRV_SSENIF_CAP_SIE4 \
									| KDRV_SSENIF_CAP_CK3 \
									| KDRV_SSENIF_CAP_DL6 | KDRV_SSENIF_CAP_DL7)
