...
#define CTL_IFE_ISP_FCURVE_END_NUM					16
...
************************/
typedef enum{
	CTL_IFE_ISP_SPTL_FILT_5X5 = 0,
	CTL_IFE_ISP_SPTL_FILT_7x7 = 1,
}CTL_IFE_ISP_FILT_MODE;

typedef struct {
	CTL_IFE_ISP_FILT_MODE  ife_filt_mode;           ///< spatial filter mode. 5x5 or 7x7
...
typedef struct {
	...
	//Transition RTH1
	CTL_IFE_ISP_RANGE_FILTER_R		rng_filt_r_1;	///< range filter ch0
	CTL_IFE_ISP_RANGE_FILTER_GR		rng_filt_gr_1;	///< range filter ch1
	CTL_IFE_ISP_RANGE_FILTER_GB		rng_filt_gb_1;	///< range filter ch2
	CTL_IFE_ISP_RANGE_FILTER_B		rng_filt_b_1;	///< range filter ch3
	CTL_IFE_ISP_RANGE_FILTER_IR		rng_filt_ir_1;	///< range filter ch2
	//Motion RTH2
	CTL_IFE_ISP_RANGE_FILTER_R		rng_filt_r_2;	///< range filter ch0
	CTL_IFE_ISP_RANGE_FILTER_GR		rng_filt_gr_2;	///< range filter ch1
	CTL_IFE_ISP_RANGE_FILTER_GB		rng_filt_gb_2;	///< range filter ch2
	CTL_IFE_ISP_RANGE_FILTER_B		rng_filt_b_2;	///< range filter ch3
	CTL_IFE_ISP_RANGE_FILTER_IR		rng_filt_ir_2;	///< range filter ch2
	...
	CTL_IFE_ISP_MOTIONSET			motion_set;		///< motion set
} CTL_IFE_ISP_FILTER;
