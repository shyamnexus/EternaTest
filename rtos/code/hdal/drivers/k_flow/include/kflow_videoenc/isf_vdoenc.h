...
#define VDOENC_MAX_PATH_NUM	8
#else
#define VDOENC_MAX_PATH_NUM	32
#endif
#endif

#define VDOENC_MAX_WIDTH  3840
#define VDOENC_MAX_HEIGHT 2160

typedef enum {
    VDOENC_TILE_CTRL_DISABLE = 0,
    VDOENC_TILE_CTRL_USER,
    VDOENC_TILE_CTRL_DEFAULT,
    VDOENC_TILE_CTRL_MAX,
    ENUM_DUMMY4WORD(VDOENC_TILE_CTRL_MODE)
} VDOENC_TILE_CTRL_MODE;
...
typedef struct {
	uintptr_t phyaddr;      ///< memory addr to put JPEG bitstream
...
typedef struct {
    VDOENC_TILE_CTRL_MODE mode;
    UINT32              max_width;
    UINT32              max_height;
} VDOENC_USER_TILE_CTRL, *PVDOENC_USER_TILE_CTRL;
...
enum {
	...
	VDOENC_PARAM_JPG_FRAMERATE_BASE,     // jpeg encode framerate base
	VDOENC_PARAM_JPG_FRAMERATE_INCR,     // jpeg encode framerate incr
	...
	VDOENC_PARAM_JPG_COLOR_TO_GRAY,
	VDOENC_PARAM_TILE_SPLIT_MODE,
	...
	VDOENC_PARAM_USER_TILE_CTRL,
	VDOENC_PARAM_USER_DATA,
	VDOENC_PARAM_BS_RING,
	VDOENC_PARAM_BG_RDO,
	VDOENC_PARAM_WATERMARK,
	VDOENC_PARAM_EMBEDDED_MD,
	VDOENC_PARAM_JPEG_ROI,
	VDOENC_PARAM_SLICE_INTERRUPT,
	VDOENC_PARAM_SMART_ROI,
	VDOENC_PARAM_SMART_BBOX,
	VDOENC_PARAM_DYNAMIC_FR,
	VDOENC_PARAM_DYNAMIC_GOP,
	VDOENC_PARAM_SEI_SIGNED_VDO,
	VDOENC_PARAM_H26X_PRIVACY,
	VDOENC_PARAM_JPG_RC_VBR_PRIORITY,
	VDOENC_PARAM_JPG_RC_MIN_FRAME_RATE,
	VDOENC_PARAM_SKIP_BS_QUICK_ROLLBACK,
	...
	VDOENC_PARAM_JPG_UVC_SLICE_ENC,
};
