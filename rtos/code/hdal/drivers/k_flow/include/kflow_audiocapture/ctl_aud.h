...
typedef enum {
	CTL_AUD_ID_CAP = 0,   //record   (dai: i2s/eac)
	//	CTL_AUD_ID_CAP2,      //record   (none)
	//	CTL_AUD_ID_CAP3,      //record   (none)
	//	CTL_AUD_ID_CAP4,      //record   (none)
	CTL_AUD_ID_OUT,       //playback (dai: i2s/eac)
	//	CTL_AUD_ID_OUT2,      //playback (none)
	//	CTL_AUD_ID_OUT3,      //playback (none)
	//	CTL_AUD_ID_OUT4,      //playback (none)
	//	CTL_AUD_ID_OUT5,      //playback (none)
	CTL_AUD_ID_MAX,
