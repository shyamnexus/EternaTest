...
typedef unsigned int        NVTIPC_U32;     ///< Unsigned 32 bits data type
typedef signed int          NVTIPC_I32;     ///< Signed 32 bits data type
...
typedef struct _NVTIPC_SYS_MSG{
	...
	NVTIPC_U64       data_addr;           ///< system command Data Address.
...
*/
extern NVTIPC_KEY kflow_nvt_ipc_ftok(const char *path);
/**
...
*/
extern NVTIPC_I32 kflow_nvt_ipc_msg_get(NVTIPC_KEY key);
/**
...
*/
extern NVTIPC_ER kflow_nvt_ipc_msg_rel(NVTIPC_U32 msqid);
...
*/
extern NVTIPC_I32 kflow_nvt_ipc_msg_snd(NVTIPC_U32 msqid, NVTIPC_SENDTO sendTo, void*  pMsg, NVTIPC_U32 msgsz);
...
*/
extern NVTIPC_I32 kflow_nvt_ipc_msg_rcv(NVTIPC_U32 msqid, void*  pMsg, NVTIPC_U32 msgsz, NVTIPC_I32 timeout_ms);
...
/**
    ...
    @code
    {
        kflow_nvt_ipc_sem_lock(NVTIPC_SEMID_NAND);
    }
    @endcode

*/
extern NVTIPC_I32 	kflow_nvt_ipc_sem_lock(unsigned long semid);
...
/**
    ...
    @code
    {
        kflow_nvt_ipc_sem_unlock(NVTIPC_SEMID_NAND);
    }
    @endcode

*/
extern NVTIPC_I32 	kflow_nvt_ipc_sem_unlock(unsigned long semid);
...
/**
    ...
    @code
    {
	    NVTIPC_KEY key;
	    NVTIPC_I32 shm_addr;
    	key = kflow_nvt_ipc_ftok("lviewd");
        shm_addr = kflow_nvt_ipc_shm_get(key,size);
	    if (shm_addr < 0)
	    {
			DBG_ERR("shm_addr = %d\r\n",shm_addr);
	    }
...
*/
extern NVTIPC_U32   kflow_nvt_ipc_shm_get(NVTIPC_KEY key, NVTIPC_U32 size);
...
/**
    ...
    @code
    {
	    kflow_nvt_ipc_shm_rel(shm_addr);
    }
    @endcode

*/
extern NVTIPC_ER    kflow_nvt_ipc_shm_rel(NVTIPC_U32 shm_addr);


extern NVTIPC_U32   kflow_nvt_ipc_get_shm_addr(void);
extern NVTIPC_U32   kflow_nvt_ipc_set_dsp_log_addr(NVTIPC_U32 dsp_id, NVTIPC_U32 log_addr);

extern NVTIPC_I32   kflow_nvt_ipc_wait_core_rdy(NVTIPC_U32 core_id, NVTIPC_I32 timeout_ms);
