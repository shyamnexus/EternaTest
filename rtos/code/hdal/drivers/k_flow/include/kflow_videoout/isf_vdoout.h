...
typedef enum _VDOOUT_HDMI_ID {
	...
	VDOOUT_HDMI_3840X2160P60       = 97,   ///< HDMI VIDEO FORMAT IS 3840X2160 & PROGRESSIVE 60FPS
...
typedef enum {
	VDOOUT_BILINEAR_TYPE_NONE       = 0,
	VDOOUT_BILINEAR_TYPE_HORIZONTAL = 1,
	VDOOUT_BILINEAR_TYPE_VERTICAL   = 2,
	ENUM_DUMMY4WORD(VDOOUT_BILINEAR_TYPE)
} VDOOUT_BILINEAR_TYPE;
...
typedef struct {
	VDOOUT_HDMI_VDOABI  video_abi[60]; ///< The structure of the supported video format and its 3D ability.
...
typedef struct _VDOOUT_DDD_CFG {
    ...
    UINT32 hdmi_aud;
    UINT32 hdmi_timing_factor;
    UINT32 hdmi_rgb_range;
} VDOOUT_DEV_CFG;
...
enum {
	...
	VDOOUT_PARAM_VND_IN,
	VDOOUT_PARAM_VND_HDMI_AUDFMT,
	VDOOUT_PARAM_VND_MERGE_WND,
	VDOOUT_PARAM_VND_HDMI_TIMING_FACTOR,
	VDOOUT_PARAM_VND_HDMI_RGB_RANGE,
