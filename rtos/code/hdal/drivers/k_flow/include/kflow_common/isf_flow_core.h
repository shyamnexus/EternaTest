...
typedef struct _ISF_DATA_CLASS {
	...
	UINT32 base;
	//data
	ULONG  (*do_new)(struct _ISF_DATA *p_data, struct _ISF_UNIT *p_thisunit, ULONG pool, UINT32 buf_size, UINT32 ddr); ///< CB to new "custom data handle", or NULL if h_data is "nvtmpp blk_id"
	ISF_RV (*do_lock)(struct _ISF_DATA *p_data, struct _ISF_UNIT *p_thisunit, ULONG h_data); ///< CB to lock "custom data handle", or NULL if h_data is "nvtmpp blk_id"
	ISF_RV (*do_unlock)(struct _ISF_DATA *p_data, struct _ISF_UNIT *p_thisunit, ULONG h_data); ///< CB to unlock "custom data handle", or NULL if h_data is "nvtmpp blk_id"
...
#define ISF_ATTR_USER_DDR_FLAG		0x00000010
...
typedef struct _ISF_BASE_UNIT {
	...
	ULONG  (*do_create)(struct _ISF_UNIT *p_thisunit, ISF_PORT *p_srcport, CHAR* pool_name, UINT32 blk_size, UINT32 blk_cnt);  ///< CB to create pool
	ISF_RV (*do_destory)(struct _ISF_UNIT *p_thisunit, ISF_PORT *p_srcport, ULONG pool);  ///< CB to destory pool
	ULONG  (*do_new_i)(struct _ISF_UNIT *p_thisunit, ISF_PORT *p_srcport, CHAR* pool_name, UINT32 size, ISF_DATA *p_data);  ///< CB to create pool and new data
	ISF_RV (*do_release_i)(struct _ISF_UNIT *p_thisunit, ISF_DATA *p_data, ISF_RV result);  ///< CB to free data and destory pool
	ULONG  (*do_new)(struct _ISF_UNIT *p_thisunit, UINT32 nport, ULONG pool, ULONG attr, UINT32 size, ISF_DATA *p_data, UINT32 probe);  ///< CB to new data and reference =1
...
typedef struct _ISF_UNIT {
	...
	#endif
	ISF_RV (*do_setportparam)(struct _ISF_UNIT *p_thisunit, UINT32 nport, UINT32 param, ULONG value);  ///< CB to set parameter of ISF_IN() or ISF_OUT() port
	ULONG (*do_getportparam)(struct _ISF_UNIT *p_thisunit, UINT32 nport, UINT32 param);  ///< CB to get parameter of ISF_IN() or ISF_OUT() port
	ISF_RV (*do_setportstruct)(struct _ISF_UNIT *p_thisunit, UINT32 nport, UINT32 param, ULONG* p_struct, UINT32 size);  ///< CB to set parameter of ISF_IN() or ISF_OUT() port
	ISF_RV (*do_getportstruct)(struct _ISF_UNIT *p_thisunit, UINT32 nport, UINT32 param, ULONG* p_struct, UINT32 size);  ///< CB to get parameter of ISF_IN() or ISF_OUT() port
...
extern ISF_RV _isf_unit_set_param(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 nport, UINT32 param, ULONG* p_value);
...
extern ISF_RV _isf_unit_get_param(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 nport, UINT32 param, ULONG* p_value);
...
extern ULONG  _isf_unit_new_data(UINT32 size, ISF_DATA *p_data);
