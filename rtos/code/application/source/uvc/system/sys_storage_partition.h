...
#define PARTITION_PATH_RTOS1  MAKE_FDT_PARTITION_PATH(rtos1)
#define PARTITION_PATH_BANK   MAKE_FDT_PARTITION_PATH(bank)
#define PARTITION_PATH_BANK1  MAKE_FDT_PARTITION_PATH(bank1)
#define PARTITION_PATH_PST    MAKE_FDT_PARTITION_PATH(pstore)
