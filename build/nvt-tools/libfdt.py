...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            spec = importlib.util.find_spec('_libfdt')
            if spec is None:
                import _libfdt
                return _libfdt
...
def fdt_property_string(*args):
  return _libfdt.fdt_property_string(*args)
...
def fdt_property_stub(*args):
  return _libfdt.fdt_property_stub(*args)
...
def fdt16_ld(*args):
  return _libfdt.fdt16_ld(*args)
fdt16_ld = _libfdt.fdt16_ld

def fdt32_ld(*args):
  return _libfdt.fdt32_ld(*args)
fdt32_ld = _libfdt.fdt32_ld

def fdt32_st(*args):
  return _libfdt.fdt32_st(*args)
fdt32_st = _libfdt.fdt32_st

def fdt64_ld(*args):
  return _libfdt.fdt64_ld(*args)
fdt64_ld = _libfdt.fdt64_ld

def fdt64_st(*args):
  return _libfdt.fdt64_st(*args)
...
def fdt_header_size(*args):
  return _libfdt.fdt_header_size(*args)
fdt_header_size = _libfdt.fdt_header_size

def fdt_header_size_(*args):
  return _libfdt.fdt_header_size_(*args)
...
def fdt_check_full(*args):
  return _libfdt.fdt_check_full(*args)
fdt_check_full = _libfdt.fdt_check_full

def fdt_get_string(*args):
  return _libfdt.fdt_get_string(*args)
...
def fdt_find_max_phandle(*args):
  return _libfdt.fdt_find_max_phandle(*args)
...
def fdt_generate_phandle(*args):
  return _libfdt.fdt_generate_phandle(*args)
...
def fdt_create_with_flags(*args):
  return _libfdt.fdt_create_with_flags(*args)
...
def fdt_setprop_placeholder(*args):
  return _libfdt.fdt_setprop_placeholder(*args)
...
def fdt_appendprop_addrrange(*args):
  return _libfdt.fdt_appendprop_addrrange(*args)
